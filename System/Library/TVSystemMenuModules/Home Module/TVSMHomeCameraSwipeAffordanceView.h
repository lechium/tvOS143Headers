...
- (void).cxx_destruct;	// IMP=0x0000000000012228
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000121f8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000011ff8
