...
+ (id)_fullScreenCameraLayout;	// IMP=0x000000000001384c
- (void).cxx_destruct;	// IMP=0x0000000000014118
...
- (id)_newCollectionViewWithFrame:(struct CGRect)arg1 collectionViewLayout:(id)arg2;	// IMP=0x0000000000013ef4
- (void)_toggleContentViews:(id)arg1;	// IMP=0x0000000000013d5c
- (void)_setPageControlsViewHidden:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000013bf0
- (void)_scheduleHidePageControlsViewTimerIfNeeded;	// IMP=0x0000000000013a78
- (void)systemMenuDidRequestDismissalWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000136b0
- (void)didPressMenu:(id)arg1;	// IMP=0x00000000000134f8
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x000000000001346c
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000013178
- (void)updateCameraItemsAnimated:(_Bool)arg1;	// IMP=0x0000000000012aec
- (void)updateCollectionViewWithInitialCameraView;	// IMP=0x0000000000012aa0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000012990
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000012878
- (void)viewDidLoad;	// IMP=0x00000000000123ec
- (id)initWithCameraItems:(id)arg1 focusedIdentifier:(id)arg2;	// IMP=0x0000000000012270
