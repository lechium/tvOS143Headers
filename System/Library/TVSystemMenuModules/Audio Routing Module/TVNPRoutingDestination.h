...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000001d7c0
- (void)connectAndPair;	// IMP=0x000000000001d7bc
- (void)togglePlayPause;	// IMP=0x000000000001d7b8
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000001d784
- (id)init;	// IMP=0x000000000001d76c
