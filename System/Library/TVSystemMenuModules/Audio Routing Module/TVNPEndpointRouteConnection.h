...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x000000000001934c
- (void).cxx_destruct;	// IMP=0x000000000001bba0
...
- (id)_preloadArtwork;	// IMP=0x000000000001b990
- (id)_placeholderArtwork;	// IMP=0x000000000001b8bc
- (void)_updateState;	// IMP=0x000000000001b728
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000000001b668
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000000001b1e4
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000000001b0dc
- (void)_updateMetadata;	// IMP=0x0000000000019f80
- (void)_createRequestController;	// IMP=0x0000000000019b10
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x00000000000198d4
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000000019794
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000000000194e4
- (void)playPause;	// IMP=0x00000000000194d0
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000019474
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000193d8
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x00000000000192f8
- (id)playerPath;	// IMP=0x000000000001924c
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x000000000001910c
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000018ea0
