...
+ (id)_destinationLayout;	// IMP=0x000000000000a500
...
- (id)_routesLayout;	// IMP=0x000000000000a600
- (void)_updateHintText;	// IMP=0x00000000000097a8
- (void)_updateTitleView;	// IMP=0x0000000000009700
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000009614
- (void)didPressPlayPause:(id)arg1;	// IMP=0x00000000000095a0
- (void)didPressMenu:(id)arg1;	// IMP=0x000000000000952c
- (void)routingViewController:(id)arg1 shareAudioPresentationRequested:(id)arg2;	// IMP=0x0000000000009514
- (void)routingViewControllerWillEndEditingVolume:(id)arg1;	// IMP=0x00000000000094c4
- (void)routingViewControllerWillBeginEditingVolume:(id)arg1;	// IMP=0x0000000000009470
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0000000000009418
- (id)preferredFocusEnvironments;	// IMP=0x00000000000093a0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000009348
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000092f0
- (void)viewDidLoad;	// IMP=0x00000000000086cc
- (void)dealloc;	// IMP=0x0000000000008580
- (id)initWithRoutingController:(id)arg1 options:(id)arg2;	// IMP=0x0000000000007fe0
