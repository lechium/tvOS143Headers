...
-(void)_addAuxImagesIfNeededForEncodingScheme:(int)arg1 sampleBuffer:(opaqueCMSampleBufferRef)arg2 metadata:(id)arg3 stillImageSettings:(id)arg4 scaleFactor:(float)arg5 processingFlags:(unsigned)arg6 ;
