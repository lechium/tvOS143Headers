...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x0000000000003b08
- (void).cxx_destruct;	// IMP=0x0000000000007cc0
...
- (void)readBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007ae8
- (void)connectToBatteryServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000079f4
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000079e0
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000079cc
- (void)enqueueTransient:(id)arg1 hapticMotor:(unsigned long long)arg2;	// IMP=0x00000000000078f4
- (void)setHapticMotor:(unsigned long long)arg1 frequency:(float)arg2 amplitude:(float)arg3;	// IMP=0x000000000000787c
- (void)fetchDeviceRegistryIDWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000077e8
- (void)requestServiceWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000770c
- (void)ping;	// IMP=0x00000000000076a0
- (float)defaultHapticDispatchFrequency;	// IMP=0x0000000000007694
- (id)defaultHapticMotors;	// IMP=0x0000000000007680
- (float)defaultRightAxisSnapRadius;	// IMP=0x0000000000007678
- (float)defaultLeftAxisSnapRadius;	// IMP=0x0000000000007670
- (float)defaultRightThumbstickDeadzoneRadius;	// IMP=0x0000000000007668
- (float)defaultLeftThumbstickDeadzoneRadius;	// IMP=0x0000000000007660
- (float)defaultIdleTimeoutDuration;	// IMP=0x0000000000007654
- (float)defaultRightThumbstickNoiseBuffer;	// IMP=0x000000000000764c
- (float)defaultLeftThumbstickNoiseBuffer;	// IMP=0x0000000000007644
- (void)enableHaptics;	// IMP=0x0000000000007398
- (_Bool)updateHapticMotor:(id)arg1;	// IMP=0x0000000000007280
- (void)stopHaptics;	// IMP=0x00000000000070d8
- (unsigned int)numberOfTimesToSendZeroHapticReport;	// IMP=0x00000000000070d0
- (_Bool)isHapticsActive;	// IMP=0x00000000000070c8
- (void)updateHaptics:(_Bool)arg1;	// IMP=0x00000000000070c4
- (void)dispatchHapticEvent;	// IMP=0x00000000000070c0
- (_Bool)isAnyHapticMotorEnabled;	// IMP=0x0000000000006edc
- (void)dispatchShareButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006de8
- (void)dispatchOptionsButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006cf4
- (void)dispatchMenuButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006c00
- (void)dispatchHomeButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006b0c
- (void)dispatchGameControllerExtendedEventWithState:(CDStruct_5be5f302)arg1;	// IMP=0x0000000000006600
- (void)dispatchMotionEventWithState:(CDStruct_06597ee6)arg1;	// IMP=0x0000000000006364
- (_Bool)isTwoAxisInputIdle:(MISSING_TYPE **)arg1 prevInput:(MISSING_TYPE **)arg2 noiseBuffer:(float)arg3;	// IMP=0x0000000000006308
- (void)applyDeadzone:(float)arg1 axisSnapRadius:(float)arg2 input:(MISSING_TYPE **)arg3;	// IMP=0x0000000000006254
- (void)dispatchEvent:(id)arg1;	// IMP=0x0000000000006244
- (void)dispatchEvent:(id)arg1 updateLastEventTime:(_Bool)arg2;	// IMP=0x00000000000061d0
- (id)createEvent:(unsigned int)arg1;	// IMP=0x0000000000006178
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x0000000000006170
- (_Bool)isIdle;	// IMP=0x0000000000006018
- (void)updateIdleState;	// IMP=0x0000000000005f60
- (void)scheduleIdleTimer;	// IMP=0x0000000000005e10
- (_Bool)shouldCreateBatteryDevice;	// IMP=0x0000000000005e08
- (void)sendBatteryReport;	// IMP=0x0000000000005cfc
- (void)updateClientBattery;	// IMP=0x0000000000005c24
- (void)createVirtualHIDDeviceForBattery;	// IMP=0x00000000000058d0
- (void)disconnect;	// IMP=0x0000000000005684
- (void)setupRawReportHandling;	// IMP=0x0000000000005680
- (void)clientNotification:(id)arg1 added:(_Bool)arg2;	// IMP=0x0000000000005598
- (void)setDispatchQueue:(id)arg1;	// IMP=0x00000000000054a4
- (void)cancel;	// IMP=0x0000000000005354
- (void)activate;	// IMP=0x00000000000052cc
- (void)setCancelHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000050c0
- (void)setEventDispatcher:(id)arg1;	// IMP=0x0000000000004ff0
- (id)eventMatching:(id)arg1 forClient:(id)arg2;	// IMP=0x0000000000004e78
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x0000000000004d44
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x00000000000049cc
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000046a4
- (id)initWithService:(unsigned int)arg1;	// IMP=0x0000000000003f00
- (void)initGameControllerDaemonXPC;	// IMP=0x0000000000003b10
