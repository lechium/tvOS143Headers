...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000001c28
...
- (id)description;	// IMP=0x0000000000001ae4
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x00000000000018c8
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001828
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001674
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001d78
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001c30
