...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000233c
...
- (id)description;	// IMP=0x00000000000021f8
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001fdc
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001f3c
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001d88
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000248c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002344
