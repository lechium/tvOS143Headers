...
@interface DualShock4HIDServicePlugin : GCGamepadHIDServicePlugin <GCLightServiceServerInterface, GCMotionServiceServerInterface, HIDServicePlugin>
{
...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x0000000000002f58
...
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006564
- (void)updateSensorsActive:(_Bool)arg1;	// IMP=0x00000000000063f0
- (void)readSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000063d8
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000062dc
- (void)updateLightWithRed:(float)arg1 green:(float)arg2 blue:(float)arg3;	// IMP=0x00000000000060b8
- (void)readLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000005fd0
- (id)defaultHapticMotors;	// IMP=0x0000000000005eec
- (float)defaultHapticDispatchFrequency;	// IMP=0x0000000000005ee0
- (void)dispatchHapticEvent;	// IMP=0x0000000000005e94
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x0000000000005e88
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x0000000000005d54
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x0000000000005a30
@property(readonly, copy) NSString *description;
- (void)updateBatteryLevel:(unsigned char)arg1 isPowerSupplyConnected:(_Bool)arg2;	// IMP=0x0000000000005858
- (void)dispatchOutputReport;	// IMP=0x0000000000005518
- (void)setupRawReportHandling;	// IMP=0x00000000000049f8
- (void)requestPairingInfo;	// IMP=0x0000000000004720
- (void)requestSensorCalibrationInfo;	// IMP=0x0000000000003ac4
- (void)requestFirmwareInfo;	// IMP=0x00000000000035fc
- (void)determineSupportMode;	// IMP=0x00000000000032c8
- (id)initWithService:(unsigned int)arg1;	// IMP=0x0000000000003028
