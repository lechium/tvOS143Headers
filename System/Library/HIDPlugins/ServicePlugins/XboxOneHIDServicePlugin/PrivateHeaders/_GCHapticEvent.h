...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000053dc
...
- (id)description;	// IMP=0x0000000000005298
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x000000000000507c
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000004fdc
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000004e28
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000552c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000053e4
