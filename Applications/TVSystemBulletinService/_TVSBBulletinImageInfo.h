...
+ (id)infoWithSymbolName:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000100011f14
+ (id)infoWithImageName:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000100011e6c
+ (id)infoWithImageName:(id)arg1;	// IMP=0x0000000100011e04
