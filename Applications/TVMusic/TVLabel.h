...
- (void)_clearCachedValues;	// IMP=0x00000001000585ac
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000584dc
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x00000001000583a0
- (_Bool)canBecomeFocused;	// IMP=0x0000000100058394
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x0000000100058344
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x00000001000582f4
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x00000001000582a4
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x0000000100058254
- (void)setFont:(id)arg1;	// IMP=0x0000000100058204
- (void)setText:(id)arg1;	// IMP=0x00000001000581b4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000580ec
