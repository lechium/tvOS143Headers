...
- (void).cxx_destruct;	// IMP=0x00000001000d44b4
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000001000d3cb4
- (void)scrollViewDidEndDecelerating:(id)arg1;	// IMP=0x00000001000d3c44
- (void)scrollViewWillEndDragging:(id)arg1 withVelocity:(struct CGPoint)arg2 targetContentOffset:(inout struct CGPoint *)arg3;	// IMP=0x00000001000d3a0c
- (void)scrollViewWillBeginDragging:(id)arg1;	// IMP=0x00000001000d399c
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000001000d38e4
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000001000d3840
- (void)_reportPAFEventForLyricsView;	// IMP=0x00000001000d3400
- (double)_springAnimate:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000d3260
- (double)_springAnimate:(CDUnknownBlockType)arg1;	// IMP=0x00000001000d3250
- (double)_scrollToLine:(long long)arg1 animated:(_Bool)arg2 cascading:(_Bool)arg3;	// IMP=0x00000001000d2b10
- (double)_scrollOffsetForLine:(long long)arg1;	// IMP=0x00000001000d2a00
- (void)_scaleView:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x00000001000d291c
- (void)_unhighlightLabel:(id)arg1;	// IMP=0x00000001000d2758
- (void)_highlightLabel:(id)arg1;	// IMP=0x00000001000d25cc
- (void)_unhideLabel:(id)arg1;	// IMP=0x00000001000d24d8
- (void)_hideLabel:(id)arg1;	// IMP=0x00000001000d2378
- (void)_updateInterludeProgressForPlayPosition:(double)arg1;	// IMP=0x00000001000d22dc
- (void)_updateLyricsCountdownViewForPlayPosition:(double)arg1;	// IMP=0x00000001000d21c8
- (void)_redisplayHiddenLines;	// IMP=0x00000001000d1f0c
- (id)_labelsToHide;	// IMP=0x00000001000d1db4
- (void)_hideLinesAboveCurrentLine;	// IMP=0x00000001000d1c24
- (void)_displayLinkUpdate;	// IMP=0x00000001000d16bc
- (_Bool)_canShowPlayButton;	// IMP=0x00000001000d1628
@property(readonly, nonatomic) _Bool isAutoScrolling;
- (void)_animateLabelsForScrollPosition:(double)arg1;	// IMP=0x00000001000d11d4
- (_Bool)_animateCascadeLabels:(id)arg1 relativeScrollOffset:(double)arg2;	// IMP=0x00000001000d0f2c
- (_Bool)_animateCascadeLabel:(id)arg1 labelIndexOffset:(long long)arg2 labelStartY:(double)arg3 relativeScrollOffset:(double)arg4;	// IMP=0x00000001000d0dd8
- (void)_highlightLine:(long long)arg1;	// IMP=0x00000001000d0b64
- (void)_stopTimedLyricsUpdating;	// IMP=0x00000001000d0a38
- (void)_startTimedLyricsUpdating;	// IMP=0x00000001000d0880
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000d0750
- (id)_labelForText:(id)arg1 textColor:(id)arg2 yPos:(double)arg3;	// IMP=0x00000001000d0530
- (void)_play;	// IMP=0x00000001000d0434
- (void)_handleTripleClick:(id)arg1;	// IMP=0x00000001000d0428
- (void)_handleMenuButton:(id)arg1;	// IMP=0x00000001000d03c8
- (void)_getDataFromAdjustmentPanel:(id)arg1;	// IMP=0x00000001000d0170
- (void)_showAdjustmentsView;	// IMP=0x00000001000cfda8
- (void)_jumpToCurrentLocation;	// IMP=0x00000001000cfb90
- (long long)_indexForLabelClosestTo:(double)arg1;	// IMP=0x00000001000cf954
- (long long)_lyricsLineIndexForLabelClosestTo:(double)arg1;	// IMP=0x00000001000cf8f0
- (_Bool)_isInSystemNowPlaying;	// IMP=0x00000001000cf84c
- (_Bool)_isViewActuallyVisible;	// IMP=0x00000001000cf7d0
@property(readonly, nonatomic) _Bool isViewVisible;
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000001000cf770
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000001000cf720
- (void)_viewWillDisappear;	// IMP=0x00000001000cf648
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000001000cf5e4
- (void)_viewDidAppear;	// IMP=0x00000001000cf508
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000cf368
- (void)_updateLabelPositionsWithLinespacing:(double)arg1 font:(id)arg2;	// IMP=0x00000001000cef7c
- (long long)_indexOfLyricsLineAtTime:(double)arg1;	// IMP=0x00000001000ced14
- (id)_lyricsTextColor;	// IMP=0x00000001000ceca0
- (id)_stringForTimeInterval:(double)arg1;	// IMP=0x00000001000cebb8
- (void)_configureStartTimeLabelForLine:(long long)arg1;	// IMP=0x00000001000ce8ac
- (id)_createSongwritersLabelAtYPosition:(double)arg1;	// IMP=0x00000001000ce638
- (void)_registerStateMachineHandlers;	// IMP=0x00000001000cd3f4
- (_Bool)_handleInterludeForLabelIndex:(long long)arg1 atElapsedTime:(double)arg2;	// IMP=0x00000001000ccfcc
- (void)_closeInterludeGap;	// IMP=0x00000001000ccbf4
- (double)_openInterludeGapAfterLabelIndex:(long long)arg1;	// IMP=0x00000001000cc968
- (void)_showInterludePlaceholderAfterLabelIndex:(long long)arg1;	// IMP=0x00000001000cc584
- (void)_serviceAutoscrollTimeout;	// IMP=0x00000001000cc4e0
- (void)_clearAutoscrollTimeout;	// IMP=0x00000001000cc4d0
- (void)_setAutoscrollTimeout;	// IMP=0x00000001000cc4a4
- (id)_labelAtIndex:(long long)arg1;	// IMP=0x00000001000cc3e4
- (void)setPlayButtonEnabled:(_Bool)arg1 updateLineHighlight:(_Bool)arg2;	// IMP=0x00000001000cc098
@property(nonatomic) double fontSize;
- (struct CGSize)preferredContentSize;	// IMP=0x00000001000cbac8
- (void)_setTextAlphaForUserInterfaceStyle:(long long)arg1;	// IMP=0x00000001000cba78
- (void)_setTextVibrancyForUserInterfaceStyle:(long long)arg1;	// IMP=0x00000001000cb9c0
- (void)_updateForUserInterfaceStyle:(long long)arg1;	// IMP=0x00000001000cb7b0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000cb62c
- (void)viewDidLoad;	// IMP=0x00000001000ca35c
- (void)applicationDidBecomeActive:(id)arg1;	// IMP=0x00000001000ca350
- (void)applicationWillResignActive:(id)arg1;	// IMP=0x00000001000ca2c8
- (_Bool)handleSelectGesture;	// IMP=0x00000001000ca200
- (id)initWithLyricsInfo:(id)arg1 viewSize:(struct CGSize)arg2;	// IMP=0x00000001000c9cb8
- (id)initWithLyricsInfo:(id)arg1;	// IMP=0x00000001000c9ca0
