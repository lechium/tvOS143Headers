...
+ (void)subjectWithSongInPlayQueue:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010008420c
+ (void)subjectWithLibraryObject:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100084014
+ (void)subjectWithObject:(id)arg1 playbackReportingDictionary:(id)arg2 container:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100083df8
- (void).cxx_destruct;	// IMP=0x0000000100084b00
...
- (id)initWithLibraryObject:(id)arg1 container:(id)arg2;	// IMP=0x000000010008494c
- (id)initWithObject:(id)arg1 playbackReportingDictionary:(id)arg2 container:(id)arg3;	// IMP=0x00000001000847d0
