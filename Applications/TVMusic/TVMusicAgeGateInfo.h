...
+ (void)initialize;	// IMP=0x0000000100054624
+ (id)ageGateInfoFromURLBag;	// IMP=0x00000001000545ac
- (void).cxx_destruct;	// IMP=0x0000000100054d18
...
- (id)description;	// IMP=0x0000000100054be4
- (id)initWithRatingThreshold:(long long)arg1 dialogTitle:(id)arg2 dialogMessage:(id)arg3;	// IMP=0x0000000100054b30
- (id)initFromURLBag;	// IMP=0x000000010005468c
- (id)init;	// IMP=0x0000000100054658
