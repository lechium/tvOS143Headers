...
- (void).cxx_destruct;	// IMP=0x000000010004c30c
...
- (void)loadImagesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010004bb14
- (id)identifier;	// IMP=0x000000010004b5d8
- (id)initWithImageProxies:(id)arg1 playlistStyle:(id)arg2;	// IMP=0x000000010004b518
