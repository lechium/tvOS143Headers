...
+ (id)loadingScreen;	// IMP=0x00000001000b46c0
- (void).cxx_destruct;	// IMP=0x00000001000b5df0
...
- (_Bool)isVisible;	// IMP=0x00000001000b5ccc
- (void)hide;	// IMP=0x00000001000b5750
- (void)timeout;	// IMP=0x00000001000b570c
- (void)showOverKeyWindowWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000b477c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b4624
