...
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000010007e754
- (void)_playerPathChanged:(id)arg1;	// IMP=0x000000010007e5cc
- (long long)playbackStateforItemWithIdentifiers:(id)arg1 inContainer:(id)arg2;	// IMP=0x000000010007e424
- (long long)playbackStateforItemWithIdentifiers:(id)arg1;	// IMP=0x000000010007e230
- (void)dealloc;	// IMP=0x000000010007e194
- (id)init;	// IMP=0x000000010007dc34
