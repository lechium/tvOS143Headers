...
- (void).cxx_destruct;	// IMP=0x0000000100056c5c
...
- (void)viewDidLayoutSubviews;	// IMP=0x000000010005680c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100056630
- (void)loadView;	// IMP=0x00000001000563cc
- (void)dealloc;	// IMP=0x000000010005636c
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000562e8
