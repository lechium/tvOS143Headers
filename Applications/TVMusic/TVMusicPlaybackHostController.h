...
- (void).cxx_destruct;	// IMP=0x00000001000137b4
...
- (_Bool)_tvTabBarShouldAutohide;	// IMP=0x0000000100013744
- (id)preferredFocusEnvironments;	// IMP=0x00000001000136a4
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000001000135a0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000132ec
- (id)initWithPlayer:(id)arg1;	// IMP=0x0000000100013264
