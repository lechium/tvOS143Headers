...
+ (void)initialize;	// IMP=0x000000010009810c
- (void).cxx_destruct;	// IMP=0x0000000100099ef8
...
- (void)_getArtworkURLsForAlbums:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100098b04
- (void)_fetchPhotoAssetsForAlbumArtwork:(CDUnknownBlockType)arg1;	// IMP=0x0000000100098304
- (void)registerRemotePhotoServer:(id)arg1;	// IMP=0x0000000100098238
- (void)photoAssetsWithOptions:(id)arg1 responseBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000981a4
- (id)init;	// IMP=0x0000000100098140
