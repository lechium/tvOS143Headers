...
- (void).cxx_destruct;	// IMP=0x0000000100083da4
...
- (void)_checkForPreloadCompletion;	// IMP=0x0000000100083c94
- (void)_artworkDidFail:(id)arg1;	// IMP=0x0000000100083b98
- (void)_artworkDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x0000000100083acc
- (void)_loadPendingImages;	// IMP=0x0000000100083880
- (id)_artworkCatalogToLoadNext;	// IMP=0x00000001000837cc
- (void)_fillQueue;	// IMP=0x00000001000836c8
- (long long)_currentQueueSize;	// IMP=0x000000010008366c
- (id)popNextImage;	// IMP=0x00000001000835c8
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010008356c
- (id)init;	// IMP=0x0000000100083400
