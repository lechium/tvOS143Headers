...
- (void).cxx_destruct;	// IMP=0x000000010004a800
...
- (struct CGSize)_fillSize;	// IMP=0x000000010004a664
- (void)setProgress:(float)arg1 animated:(_Bool)arg2;	// IMP=0x000000010004a5a4
- (void)tintColorDidChange;	// IMP=0x000000010004a390
- (void)layoutSubviews;	// IMP=0x000000010004a1f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100049fe0
