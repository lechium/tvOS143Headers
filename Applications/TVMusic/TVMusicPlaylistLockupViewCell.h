...
+ (id)playlistViewFromElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00000001000b5e6c
- (void).cxx_destruct;	// IMP=0x00000001000b80b8
...
- (id)_randomColor;	// IMP=0x00000001000b7f1c
- (void)_configureLabel:(id)arg1 withTextElement:(id)arg2 maxWidth:(double)arg3;	// IMP=0x00000001000b7d8c
- (struct CGRect)_scaleRect:(struct CGRect)arg1 withStyle:(id)arg2;	// IMP=0x00000001000b7c6c
- (void)_setColorsForUserInterfaceStyle:(long long)arg1;	// IMP=0x00000001000b7b18
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000b7a4c
- (void)layoutSubviews;	// IMP=0x00000001000b7968
- (void)layoutWithElement:(id)arg1;	// IMP=0x00000001000b6614
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000b6588
- (void)prepareForReuse;	// IMP=0x00000001000b6534
- (_Bool)canBecomeFocused;	// IMP=0x00000001000b652c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b5f20
