...
- (void).cxx_destruct;	// IMP=0x0000000100010c14
...
- (void)_callElapsedTimeObserversDueToTimeJump:(_Bool)arg1;	// IMP=0x0000000100010830
- (void)_fireElapsedTimeUpdate:(id)arg1;	// IMP=0x0000000100010820
- (void)_updateElapsedTimeTimer;	// IMP=0x0000000100010744
@property(readonly, nonatomic) double elapsedTime;
- (float)_rateForState:(id)arg1;	// IMP=0x0000000100010324
...
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x0000000100010080
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x000000010001007c
- (void)updateSubtitleOptions;	// IMP=0x0000000100010078
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x0000000100010074
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010001006c
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100010064
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000fff0
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x000000010000ff28
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x000000010000fed4
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x000000010000fec8
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2;	// IMP=0x000000010000febc
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x000000010000feb0
- (void)setElapsedTime:(double)arg1;	// IMP=0x000000010000fdb0
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000fda4
- (void)stop;	// IMP=0x000000010000fd14
- (void)scanWithRate:(double)arg1;	// IMP=0x000000010000fba4
- (void)togglePlayPause;	// IMP=0x000000010000fb5c
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000fb50
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000fb44
- (void)pause;	// IMP=0x000000010000fafc
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000faf0
- (void)play;	// IMP=0x000000010000fa04
- (void)continueLoadingCurrentItem;	// IMP=0x000000010000fa00
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x000000010000f994
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x000000010000f984
- (void)setLastElapsedTime:(double)arg1 atTimestamp:(id)arg2;	// IMP=0x000000010000f910
- (void)invalidate;	// IMP=0x000000010000f8dc
- (id)initWithName:(id)arg1;	// IMP=0x000000010000f7f4
- (id)init;	// IMP=0x000000010000f7e4
