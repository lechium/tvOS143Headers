...
- (void).cxx_destruct;	// IMP=0x000000010000f754
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000010000f638
- (void)connectAndPair;	// IMP=0x000000010000f634
- (void)togglePlayPause;	// IMP=0x000000010000f630
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000010000f5fc
- (id)init;	// IMP=0x000000010000f5e4
