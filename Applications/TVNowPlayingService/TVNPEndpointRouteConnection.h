...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0000000100028b88
- (void).cxx_destruct;	// IMP=0x000000010002b37c
...
- (id)_preloadArtwork;	// IMP=0x000000010002b16c
- (id)_placeholderArtwork;	// IMP=0x000000010002b098
- (void)_updateState;	// IMP=0x000000010002af04
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000010002ae44
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000010002a9f0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000010002a8e8
- (void)_updateMetadata;	// IMP=0x000000010002978c
- (void)_createRequestController;	// IMP=0x000000010002931c
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x00000001000290e0
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000100028fd0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000100028d20
- (void)playPause;	// IMP=0x0000000100028d0c
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000100028cb0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100028c14
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000100028b34
- (id)playerPath;	// IMP=0x0000000100028a88
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000100028948
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x00000001000286dc
