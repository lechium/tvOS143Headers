...
+ (id)contextWithReason:(unsigned long long)arg1;	// IMP=0x000000010014492c
+ (id)defaultContext;	// IMP=0x00000001001448c4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100144998
- (_Bool)playbackIsUserRequested;	// IMP=0x0000000100144974
