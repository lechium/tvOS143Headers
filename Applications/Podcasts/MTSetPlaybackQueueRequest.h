...
+ (id)requestWithContext:(id)arg1;	// IMP=0x0000000100144ac0
- (void).cxx_destruct;	// IMP=0x0000000100144d38
...
- (void)finishWithStatus:(long long)arg1;	// IMP=0x0000000100144c28
- (_Bool)validate;	// IMP=0x0000000100144b38
