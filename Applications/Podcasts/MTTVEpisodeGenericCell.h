...
+ (double)height;	// IMP=0x000000010014deac
- (void).cxx_destruct;	// IMP=0x000000010014e24c
...
- (void)_ensureFocusedFloatingContentView;	// IMP=0x000000010014e0f4
- (void)configureSubviews;	// IMP=0x000000010014e088
- (void)prepareForReuse;	// IMP=0x000000010014e020
- (void)updatePlayStatusForCurrentPlayerItemDidChange;	// IMP=0x000000010014dfc4
- (void)dealloc;	// IMP=0x000000010014df24
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000010014deb8
