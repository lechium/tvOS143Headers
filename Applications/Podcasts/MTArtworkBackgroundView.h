...
- (void).cxx_destruct;	// IMP=0x00000001000896dc
...
- (void)layoutSubviews;	// IMP=0x0000000100089244
- (void)_updateGradientColors;	// IMP=0x00000001000890d8
- (id)_blurredImageForImage:(id)arg1;	// IMP=0x0000000100089040
- (id)initWithArtwork:(id)arg1 blendColor:(id)arg2;	// IMP=0x0000000100088c78
- (id)init;	// IMP=0x0000000100088c64
