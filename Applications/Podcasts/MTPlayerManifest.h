...
- (void).cxx_destruct;	// IMP=0x00000001000eca28
...
- (id)metricsAdditionalData;	// IMP=0x00000001000ec840
- (id)metricsContentIdentifier;	// IMP=0x00000001000ec82c
- (void)enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001000ec77c
- (id)objectAtIndex:(unsigned long long)arg1;	// IMP=0x00000001000ec740
- (_Bool)userActivityContainsPlayhead;	// IMP=0x00000001000ec65c
- (id)activitySpotlightIdentifier;	// IMP=0x00000001000ec654
- (id)activity;	// IMP=0x00000001000ec5f8
- (id)init;	// IMP=0x00000001000ec54c
