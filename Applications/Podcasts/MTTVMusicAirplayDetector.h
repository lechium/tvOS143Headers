...
- (void).cxx_destruct;	// IMP=0x0000000100131d78
...
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000100131b78
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000100131a1c
