...
- (void).cxx_destruct;	// IMP=0x000000010004414c
...
- (void)invokeTaskCompletionBlocksWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100043bd4
- (void)addTaskCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100043b18
- (void)invalidate;	// IMP=0x0000000100043ab8
- (void)_invalidateTaskAssertionForced:(_Bool)arg1;	// IMP=0x00000001000438cc
- (void)endTaskOperation;	// IMP=0x0000000100043890
- (void)finishTaskOperationWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000100043688
- (void)beginTaskOperation;	// IMP=0x0000000100043308
...
- (void)_onQueueFireExpirationHandlerIfNecesary;	// IMP=0x0000000100042da8
...
- (id)description;	// IMP=0x000000010004280c
- (void)_invalidateAssertionTimer;	// IMP=0x0000000100042724
- (void)_invalidateTaskTimer;	// IMP=0x000000010004263c
- (void)dealloc;	// IMP=0x0000000100042560
- (id)initWithHandlerQueue:(id)arg1 taskTimeout:(double)arg2 assertionTimeout:(double)arg3 debugDescription:(id)arg4;	// IMP=0x000000010004211c
