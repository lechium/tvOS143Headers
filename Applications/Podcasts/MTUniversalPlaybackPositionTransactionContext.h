...
+ (id)UPPDomainVersion;	// IMP=0x000000010007f4cc
+ (void)setUPPDomainVersion:(id)arg1;	// IMP=0x000000010007f428
- (void).cxx_destruct;	// IMP=0x000000010007f570
...
- (id)lastSyncedDomainVersion;	// IMP=0x000000010007f530
