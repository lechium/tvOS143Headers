...
- (void).cxx_destruct;	// IMP=0x00000001000f0108
...
- (void)_updateBarMetricsForArtworkSize:(struct CGSize)arg1;	// IMP=0x00000001000efe5c
- (id)_blurredArtworkForArtwork:(id)arg1;	// IMP=0x00000001000efd68
- (_Bool)canBecomeFocused;	// IMP=0x00000001000efd60
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000efd48
- (void)layoutSubviews;	// IMP=0x00000001000efc80
@property(readonly, nonatomic) _Bool playing;
@property(nonatomic) long long playbackState;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000ef938
