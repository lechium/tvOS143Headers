...
- (void).cxx_destruct;	// IMP=0x000000010012d9e8
...
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010012d8c0
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x000000010012d740
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010012d73c
- (id)_extraObjects;	// IMP=0x000000010012d620
- (id)allObjects;	// IMP=0x000000010012d584
- (void)_initializeFrc;	// IMP=0x000000010012d4d4
