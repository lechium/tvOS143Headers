...
+ (id)watchConfiguration;	// IMP=0x00000001001813c4
+ (id)homepodConfiguration;	// IMP=0x0000000100181224
+ (id)defaultConfiguration;	// IMP=0x0000000100181094
- (void).cxx_destruct;	// IMP=0x00000001001814ec
- (id)init;	// IMP=0x000000010018153c
- (id)initWithTimeoutIntervalForResource:(double)arg1 workQueueConcurrent:(_Bool)arg2 useBackgroundFetchForFeedDownloads:(_Bool)arg3 keepsFeedFileInTempDirAfterDownload:(_Bool)arg4 supportsBatchInsertion:(_Bool)arg5 usesCleanEpisodeTitles:(_Bool)arg6;	// IMP=0x000000010018141c
