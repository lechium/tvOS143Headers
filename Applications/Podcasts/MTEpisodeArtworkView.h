...
- (void).cxx_destruct;	// IMP=0x000000010002ec68
...
- (_Bool)canBecomeFocused;	// IMP=0x000000010002ec00
- (void)_updateBarMetricsForArtworkSize:(struct CGSize)arg1;	// IMP=0x000000010002e9a8
- (id)_blurredArtworkForArtwork:(id)arg1;	// IMP=0x000000010002e8b4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010002e5a8
- (void)layoutSubviews;	// IMP=0x000000010002e438
- (void)updatePlaybackState;	// IMP=0x000000010002e3a4
- (void)stopObservingPlaybackState;	// IMP=0x000000010002e344
- (void)startObservingPlaybackState;	// IMP=0x000000010002e2dc
@property(retain, nonatomic) UIImage *artwork;
- (void)dealloc;	// IMP=0x000000010002dea8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002de14
