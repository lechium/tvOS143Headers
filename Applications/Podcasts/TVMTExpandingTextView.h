...
+ (double)cornerRadius;	// IMP=0x000000010013a4a4
- (void).cxx_destruct;	// IMP=0x000000010013b148
...
- (void)_playButtonAction:(id)arg1;	// IMP=0x000000010013aec8
- (void)_selectButtonAction:(id)arg1;	// IMP=0x000000010013ae3c
- (void)floatingContentView:(id)arg1 isTransitioningFromState:(unsigned long long)arg2 toState:(unsigned long long)arg3;	// IMP=0x000000010013ae14
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000010013ad7c
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010013ac84
- (struct CGRect)_moreLabelFrame;	// IMP=0x000000010013a938
- (id)_moreLabelExclusionPath;	// IMP=0x000000010013a89c
- (void)_recomputeTextSizeIfNeeded;	// IMP=0x000000010013a750
- (void)_setNeedsTextSizeComputation;	// IMP=0x000000010013a73c
@property(nonatomic) unsigned long long maximumNumberOfLines;
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000010013a428
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010013a324
- (_Bool)canBecomeFocused;	// IMP=0x000000010013a318
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010013a220
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010013a1c4
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000010013a128
- (void)layoutSubviews;	// IMP=0x0000000100139dbc
- (void)updateLabelsTextColorForFocused:(_Bool)arg1;	// IMP=0x0000000100139c1c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001001394b8
