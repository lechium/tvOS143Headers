...
+ (_Bool)isMediaItemSyncedFromiTunes:(id)arg1;	// IMP=0x00000001000a0034
+ (id)propertiesForMediaItem;	// IMP=0x000000010009fe88
+ (_Bool)isMissingAssetForItem:(id)arg1;	// IMP=0x000000010009fd10
+ (_Bool)isMissingFilePathForItem:(id)arg1;	// IMP=0x000000010009fcb0
+ (id)itemWithMPMediaItem:(id)arg1 isRestoreDownloadCandidate:(_Bool)arg2;	// IMP=0x000000010009f4c0
+ (id)itemWithMPMediaItem:(id)arg1;	// IMP=0x000000010009f4b0
- (void).cxx_destruct;	// IMP=0x00000001000a0264
...
- (id)description;	// IMP=0x000000010009fdbc
