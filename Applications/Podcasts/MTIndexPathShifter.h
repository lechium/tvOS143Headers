...
- (void).cxx_destruct;	// IMP=0x0000000100127bc8
...
- (void)_setIndexPath:(unsigned long long)arg1;	// IMP=0x0000000100127aa8
- (void)_shiftIndexPath:(unsigned long long)arg1;	// IMP=0x0000000100127a44
- (void)processChangeAtIndexPath:(id)arg1 forChangeType:(unsigned long long)arg2 newIndexPath:(id)arg3;	// IMP=0x00000001001277d4
