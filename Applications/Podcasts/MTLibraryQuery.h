...
- (void).cxx_destruct;	// IMP=0x0000000100037134
...
- (void)runQueryInContext:(id)arg1;	// IMP=0x0000000100036c50
- (void)runQuery;	// IMP=0x0000000100036bd4
- (void)runQueryWithPodcastPredicate:(id)arg1 episodePredicate:(id)arg2;	// IMP=0x0000000100036b4c
- (id)init;	// IMP=0x0000000100036ae8
