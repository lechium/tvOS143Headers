...
+ (id)groupWithTitle:(id)arg1 footerText:(id)arg2 settingsHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010010dee8
+ (id)groupWithTitle:(id)arg1 footerText:(id)arg2 settings:(id)arg3;	// IMP=0x000000010010dd28
- (void).cxx_destruct;	// IMP=0x000000010010e16c
