...
- (void).cxx_destruct;	// IMP=0x0000000100113448
...
- (void)addCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000100113394
- (id)initWithProperties:(id)arg1;	// IMP=0x0000000100113058
- (id)init;	// IMP=0x0000000100113048
