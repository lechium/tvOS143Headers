...
+ (id)requestForUrl:(id)arg1 key:(id)arg2 podcastUuid:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000170ac
- (void).cxx_destruct;	// IMP=0x000000010001747c
...
- (id)description;	// IMP=0x00000001000172cc
- (id)initWithUrl:(id)arg1 key:(id)arg2 podcastUuid:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100017160
