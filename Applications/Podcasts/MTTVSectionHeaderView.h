...
+ (id)font;	// IMP=0x000000010016e934
+ (double)height;	// IMP=0x000000010016e888
- (void).cxx_destruct;	// IMP=0x000000010016f63c
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010016f4f4
- (void)layoutSubviews;	// IMP=0x000000010016f03c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010016ef70
- (void)_updateBlurEffects;	// IMP=0x000000010016ec80
- (void)prepareForReuse;	// IMP=0x000000010016ebec
- (void)_configureSubviews;	// IMP=0x000000010016e9d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010016e954
