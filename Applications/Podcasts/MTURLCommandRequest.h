...
- (void).cxx_destruct;	// IMP=0x00000001000b3148
...
- (void)_lookupEpisodeUuidIfNecessaryFromURLString:(id)arg1;	// IMP=0x00000001000b2e7c
- (void)_lookupPodcastUuidIfNecessaryFromURLString:(id)arg1;	// IMP=0x00000001000b2c20
- (void)_loadQueryParameterValuesFromString:(id)arg1;	// IMP=0x00000001000b26e0
- (id)copyWithPlayReason:(unsigned long long)arg1;	// IMP=0x00000001000b26b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b2568
- (id)initWithURLString:(id)arg1;	// IMP=0x00000001000b24dc
