...
+ (void)loadBagContextFromIMURLBag:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100051180
+ (double)defaultPollingInterval;	// IMP=0x0000000100051068
- (void).cxx_destruct;	// IMP=0x0000000100051d48
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100051074
