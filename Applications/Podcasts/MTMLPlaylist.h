...
+ (id)playlistWithMPPlaylist:(id)arg1;	// IMP=0x000000010009a0c0
- (void).cxx_destruct;	// IMP=0x000000010009a73c
...
- (id)description;	// IMP=0x000000010009a5ac
- (_Bool)isEmpty;	// IMP=0x000000010009a410
- (id)children;	// IMP=0x000000010009a408
- (void)addChild:(id)arg1;	// IMP=0x000000010009a394
