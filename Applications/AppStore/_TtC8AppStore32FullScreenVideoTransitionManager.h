...
- (void).cxx_destruct;	// IMP=0x00000001000a1e1c
- (id)init;	// IMP=0x00000001000a1e94
- (void)animateTransition:(id)arg1;	// IMP=0x00000001000a1450
- (double)transitionDuration:(id)arg1;	// IMP=0x00000001000a1324
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x00000001000a1314
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x00000001000a1278
