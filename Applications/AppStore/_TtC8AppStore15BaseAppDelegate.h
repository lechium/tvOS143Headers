...
- (void).cxx_destruct;	// IMP=0x00000001000fe540
- (id)init;	// IMP=0x00000001000fe4f0
- (void)performDebugGesture:(id)arg1;	// IMP=0x00000001000fdd14
- (_Bool)application:(id)arg1 openURL:(id)arg2 options:(id)arg3;	// IMP=0x00000001000fdbd0
- (void)applicationDidEnterBackground:(id)arg1;	// IMP=0x00000001000fdaac
- (void)applicationWillEnterForeground:(id)arg1;	// IMP=0x00000001000fda60
- (void)applicationDidBecomeActive:(id)arg1;	// IMP=0x00000001000fda14
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x00000001000fd878
