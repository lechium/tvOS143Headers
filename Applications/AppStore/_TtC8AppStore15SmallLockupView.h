...
- (void).cxx_destruct;	// IMP=0x000000010009a370
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010009a23c
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010009a0cc
- (void)layoutSubviews;	// IMP=0x000000010009a0a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100099e18
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100099df8
