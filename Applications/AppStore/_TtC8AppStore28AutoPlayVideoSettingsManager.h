...
- (void).cxx_destruct;	// IMP=0x00000001000fac78
- (void)saveFullScreenAudioSettings;	// IMP=0x00000001000fba7c
- (void)restoreFullScreenAudioSettings;	// IMP=0x00000001000fba78
- (void)updateAutoPlayVideoSettings;	// IMP=0x00000001000fb720
- (void)dealloc;	// IMP=0x00000001000fabcc
- (id)init;	// IMP=0x00000001000fab1c
