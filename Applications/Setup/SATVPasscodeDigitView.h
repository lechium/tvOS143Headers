...
- (void).cxx_destruct;	// IMP=0x00000001000395f4
...
- (id)_labelFont;	// IMP=0x000000010003941c
- (id)hiddenDigitImage;	// IMP=0x0000000100039178
- (id)arrowImage:(_Bool)arg1;	// IMP=0x0000000100038f58
- (void)downGesture:(id)arg1;	// IMP=0x0000000100038e30
- (void)upGesture:(id)arg1;	// IMP=0x0000000100038d1c
@property(copy, nonatomic) NSString *text;
- (void)setHighlightProgress:(double)arg1;	// IMP=0x0000000100038c10
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100038ad8
- (_Bool)canBecomeFocused;	// IMP=0x0000000100038ad0
- (void)layoutSubviews;	// IMP=0x0000000100038858
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100038258
