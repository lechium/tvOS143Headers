...
- (void).cxx_destruct;	// IMP=0x0000000100078a9c
...
- (void)setTitle:(id)arg1 subtitle:(id)arg2 languageCode:(id)arg3 animated:(_Bool)arg4;	// IMP=0x00000001000781c4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100078158
- (void)layoutSubviews;	// IMP=0x0000000100078060
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100077f1c
