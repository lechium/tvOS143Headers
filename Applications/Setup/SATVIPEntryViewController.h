...
- (void).cxx_destruct;	// IMP=0x000000010002ff0c
@property(nonatomic) __weak id <SATVIPEntryViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property(copy, nonatomic) NSString *prompt; // @synthesize prompt=_prompt;
- (void)_didSelectMenu;	// IMP=0x000000010002fec4
- (id)_ipEntryView;	// IMP=0x000000010002fe54
- (void)ipEntryViewDidFinishEditing:(id)arg1;	// IMP=0x000000010002fdf0
@property(copy, nonatomic) NSString *ipAddress;
- (void)setTitle:(id)arg1;	// IMP=0x000000010002fc48
- (id)preferredFocusEnvironments;	// IMP=0x000000010002fb90
- (_Bool)becomeFirstResponder;	// IMP=0x000000010002fb78
- (void)viewDidLayoutSubviews;	// IMP=0x000000010002f988
- (void)loadView;	// IMP=0x000000010002f5b4
