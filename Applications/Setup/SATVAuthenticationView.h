...
- (void).cxx_destruct;	// IMP=0x000000010006ab40
...
- (void)_setSystemInputView:(id)arg1;	// IMP=0x000000010006a934
- (id)_createButtonStackView;	// IMP=0x000000010006a86c
- (id)_buildDialogueColumnStackView;	// IMP=0x000000010006a64c
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010006a4f8
- (void)setPreferredFocusedEnvironmentForGridLayoutGuide:(id)arg1;	// IMP=0x000000010006a400
- (void)setSystemInputView:(id)arg1 touchInputEnabled:(_Bool)arg2;	// IMP=0x0000000100069f48
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100069898
