...
- (void).cxx_destruct;	// IMP=0x0000000100069884
...
- (_Bool)_containsInertiaSelectionChanges;	// IMP=0x0000000100069844
- (void)layoutSubviews;	// IMP=0x00000001000697d8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100069734
