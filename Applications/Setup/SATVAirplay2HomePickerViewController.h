...
- (void).cxx_destruct;	// IMP=0x0000000100070ff0
...
- (void)_updateTableViewAndAnimateChanges:(_Bool)arg1;	// IMP=0x0000000100070d30
- (id)_cellForRowAtIndexPath:(id)arg1 itemIdentifier:(id)arg2;	// IMP=0x0000000100070bfc
- (id)_homeAtIndexPath:(id)arg1;	// IMP=0x0000000100070b3c
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000100070ac0
- (id)tableView:(id)arg1 titleForHeaderInSection:(long long)arg2;	// IMP=0x0000000100070a40
- (void)airplay2DataSourceDidUpdate:(id)arg1;	// IMP=0x00000001000709a8
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000100070934
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000708ac
- (void)viewDidLoad;	// IMP=0x0000000100070690
- (id)initWithDataSource:(id)arg1;	// IMP=0x000000010007060c
