...
- (void).cxx_destruct;	// IMP=0x0000000100042344
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000100042160
- (void)pulseAtBeginTime:(double)arg1;	// IMP=0x0000000100041b34
- (void)layoutSubviews;	// IMP=0x0000000100041a2c
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x00000001000419cc
