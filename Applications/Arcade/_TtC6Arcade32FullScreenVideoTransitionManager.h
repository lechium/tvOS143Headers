...
- (id)init;	// IMP=0x00000001000a2e08
- (void)animateTransition:(id)arg1;	// IMP=0x00000001000a23c4
- (double)transitionDuration:(id)arg1;	// IMP=0x00000001000a2298
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x00000001000a2288
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x00000001000a21ec
