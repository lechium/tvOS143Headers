...
- (void).cxx_destruct;	// IMP=0x0000000100063210
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100063110
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100062ff8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100062df8
- (void)prepareForReuse;	// IMP=0x0000000100062d7c
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100062b4c
@property(nonatomic, readonly) _Bool canBecomeFocused;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010006190c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000618ec
