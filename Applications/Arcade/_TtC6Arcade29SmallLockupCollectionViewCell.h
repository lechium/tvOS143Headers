...
- (void).cxx_destruct;	// IMP=0x00000001000a8ee0
...
- (void)prepareForReuse;	// IMP=0x00000001000a8dc4
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000a8ba8
- (id)_preferredConfigurationForFocusAnimation:(long long)arg1 inContext:(id)arg2;	// IMP=0x00000001000a8ac4
- (void)layoutSubviews;	// IMP=0x00000001000a8710
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000a8294
