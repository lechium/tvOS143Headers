...
- (void).cxx_destruct;	// IMP=0x00000001000f5188
- (void)saveFullScreenAudioSettings;	// IMP=0x00000001000f5f8c
- (void)restoreFullScreenAudioSettings;	// IMP=0x00000001000f5f88
- (void)updateAutoPlayVideoSettings;	// IMP=0x00000001000f5c30
- (void)dealloc;	// IMP=0x00000001000f50dc
- (id)init;	// IMP=0x00000001000f502c
