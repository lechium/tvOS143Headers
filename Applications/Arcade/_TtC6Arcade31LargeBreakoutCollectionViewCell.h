...
- (void).cxx_destruct;	// IMP=0x000000010004e6a4
- (void)prepareForReuse;	// IMP=0x000000010004e5ec
- (void)layoutSubviews;	// IMP=0x000000010004e4dc
- (void)didUpdateFocusWithNotification:(id)arg1;	// IMP=0x000000010004e1ac
- (void)didMoveToWindow;	// IMP=0x000000010004e180
@property(nonatomic, readonly) _Bool canBecomeFocused;
@property(nonatomic, readonly) NSArray *preferredFocusEnvironments;
@property(nonatomic, retain) UIColor *backgroundColor;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010004dd58
