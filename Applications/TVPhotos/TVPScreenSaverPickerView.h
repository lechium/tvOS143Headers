...
- (void).cxx_destruct;	// IMP=0x0000000100063128
...
- (void)updateDelegate:(id)arg1;	// IMP=0x0000000100062fa8
- (void)tableView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100062ee0
- (_Bool)tableView:(id)arg1 canFocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100062ed8
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000100062cb8
- (id)init;	// IMP=0x0000000100061fd0
- (id)preferredFocusEnvironments;	// IMP=0x0000000100061f58
