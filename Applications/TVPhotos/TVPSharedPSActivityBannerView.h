...
- (void).cxx_destruct;	// IMP=0x0000000100060d4c
...
- (void)_detachMotionEffects;	// IMP=0x0000000100060c2c
- (void)_attachMotionEffects;	// IMP=0x0000000100060a7c
- (void)layoutSubviews;	// IMP=0x00000001000606a0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100060500
- (_Bool)canBecomeFocused;	// IMP=0x00000001000604f8
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000602d4
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000600b0
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010005fe8c
- (_Bool)_unapplyMotionEffect:(id)arg1;	// IMP=0x000000010005fe54
- (_Bool)_applyKeyPathsAndRelativeValues:(id)arg1 forMotionEffect:(id)arg2;	// IMP=0x000000010005fd70
- (id)init;	// IMP=0x000000010005f910
