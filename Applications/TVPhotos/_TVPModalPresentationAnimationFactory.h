...
- (id)_timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000100005dac
- (id)_basicAnimationForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000100005d94
- (id)initWithCurve:(unsigned long long)arg1;	// IMP=0x0000000100005d4c
