...
- (void).cxx_destruct;	// IMP=0x000000010001f094
...
- (void)viewDidLayoutSubviews;	// IMP=0x000000010001ec44
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010001ea68
- (void)loadView;	// IMP=0x000000010001e804
- (void)dealloc;	// IMP=0x000000010001e7a4
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010001e720
