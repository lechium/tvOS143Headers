...
- (void).cxx_destruct;	// IMP=0x0000000100065b78
...
- (void)_updateVideoOverlayForItemView:(id)arg1;	// IMP=0x0000000100065998
- (unsigned long long)_allowedModesFromModes:(id)arg1;	// IMP=0x000000010006591c
- (id)oneUpViewCachingManager:(id)arg1 assetAtIndex:(unsigned long long)arg2;	// IMP=0x000000010006590c
- (void)oneupView:(id)arg1 willBeginViewTransitionForFocusedView:(id)arg2;	// IMP=0x000000010006584c
- (void)oneupView:(id)arg1 didPlayItemAtIndex:(unsigned long long)arg2;	// IMP=0x0000000100065774
- (void)oneupView:(id)arg1 didSelectItemAtIndex:(unsigned long long)arg2;	// IMP=0x000000010006569c
- (void)oneupView:(id)arg1 didFocusItemAtIndex:(unsigned long long)arg2;	// IMP=0x0000000100065618
- (id)oneupView:(id)arg1 supplementaryViewForItemAtIndex:(unsigned long long)arg2;	// IMP=0x0000000100065574
- (id)oneupView:(id)arg1 viewForItemAtIndex:(unsigned long long)arg2;	// IMP=0x0000000100065564
- (long long)numberOfItemsInOneupView:(id)arg1;	// IMP=0x0000000100065508
- (void)itemDidFinishPlaying:(id)arg1;	// IMP=0x0000000100065480
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x00000001000653ec
- (void)navigationController:(id)arg1 didShowViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x0000000100065300
- (id)assetAtIndex:(long long)arg1;	// IMP=0x000000010006526c
- (_Bool)performReloadOnLibraryChangeNotificationIfRequired:(id)arg1;	// IMP=0x0000000100065048
- (id)configureItemViewForOneupView:(id)arg1 AtIndex:(long long)arg2 showVideoBadgeInCaptionMode:(_Bool)arg3;	// IMP=0x0000000100063c10
- (void)startVideoPlaybackForItem:(id)arg1;	// IMP=0x00000001000636e4
@property(retain, nonatomic) PHAsset *focusedAsset;
- (void)dealloc;	// IMP=0x0000000100063614
- (void)willMoveToParentViewController:(id)arg1;	// IMP=0x0000000100063598
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100063540
- (void)viewDidLoad;	// IMP=0x00000001000634cc
- (void)loadView;	// IMP=0x000000010006326c
- (id)init;	// IMP=0x00000001000631b4
