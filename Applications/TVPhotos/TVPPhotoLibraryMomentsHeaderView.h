...
- (void).cxx_destruct;	// IMP=0x0000000100028d08
...
- (_Bool)_isLabel:(id)arg1 aboveFocusedRect:(struct CGRect)arg2;	// IMP=0x0000000100028a34
- (_Bool)_hasSubtitle;	// IMP=0x00000001000289d8
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000010002842c
- (void)prepareForReuse;	// IMP=0x0000000100028340
...
- (struct CGRect)_effectiveFocusedRect;	// IMP=0x0000000100027e8c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100026d04
- (_Bool)canBecomeFocused;	// IMP=0x0000000100026cfc
