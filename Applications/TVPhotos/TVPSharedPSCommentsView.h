...
- (void).cxx_destruct;	// IMP=0x00000001000184e8
...
- (id)_latestCommentIndexPathForCommentsView;	// IMP=0x0000000100018318
- (void)_scrollToLastComment;	// IMP=0x0000000100018298
- (void)layoutSubviews;	// IMP=0x0000000100017f4c
- (id)preferredFocusEnvironments;	// IMP=0x0000000100017ec4
- (id)dequeueReusableViewForIdentifier:(id)arg1;	// IMP=0x0000000100017e20
- (void)reloadCommentsData;	// IMP=0x0000000100017ddc
- (void)registerClass:(Class)arg1 forCommentsWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017cf0
- (void)registerClass:(Class)arg1 forSubheaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017c24
- (void)registerClass:(Class)arg1 forHeaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017b58
