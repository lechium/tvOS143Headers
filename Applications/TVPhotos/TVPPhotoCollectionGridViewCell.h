...
- (void).cxx_destruct;	// IMP=0x000000010000b8b8
...
- (void)_updateLayoutProperties;	// IMP=0x000000010000b404
- (double)_focusedGrowthMagnitude;	// IMP=0x000000010000b390
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010000afac
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010000aeac
@property(readonly, nonatomic) struct CGSize imageSize;
@property(retain, nonatomic) UIImage *badgeImage;
@property(copy, nonatomic) NSString *title;
- (double)cellCornerRadius;	// IMP=0x000000010000ad74
- (void)prepareForReuse;	// IMP=0x000000010000ad18
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000a6d0
