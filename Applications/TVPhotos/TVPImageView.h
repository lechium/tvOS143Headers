...
- (void).cxx_destruct;	// IMP=0x000000010005b0c4
...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x000000010005af60
- (void)_setImage:(id)arg1;	// IMP=0x000000010005adec
- (id)_imageView;	// IMP=0x000000010005ac58
- (void)_loadImage;	// IMP=0x000000010005a598
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010005a424
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005a034
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000100059f24
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100059e7c
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000100059e08
- (void)setContentMode:(long long)arg1;	// IMP=0x0000000100059de4
- (void)layoutSubviews;	// IMP=0x0000000100059d78
- (long long)contentMode;	// IMP=0x0000000100059d60
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000100059d48
- (void)dealloc;	// IMP=0x0000000100059cdc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100059bf8
