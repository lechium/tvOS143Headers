...
- (void).cxx_destruct;	// IMP=0x000000010001cf24
...
- (void)_initializeSlideshowSettings;	// IMP=0x000000010001bf74
- (struct CGSize)_getAttributedTextSize:(id)arg1 font:(id)arg2 maxWidth:(double)arg3;	// IMP=0x000000010001bebc
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x000000010001b6ac
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x000000010001b124
- (id)tableView:(id)arg1 titleForHeaderInSection:(long long)arg2;	// IMP=0x000000010001b0a0
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x000000010001b008
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x000000010001afec
- (void)_slideshowThemeChanged:(id)arg1;	// IMP=0x000000010001aaa4
- (id)preferredFocusEnvironments;	// IMP=0x000000010001a9b0
- (void)dealloc;	// IMP=0x000000010001a938
- (void)viewDidLoad;	// IMP=0x000000010001a234
- (void)_handleMenuTap:(id)arg1;	// IMP=0x000000010001a11c
- (void)loadView;	// IMP=0x000000010001a04c
- (void)refreshPhotoAssets:(id)arg1;	// IMP=0x000000010001a00c
- (id)init;	// IMP=0x0000000100019f90
- (id)initWithPhotoAssets:(id)arg1;	// IMP=0x0000000100019f00
