...
- (void).cxx_destruct;	// IMP=0x000000010008cd6c
...
- (void)_configureVideoBadgeView;	// IMP=0x000000010008ca90
- (void)layoutSubviews;	// IMP=0x000000010008c86c
- (void)didAnimateToFullScreenMode;	// IMP=0x000000010008c81c
- (void)willAnimateToFullScreenMode;	// IMP=0x000000010008c800
- (void)didAnimateToCaptionMode;	// IMP=0x000000010008c7bc
- (void)willAnimateToCaptionMode;	// IMP=0x000000010008c76c
