...
- (void).cxx_destruct;	// IMP=0x00000001000811a0
...
- (void)layoutSubviews;	// IMP=0x0000000100080ccc
- (void)setTotalComments:(unsigned long long)arg1 commentBadge:(id)arg2;	// IMP=0x00000001000809a4
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000808f0
- (void)_updatePlaceholderImage;	// IMP=0x00000001000807e8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100080790
