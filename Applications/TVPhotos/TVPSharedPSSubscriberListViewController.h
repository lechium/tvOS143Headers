...
+ (id)_sharedAlbumSubscribersFromAlbum:(id)arg1;	// IMP=0x0000000100041708
- (void).cxx_destruct;	// IMP=0x00000001000419d8
...
- (void)_onSelectActionButton:(id)arg1;	// IMP=0x0000000100041258
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x000000010004107c
- (struct CGSize)formSize;	// IMP=0x0000000100041068
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100040f50
- (void)viewDidLoad;	// IMP=0x0000000100040ad8
- (void)setMenuGestureRcognizer:(id)arg1;	// IMP=0x00000001000409dc
