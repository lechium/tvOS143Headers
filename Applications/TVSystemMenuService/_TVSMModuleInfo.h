...
+ (id)_defaultModuleDirectories;	// IMP=0x000000010000a1a4
+ (id)allModuleInfos;	// IMP=0x0000000100009e10
- (void).cxx_destruct;	// IMP=0x000000010000a40c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000a1a0
- (id)_initWithURL:(id)arg1;	// IMP=0x000000010000a0b0
