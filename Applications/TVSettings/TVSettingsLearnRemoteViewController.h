...
- (void).cxx_destruct;	// IMP=0x00000001000aafc8
...
- (id)_imageForAction:(int)arg1;	// IMP=0x00000001000aabec
- (void)_learnNextAction:(id)arg1;	// IMP=0x00000001000aab4c
- (void)_learnPreviousAction:(id)arg1;	// IMP=0x00000001000aaaac
- (void)_updateProgressViewWithProgress:(double)arg1 animated:(_Bool)arg2;	// IMP=0x00000001000aaa14
- (void)_hideProgressView;	// IMP=0x00000001000aa98c
- (void)irLearningManager:(id)arg1 didFinishLearningAction:(int)arg2;	// IMP=0x00000001000aa500
- (void)irLearningManager:(id)arg1 didCompleteLearningAction:(int)arg2 withResult:(_Bool)arg3 error:(id)arg4;	// IMP=0x00000001000a9f4c
- (void)irLearningManager:(id)arg1 didLearnAction:(int)arg2 withProgress:(double)arg3;	// IMP=0x00000001000a9df8
- (void)irLearningManager:(id)arg1 willStartLearningAction:(int)arg2;	// IMP=0x00000001000a9a88
- (void)irLearningManagerDidCancel:(id)arg1;	// IMP=0x00000001000a9a84
- (void)irLearningManager:(id)arg1 didSaveLearnedActions:(id)arg2 forDeviceWithUUID:(id)arg3;	// IMP=0x00000001000a97a8
- (void)irLearningManager:(id)arg1 didFailToStartLearningWithError:(id)arg2;	// IMP=0x00000001000a9594
- (id)preferredFocusEnvironments;	// IMP=0x00000001000a950c
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000001000a9390
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000a9198
- (void)viewDidLoad;	// IMP=0x00000001000a7d5c
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000a7c78
