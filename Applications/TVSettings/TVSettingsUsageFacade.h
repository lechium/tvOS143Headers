...
- (void).cxx_destruct;	// IMP=0x000000010009767c
...
- (void)_fetchAppUsageInfo;	// IMP=0x0000000100097284
- (void)uninstallAppWithProxy:(id)arg1;	// IMP=0x00000001000970d8
- (void)dealloc;	// IMP=0x0000000100097004
- (id)init;	// IMP=0x0000000100096ed4
