...
- (void).cxx_destruct;	// IMP=0x00000001000b0074
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000afb70
- (unsigned long long)hash;	// IMP=0x00000001000afb4c
- (id)initWithPhotoCollections:(id)arg1;	// IMP=0x00000001000afacc
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000001000afa4c
- (id)initWithName:(id)arg1;	// IMP=0x00000001000af9cc
