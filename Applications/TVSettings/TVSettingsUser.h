...
- (void).cxx_destruct;	// IMP=0x0000000100096df8
...
- (void)_updateWithUserProfile:(id)arg1 postKVONotifications:(_Bool)arg2;	// IMP=0x00000001000967b4
- (unsigned long long)hash;	// IMP=0x00000001000967a4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100096700
- (id)description;	// IMP=0x0000000100096680
- (void)updateWithUserProfile:(id)arg1;	// IMP=0x00000001000961a8
- (id)initWithUserProfile:(id)arg1 amsBag:(id)arg2;	// IMP=0x0000000100096050
- (id)initWithSystemUser:(id)arg1 amsBag:(id)arg2;	// IMP=0x0000000100095d34
