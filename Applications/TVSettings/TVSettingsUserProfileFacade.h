...
+ (id)keyPathsForValuesAffectingIsSigningInOrOutInProgress;	// IMP=0x00000001000d14ec
- (void).cxx_destruct;	// IMP=0x00000001000d5a14
...
- (void)_acquireIgnoringAccountNotificationsAssertionWithName:(id)arg1;	// IMP=0x00000001000d5788
- (void)_presentDialogWithError:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x00000001000d5510
- (void)_cleanUpAfterSigningInOrOut;	// IMP=0x00000001000d54ac
- (void)_restorePersona;	// IMP=0x00000001000d53ac
- (_Bool)_adoptPersona;	// IMP=0x00000001000d50b4
- (void)_signInGameCenterWithPresentingViewController:(id)arg1;	// IMP=0x00000001000d49ac
- (void)_signIniTunesWithPresentingViewController:(id)arg1;	// IMP=0x00000001000d4658
- (void)_signIniCloudWithPresentingViewController:(id)arg1;	// IMP=0x00000001000d41b0
- (void)_authenticateForServiceType:(long long)arg1 presentingViewController:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000d3e0c
- (void)_updateProfileWithServiceType:(long long)arg1 toAltDSID:(id)arg2;	// IMP=0x00000001000d39c8
- (void)_updateiCloudPhotoValues;	// IMP=0x00000001000d3844
- (void)_updateiCloudPhotoSettingWithEnabled:(_Bool)arg1 dataclass:(id)arg2 presentingViewController:(id)arg3;	// IMP=0x00000001000d3230
- (void)accountStoreObserver:(id)arg1 didModifyPrimaryAppleAccount:(id)arg2;	// IMP=0x00000001000d314c
- (void)userProfileManagerDidUpdate:(id)arg1;	// IMP=0x00000001000d3004
- (void)setiCloudPhotoStreamEnabled:(_Bool)arg1 presentingViewController:(id)arg2;	// IMP=0x00000001000d2fe8
- (void)setiCloudSharedPhotosEnabled:(_Bool)arg1 presentingViewController:(id)arg2;	// IMP=0x00000001000d2fcc
- (void)setiCloudPhotoLibraryEnabled:(_Bool)arg1 presentingViewController:(id)arg2;	// IMP=0x00000001000d2fb0
- (void)setAuthenticationNeededToChangeiCloudPhotoOptions;	// IMP=0x00000001000d2fa4
@property(readonly, nonatomic) _Bool userSupportsiCloudPhotoOptions;
- (void)removeUserWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000d206c
- (_Bool)canSignOutOfServiceType:(long long)arg1;	// IMP=0x00000001000d200c
- (void)signOutOfServiceType:(long long)arg1;	// IMP=0x00000001000d1920
- (void)signInServiceType:(long long)arg1 presentingViewController:(id)arg2;	// IMP=0x00000001000d1644
@property(readonly, nonatomic) _Bool userHasActiveiTunes;
- (void)dealloc;	// IMP=0x00000001000d1464
- (id)initWithUser:(id)arg1;	// IMP=0x00000001000d1278
