...
- (void).cxx_destruct;	// IMP=0x00000001000b67a8
...
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000b634c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000b6170
- (void)loadView;	// IMP=0x00000001000b5f0c
- (void)dealloc;	// IMP=0x00000001000b5eac
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000b5e28
