...
- (void).cxx_destruct;	// IMP=0x00000001000ca30c
...
- (id)hiddenDigitImage;	// IMP=0x00000001000c9ea4
- (id)arrowImage:(_Bool)arg1;	// IMP=0x00000001000c9c94
- (void)downGesture:(id)arg1;	// IMP=0x00000001000c9b74
- (void)upGesture:(id)arg1;	// IMP=0x00000001000c9a68
@property(copy, nonatomic) NSString *text;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000c97c4
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000c968c
- (_Bool)canBecomeFocused;	// IMP=0x00000001000c9684
- (void)layoutSubviews;	// IMP=0x00000001000c940c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000c8d10
