...
- (void).cxx_destruct;	// IMP=0x00000001000cd3dc
...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x00000001000cd278
- (void)_setImage:(id)arg1;	// IMP=0x00000001000cd104
- (id)_imageView;	// IMP=0x00000001000ccf70
- (void)_loadImage;	// IMP=0x00000001000cc98c
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000001000cc818
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000cc428
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00000001000cc318
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000cc270
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000001000cc1fc
- (void)setContentMode:(long long)arg1;	// IMP=0x00000001000cc1d8
- (void)layoutSubviews;	// IMP=0x00000001000cc16c
- (long long)contentMode;	// IMP=0x00000001000cc154
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000001000cc13c
- (void)dealloc;	// IMP=0x00000001000cc0d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000cbfec
