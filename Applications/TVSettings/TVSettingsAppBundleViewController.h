...
- (void).cxx_destruct;	// IMP=0x0000000100025418
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000252c8
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x00000001000251cc
- (id)loadSettingGroups;	// IMP=0x000000010002343c
- (void)dealloc;	// IMP=0x00000001000233a4
