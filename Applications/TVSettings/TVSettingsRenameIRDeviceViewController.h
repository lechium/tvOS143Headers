...
- (void).cxx_destruct;	// IMP=0x0000000100055634
...
- (void)editingController:(id)arg1 didCancelForSettingItem:(id)arg2;	// IMP=0x0000000100055584
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x0000000100055358
- (void)viewDidLoad;	// IMP=0x00000001000550d0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100055048
