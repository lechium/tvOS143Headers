...
- (void).cxx_destruct;	// IMP=0x00000001000449fc
...
- (id)description;	// IMP=0x0000000100044898
- (id)init;	// IMP=0x0000000100044880
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x00000001000447b8
