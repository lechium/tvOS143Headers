...
- (void).cxx_destruct;	// IMP=0x000000010008fca0
...
- (void)_setPaidSettingValue:(unsigned long long)arg1 freeSettingValue:(unsigned long long)arg2;	// IMP=0x000000010008f9e4
- (void)_syncPasswordPaidSetting:(unsigned long long)arg1 freeSetting:(unsigned long long)arg2 originalPaidSetting:(unsigned long long)arg3 originalFreeSetting:(unsigned long long)arg4;	// IMP=0x000000010008f5b0
- (void)_updatePaidSetting:(unsigned long long)arg1 freeSetting:(unsigned long long)arg2;	// IMP=0x000000010008f424
- (void)_refreshAccount;	// IMP=0x000000010008f280
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x000000010008f0fc
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleDialogRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010008eee4
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleAuthenticateRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010008ec8c
- (void)setAsnFreeSetting:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000010008ec34
- (void)setAsnPaidSetting:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000010008ebdc
- (void)setAsnFreeSetting:(id)arg1;	// IMP=0x000000010008eb94
- (void)setAsnPaidSetting:(id)arg1;	// IMP=0x000000010008eb4c
- (void)dealloc;	// IMP=0x000000010008eac4
- (id)initWithAccount:(id)arg1 amsBag:(id)arg2;	// IMP=0x000000010008e994
