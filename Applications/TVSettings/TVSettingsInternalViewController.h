...
- (void).cxx_destruct;	// IMP=0x000000010003107c
@property(retain) NSMutableSet *loadedBundleNames; // @synthesize loadedBundleNames=_loadedBundleNames;
- (id)_loadSettingGroupWithBundlesInDirectory:(id)arg1;	// IMP=0x0000000100030bcc
- (id)loadSettingGroups;	// IMP=0x0000000100030abc
