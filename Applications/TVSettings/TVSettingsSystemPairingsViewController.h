...
+ (void)initialize;	// IMP=0x000000010006eed0
- (void).cxx_destruct;	// IMP=0x0000000100070f28
...
- (void)_replaceLastNavigationViewControllerWithViewController:(id)arg1;	// IMP=0x0000000100070d1c
- (void)_hideActivityIndicator;	// IMP=0x0000000100070c8c
- (void)_showActivityIndicator;	// IMP=0x0000000100070c24
- (void)_stopShowActivityIndicatorTimer;	// IMP=0x0000000100070bcc
- (void)_startShowActivityIndicatorTimer;	// IMP=0x0000000100070a8c
- (void)_didFinishPairing;	// IMP=0x0000000100070a38
- (void)_presentPairingUIWithSettingItem:(id)arg1;	// IMP=0x0000000100070780
- (void)digitEntryViewControllerDidCancel:(id)arg1;	// IMP=0x0000000100070774
- (void)digitEntryViewControllerDidFinish:(id)arg1;	// IMP=0x000000010007030c
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x00000001000701f0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010006fdec
- (id)loadSettingGroups;	// IMP=0x000000010006f58c
- (void)_applicationDidEnterBackgroundNotification:(id)arg1;	// IMP=0x000000010006f500
- (void)_applicationWillEnterForegroundNotification:(id)arg1;	// IMP=0x000000010006f47c
- (void)_stopPairingServices;	// IMP=0x000000010006f3bc
- (void)_startPairingServices;	// IMP=0x000000010006f2a8
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000010006f258
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010006f1bc
- (void)dealloc;	// IMP=0x000000010006f0b0
- (id)initWithStyle:(long long)arg1;	// IMP=0x000000010006ef3c
