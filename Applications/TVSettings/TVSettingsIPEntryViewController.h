...
- (void).cxx_destruct;	// IMP=0x00000001000d9adc
@property(nonatomic) __weak id <TVSettingsIPEntryViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property(copy, nonatomic) NSString *prompt; // @synthesize prompt=_prompt;
- (id)_ipEntryView;	// IMP=0x00000001000d9a28
- (void)ipEntryViewDidFinishEditing:(id)arg1;	// IMP=0x00000001000d9984
@property(copy, nonatomic) NSString *ipAddress;
- (void)setTitle:(id)arg1;	// IMP=0x00000001000d97fc
- (id)preferredFocusEnvironments;	// IMP=0x00000001000d9744
- (_Bool)becomeFirstResponder;	// IMP=0x00000001000d972c
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000d953c
- (void)loadView;	// IMP=0x00000001000d9198
