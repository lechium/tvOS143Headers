...
+ (id)namedLayerStackWithImage:(id)arg1 cornerRadiusFlatImage:(id)arg2 decodeLayerImagesImmediately:(_Bool)arg3;	// IMP=0x000000010001a194
+ (id)namedLayerStackWithImage:(id)arg1 cornerRadiusFlatImage:(id)arg2;	// IMP=0x000000010001a12c
+ (id)namedLayerStackWithLayers:(id)arg1 cornerRadiusFlatImage:(id)arg2 radiosityImage:(id)arg3;	// IMP=0x000000010001a058
+ (id)namedLayerStackWithLayers:(id)arg1 cornerRadiusFlatImage:(id)arg2;	// IMP=0x0000000100019ff0
+ (id)namedLayerStackProxyFromLayerStack:(id)arg1 layers:(id)arg2 cornerRadiusFlatImage:(id)arg3;	// IMP=0x0000000100019f18
+ (id)namedLayerStackProxyFromLayerStack:(id)arg1 cornerRadiusFlatImage:(id)arg2;	// IMP=0x0000000100019e78
- (void).cxx_destruct;	// IMP=0x000000010001ac1c
...
- (id)_init;	// IMP=0x0000000100019e44
- (id)init;	// IMP=0x0000000100019e2c
