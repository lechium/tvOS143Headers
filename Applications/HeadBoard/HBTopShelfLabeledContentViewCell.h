...
- (void).cxx_destruct;	// IMP=0x00000001000629e0
...
- (void)_updateDefaultUnhighlightedColor;	// IMP=0x000000010006281c
- (double)_maxTitleWidthWithFocus:(_Bool)arg1;	// IMP=0x00000001000627c4
- (id)_animatedTitleLabel;	// IMP=0x00000001000627b8
- (Class)_labelClass;	// IMP=0x00000001000627ac
- (void)_updateTitleExpirationAppearance;	// IMP=0x0000000100062450
- (void)_updateOverlayView;	// IMP=0x0000000100061b3c
- (void)layoutSubviews;	// IMP=0x0000000100061aec
- (void)setUnhighlightedTextColor:(id)arg1;	// IMP=0x000000010006083c
- (id)unhighlightedTextColor;	// IMP=0x0000000100060830
- (void)setHighlightedTextColor:(id)arg1;	// IMP=0x00000001000607fc
- (id)highlightedTextColor;	// IMP=0x00000001000607f0
- (void)setTitle:(id)arg1;	// IMP=0x00000001000607bc
- (id)title;	// IMP=0x00000001000607b0
- (void)didMoveToWindow;	// IMP=0x000000010006073c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100060670
- (void)prepareForReuse;	// IMP=0x00000001000605b8
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000600e8
- (void)dealloc;	// IMP=0x0000000100060088
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005ff38
