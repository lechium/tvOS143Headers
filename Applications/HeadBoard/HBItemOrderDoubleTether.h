...
- (void).cxx_destruct;	// IMP=0x00000001000590b8
...
- (unsigned long long)insertionIndexInItems:(id)arg1;	// IMP=0x0000000100058f60
- (id)initWithLeadingApplication:(id)arg1 distance:(unsigned long long)arg2 trailingApplication:(id)arg3 distance:(unsigned long long)arg4;	// IMP=0x0000000100058e84
