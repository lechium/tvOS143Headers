...
- (void).cxx_destruct;	// IMP=0x00000001000a3b40
...
- (_Bool)_handleFetchDidCompleteWithIdentifier:(id)arg1;	// IMP=0x00000001000a39d0
- (void)_stopTimerAndResetState:(_Bool)arg1;	// IMP=0x00000001000a3818
- (void)_stopTimer;	// IMP=0x00000001000a3808
- (double)_tryToAdjustTimerFireTime:(double)arg1;	// IMP=0x00000001000a3794
- (void)_adjustTimerForActiveOrInactiveContent;	// IMP=0x00000001000a372c
- (void)_setTimerFireTime:(double)arg1;	// IMP=0x00000001000a3568
- (double)_minimumRefetchTimerFireTimeWithFireTime:(double)arg1;	// IMP=0x00000001000a34e0
- (_Bool)_haveUrgentFetchPriority;	// IMP=0x00000001000a34bc
- (double)_firstFetchTimerFireTimeWithContentActive:(_Bool)arg1;	// IMP=0x00000001000a3424
- (_Bool)_hasStartedAtLeastOneFetch;	// IMP=0x00000001000a33f8
- (_Bool)_haveValidFetchStartAndEndTimes;	// IMP=0x00000001000a3394
- (double)_timerFireTimeWithContentActive:(_Bool)arg1;	// IMP=0x00000001000a32c8
- (void)_startTimer;	// IMP=0x00000001000a2efc
- (void)_initializeStateMachine;	// IMP=0x00000001000a1c3c
- (void)internetDidBecomeAvailable;	// IMP=0x00000001000a1bf4
- (void)topShelfContentDidChange;	// IMP=0x00000001000a1bac
- (void)topShelfFetchDidCompleteWithIdentfier:(id)arg1;	// IMP=0x00000001000a1ab8
- (void)resume;	// IMP=0x00000001000a18b0
- (void)pause;	// IMP=0x00000001000a1868
- (void)stop;	// IMP=0x00000001000a1820
- (void)start;	// IMP=0x00000001000a17d8
- (void)dealloc;	// IMP=0x00000001000a178c
- (id)initWithApplicationIdentifier:(id)arg1 configuration:(id)arg2 fetchPriority:(long long)arg3 processingQueue:(id)arg4 delegate:(id)arg5;	// IMP=0x00000001000a15c8
