...
- (void).cxx_destruct;	// IMP=0x0000000100015f00
...
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x0000000100015d68
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x0000000100015d60
- (long long)numberOfSectionsInCollectionView:(id)arg1;	// IMP=0x0000000100015d58
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x0000000100015d3c
- (id)preferredFocusEnvironments;	// IMP=0x0000000100015cb4
- (id)initWithItem:(id)arg1;	// IMP=0x0000000100015970
