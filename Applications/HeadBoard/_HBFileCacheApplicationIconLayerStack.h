...
- (void).cxx_destruct;	// IMP=0x00000001000344b0
...
- (void)_deflateLayerStack;	// IMP=0x00000001000342f8
- (void)_inflateLayerStack;	// IMP=0x0000000100034010
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x0000000100033e98
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000100033a5c
