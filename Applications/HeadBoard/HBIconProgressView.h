...
+ (id)_pieImageAtFraction:(double)arg1;	// IMP=0x00000001000447fc
- (void).cxx_destruct;	// IMP=0x0000000100045320
...
- (id)_maskImage;	// IMP=0x00000001000450e0
- (void)_drawPauseUIWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000100044f00
- (void)_drawIncomingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000100044e04
- (void)_drawOutgoingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000100044c1c
- (void)_drawPieWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000100044b7c
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000001000445f0
- (void)_clearDisplayLink;	// IMP=0x00000001000445b4
- (void)_ensureDisplayLink;	// IMP=0x00000001000444d8
- (void)_onDisplayLink:(id)arg1;	// IMP=0x00000001000443a8
- (void)_updateFractionTransitionAnimated:(_Bool)arg1;	// IMP=0x000000010004429c
- (void)_updateStateTransitionAnimated:(_Bool)arg1;	// IMP=0x0000000100044178
- (void)_updatePausedTransitionAnimated:(_Bool)arg1;	// IMP=0x00000001000440d8
- (void)_updateTransitionsAnimated:(_Bool)arg1;	// IMP=0x0000000100043e8c
- (_Bool)_hasActiveTransitions;	// IMP=0x0000000100043e4c
- (void)setState:(long long)arg1 paused:(_Bool)arg2 fractionLoaded:(double)arg3 animated:(_Bool)arg4;	// IMP=0x0000000100043d44
- (void)dealloc;	// IMP=0x0000000100043cec
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100043c6c
