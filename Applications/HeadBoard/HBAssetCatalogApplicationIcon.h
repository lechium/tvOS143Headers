...
- (void).cxx_destruct;	// IMP=0x00000001000387d0
...
- (id)copyFlattenedImage;	// IMP=0x000000010003860c
- (id)flattenedImage;	// IMP=0x00000001000385c8
- (id)copyRadiosityImage;	// IMP=0x0000000100038478
- (id)radiosityImage;	// IMP=0x0000000100038434
@property(readonly, nonatomic) double scale;
@property(readonly, nonatomic) struct CGSize size;
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000100038178
