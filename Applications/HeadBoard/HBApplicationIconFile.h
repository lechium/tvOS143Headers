...
+ (id)_fileDataWithMetadataData:(id)arg1 flattenedImageData:(id)arg2 radiosityImageData:(id)arg3;	// IMP=0x0000000100039c7c
+ (id)_imageDataWithImage:(struct CGImage *)arg1 extraOptions:(id)arg2;	// IMP=0x0000000100039b00
+ (id)iconFileDataWithApplication:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000392d0
- (void).cxx_destruct;	// IMP=0x0000000100039eac
...
- (id)radiosityImage;	// IMP=0x0000000100039a38
@property(readonly, nonatomic) NSArray *layers;
@property(readonly, nonatomic) double imageScale;
@property(readonly, nonatomic) struct CGSize imageSize;
- (id)flattenedImage;	// IMP=0x000000010003986c
- (id)description;	// IMP=0x00000001000390b8
- (id)initWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100038ec8
