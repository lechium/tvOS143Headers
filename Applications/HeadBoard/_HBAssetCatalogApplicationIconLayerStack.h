...
- (void).cxx_destruct;	// IMP=0x0000000100019228
...
- (void)_deflateLayerStack;	// IMP=0x0000000100019070
- (void)_inflateLayerStack;	// IMP=0x0000000100018d88
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x0000000100018c10
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000100018900
