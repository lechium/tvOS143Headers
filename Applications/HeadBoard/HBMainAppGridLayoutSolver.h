...
+ (struct CGRect)_dockFrameWithBounds:(struct CGRect)arg1 focusState:(unsigned long long)arg2;	// IMP=0x000000010008b304
- (void).cxx_destruct;	// IMP=0x000000010008b428
...
- (unsigned long long)_updateWithChanges:(unsigned long long)arg1 nextState:(id)arg2;	// IMP=0x000000010008afa8
- (unsigned long long)updateState:(CDUnknownBlockType)arg1;	// IMP=0x000000010008aec8
...
- (id)init;	// IMP=0x000000010008ae28
- (id)initWithState:(id)arg1;	// IMP=0x000000010008ad68
