...
- (id)_promotionImageName;	// IMP=0x000000010003f6a8
- (id)_topShelfPromotionCarouselItem;	// IMP=0x000000010003f69c
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000010003f5c4
...
- (id)initWithTopShelfPromotionCarouselItem:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x000000010003f41c
