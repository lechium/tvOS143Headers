...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100038a9c
- (void).cxx_destruct;	// IMP=0x0000000100038c84
...
- (id)description;	// IMP=0x0000000100038aa4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100038980
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010003884c
- (id)_init;	// IMP=0x0000000100038818
