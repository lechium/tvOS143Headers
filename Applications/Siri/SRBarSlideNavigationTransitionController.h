...
- (void).cxx_destruct;	// IMP=0x0000000100023bfc
...
- (void)_performNavigationBarAnimations;	// IMP=0x0000000100023b54
- (void)coordinateAdditionalTransitionsWithTransitionCoordinator:(id)arg1;	// IMP=0x0000000100023950
- (void)configureWithNavigationController:(id)arg1;	// IMP=0x00000001000238cc
