...
+ (id)configuration;	// IMP=0x0000000100082358
+ (id)new;	// IMP=0x0000000100082350
- (void).cxx_destruct;	// IMP=0x00000001000824c4
...
- (id)identifierForService:(long long)arg1;	// IMP=0x0000000100082418
- (id)domainForService:(long long)arg1;	// IMP=0x00000001000823d0
- (id)init;	// IMP=0x0000000100082338
- (id)_init;	// IMP=0x0000000100082278
