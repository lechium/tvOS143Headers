...
- (void).cxx_destruct;	// IMP=0x00000001000752a8
...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x0000000100075084
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x0000000100074fe4
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100074f64
