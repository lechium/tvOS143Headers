...
+ (id)sharedApplication;	// IMP=0x000000010004b2b0
- (void).cxx_destruct;	// IMP=0x000000010004b3a4
@property(nonatomic) __weak id <SRApplicationDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void)setFrontMostAppOrientation:(long long)arg1;	// IMP=0x000000010004b360
- (long long)_frontMostAppOrientation;	// IMP=0x000000010004b350
- (long long)launchOrientation;	// IMP=0x000000010004b340
