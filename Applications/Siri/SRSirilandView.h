...
+ (id)sirilandView;	// IMP=0x000000010007fcf4
- (void).cxx_destruct;	// IMP=0x000000010008041c
...
- (void)statusBarFrameDidChange;	// IMP=0x00000001000802ac
- (_Bool)_keylineIsVisible;	// IMP=0x0000000100080274
- (void)layoutSubviews;	// IMP=0x000000010007ff5c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010007fd08
