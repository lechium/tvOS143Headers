...
- (void)_scrollingDidEnd;	// IMP=0x0000000100088690
- (id)_activePageViewBasedOnScrollViewPosition;	// IMP=0x00000001000884e4
- (_Bool)_multiplePageViewsAreVisible;	// IMP=0x0000000100088348
- (_Bool)_containsPageView:(id)arg1;	// IMP=0x00000001000882f8
- (id)_pageViews;	// IMP=0x00000001000882e0
- (void)scrollViewDidEndDragging:(id)arg1 willDecelerate:(_Bool)arg2;	// IMP=0x00000001000882cc
- (void)scrollViewDidEndDecelerating:(id)arg1;	// IMP=0x00000001000882c0
- (void)scrollViewWillBeginDragging:(id)arg1;	// IMP=0x00000001000882b0
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000100088278
- (void)_updateTransitionState;	// IMP=0x00000001000881b4
@property(nonatomic, getter=isPagingEnabled) _Bool pagingEnabled;
- (void)setActivePageView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000010008806c
- (void)removePageView:(id)arg1;	// IMP=0x0000000100087eb4
- (void)addPageView:(id)arg1;	// IMP=0x0000000100087e34
- (void)insertPageView:(id)arg1 atIndex:(long long)arg2;	// IMP=0x0000000100087cdc
- (void)reloadData;	// IMP=0x0000000100087ad8
- (void)layoutSubviews;	// IMP=0x0000000100087948
- (void)didMoveToWindow;	// IMP=0x00000001000878f8
- (id)initWithFrame:(struct CGRect)arg1 textInputEnabled:(_Bool)arg2;	// IMP=0x000000010008781c
