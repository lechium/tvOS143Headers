...
- (void).cxx_destruct;	// IMP=0x000000010003d984
@property(nonatomic) __weak id <SRStarkItemControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (unsigned long long)autoDismissalReason;	// IMP=0x000000010003d934
- (long long)autoDismissalStrategy;	// IMP=0x000000010003d904
- (void)viewDidLoad;	// IMP=0x000000010003d764
- (void)loadView;	// IMP=0x000000010003d6f0
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 shouldSynthesizeTitles:(_Bool)arg3;	// IMP=0x000000010003d5f4
