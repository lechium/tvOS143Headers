...
- (void).cxx_destruct;	// IMP=0x0000000100028304
...
- (void)_setKeylineHidden:(id)arg1 hidden:(_Bool)arg2;	// IMP=0x00000001000281d8
- (void)layoutSubviews;	// IMP=0x0000000100027e88
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100027e78
- (id)initWithFrame:(struct CGRect)arg1 collectionView:(id)arg2;	// IMP=0x0000000100027c50
