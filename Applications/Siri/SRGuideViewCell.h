...
+ (_Bool)chevronBlendEffectEnabled;	// IMP=0x0000000100035444
+ (struct UIEdgeInsets)defaultInsets;	// IMP=0x00000001000353e8
+ (double)heightOfCellWithName:(id)arg1 tagPhrase:(id)arg2 width:(double)arg3;	// IMP=0x0000000100035058
+ (_Bool)placesImageAboveText;	// IMP=0x000000010003491c
+ (_Bool)_allowsTextToWrap;	// IMP=0x00000001000348a8
+ (id)_tagPhraseLabelFont;	// IMP=0x0000000100034894
+ (id)_nameLabelFont;	// IMP=0x0000000100034880
- (void).cxx_destruct;	// IMP=0x0000000100035524
...
- (void)updateConstraints;	// IMP=0x0000000100034990
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100034514
