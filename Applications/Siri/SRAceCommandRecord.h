...
- (void).cxx_destruct;	// IMP=0x0000000100092d80
...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x0000000100092cc4
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x0000000100092808
- (void)incrementNumberOfStoppedActions;	// IMP=0x00000001000927d0
- (void)incrementNumberOfStartedActions;	// IMP=0x0000000100092798
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100092670
