...
- (void).cxx_destruct;	// IMP=0x0000000100081c24
...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x0000000100081900
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x0000000100080e74
- (id)init;	// IMP=0x0000000100080494
