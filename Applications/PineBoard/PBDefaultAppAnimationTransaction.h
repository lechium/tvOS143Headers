...
- (void).cxx_destruct;	// IMP=0x00000001001aa524
...
- (void)_startFadeAnimation;	// IMP=0x00000001001a9ee4
- (void)_startScaleAnimation;	// IMP=0x00000001001a98f0
- (void)_startCoordinatedAnimation;	// IMP=0x00000001001a9788
- (void)_startReduceMotionAnimation;	// IMP=0x00000001001a96b8
- (void)_didComplete;	// IMP=0x00000001001a956c
- (void)_willFailWithReason:(id)arg1;	// IMP=0x00000001001a93d4
- (void)_willInterruptWithReason:(id)arg1;	// IMP=0x00000001001a923c
- (void)_begin;	// IMP=0x00000001001a9080
- (_Bool)_canBeInterrupted;	// IMP=0x00000001001a9060
- (id)initWithSceneLayoutViewController:(id)arg1 fromViewController:(id)arg2 toViewController:(id)arg3 isResigning:(_Bool)arg4;	// IMP=0x00000001001a8eb8
