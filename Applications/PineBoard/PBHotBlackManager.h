...
+ (id)sharedInstance;	// IMP=0x00000001000b3a18
+ (id)dependencyDescription;	// IMP=0x00000001000b3838
- (void).cxx_destruct;	// IMP=0x00000001000b43d8
@property(readonly, nonatomic) PBSystemOverlayController *overlayController; // @synthesize overlayController=_overlayController;
- (void)displayState:(id)arg1 didChangeWithConnection:(long long)arg2;	// IMP=0x00000001000b423c
- (void)prepareUIForSystemOverlayPresentationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000b4158
- (_Bool)dismiss;	// IMP=0x00000001000b4020
- (void)present;	// IMP=0x00000001000b3f00
@property(readonly, nonatomic, getter=isPresenting) _Bool presenting;
- (void)dealloc;	// IMP=0x00000001000b3e2c
- (id)init;	// IMP=0x00000001000b3b18
