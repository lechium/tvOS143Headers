...
- (void).cxx_destruct;	// IMP=0x00000001000afd6c
...
- (_Bool)_needsUI;	// IMP=0x00000001000afa80
- (void)_begin;	// IMP=0x00000001000af48c
- (id)initWithRequest:(id)arg1;	// IMP=0x00000001000af1fc
