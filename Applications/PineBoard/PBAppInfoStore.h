...
- (void).cxx_destruct;	// IMP=0x000000010002a6dc
...
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 applicationInfo:(id)arg4;	// IMP=0x0000000100029d90
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 placeholder:(id)arg4;	// IMP=0x0000000100029a30
- (void)queue_processUpdates:(id)arg1;	// IMP=0x0000000100027c40
- (void)_extraMultiUserApplicationsDidChange;	// IMP=0x000000010002785c
- (void)languageDidChange;	// IMP=0x0000000100027454
- (void)applicationIconDidChange:(id)arg1;	// IMP=0x0000000100027044
- (void)placeholderDidChangeSignificantly:(id)arg1;	// IMP=0x0000000100026e9c
- (void)placeholderProgressDidUpdate:(id)arg1;	// IMP=0x0000000100026cf4
- (void)handleDynamicStateChanged:(id)arg1;	// IMP=0x0000000100026c4c
- (void)handlePolicyChanged:(id)arg1;	// IMP=0x0000000100026ba4
- (id)appInfoControllerWithEnabledApps;	// IMP=0x0000000100026afc
- (id)appInfoControllerWithEnabledAndVisibleApps;	// IMP=0x0000000100026a54
- (id)appInfoControllerWithEnabledAndVisibleAppsAndPlaceholders;	// IMP=0x00000001000269ac
- (id)appInfoControllerWithEverything;	// IMP=0x0000000100026958
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100026848
- (void)_enqueueUpdate:(id)arg1;	// IMP=0x0000000100026678
- (void)removeObserver:(id)arg1;	// IMP=0x0000000100026550
- (id)addObserver:(id)arg1;	// IMP=0x0000000100026288
- (id)configuration;	// IMP=0x0000000100026130
- (id)appInfos;	// IMP=0x0000000100025ed0
- (void)dealloc;	// IMP=0x0000000100025b54
- (id)initWithApplicationLibrary:(id)arg1 policy:(id)arg2 dynamicStateDataSource:(id)arg3;	// IMP=0x0000000100024880
