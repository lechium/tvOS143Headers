...
- (void).cxx_destruct;	// IMP=0x00000001000f7010
...
- (void)_beginDismissalTransactionAnimated:(_Bool)arg1 shouldUpdateWallpaper:(_Bool)arg2 shouldApplyStartValues:(_Bool)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000f6bac
- (void)viewServiceDidTerminate;	// IMP=0x00000001000f6ae4
- (void)viewServiceDidDismiss:(id)arg1;	// IMP=0x00000001000f6a58
- (void)viewService:(id)arg1 willDismissWithResult:(id)arg2;	// IMP=0x00000001000f6998
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000f6518
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000f62cc
- (void)screenSaverTransitionUpdatedAcceptEvents:(_Bool)arg1;	// IMP=0x00000001000f5ee0
- (void)screenSaverTransitionShowSnapshotImage:(id)arg1;	// IMP=0x00000001000f5d04
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (void)viewDidLoad;	// IMP=0x00000001000f5968
- (id)initWithChildViewController:(id)arg1;	// IMP=0x00000001000f57b0
