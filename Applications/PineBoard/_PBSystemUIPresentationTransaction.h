...
- (void).cxx_destruct;	// IMP=0x00000001001996e4
...
- (_Bool)_canBeInterrupted;	// IMP=0x00000001001995f8
- (void)_begin;	// IMP=0x00000001001991e8
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000100199028
