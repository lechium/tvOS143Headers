...
+ (long long)_alertActionStyleForButtonPresentationStyle:(id)arg1;	// IMP=0x00000001001bdfc0
- (void).cxx_destruct;	// IMP=0x00000001001bece0
...
- (long long)_typeForCurrentTemplateKey;	// IMP=0x00000001001bdf60
- (id)_safeLocalizedValue:(id)arg1 withBundle:(id)arg2;	// IMP=0x00000001001bdae4
- (_Bool)isAlive;	// IMP=0x00000001001bd874
- (void)cancel;	// IMP=0x00000001001bd83c
- (void)didSelectButtonAtIndex:(long long)arg1;	// IMP=0x00000001001bd198
- (_Bool)isLastTextField:(long long)arg1;	// IMP=0x00000001001bd114
- (long long)keyboardTypeForTextField:(long long)arg1;	// IMP=0x00000001001bd004
- (_Bool)isSecureTextField:(long long)arg1;	// IMP=0x00000001001bcf80
@property(readonly, nonatomic) long long notificationType;
- (void)updateWithMessage:(id)arg1 requestFlags:(int)arg2;	// IMP=0x00000001001bb0e8
- (id)initWithMessage:(id)arg1 replyPort:(unsigned int)arg2 requestFlags:(int)arg3;	// IMP=0x00000001001bafd0
