...
+ (id)defaultManager;	// IMP=0x00000001000d3e14
- (void).cxx_destruct;	// IMP=0x00000001000d55fc
...
- (_Bool)dismissAppSwitcherToBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000d4bf0
- (void)presentAppSwitcherWithFocusedBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000d4258
- (void)invalidateSceneHosting;	// IMP=0x00000001000d4244
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (_Bool)shouldActivateForProcessWithIdentifier:(id)arg1;	// IMP=0x00000001000d4068
- (id)_init;	// IMP=0x00000001000d3f60
- (id)init;	// IMP=0x00000001000d3f24
