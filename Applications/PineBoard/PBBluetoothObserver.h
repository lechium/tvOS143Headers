...
- (void).cxx_destruct;	// IMP=0x000000010008b62c
...
- (void)_reloadStatistics;	// IMP=0x000000010008a840
- (void)_signalReloadStatisticsSource;	// IMP=0x000000010008a7f0
- (void)_handleBluetoothManagerNotificationHandler:(id)arg1;	// IMP=0x000000010008a78c
- (void)pairingAgent:(id)arg1 peerDidUnpair:(id)arg2;	// IMP=0x000000010008a6f8
- (void)pairingAgent:(id)arg1 peerDidFailToCompletePairing:(id)arg2 error:(id)arg3;	// IMP=0x000000010008a638
- (void)pairingAgent:(id)arg1 peerDidCompletePairing:(id)arg2;	// IMP=0x000000010008a5a4
@property(readonly, nonatomic) PBBluetoothDeviceStatistics *pairedDeviceStatistics;
- (void)dealloc;	// IMP=0x000000010008a278
- (id)init;	// IMP=0x0000000100089d0c
