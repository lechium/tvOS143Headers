...
+ (id)_appIconNameForAppInfo:(id)arg1;	// IMP=0x00000001000c2b74
+ (id)_placeholderIconImageForScale:(double)arg1;	// IMP=0x00000001000c2b30
+ (id)_pathForCacheKey:(id)arg1 cacheDirectory:(id)arg2;	// IMP=0x00000001000c2a80
+ (id)_cacheKeyForBundleIdentifier:(id)arg1 scale:(double)arg2 lastModifiedDate:(double)arg3;	// IMP=0x00000001000c29c4
+ (id)sharedAppSwitcherIconCache;	// IMP=0x00000001000bfee0
- (void).cxx_destruct;	// IMP=0x00000001000c2d60
...
- (void)_buildAndPruneCache;	// IMP=0x00000001000c21a4
- (void)_workQueue_removeApplicationIconsForCacheEntry:(id)arg1;	// IMP=0x00000001000c1f14
- (void)_workQueue_removeApplicationIconsForAppInfo:(id)arg1;	// IMP=0x00000001000c1c84
- (void)_workQueue_createApplicationIcon:(id)arg1 preferExisting:(_Bool)arg2;	// IMP=0x00000001000c12b0
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x00000001000c0ac8
- (id)iconImageForAppWithBundleIdentifier:(id)arg1 scale:(double)arg2;	// IMP=0x00000001000c0608
- (id)initWithName:(id)arg1 iconSize:(struct CGSize)arg2;	// IMP=0x00000001000c0040
