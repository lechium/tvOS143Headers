...
- (void).cxx_destruct;	// IMP=0x0000000100190a54
...
- (void)_begin;	// IMP=0x0000000100190478
- (id)initWithSceneIdentity:(id)arg1 backgroundAllOtherScenes:(_Bool)arg2;	// IMP=0x0000000100190354
