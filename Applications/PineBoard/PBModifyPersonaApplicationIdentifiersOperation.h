...
- (void).cxx_destruct;	// IMP=0x000000010008866c
...
- (void)start;	// IMP=0x0000000100087c58
- (_Bool)isFinished;	// IMP=0x0000000100087be8
- (_Bool)isExecuting;	// IMP=0x0000000100087b78
- (_Bool)isAsynchronous;	// IMP=0x0000000100087b58
- (id)initWithPersonaUniqueString:(id)arg1 applicationIdentifiers:(id)arg2;	// IMP=0x0000000100087a48
- (id)initWithPersonaManager:(id)arg1 personaUniqueString:(id)arg2 applicationIdentifiers:(id)arg3;	// IMP=0x000000010008789c
