...
- (void).cxx_destruct;	// IMP=0x000000010017924c
...
- (id)_messageStringAttributes;	// IMP=0x0000000100178a9c
- (id)_titleStringAttributes;	// IMP=0x000000010017880c
- (void)_menuButtonPressed:(id)arg1;	// IMP=0x0000000100178694
- (void)textEntryControllerDidFinish:(id)arg1;	// IMP=0x0000000100178578
- (void)buttonView:(id)arg1 didSelectButton:(id)arg2 atIndex:(long long)arg3;	// IMP=0x00000001001783f4
- (void)_synchronizeEnteredValues;	// IMP=0x0000000100178368
- (id)textField;	// IMP=0x000000010017825c
- (void)_showChildViewController:(id)arg1;	// IMP=0x0000000100178004
- (id)_buttonsForTextField:(long long)arg1 defaultButtonIndex:(long long *)arg2;	// IMP=0x0000000100177c84
- (void)_showTextEntryViewControllerForTextField:(long long)arg1;	// IMP=0x00000001001774f0
- (void)_configureStateMachine;	// IMP=0x0000000100176a4c
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x0000000100176968
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x00000001001768e0
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x00000001001767fc
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100176730
- (void)viewDidLoad;	// IMP=0x00000001001766cc
- (void)loadView;	// IMP=0x0000000100176598
- (unsigned long long)addButtonWithTitle:(id)arg1;	// IMP=0x00000001001764e4
- (void)setAlternateTitle:(id)arg1 message:(id)arg2 forTextFieldAtIndex:(unsigned long long)arg3;	// IMP=0x00000001001763d4
- (unsigned long long)addTextFieldWithInitialText:(id)arg1 placeholder:(id)arg2 keyboardType:(long long)arg3;	// IMP=0x0000000100176204
- (id)init;	// IMP=0x0000000100176190
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100175f6c
