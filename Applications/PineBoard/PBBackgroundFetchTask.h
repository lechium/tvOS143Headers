...
+ (id)makeUIFetchContentInBackgroundActionFromBundleID:(id)arg1;	// IMP=0x0000000100110ab8
- (void).cxx_destruct;	// IMP=0x0000000100111a28
...
- (void)finishWithResult:(unsigned long long)arg1;	// IMP=0x000000010011167c
- (id)initForApplication:(id)arg1 sequenceNumber:(unsigned int)arg2;	// IMP=0x0000000100111000
