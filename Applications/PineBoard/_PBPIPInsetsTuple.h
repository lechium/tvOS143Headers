...
- (void).cxx_destruct;	// IMP=0x000000010006b83c
...
- (void)dropFence;	// IMP=0x000000010006b79c
- (id)initWithValue:(id)arg1 animationSettings:(id)arg2 animationFence:(id)arg3;	// IMP=0x000000010006b634
- (id)init;	// IMP=0x000000010006b530
