...
+ (id)exportedInterface;	// IMP=0x00000001001b933c
+ (id)serviceViewControllerInterface;	// IMP=0x00000001001b8fac
- (void).cxx_destruct;	// IMP=0x00000001001b97ac
...
- (void)dealloc;	// IMP=0x00000001001b8f34
- (void)_dismissViewServiceAnimated:(_Bool)arg1 withOptions:(id)arg2 dismissalResult:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001001b88f8
- (void)dismissWithResult:(id)arg1;	// IMP=0x00000001001b8500
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x00000001001b836c
- (void)dismissViewServiceAnimated:(_Bool)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001b82bc
- (void)messageViewServiceWithMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001001b80d8
- (void)prepareViewServiceAnimated:(_Bool)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001b7e34
