...
- (void).cxx_destruct;	// IMP=0x00000001001ac170
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000001001abdc8
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000001001abd24
- (id)succinctDescriptionBuilder;	// IMP=0x00000001001abc3c
- (id)succinctDescription;	// IMP=0x00000001001abbcc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001abb78
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001ab450
...
- (id)initWithElement:(id)arg1;	// IMP=0x00000001001aafa8
- (id)initWithElement:(id)arg1 controller:(id)arg2;	// IMP=0x00000001001aaddc
