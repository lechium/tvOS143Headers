...
+ (_Bool)isWallpaperRequired;	// IMP=0x000000010022df04
- (void).cxx_destruct;	// IMP=0x000000010022e5d4
...
- (id)_newSnapshotView;	// IMP=0x000000010022e0e4
- (void)didMoveToWindow;	// IMP=0x000000010022df5c
- (id)contentViewToAnimateToOnInterfaceChange;	// IMP=0x000000010022df24
