...
+ (_Bool)_connection:(id)arg1 hasValidEntitlementWithReply:(CDUnknownBlockType)arg2;	// IMP=0x00000001001b7a80
- (void).cxx_destruct;	// IMP=0x00000001001b7dd8
...
- (_Bool)_hasValidEntitlementWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000001001b79d4
- (_Bool)_hasValidEntitlement;	// IMP=0x00000001001b7990
- (void)removeLayoutElementsWithIdentifiers:(id)arg1 withTransitionContext:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001001b7150
- (void)addLayoutElements:(id)arg1 withTransitionContext:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001001b6960
- (void)layoutController:(id)arg1 didUpdateHints:(id)arg2 withTransitionContext:(id)arg3;	// IMP=0x00000001001b681c
- (void)invalidate;	// IMP=0x00000001001b67d0
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x00000001001b6658
