...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001a20bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001a2090
- (id)initWithContext:(id)arg1;	// IMP=0x00000001001a1f80
