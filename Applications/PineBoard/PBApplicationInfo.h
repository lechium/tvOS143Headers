...
@interface PBApplicationInfo : _UIApplicationInfo
{
    ...
    _Bool _supportsBrowsingChannelGuideUserActivityType;	// 29 = 0x1d
...
+ (_Bool)_isExtraMultiUserApplication:(id)arg1;	// IMP=0x00000001000bd388
+ (id)_infoPlistKeys;	// IMP=0x00000001000bd1f0
+ (id)_entitlementKeys;	// IMP=0x00000001000bd0a4
- (void).cxx_destruct;	// IMP=0x00000001000bdb48
...
- (void)_refreshRunsAsCurrentUser;	// IMP=0x00000001000bce48
- (void)_refreshLocalizedName;	// IMP=0x00000001000bccc0
- (id)getEntitlementValueUncached:(id)arg1 ofClass:(Class)arg2;	// IMP=0x00000001000bcbb4
- (id)getInfoPlistValueUncached:(id)arg1;	// IMP=0x00000001000bc920
...
- (void)_loadFromProxy:(id)arg1;	// IMP=0x00000001000bb320
- (void)pb_reportUntrustedLaunchAttempt;	// IMP=0x000000010024d5f8
