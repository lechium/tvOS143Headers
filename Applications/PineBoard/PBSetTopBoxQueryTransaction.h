...
- (void).cxx_destruct;	// IMP=0x0000000100135830
...
- (void)_begin;	// IMP=0x0000000100135000
- (_Bool)_canBeInterrupted;	// IMP=0x0000000100134fe0
- (double)watchdogTimeout;	// IMP=0x0000000100134fc0
- (_Bool)shouldWatchdog:(id *)arg1;	// IMP=0x0000000100134f9c
@property(readonly, nonatomic, getter=isFresh) _Bool fresh;
- (id)init;	// IMP=0x0000000100134e28
- (id)initWithLog:(id)arg1 identityProviderInfoCenter:(id)arg2 currentBundleIdentifier:(id)arg3;	// IMP=0x0000000100134c9c
