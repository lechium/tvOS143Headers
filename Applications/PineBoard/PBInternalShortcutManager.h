...
+ (id)sharedInstance;	// IMP=0x00000001000c41a0
+ (id)dependencyDescription;	// IMP=0x00000001000c40e8
- (void).cxx_destruct;	// IMP=0x00000001000c486c
@property(retain, nonatomic) NSMutableDictionary *handlers; // @synthesize handlers=_handlers;
@property(retain, nonatomic) PBBulletinService *bulletinService; // @synthesize bulletinService=_bulletinService;
- (void)executeShortcut;	// IMP=0x00000001000c4570
- (void)registerWithOption:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000c439c
