...
- (void).cxx_destruct;	// IMP=0x000000010003053c
...
- (id)description;	// IMP=0x0000000100030194
- (unsigned long long)hash;	// IMP=0x000000010003015c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010002ffdc
- (id)initWithToken:(id)arg1 requestType:(unsigned long long)arg2;	// IMP=0x000000010002fedc
- (id)initWithToken:(id)arg1;	// IMP=0x000000010002fe3c
- (id)init;	// IMP=0x000000010002fe04
