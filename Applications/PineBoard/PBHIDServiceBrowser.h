...
- (void).cxx_destruct;	// IMP=0x00000001001dc354
...
- (void)_addService:(struct __IOHIDServiceClient *)arg1;	// IMP=0x00000001001dc1c4
- (void)_copyInitialServices;	// IMP=0x00000001001dc11c
- (void)_stopMonitoring;	// IMP=0x00000001001dc0ac
- (void)_startMonitoring;	// IMP=0x00000001001dc044
- (_Bool)eventSenderMatchesDiscoveredService:(struct __IOHIDEvent *)arg1;	// IMP=0x00000001001dbfc8
- (void)dealloc;	// IMP=0x00000001001dbf1c
- (id)init;	// IMP=0x00000001001dbe68
- (id)initWithDeviceMatching:(id)arg1 predicate:(CDUnknownBlockType)arg2;	// IMP=0x00000001001dbba8
