...
+ (id)sharedInstance;	// IMP=0x00000001000b1ff8
+ (id)dependencyDescription;	// IMP=0x00000001000b1e50
- (void).cxx_destruct;	// IMP=0x00000001000b37e8
...
- (void)dismiss;	// IMP=0x00000001000b369c
- (void)presentForDisplayModes:(id)arg1 selectionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b23f0
...
- (id)init;	// IMP=0x00000001000b20f8
