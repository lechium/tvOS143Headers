...
+ (double)_longestLabelWidthInViews:(id)arg1;	// IMP=0x0000000100051d64
+ (id)_labelWithText:(id)arg1;	// IMP=0x0000000100051be4
- (void).cxx_destruct;	// IMP=0x0000000100051f70
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000519f8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100050d90
