...
- (void).cxx_destruct;	// IMP=0x00000001000b25d4
...
- (id)_itemIdentifiersForIndexes:(id)arg1;	// IMP=0x00000001000b23d0
- (id)_sectionItemCollectionsWithIndexBarItems:(id)arg1;	// IMP=0x00000001000b20fc
- (id)_indexBarItems;	// IMP=0x00000001000b20a8
- (_Bool)_canProvideIndexTitles;	// IMP=0x00000001000b2038
- (_Bool)_canHaveMultipleSections;	// IMP=0x00000001000b1fc8
- (id)_sectionForIndex:(unsigned long long)arg1;	// IMP=0x00000001000b1f4c
- (void)_updateSections;	// IMP=0x00000001000b1948
- (id)_mediaEntitiesInSectionWithIdentifier:(id)arg1;	// IMP=0x00000001000b1864
- (id)_mediaEntities;	// IMP=0x00000001000b1810
- (void)_updateWithLatestFetchResult:(id)arg1 previousFetchResult:(id)arg2;	// IMP=0x00000001000b14d8
- (id)_itemIdentifierForMediaEntity:(id)arg1;	// IMP=0x00000001000b1124
- (id)_itemIdentifiersForMediaEntities:(id)arg1;	// IMP=0x00000001000b0f90
- (void)_notfiyDelegatesCurrentSortDidChange:(id)arg1;	// IMP=0x00000001000b0f08
- (void)_notfiyDelegatesMediaEntitiesDidChangeWithAnimateChanges:(_Bool)arg1 itemIdentifiersOfAmendedItems:(id)arg2;	// IMP=0x00000001000b0e2c
- (void)_notifyDelegateMediaEntitiesDidChange:(id)arg1 changeSet:(id)arg2 itemIdentifiersOfAmendedItems:(id)arg3;	// IMP=0x00000001000b0d6c
- (void)_notifyDelegateCurrentSortDidChange:(id)arg1;	// IMP=0x00000001000b0cec
@property(readonly, copy) NSString *description;
- (id)indexPathForIndexTitle:(id)arg1 atIndex:(long long)arg2;	// IMP=0x00000001000b06f8
@property(readonly, copy, nonatomic) NSArray *indexTitles;
- (id)itemIdentifierForIndexPath:(id)arg1;	// IMP=0x00000001000b04d8
- (id)itemIdentifiersInSectionWithIdentifier:(id)arg1;	// IMP=0x00000001000b046c
- (id)sectionTitleAIndex:(unsigned long long)arg1;	// IMP=0x00000001000b0418
@property(readonly, copy, nonatomic) NSOrderedSet *sectionIdentifiers;
- (void)removeAll;	// IMP=0x00000001000b0240
- (_Bool)updateWithMediaEntitiesDataSourceFetchResult:(id)arg1 itemIdentifiersOfAmendedItems:(id *)arg2;	// IMP=0x00000001000aff3c
- (_Bool)updateWithMediaEntitiesDataSourceFetchResult:(id)arg1;	// IMP=0x00000001000aff2c
- (id)mediaItemForItemIdentifier:(id)arg1;	// IMP=0x00000001000afec0
- (id)mediaEntityCollectionForItemIdentifier:(id)arg1;	// IMP=0x00000001000afe54
- (id)mediaEntityForItemIdentifier:(id)arg1;	// IMP=0x00000001000afd9c
- (id)mediaItemAtIndexPath:(id)arg1;	// IMP=0x00000001000afd30
- (id)mediaEntityCollectionAtIndexPath:(id)arg1;	// IMP=0x00000001000afcc4
- (id)mediaEntityAtIndexPath:(id)arg1;	// IMP=0x00000001000afc18
...
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000001000af960
- (id)init;	// IMP=0x00000001000af8d8
