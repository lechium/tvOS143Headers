...
- (void).cxx_destruct;	// IMP=0x00000001000bed2c
...
- (id)initWithMediaEntitiesDataSource:(id)arg1 shelfViewControllerBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000beb98
