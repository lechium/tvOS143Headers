...
- (void).cxx_destruct;	// IMP=0x0000000100009cec
...
- (void)_stopAnimations;	// IMP=0x0000000100009a50
- (void)_startAnimations;	// IMP=0x0000000100009000
- (void)_addImage:(id)arg1;	// IMP=0x0000000100008d50
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000100008d18
- (void)layoutSubviews;	// IMP=0x0000000100008b68
- (void)didMoveToWindow;	// IMP=0x0000000100008a94
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000835c
