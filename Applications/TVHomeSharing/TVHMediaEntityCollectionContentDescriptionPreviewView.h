...
- (void).cxx_destruct;	// IMP=0x0000000100091970
...
- (void)_didSelectContentDescriptionText;	// IMP=0x00000001000918ac
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100090fa8
