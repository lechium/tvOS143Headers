...
+ (struct NSDirectionalEdgeInsets)defaultHeaderViewMargin;	// IMP=0x00000001000bfd68
- (void).cxx_destruct;	// IMP=0x00000001000c0720
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x00000001000c0508
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x00000001000c0270
- (void)invalidateLayoutWithContext:(id)arg1;	// IMP=0x00000001000c01cc
- (struct CGSize)collectionViewContentSize;	// IMP=0x00000001000c00fc
- (void)prepareLayout;	// IMP=0x00000001000bfd8c
- (_Bool)flipsHorizontallyInOppositeLayoutDirection;	// IMP=0x00000001000bfd84
- (long long)developmentLayoutDirection;	// IMP=0x00000001000bfd7c
- (id)init;	// IMP=0x00000001000bfcd0
