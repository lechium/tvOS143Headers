...
- (void).cxx_destruct;	// IMP=0x0000000100075170
...
- (void)_notifyDelegate;	// IMP=0x0000000100075098
- (void)_startLoadingImageWithImageProxy:(id)arg1 userInterfaceLayoutDirection:(long long)arg2;	// IMP=0x0000000100074be8
- (void)stopLoadingAndReset;	// IMP=0x0000000100074b50
- (void)startLoadingImageProxy:(id)arg1 userInterfaceLayoutDirection:(long long)arg2;	// IMP=0x0000000100074ac8
