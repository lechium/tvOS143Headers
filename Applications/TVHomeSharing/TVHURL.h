...
+ (id)_mediaEntityIdentifierFromString:(id)arg1;	// IMP=0x00000001000a7770
+ (id)_mediaServerIdentifierFromString:(id)arg1;	// IMP=0x00000001000a76dc
+ (unsigned long long)_mediaItemTypeFromString:(id)arg1;	// IMP=0x00000001000a762c
+ (unsigned long long)_mediaCategoryTypeFromString:(id)arg1;	// IMP=0x00000001000a757c
+ (unsigned long long)_displayTypeFromString:(id)arg1;	// IMP=0x00000001000a7500
+ (id)_displayTypeStringFromDisplayType:(unsigned long long)arg1;	// IMP=0x00000001000a74bc
+ (unsigned long long)_actionFromString:(id)arg1;	// IMP=0x00000001000a741c
+ (id)_actionStringFromAction:(unsigned long long)arg1;	// IMP=0x00000001000a73e4
+ (id)URLFromURL:(id)arg1;	// IMP=0x00000001000a630c
+ (id)new;	// IMP=0x00000001000a62d0
- (void).cxx_destruct;	// IMP=0x00000001000a788c
...
- (id)description;	// IMP=0x00000001000a6d4c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000a6c1c
- (unsigned long long)hash;	// IMP=0x00000001000a6bd0
@property(readonly, nonatomic) _Bool browsesMediaLibrary;
@property(readonly, nonatomic) _Bool requiresMediaLibrary;
- (id)_initWithURL:(id)arg1 action:(unsigned long long)arg2;	// IMP=0x00000001000a6af0
- (id)init;	// IMP=0x00000001000a6a68
