...
- (void)_messageTimedOut;	// IMP=0x0000000100011660
- (void)userStop;	// IMP=0x000000010001159c
- (_Bool)performAction:(id)arg1 withOptions:(id)arg2 outInfo:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000100011594
- (_Bool)setProperty:(id)arg1 qualifier:(id)arg2 value:(id)arg3 error:(id *)arg4;	// IMP=0x000000010001158c
- (id)getProperty:(id)arg1 qualifier:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100011584
- (_Bool)stopWithOptions:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000114f4
- (void)startWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000110b8
