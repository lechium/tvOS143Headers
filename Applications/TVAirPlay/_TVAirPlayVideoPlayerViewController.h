...
- (void).cxx_destruct;	// IMP=0x000000010001d5c4
...
- (void)playerViewControllerWillStopPictureInPicture:(id)arg1;	// IMP=0x000000010001d474
- (void)playerViewControllerDidStartPictureInPicture:(id)arg1;	// IMP=0x000000010001d2d4
- (void)dismiss;	// IMP=0x000000010001d168
- (void)viewDidLoad;	// IMP=0x000000010001d0f4
- (void)dealloc;	// IMP=0x000000010001cff4
