...
- (void).cxx_destruct;	// IMP=0x0000000100014fa8
...
- (void)_menuPressed;	// IMP=0x0000000100014eec
- (void)setTitle:(id)arg1;	// IMP=0x0000000100014cf4
- (void)viewDidLoad;	// IMP=0x00000001000147f0
