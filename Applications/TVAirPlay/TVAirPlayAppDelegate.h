...
- (void).cxx_destruct;	// IMP=0x00000001000146b4
...
- (void)_updatePlaybackActive;	// IMP=0x0000000100014464
- (void)_updateCloudConnectivityState;	// IMP=0x00000001000142c4
- (void)_reenableAirPlaySpeakerIfNecessary;	// IMP=0x0000000100013f2c
- (void)_disableAirPlaySpeakerIfNecessary;	// IMP=0x0000000100013bd8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100013b20
- (void)applicationWillTerminate:(id)arg1;	// IMP=0x0000000100013888
- (void)dealloc;	// IMP=0x000000010001379c
- (id)application:(id)arg1 configurationForConnectingSceneSession:(id)arg2 options:(id)arg3;	// IMP=0x00000001000135b4
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x0000000100012b9c
