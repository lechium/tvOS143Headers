...
+ (id)testObjectWithInfo:(id)arg1;	// IMP=0x0000000100007714
- (void).cxx_destruct;	// IMP=0x0000000100007c20
...
- (unsigned long long)deletes;	// IMP=0x0000000100007aa4
- (void)addDeletes:(unsigned long long)arg1;	// IMP=0x00000001000079d8
- (void)addTerminationFailure:(id)arg1;	// IMP=0x0000000100007910
- (void)addRemoveFailure:(id)arg1;	// IMP=0x0000000100007848
- (id)description;	// IMP=0x0000000100007768
- (id)initWithInfo:(id)arg1;	// IMP=0x00000001000073f8
