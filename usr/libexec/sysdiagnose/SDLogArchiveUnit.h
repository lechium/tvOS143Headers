...
+ (id)logArchiveUnitWithDictionary:(id)arg1;	// IMP=0x00000001000053c4
- (void).cxx_destruct;	// IMP=0x0000000100005730
@property(retain) NSMutableDictionary *archive_arguments; // @synthesize archive_arguments=_archive_arguments;
- (void)logArchiveOverride:(id)arg1;	// IMP=0x000000010000546c
