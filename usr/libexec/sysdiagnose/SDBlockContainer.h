...
+ (id)containerWithName:(id)arg1 forBlock:(CDUnknownBlockType)arg2 withTimeout:(double)arg3 withDelegate:(id)arg4;	// IMP=0x000000010003d79c
- (void).cxx_destruct;	// IMP=0x000000010003de7c
...
- (_Bool)execute;	// IMP=0x000000010003d8ac
