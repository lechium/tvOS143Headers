...
+ (id)containerAtLocation:(id)arg1 forTaskType:(unsigned long long)arg2 withTimeout:(double)arg3 withConnection:(id)arg4 withDelegate:(id)arg5;	// IMP=0x000000010003debc
- (void).cxx_destruct;	// IMP=0x000000010003e99c
