...
- (void).cxx_destruct;	// IMP=0x0000000100015520
...
- (id)statusString;	// IMP=0x0000000100015398
- (_Bool)terminate;	// IMP=0x0000000100015210
- (_Bool)resume;	// IMP=0x00000001000150d4
- (_Bool)suspend;	// IMP=0x0000000100014f98
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0000000100014ccc
