...
- (void).cxx_destruct;	// IMP=0x000000010003e9ac
...
- (void)extractArchiveWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010003e680
- (id)initWithDestinationURL:(id)arg1 forArchiveUUID:(id)arg2;	// IMP=0x000000010003e548
