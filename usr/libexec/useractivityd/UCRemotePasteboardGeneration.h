...
- (void).cxx_destruct;	// IMP=0x000000010002e854
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x000000010002e394
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d618
- (void)dealloc;	// IMP=0x000000010002d4c8
- (void)updateState:(unsigned long long)arg1;	// IMP=0x000000010002d338
- (id)stateAsString;	// IMP=0x000000010002d2a8
- (id)initWithRequester:(id)arg1;	// IMP=0x000000010002d0cc
