...
- (id)localPBStatus;	// IMP=0x000000010003916c
- (id)statusString;	// IMP=0x0000000100039160
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x0000000100038c14
- (void)showProgressUI:(id)arg1;	// IMP=0x00000001000385f4
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000100037950
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0000000100036dd0
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100035130
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x0000000100034fb4
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x0000000100034fa8
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100032a78
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100030cc0
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100030940
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x0000000100030840
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x000000010003057c
- (void)clearLocalPasteboardInformation;	// IMP=0x00000001000304a8
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x000000010002fe18
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x000000010002fd40
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x000000010002fccc
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002fbb4
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x000000010002f7f4
- (id)currentPasteboardActivityInfo;	// IMP=0x000000010002f528
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x000000010002f3d8
- (id)items;	// IMP=0x000000010002f3cc
- (void)startConnection:(int)arg1;	// IMP=0x000000010002f320
...
- (id)uuid;	// IMP=0x000000010002f06c
- (void)dealloc;	// IMP=0x000000010002ef9c
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x000000010002e8a8
