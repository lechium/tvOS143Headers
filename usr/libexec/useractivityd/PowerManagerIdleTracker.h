...
+ (unsigned long long)setup:(id)arg1 interval:(double)arg2;	// IMP=0x00000001000063d8
+ (id)idleTracker:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0000000100005fc8
- (void).cxx_destruct;	// IMP=0x0000000100006cf8
...
- (void)invalidate;	// IMP=0x0000000100006918
- (void)dealloc;	// IMP=0x00000001000062d4
- (id)init:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x000000010000606c
