...
- (void).cxx_destruct;	// IMP=0x000000010003c198
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x000000010003bf80
- (long long)tryWriteMessage;	// IMP=0x000000010003b920
- (long long)tryWriteRawData;	// IMP=0x000000010003b63c
- (long long)handleSpaceAvalible;	// IMP=0x000000010003b5c8
- (void)handleMessageRead;	// IMP=0x000000010003b464
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x000000010003b3e4
- (void)processHeader;	// IMP=0x000000010003b2c8
- (void)handleBytesAvailable;	// IMP=0x000000010003aefc
- (void)handleOpenCompleted;	// IMP=0x000000010003adf4
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x000000010003abbc
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x000000010003a894
- (_Bool)writeRawData:(id)arg1;	// IMP=0x000000010003a698
- (void)_stop;	// IMP=0x000000010003a450
- (void)tryStop;	// IMP=0x000000010003a314
- (void)stop;	// IMP=0x000000010003a278
- (void)start;	// IMP=0x0000000100039f04
- (long long)queueCount;	// IMP=0x0000000100039e88
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000100039c54
