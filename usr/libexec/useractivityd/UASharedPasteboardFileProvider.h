...
- (void).cxx_destruct;	// IMP=0x0000000100005f8c
...
- (void)_provideItemAtURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100005e5c
- (void)_provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100005cb0
- (void)unlockWithError:(id)arg1;	// IMP=0x0000000100005a88
- (id)initWithURL:(id)arg1;	// IMP=0x00000001000059b4
