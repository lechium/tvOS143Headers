...
- (void).cxx_destruct;	// IMP=0x00000001000535a4
...
- (id)description;	// IMP=0x0000000100053160
- (id)encodeAsData;	// IMP=0x0000000100052924
- (id)initWithData:(id)arg1;	// IMP=0x0000000100051fd4
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000100051ec0
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x0000000100051e2c
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x0000000100051c74
