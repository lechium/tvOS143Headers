...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100066480
- (void).cxx_destruct;	// IMP=0x00000001000668a8
...
- (id)description;	// IMP=0x00000001000666e8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000665a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100066488
- (id)init;	// IMP=0x000000010006644c
