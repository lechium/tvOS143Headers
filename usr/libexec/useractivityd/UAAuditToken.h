...
- (id)debugDescription;	// IMP=0x000000010007b850
- (id)description;	// IMP=0x000000010007b72c
- (const char *)objCType;	// IMP=0x000000010007b720
- (void)getValue:(void *)arg1;	// IMP=0x000000010007b708
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x000000010007b3e0
