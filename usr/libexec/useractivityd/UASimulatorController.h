...
+ (void)setSimulatorForCommandPort:(unsigned int)arg1 controller:(id)arg2;	// IMP=0x0000000100045aec
+ (id)simulatorControllerForCommandPort:(unsigned int)arg1;	// IMP=0x0000000100045a30
- (void).cxx_destruct;	// IMP=0x000000010004665c
...
- (id)simulatorStatus;	// IMP=0x00000001000462d4
- (id)statusString;	// IMP=0x00000001000460a4
- (_Bool)terminate;	// IMP=0x0000000100045eec
- (_Bool)active;	// IMP=0x0000000100045e84
- (void)removeSimulator:(id)arg1;	// IMP=0x0000000100045de8
- (void)addSimulator:(id)arg1;	// IMP=0x0000000100045d50
@property(readonly, retain) NSSet *simulators;
- (id)initWithManager:(id)arg1;	// IMP=0x0000000100045be4
