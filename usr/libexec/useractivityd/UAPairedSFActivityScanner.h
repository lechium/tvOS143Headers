...
- (void).cxx_destruct;	// IMP=0x0000000100045a00
...
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100045810
- (void)receiveAdvertisement:(id)arg1 options:(id)arg2 fromPeer:(id)arg3;	// IMP=0x00000001000455b8
- (void)scanForTypes:(unsigned long long)arg1;	// IMP=0x00000001000455b4
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000001000454d4
