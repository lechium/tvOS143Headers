...
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x00000001000e8adc
- (void)applicationsWillUninstall:(id)arg1;	// IMP=0x00000001000e89c8
- (void)applicationsDidInstall:(id)arg1;	// IMP=0x00000001000e88b4
- (int)getFilteredMediaTypesMask:(int)arg1;	// IMP=0x00000001000e8834
- (void)handleAppUninstall:(id)arg1;	// IMP=0x00000001000e85f4
- (void)handleAppInstall:(id)arg1;	// IMP=0x00000001000e83f0
- (void)dealloc;	// IMP=0x00000001000e8370
- (id)init;	// IMP=0x00000001000e81f4
@property(readonly) _Bool iTunesRadioEnabled;
- (void)_updateITunesRadioEnabled;	// IMP=0x00000001000e80f0
