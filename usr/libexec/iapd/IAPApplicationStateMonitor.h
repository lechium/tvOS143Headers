...
- (id)applicationInfoForPIDSync:(int)arg1;	// IMP=0x000000010005b1c8
- (id)applicationInfoForBundleIDSync:(id)arg1;	// IMP=0x000000010005b164
- (void)layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x000000010005ae24
- (void)stopObserving;	// IMP=0x000000010005acf0
- (void)startObserving;	// IMP=0x000000010005a830
- (void)dealloc;	// IMP=0x000000010005a79c
- (id)init;	// IMP=0x000000010005a728
- (void)sharedInit;	// IMP=0x000000010005a67c
