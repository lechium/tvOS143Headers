...
- (_Bool)showAudioBooks;	// IMP=0x000000010003646c
- (_Bool)showITunesU;	// IMP=0x000000010003644c
- (_Bool)showPodcasts;	// IMP=0x000000010003642c
- (_Bool)showMusic;	// IMP=0x000000010003640c
- (void)handlMediaLibraryNeedFilterChange:(id)arg1;	// IMP=0x0000000100036334
- (id)stationNameForIndex:(unsigned long long)arg1;	// IMP=0x0000000100036168
- (id)stationForIndex:(unsigned long long)arg1;	// IMP=0x000000010003601c
- (void)iterateStationsList:(CDUnknownBlockType)arg1;	// IMP=0x0000000100035d90
- (void)_radioLibraryChanged:(id)arg1;	// IMP=0x0000000100035cf4
- (_Bool)_updateRadioLibraryList;	// IMP=0x00000001000356ec
@property(readonly, nonatomic) unsigned int stationCount;
- (void)dealloc;	// IMP=0x00000001000355e8
- (id)init;	// IMP=0x00000001000354a0
