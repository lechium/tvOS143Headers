...
+ (unsigned int)clientIDForCameraClient;	// IMP=0x00000001000b91ac
+ (unsigned int)clientIDForLocationClient;	// IMP=0x00000001000b91a0
...
- (void)_setJetsamPrioritySpecialCasing:(_Bool)arg1;	// IMP=0x00000001000b9c10
- (int)_getProcessId;	// IMP=0x00000001000b9b18
@property(nonatomic) _Bool cameraSupportedByClient;
@property(nonatomic) _Bool locationSupportedByClient;
- (void)decreaseSessionRefCount;	// IMP=0x00000001000b990c
- (void)increaseSessionRefCount;	// IMP=0x00000001000b98b8
- (_Bool)canSendConnectionEventForAccessory:(id)arg1;	// IMP=0x00000001000b94d0
- (void)takeProcessAssertion:(id)arg1;	// IMP=0x00000001000b91b8
- (void)dealloc;	// IMP=0x00000001000b8f90
- (id)initWithCapabilities:(unsigned int)arg1 auditToken:(CDStruct_4c969caf)arg2 xpcConnection:(id)arg3 eaProtocols:(id)arg4 andBundleId:(id)arg5;	// IMP=0x00000001000b8a54
