...
+ (id)modulatorWithBudgets:(id)arg1 persistence:(id)arg2 withQueue:(id)arg3 withStore:(id)arg4;	// IMP=0x00000001000032f0
- (void).cxx_destruct;	// IMP=0x00000001000052d4
...
- (double)areaUnderTrapeziodWithFirstValue:(double)arg1 andSecondValue:(double)arg2;	// IMP=0x00000001000051bc
- (double)gaussianKDEatDate:(id)arg1 withTimeline:(id)arg2 withNormalizer:(double)arg3;	// IMP=0x0000000100004fb0
- (double)budgetProportionAtDate:(id)arg1 withTimeline:(id)arg2 withNormalizer:(double)arg3;	// IMP=0x0000000100004ecc
- (id)usageTimelineForWidget:(id)arg1 withStartDate:(id)arg2;	// IMP=0x0000000100004d10
- (double)unlocked_budgetAllocationProportionAtDate:(id)arg1 forWidget:(id)arg2;	// IMP=0x0000000100004440
- (int)computeSlotForDate:(id)arg1 relativeToDate:(id)arg2;	// IMP=0x0000000100004388
- (void)updateCapacity:(double)arg1 forBudgetWithName:(id)arg2;	// IMP=0x00000001000041dc
- (void)modulateBudgets:(id)arg1 lastModulatedAt:(id)arg2 forNumberOfModulationSlots:(int)arg3 atDate:(id)arg4;	// IMP=0x0000000100003c34
- (void)_queue_modulateBudgets;	// IMP=0x0000000100003a64
- (id)usageTimeline;	// IMP=0x0000000100003950
- (double)relativeUsageAtDate:(id)arg1 withTimeline:(id)arg2;	// IMP=0x00000001000034a4
- (int)numberOfModulationFromDate:(id)arg1 toDate:(id)arg2;	// IMP=0x000000010000342c
- (void)unlocked_addBudgetsToBeModulated:(id)arg1;	// IMP=0x00000001000033a8
- (id)initWithBudgets:(id)arg1 persistence:(id)arg2 withQueue:(id)arg3 withStore:(id)arg4;	// IMP=0x0000000100002f00
