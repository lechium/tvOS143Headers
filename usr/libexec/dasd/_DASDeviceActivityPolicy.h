...
+ (_Bool)isDeviceInUse:(id)arg1;	// IMP=0x00000001000243dc
+ (id)policyInstance;	// IMP=0x0000000100023de8
+ (void)printLowLikelihoodRegions;	// IMP=0x00000001000238a4
- (void).cxx_destruct;	// IMP=0x0000000100024a9c
...
- (double)predictedScoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x00000001000249b0
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x00000001000245c8
- (_Bool)backgroundTaskAllowedWithType:(id)arg1 withRationale:(id)arg2 withState:(id)arg3;	// IMP=0x0000000100024488
- (double)scoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100024054
- (double)weightForActivity:(id)arg1;	// IMP=0x0000000100023fe4
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x0000000100023f5c
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100023e84
- (_Bool)shouldLogScoreToPowerLog;	// IMP=0x0000000100023de0
- (id)predictionForDeviceActivity;	// IMP=0x0000000100023d74
- (id)init;	// IMP=0x0000000100023b80
- (id)initializeTriggers;	// IMP=0x0000000100023a50
