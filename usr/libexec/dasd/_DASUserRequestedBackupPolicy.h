...
+ (id)policyInstance;	// IMP=0x000000010002e510
- (void).cxx_destruct;	// IMP=0x000000010002e9b8
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002e6cc
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010002e6c0
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002e604
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002e57c
- (id)init;	// IMP=0x000000010002e460
- (id)initializeTriggers;	// IMP=0x000000010002e330
