...
+ (id)persistence;	// IMP=0x00000001000054fc
...
- (id)convertNameFromCompactToFull:(id)arg1;	// IMP=0x00000001000060ec
- (id)convertNameFromFullToCompact:(id)arg1;	// IMP=0x0000000100006048
- (void)saveModulationDate:(id)arg1;	// IMP=0x0000000100005e48
- (void)updateBudget:(id)arg1;	// IMP=0x0000000100005cf8
- (void)saveBudgets:(id)arg1;	// IMP=0x0000000100005a34
- (id)loadBudgetsWithExpectedNames:(id)arg1;	// IMP=0x00000001000055a0
- (id)init;	// IMP=0x000000010000537c
