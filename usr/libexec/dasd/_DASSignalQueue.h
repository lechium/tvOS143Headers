...
- (double)percentile:(double)arg1;	// IMP=0x000000010000d770
- (double)dominant;	// IMP=0x000000010000d768
- (double)trend;	// IMP=0x000000010000d760
- (double)rate;	// IMP=0x000000010000d4a8
- (double)mean;	// IMP=0x000000010000d2bc
- (id)top;	// IMP=0x000000010000d1f0
- (id)allObjects;	// IMP=0x000000010000d034
- (void)addObject:(id)arg1;	// IMP=0x000000010000cee0
- (id)initWithCount:(unsigned long long)arg1;	// IMP=0x000000010000ce5c
