...
- (void).cxx_destruct;	// IMP=0x0000000100040600
...
- (double)scoreForApplication:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100040338
- (id)scoresForAllApplicationsAtDate:(id)arg1;	// IMP=0x000000010003fb20
- (id)initWithAlgorithms:(id)arg1;	// IMP=0x000000010003f9b0
