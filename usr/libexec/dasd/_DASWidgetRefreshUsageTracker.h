...
+ (id)sharedInstance;	// IMP=0x0000000100008768
- (void).cxx_destruct;	// IMP=0x0000000100009bbc
...
- (double)stopTrackingActivity:(id)arg1;	// IMP=0x0000000100009a28
- (void)startTrackingActivity:(id)arg1;	// IMP=0x0000000100009990
- (int)allocateBudgetForViews:(int)arg1;	// IMP=0x0000000100009954
- (id)getAverageWidgetViewsPerDayWithStore:(id)arg1;	// IMP=0x0000000100009258
- (void)invalidateComputedBudgetCache;	// IMP=0x0000000100009214
- (void)computeBudgetFromHistoryForAllWidgets;	// IMP=0x0000000100008c9c
- (id)dailyBudgetsForAllWidgets;	// IMP=0x0000000100008b04
- (id)dailyBudgetForWidget:(id)arg1;	// IMP=0x0000000100008a94
- (void)setBudgetMaximums;	// IMP=0x0000000100008964
- (id)init;	// IMP=0x0000000100008804
