...
- (void).cxx_destruct;	// IMP=0x000000010002fa28
...
- (id)description;	// IMP=0x000000010002f9a8
- (id)initWithCondition:(id)arg1 withRequiredValue:(double)arg2 withCurrentValue:(double)arg3;	// IMP=0x000000010002f91c
