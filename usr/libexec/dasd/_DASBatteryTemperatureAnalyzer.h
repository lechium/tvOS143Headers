...
- (void).cxx_destruct;	// IMP=0x000000010000e884
...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x000000010000e498
- (double)getReferenceTemperatureForContext:(id)arg1 reader:(id)arg2;	// IMP=0x000000010000e39c
- (void)recordValue;	// IMP=0x000000010000e2ec
- (void)stop;	// IMP=0x000000010000e280
- (void)start;	// IMP=0x000000010000e1f0
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x000000010000dfa8
