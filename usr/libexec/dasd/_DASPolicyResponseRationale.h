...
- (void).cxx_destruct;	// IMP=0x000000010002feb4
...
- (void)addRationaleWithCondition:(id)arg1;	// IMP=0x000000010002fd7c
- (void)addRationaleForCondition:(id)arg1 withRequiredValue:(double)arg2 withCurrentValue:(double)arg3;	// IMP=0x000000010002fcf0
- (id)initWithPolicyName:(id)arg1;	// IMP=0x000000010002fc4c
- (id)description;	// IMP=0x000000010002fa34
