...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x000000010000ef9c
- (double)getReferenceChargeRateForContext:(id)arg1 reader:(id)arg2;	// IMP=0x000000010000edf8
- (void)recordValue;	// IMP=0x000000010000ed48
- (void)stop;	// IMP=0x000000010000ecdc
- (void)start;	// IMP=0x000000010000ec4c
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x000000010000e9f4
