...
+ (id)sharedInstance;	// IMP=0x0000000100036fb4
- (void).cxx_destruct;	// IMP=0x000000010003798c
...
- (long long)roundedTemperature:(long long)arg1;	// IMP=0x000000010003786c
- (_Bool)storeBatteryTemperatureEvent:(long long)arg1 metaData:(id)arg2;	// IMP=0x0000000100037690
- (id)getBatteryStatus;	// IMP=0x00000001000374d8
- (void)handleBatteryNotification;	// IMP=0x00000001000371c8
- (void)startRecording;	// IMP=0x0000000100037038
- (id)init;	// IMP=0x0000000100036ef4
