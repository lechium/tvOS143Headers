...
+ (id)policyInstance;	// IMP=0x000000010002dde4
- (void).cxx_destruct;	// IMP=0x000000010002e2d0
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002e054
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010002e04c
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002df98
- (void)handleTriggerEvent;	// IMP=0x000000010002df04
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002de50
- (id)init;	// IMP=0x000000010002d958
- (id)initializeTriggers;	// IMP=0x000000010002d60c
