...
- (void).cxx_destruct;	// IMP=0x00000001000415e8
...
- (void)updateScores;	// IMP=0x0000000100041578
- (id)scoresForAllApplicationsAtDate:(id)arg1;	// IMP=0x00000001000414cc
- (double)scoreForApplication:(id)arg1 atDate:(id)arg2;	// IMP=0x00000001000413c0
- (void)updateTimeline;	// IMP=0x0000000100041158
- (void)convertTimelineToApplicationDictionaries:(id)arg1;	// IMP=0x0000000100041154
- (id)init;	// IMP=0x00000001000410ac
