...
- (id)submitMessage:(id)arg1;	// IMP=0x0000000100024ea4
@property(retain, nonatomic) NSArray *configuredMetricIDs;
@property(retain, nonatomic) NSArray *interestedMetricIDs;
- (void)iterateConfigChange;	// IMP=0x000000010002481c
- (id)initWithMessageGroupType:(long long)arg1 andConfigChangeDelegate:(id)arg2 onQueue:(id)arg3;	// IMP=0x0000000100024348
- (id)init;	// IMP=0x0000000100024298
