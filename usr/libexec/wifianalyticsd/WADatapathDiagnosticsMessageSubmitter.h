...
- (void).cxx_destruct;	// IMP=0x0000000100057488
...
- (id)submitDPSRMessage:(id)arg1;	// IMP=0x0000000100051a38
- (id)submitSlowWiFiMessage:(id)arg1;	// IMP=0x00000001000514ac
- (id)submitMessage:(id)arg1;	// IMP=0x0000000100051220
- (id)initWithMessageGroupType:(long long)arg1;	// IMP=0x0000000100051110
