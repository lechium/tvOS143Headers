...
+ (id)testObjectWithInfo:(id)arg1;	// IMP=0x0000000100010088
- (void).cxx_destruct;	// IMP=0x0000000100010594
...
- (unsigned long long)deletes;	// IMP=0x0000000100010418
- (void)addDeletes:(unsigned long long)arg1;	// IMP=0x000000010001034c
- (void)addTerminationFailure:(id)arg1;	// IMP=0x0000000100010284
- (void)addRemoveFailure:(id)arg1;	// IMP=0x00000001000101bc
- (id)description;	// IMP=0x00000001000100dc
- (id)initWithInfo:(id)arg1;	// IMP=0x000000010000fd6c
