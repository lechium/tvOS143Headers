...
- (void).cxx_destruct;	// IMP=0x0000000100198f74
...
- (void)_readAboutText:(id)arg1;	// IMP=0x00000001001988fc
- (void)_didNotCompleteOptIn;	// IMP=0x00000001001988a0
- (void)_optOut:(id)arg1;	// IMP=0x000000010019880c
- (void)_optIn:(id)arg1;	// IMP=0x0000000100198778
- (void)_handleHomeButton:(id)arg1;	// IMP=0x0000000100198660
- (void)_handleMenuButton:(id)arg1;	// IMP=0x000000010019850c
- (id)preferredFocusEnvironments;	// IMP=0x000000010019845c
- (void)viewDidLoad;	// IMP=0x0000000100197b90
- (id)initWithOfferDictationOnly:(_Bool)arg1;	// IMP=0x0000000100197aac
