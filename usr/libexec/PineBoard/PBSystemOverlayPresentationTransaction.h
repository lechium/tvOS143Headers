...
- (void).cxx_destruct;	// IMP=0x0000000100158cd0
...
- (void)_begin;	// IMP=0x0000000100158740
- (void)interruptWithContext:(id)arg1;	// IMP=0x00000001001586c4
- (_Bool)_canBeInterrupted;	// IMP=0x0000000100158674
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 presentationDelegate:(id)arg4;	// IMP=0x00000001001584dc
- (id)init;	// IMP=0x00000001001584a4
