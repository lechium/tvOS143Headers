...
- (void).cxx_destruct;	// IMP=0x0000000100192464
...
- (void)_prepareKioskAnimationInTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100191d8c
- (id)_defaultAppAnimationTransaction;	// IMP=0x0000000100191c2c
- (void)_begin;	// IMP=0x000000010019151c
- (_Bool)_canBeInterrupted;	// IMP=0x00000001001914fc
- (id)initWithScreenSaverViewController:(id)arg1 animated:(_Bool)arg2 options:(id)arg3;	// IMP=0x000000010019137c
