...
- (void).cxx_destruct;	// IMP=0x000000010023dad8
...
- (void)_updateIconImage;	// IMP=0x000000010023d738
- (void)_updateDisplayName;	// IMP=0x000000010023d600
- (void)_updateForProgressChange;	// IMP=0x000000010023d5cc
- (id)description;	// IMP=0x000000010023d570
- (id)initWithType:(long long)arg1 bundleIdentifier:(id)arg2 appInfo:(id)arg3 dataSource:(id)arg4 live:(_Bool)arg5;	// IMP=0x000000010023d0e8
