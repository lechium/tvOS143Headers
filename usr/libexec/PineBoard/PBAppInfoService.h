...
- (void).cxx_destruct;	// IMP=0x00000001000877d0
...
- (void)appInfoUpdatesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000100086c3c
- (void)setServiceDelegate:(id)arg1;	// IMP=0x0000000100086bb8
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x0000000100086584
- (void)invalidate;	// IMP=0x0000000100086570
- (id)initWithInfoStore:(id)arg1 remoteConnection:(id)arg2;	// IMP=0x000000010008604c
