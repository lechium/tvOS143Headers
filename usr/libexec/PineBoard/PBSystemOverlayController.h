...
+ (id)keyPathsForValuesAffectingHasActivePresentation;	// IMP=0x0000000100104300
- (void).cxx_destruct;	// IMP=0x00000001001057b8
...
- (void)_checkPendingRequests;	// IMP=0x0000000100104f94
- (void)_callPendingDismissalCompletionHandlersForSession:(id)arg1 success:(_Bool)arg2;	// IMP=0x0000000100104d54
- (void)_callPendingPresentationCompletionHandlersForSession:(id)arg1 success:(_Bool)arg2;	// IMP=0x0000000100104b14
- (void)systemOverlaySessionDidInvalidate:(id)arg1;	// IMP=0x000000010010485c
- (void)systemOverlaySessionDidCancel:(id)arg1 withContext:(id)arg2;	// IMP=0x000000010010474c
- (void)systemOverlaySessionDidDismiss:(id)arg1;	// IMP=0x0000000100104694
- (void)systemOverlaySessionWillDismiss:(id)arg1 withContext:(id)arg2;	// IMP=0x00000001001045ac
- (void)systemOverlaySessionDidPresent:(id)arg1;	// IMP=0x00000001001044f4
- (void)systemOverlaySessionWillPresent:(id)arg1;	// IMP=0x000000010010446c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010010435c
- (void)resume;	// IMP=0x000000010010405c
- (void)pauseWithOptions:(long long)arg1;	// IMP=0x0000000100103e54
@property(readonly, nonatomic) _Bool hasActivePresentation;
- (void)dismissWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001039f8
- (void)presentWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100103594
- (id)initWithName:(id)arg1 layoutLevel:(long long)arg2 presentationHandler:(id)arg3 delegate:(id)arg4;	// IMP=0x000000010010326c
- (id)init;	// IMP=0x0000000100103234
