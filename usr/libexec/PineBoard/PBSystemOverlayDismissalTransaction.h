...
- (void).cxx_destruct;	// IMP=0x0000000100263000
...
- (void)_begin;	// IMP=0x0000000100262b5c
- (_Bool)_canBeInterrupted;	// IMP=0x0000000100262b3c
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 deactivationReasons:(unsigned long long)arg4 presentationDelegate:(id)arg5;	// IMP=0x0000000100262980
- (id)init;	// IMP=0x0000000100262948
