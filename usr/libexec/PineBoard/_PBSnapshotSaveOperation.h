...
- (void).cxx_destruct;	// IMP=0x00000001000e2a78
...
- (void)cancel;	// IMP=0x00000001000e27d8
- (void)main;	// IMP=0x00000001000e1cbc
- (id)initWithSnapshot:(id)arg1 dataProvider:(id)arg2 manifest:(id)arg3;	// IMP=0x00000001000e1ac8
