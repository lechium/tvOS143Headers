...
- (void).cxx_destruct;	// IMP=0x0000000100105cd0
- (_Bool)_insertAtFrontOfQueue;	// IMP=0x0000000100105cac
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100105ba0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100105b74
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000100105974
