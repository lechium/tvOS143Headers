...
- (void).cxx_destruct;	// IMP=0x00000001000c8ac8
...
- (void)_updateState;	// IMP=0x00000001000c85d0
- (void)_removeAcceptsEventObserverForViewController:(id)arg1;	// IMP=0x00000001000c8504
- (void)_addAcceptsEventObserverForViewController:(id)arg1;	// IMP=0x00000001000c8420
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000c82e0
- (void)setContentViewController:(id)arg1 animated:(_Bool)arg2 transitionBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000001000c7dc4
- (id)preferredFocusEnvironments;	// IMP=0x00000001000c7cec
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000001000c7ac0
- (void)loadView;	// IMP=0x00000001000c79e0
- (id)initWithLayoutLevel:(long long)arg1;	// IMP=0x00000001000c78f4
