...
- (void).cxx_destruct;	// IMP=0x0000000100085f60
...
- (void)_readAboutText:(id)arg1;	// IMP=0x000000010008591c
- (void)_didNotCompleteOptIn;	// IMP=0x00000001000858c0
- (void)_optOut:(id)arg1;	// IMP=0x000000010008582c
- (void)_optIn:(id)arg1;	// IMP=0x0000000100085798
- (void)_handleHomeButton:(id)arg1;	// IMP=0x0000000100085680
- (void)_handleMenuButton:(id)arg1;	// IMP=0x000000010008552c
- (id)preferredFocusEnvironments;	// IMP=0x000000010008547c
- (void)viewDidLoad;	// IMP=0x0000000100084c78
