...
- (id)description;	// IMP=0x000000010010d564
- (unsigned long long)hash;	// IMP=0x000000010010d190
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010010cb70
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010010c7a8
