...
- (void).cxx_destruct;	// IMP=0x0000000100163fd8
...
- (void)_didDismiss:(id)arg1;	// IMP=0x0000000100163d9c
- (void)_willDismiss:(id)arg1;	// IMP=0x0000000100163cf4
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100163ae0
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010016382c
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (_Bool)definesPresentationContext;	// IMP=0x00000001001637ec
- (void)dealloc;	// IMP=0x00000001001636cc
- (id)initWithContentViewController:(id)arg1 supportsInterruption:(_Bool)arg2;	// IMP=0x00000001001634b4
