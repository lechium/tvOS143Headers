...
- (void).cxx_destruct;	// IMP=0x000000010008bce8
...
- (_Bool)_canBeInterrupted;	// IMP=0x000000010008bbfc
- (void)_begin;	// IMP=0x000000010008b8b8
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000010008b6f8
