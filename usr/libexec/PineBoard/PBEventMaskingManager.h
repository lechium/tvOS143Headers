...
+ (id)sharedInstance;	// IMP=0x000000010011b1b8
+ (id)dependencyDescription;	// IMP=0x000000010011b010
- (void).cxx_destruct;	// IMP=0x000000010011b8bc
@property(readonly, nonatomic) PBSystemOverlayController *overlayController; // @synthesize overlayController=_overlayController;
- (void)prepareUIForSystemOverlayPresentationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010011b7b8
- (void)dismiss;	// IMP=0x000000010011b6a4
- (void)present;	// IMP=0x000000010011b584
@property(readonly, nonatomic, getter=isPresenting) _Bool presenting;
- (id)init;	// IMP=0x000000010011b2b8
