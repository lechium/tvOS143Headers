...
+ (id)sharedInstance;	// IMP=0x00000001001e0708
+ (id)dependencyDescription;	// IMP=0x00000001001e0650
- (void).cxx_destruct;	// IMP=0x00000001001e0e40
...
- (id)_init;	// IMP=0x00000001001e0870
- (id)init;	// IMP=0x00000001001e0818
