...
- (void)_setInsertAtFrontOfQueue:(_Bool)arg1;	// IMP=0x0000000100105fec
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100105dbc
- (id)init;	// IMP=0x0000000100105d30
