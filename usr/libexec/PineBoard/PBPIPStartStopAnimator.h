...
- (void).cxx_destruct;	// IMP=0x00000001001a6468
...
- (void)_performReducedMotionAnimation;	// IMP=0x00000001001a5da0
- (void)_performDefaultAnimation;	// IMP=0x00000001001a5ae0
- (void)startAnimation;	// IMP=0x00000001001a5a88
- (id)initWithContext:(unsigned long long)arg1 layout:(id)arg2 targetSize:(struct CGSize)arg3 quadrant:(long long)arg4 pipInsets:(struct UIEdgeInsets)arg5;	// IMP=0x00000001001a58a0
