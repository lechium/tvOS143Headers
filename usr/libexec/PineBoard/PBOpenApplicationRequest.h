...
- (void).cxx_destruct;	// IMP=0x00000001000e5178
...
- (id)_makeTransitionPayload;	// IMP=0x00000001000e4dfc
- (id)_payloadSourceApplication;	// IMP=0x00000001000e4ca0
- (_Bool)_shouldSendPayloadSourceApplication;	// IMP=0x00000001000e4a78
- (id)_makeTransitionActions;	// IMP=0x00000001000e471c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000e46ac
- (unsigned long long)hash;	// IMP=0x00000001000e4580
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000e4230
- (id)debugDescription;	// IMP=0x00000001000e3f8c
- (id)description;	// IMP=0x00000001000e3e34
- (id)makeSceneTransitionContext;	// IMP=0x00000001000e3b84
- (id)makeProcessExecutionContext;	// IMP=0x00000001000e37f8
...
- (id)_initWithOpenApplicationOptions:(id)arg1 auditToken:(id)arg2 trustedRequest:(_Bool)arg3 fromAppInfo:(id)arg4 toAppInfo:(id)arg5;	// IMP=0x00000001000e2ce4
- (id)initWithRequest:(id)arg1 fromAppInfo:(id)arg2 toAppInfo:(id)arg3;	// IMP=0x00000001000e2b14
