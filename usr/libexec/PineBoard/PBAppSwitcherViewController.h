...
- (void).cxx_destruct;	// IMP=0x000000010020e9c4
...
- (void)invalidateSceneLayoutElements;	// IMP=0x000000010020e7f8
- (void)transitionToSwitcherWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010020e694
- (id)preferredFocusEnvironments;	// IMP=0x000000010020e64c
- (void)viewDidLoad;	// IMP=0x000000010020e398
- (id)initWithDataSource:(id)arg1;	// IMP=0x000000010020e298
