...
- (void).cxx_destruct;	// IMP=0x000000010016e6ec
...
- (void)_setShadowRadius:(double)arg1 alpha:(double)arg2;	// IMP=0x000000010016e2c4
- (void)_setDimingAlpha:(double)arg1;	// IMP=0x000000010016e228
- (void)_setContentAlpha:(double)arg1;	// IMP=0x000000010016e1ac
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010016defc
- (void)layoutSubviews;	// IMP=0x000000010016d830
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000010016d2e0
- (void)dealloc;	// IMP=0x000000010016d274
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010016cb74
