...
- (void).cxx_destruct;	// IMP=0x0000000100150b48
...
- (void)_prepareKioskAnimationInTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001503a4
- (id)_defaultAppAnimationTransaction;	// IMP=0x00000001001501e4
- (void)_begin;	// IMP=0x000000010014fb04
- (_Bool)_canBeInterrupted;	// IMP=0x000000010014fae4
- (id)initWithScreenSaverViewController:(id)arg1 animated:(_Bool)arg2 updateWallpaper:(_Bool)arg3 applyStartValues:(_Bool)arg4;	// IMP=0x000000010014f958
