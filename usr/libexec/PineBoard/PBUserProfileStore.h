...
- (void).cxx_destruct;	// IMP=0x00000001000960f4
...
- (id)_workQueue_updateUserProfileWithIdentifier:(id)arg1 attributes:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100095774
- (id)_workQueue_createUserProfileWithAttributes:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000953c4
- (void)_workQueue_takeSnapshot;	// IMP=0x0000000100095194
- (id)_workQueue_updateUserProfileWithIdentifier:(id)arg1 usingBlock:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x0000000100094db8
- (void)_workQueue_removeUserProfileWithIdentifier:(id)arg1;	// IMP=0x00000001000946fc
- (void)_workQueue_insertOrUpdateUserProfile:(id)arg1 removedSelectedUserProfile:(id)arg2;	// IMP=0x0000000100093f78
- (void)_workQueue_insertOrUpdateUserProfile:(id)arg1;	// IMP=0x0000000100093f00
- (_Bool)_workQueue_addUserProfile:(id)arg1 error:(id *)arg2;	// IMP=0x000000010009375c
- (void)_workQueue_writeUserProfilesArchive;	// IMP=0x0000000100093448
- (void)_workQueue_initializeUserProfileStorage;	// IMP=0x0000000100092d18
- (void)save;	// IMP=0x0000000100092c3c
- (void)performBatchUpdatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100092610
- (void)updateUserProfileWithIdentifier:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000923f0
- (void)removeUserProfileWithIdentifier:(id)arg1;	// IMP=0x00000001000922b8
- (void)addUserProfile:(id)arg1;	// IMP=0x000000010009214c
...
- (id)initWithType:(long long)arg1;	// IMP=0x0000000100091e48
