...
+ (id)predicatesWithPreferredSDRColorMapping:(long long)arg1 frameRate:(double)arg2;	// IMP=0x00000001000a7984
+ (id)predicatWithDynamicRange:(long long)arg1 frameRate:(double)arg2;	// IMP=0x00000001000a790c
...
- (unsigned long long)hash;	// IMP=0x00000001000a8238
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000a8038
- (id)description;	// IMP=0x00000001000a7d40
@property(readonly, nonatomic) double roundedFrameRate;
- (id)initWithDynamicRange:(long long)arg1 SDRColorMapping:(long long)arg2 frameRate:(double)arg3;	// IMP=0x00000001000a7be4
