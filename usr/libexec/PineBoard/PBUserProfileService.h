...
- (void)_handleUserProfileAccountNotification:(id)arg1;	// IMP=0x000000010002d9b4
- (void)_endIgnoringUserProfileAccountNotifications;	// IMP=0x000000010002d680
- (void)_beginIgnoringUserProfileAccountNotifications;	// IMP=0x000000010002d388
- (void)removeUserProfileWithIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010002cfe8
- (void)updateUserProfileWithIdentifier:(id)arg1 attributes:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002cb98
- (void)createUserProfileWithAttributes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010002c6ec
- (void)selectUserProfileWithIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010002c20c
- (void)fetchUserProfilesSnapshotWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010002bd60
- (void)setServiceDelegate:(id)arg1;	// IMP=0x000000010002bc3c
- (void)_userProfileManagerDidUpdate;	// IMP=0x000000010002b910
- (void)dealloc;	// IMP=0x000000010002b6c8
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x000000010002b2d8
