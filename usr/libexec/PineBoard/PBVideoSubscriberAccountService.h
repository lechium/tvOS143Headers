...
- (void).cxx_destruct;	// IMP=0x00000001001653ec
...
- (void)installAppWithMetadata:(id)arg1;	// IMP=0x0000000100164154
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x000000010016406c
- (id)init;	// IMP=0x0000000100164034
