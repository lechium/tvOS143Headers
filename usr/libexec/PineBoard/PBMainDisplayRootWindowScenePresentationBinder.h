...
+ (id)sharedInstance;	// IMP=0x000000010011d900
+ (id)dependencyDescription;	// IMP=0x000000010011d848
- (void).cxx_destruct;	// IMP=0x000000010011dbd8
@property(readonly, nonatomic) UIRootSceneWindow *rootWindow; // @synthesize rootWindow=_rootWindow;
- (id)init;	// IMP=0x000000010011d9d0
