...
- (void).cxx_destruct;	// IMP=0x000000010007c2c0
...
- (void)sceneManager:(id)arg1 didChangeFocusFromScene:(id)arg2 toScene:(id)arg3;	// IMP=0x000000010007bd9c
- (void)_updateAppVolumeHUDAssertions;	// IMP=0x000000010007bc44
- (void)_updateApplicationStateForBundleIdentifier:(id)arg1;	// IMP=0x000000010007ba84
- (void)_updateApplicationState:(unsigned int)arg1 forBundleIdentifier:(id)arg2 withInfo:(id)arg3;	// IMP=0x000000010007af04
- (_Bool)_routeIsOdeon:(id)arg1;	// IMP=0x000000010007ac5c
- (float)odeonVolumeStepForCurrentVolume:(float)arg1 isIncrementing:(_Bool)arg2;	// IMP=0x000000010007ab08
- (_Bool)odeonActiveForRoutingController:(id)arg1;	// IMP=0x000000010007a914
- (_Bool)enableModernVolumeController;	// IMP=0x000000010007a8d8
- (void)_presentVolumeBulletinForRoutes:(id)arg1 volumeLevel:(float)arg2;	// IMP=0x000000010007a3b4
- (void)_updateVolume;	// IMP=0x000000010007925c
- (void)_setNeedsVolumeUpdate;	// IMP=0x0000000100079148
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x00000001000790a4
- (void)routingController:(id)arg1 pickedRoutesDidChange:(id)arg2;	// IMP=0x0000000100078ef0
- (void)volumeController:(id)arg1 volumeValueDidChange:(float)arg2;	// IMP=0x0000000100078c84
- (void)volumeController:(id)arg1 volumeControlAvailableDidChange:(_Bool)arg2;	// IMP=0x0000000100078a10
- (void)setSystemVolumeHUDSuppressed:(_Bool)arg1 forApp:(id)arg2;	// IMP=0x00000001000787a4
- (void)setVolumeNotificationsEnabled:(_Bool)arg1 forOutputContext:(unsigned long long)arg2;	// IMP=0x000000010007862c
- (_Bool)volumeSupportedForOutputContext:(unsigned long long)arg1;	// IMP=0x00000001000785d4
- (void)muteVolumeForOutputContext:(unsigned long long)arg1;	// IMP=0x0000000100078064
- (void)decreaseVolumeForOutputContext:(unsigned long long)arg1;	// IMP=0x0000000100077bf0
- (void)increaseVolumeForOutputContext:(unsigned long long)arg1;	// IMP=0x00000001000776f0
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000100076fdc
- (id)init;	// IMP=0x0000000100076fa4
