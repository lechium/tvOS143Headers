...
- (void).cxx_destruct;	// IMP=0x00000001000abdac
@property(readonly, nonatomic) PBVolumeSlider *sliderView; // @synthesize sliderView=_sliderView;
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x00000001000abc88
- (void)layoutSubviews;	// IMP=0x00000001000abb6c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000ab288
