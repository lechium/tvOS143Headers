...
- (void).cxx_destruct;	// IMP=0x0000000100082ebc
...
- (void)powerInfoChangeNotificationHandler:(id)arg1;	// IMP=0x0000000100081f34
- (void)systemHasPoweredOnNotificationHandler:(id)arg1;	// IMP=0x0000000100081ac0
- (void)systemWillSleepNotificationHandler:(id)arg1;	// IMP=0x00000001000815d4
- (void)stopPowerUpdates;	// IMP=0x0000000100081430
- (void)startPowerUpdates;	// IMP=0x0000000100080cbc
- (_Bool)isOldUpdateTypeEnabled:(int)arg1;	// IMP=0x0000000100080c80
- (_Bool)isUpdateTypeEnabled:(int)arg1;	// IMP=0x0000000100080c44
- (void)startSiphoningControl;	// IMP=0x0000000100080bec
- (void)dealloc;	// IMP=0x0000000100080b60
- (id)initWithEndpointUID:(id)arg1 andBitmask:(unsigned long long)arg2 andOldBitmask:(unsigned long long)arg3;	// IMP=0x0000000100080a24
