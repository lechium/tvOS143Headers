...
+ (id)sharedManager;	// IMP=0x00000001000d48f4
- (void).cxx_destruct;	// IMP=0x00000001000d7270
...
- (unsigned int)sentenceTypesBitmask:(id)arg1 forUUID:(id)arg2;	// IMP=0x00000001000d6f28
- (_Bool)isSentenceArrayValidForUUID:(id)arg1;	// IMP=0x00000001000d6d9c
- (_Bool)isSentenceTypeSupported:(int)arg1 forUUID:(id)arg2;	// IMP=0x00000001000d6afc
- (_Bool)setNMEAFilterList:(id)arg1 forUUID:(id)arg2;	// IMP=0x00000001000d6194
- (_Bool)stopLocationUpdatesForUUID:(id)arg1;	// IMP=0x00000001000d5d60
- (_Bool)sendGPRMCDataStatus:(_Bool)arg1 valueV:(_Bool)arg2 valueX:(_Bool)arg3 forUUID:(id)arg4;	// IMP=0x00000001000d58fc
- (_Bool)startLocationUpdatesForUUID:(id)arg1;	// IMP=0x00000001000d4fe8
- (_Bool)resetLocationEndpointUUID:(id)arg1;	// IMP=0x00000001000d4d30
- (_Bool)setLocationEndpointUUID:(id)arg1 withSupportedNMEASentences:(struct __CFArray *)arg2;	// IMP=0x00000001000d4a54
- (void)dealloc;	// IMP=0x00000001000d49dc
- (id)init;	// IMP=0x00000001000d4960
