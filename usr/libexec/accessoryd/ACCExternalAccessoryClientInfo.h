...
- (void).cxx_destruct;	// IMP=0x0000000100094dec
...
- (_Bool)canSendLaunchEvent;	// IMP=0x0000000100094ac4
- (_Bool)canSendConnectionEventForAccessory:(id)arg1;	// IMP=0x00000001000945dc
- (void)addClientRegistrationInformation:(id)arg1;	// IMP=0x00000001000943b0
- (void)_determineEntitlementsForXPCConnection;	// IMP=0x00000001000942d0
- (void)dealloc;	// IMP=0x0000000100094194
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00000001000940bc
