...
+ (void)_setUSBHubOverCurrentSiphoning:(id)arg1;	// IMP=0x00000001000094d4
+ (void)_resetUSBHubOverCurrentSiphoning:(id)arg1;	// IMP=0x0000000100009438
+ (_Bool)_getUSBHubOverCurrentState:(id)arg1;	// IMP=0x0000000100009388
+ (unsigned int)_getUSBHubSiphoningCurrentActualRequirementInmA:(id)arg1;	// IMP=0x00000001000092d8
+ (unsigned int)_getUSBHubSiphoningCurrentRequirementInmA:(id)arg1;	// IMP=0x0000000100009228
+ (unsigned int)_getUSBHubUnitLoadInmA:(id)arg1;	// IMP=0x0000000100009178
+ (unsigned int)_getChargerVoltageInmV:(id)arg1;	// IMP=0x00000001000090c8
+ (unsigned int)_getChargerCurrentInmA:(id)arg1;	// IMP=0x0000000100009018
+ (int)_getReserveCurrentInmA:(id)arg1;	// IMP=0x0000000100008f68
- (void).cxx_destruct;	// IMP=0x00000001000095ec
...
- (void)_sendChangedSiphoningValues;	// IMP=0x0000000100008ab0
- (void)_updateSiphoningValues;	// IMP=0x0000000100008884
- (void)_processPowerInfoChangeTimeout;	// IMP=0x00000001000082b8
- (void)_cckHubChangeNotificationHandler:(id)arg1;	// IMP=0x0000000100007f5c
- (void)_powerInfoChangeNotificationHandler:(id)arg1;	// IMP=0x0000000100007d78
- (void)setOverCurrentSiphoning;	// IMP=0x0000000100007d5c
- (void)resetOverCurrentSiphoning;	// IMP=0x0000000100007d40
- (_Bool)getOverCurrentState;	// IMP=0x0000000100007d24
- (unsigned int)calculateSiphoningCurrent:(unsigned int)arg1;	// IMP=0x0000000100007abc
- (id)siphoningDebounceTimerSource;	// IMP=0x00000001000079f0
- (void)dealloc;	// IMP=0x0000000100007990
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000100007790
