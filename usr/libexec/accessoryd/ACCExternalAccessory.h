...
+ (id)accessoryDictionaryForLogging:(id)arg1;	// IMP=0x00000001000bb424
+ (unsigned int)_generateLegacyIAPConnectionID;	// IMP=0x00000001000bb3ac
...
- (void)_constructEADictionary:(id)arg1;	// IMP=0x00000001000ba5c0
- (void)_addEAProtocolsForEAEndpoints:(id)arg1;	// IMP=0x00000001000ba258
- (void)_addEAProtocolPrimaryEndpointInfo:(struct ACCEndpoint_s *)arg1;	// IMP=0x00000001000b9f30
- (id)_nativeUSBEndpointUUIDForProtocolIdentifier:(id)arg1 iAP2Endpoint:(CDStruct_4aa09b98 *)arg2;	// IMP=0x00000001000b9c74
- (void)_addiAP2VehicleInfo:(CDStruct_4aa09b98 *)arg1;	// IMP=0x00000001000b95ec
- (void)_addiAP2EAProtocols:(CDStruct_4aa09b98 *)arg1;	// IMP=0x00000001000b8e64
- (void)_addiAP2IdentificationInfo:(CDStruct_4aa09b98 *)arg1;	// IMP=0x00000001000b8c08
- (void)_addAccessoryInfo:(struct ACCEndpoint_s *)arg1;	// IMP=0x00000001000b8724
- (void)_addiAP2AuthInfo:(CDStruct_4aa09b98 *)arg1;	// IMP=0x00000001000b869c
- (id)copyExternalAccessoryProtocols;	// IMP=0x00000001000b8594
- (id)externalAccessoryProtocolInformationForProtocolName:(id)arg1;	// IMP=0x00000001000b8368
- (void)updateAccessoryInfo;	// IMP=0x00000001000b7a6c
- (id)description;	// IMP=0x00000001000b7a18
- (id)initWithEndpointUUIDs:(id)arg1 primaryEndpointUUID:(id)arg2;	// IMP=0x00000001000b7700
