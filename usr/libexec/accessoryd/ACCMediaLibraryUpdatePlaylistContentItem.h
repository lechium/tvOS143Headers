...
- (void).cxx_destruct;	// IMP=0x000000010010023c
...
- (void)fillStruct:(CDStruct_f51598dc *)arg1;	// IMP=0x00000001000fff24
- (id)copyNSRepresentation:(int)arg1;	// IMP=0x00000001000ffd70
- (id)debugDescription;	// IMP=0x00000001000ffcd0
- (id)description;	// IMP=0x00000001000ffc84
- (id)initWithMediaLibrary:(id)arg1 playlistPersistentID:(unsigned long long)arg2 dict:(id)arg3;	// IMP=0x00000001000ff8c8
- (id)initWithMediaLibrary:(id)arg1 persistentID:(unsigned long long)arg2 playlistPersistentID:(unsigned long long)arg3;	// IMP=0x00000001000ff7ec
