...
- (void).cxx_destruct;	// IMP=0x00000001000956f0
...
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4 usingDebugDescription:(_Bool)arg5;	// IMP=0x0000000100095114
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4;	// IMP=0x0000000100095094
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x0000000100095020
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 usingDebugDescription:(_Bool)arg4;	// IMP=0x0000000100094f58
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x0000000100094ee8
- (void)_appendSubheader:(id)arg1 toString:(id)arg2;	// IMP=0x0000000100094e98
- (id)createDiagnosticInfo;	// IMP=0x0000000100094324
- (id)init;	// IMP=0x00000001000942c0
