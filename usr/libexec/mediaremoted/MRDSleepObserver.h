...
- (void).cxx_destruct;	// IMP=0x00000001000a57f0
...
- (void)notifyDelegateOfWake;	// IMP=0x00000001000a5728
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000a5684
- (id)init;	// IMP=0x00000001000a5350
