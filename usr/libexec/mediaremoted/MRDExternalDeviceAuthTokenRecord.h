...
- (void).cxx_destruct;	// IMP=0x00000001000b97ac
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00000001000b9700
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b96c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b9688
