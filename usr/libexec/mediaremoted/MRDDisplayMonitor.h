...
- (void).cxx_destruct;	// IMP=0x00000001000b1110
...
- (void)dealloc;	// IMP=0x00000001000b1060
- (void)scheduleLayoutChangeForReason:(id)arg1;	// IMP=0x00000001000b0e18
- (void)layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x00000001000b0b74
@property(readonly, nonatomic) _Bool lockScreenVisible;
- (id)_fbsDisplayMonitorConfiguration;	// IMP=0x00000001000b08e4
- (id)init;	// IMP=0x00000001000b0648
