...
- (void).cxx_destruct;	// IMP=0x00000001000145ec
@property(readonly, nonatomic) int processID; // @synthesize processID=_processID;
@property(readonly, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (void)dispatchHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000100014520
- (id)initWithBundleID:(id)arg1 processID:(int)arg2;	// IMP=0x000000010001442c
