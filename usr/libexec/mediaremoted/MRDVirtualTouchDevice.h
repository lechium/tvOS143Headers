...
- (void).cxx_destruct;	// IMP=0x00000001000b060c
...
- (id)_newIOKitDeviceProperties;	// IMP=0x00000001000b0424
- (_Bool)handleTouchEvent:(struct _MRHIDTouchEvent)arg1;	// IMP=0x00000001000b0094
- (_Bool)handleHIDReport:(id)arg1;	// IMP=0x00000001000aff64
- (id)deviceProperties;	// IMP=0x00000001000aff1c
- (void)dealloc;	// IMP=0x00000001000afed0
- (id)initWithDeviceDescriptor:(id)arg1;	// IMP=0x00000001000afd78
