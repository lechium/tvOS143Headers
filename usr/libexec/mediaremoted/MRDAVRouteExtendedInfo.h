...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x0000000100033598
- (void).cxx_destruct;	// IMP=0x00000001000337f0
...
- (id)_extendedInfo;	// IMP=0x00000001000337b0
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x00000001000335ec
