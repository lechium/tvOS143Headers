...
- (void)cancel;	// IMP=0x00000001000b5914
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x00000001000b5904
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x00000001000b580c
