...
- (void).cxx_destruct;	// IMP=0x0000000100093024
...
- (void)_onSyncSelf_maybeSetupPlaybackTimeoutTimerForEvent:(long long)arg1;	// IMP=0x0000000100092ad4
- (id)_onSyncSelf_calculateElectedPlayerForOriginClient:(id)arg1 event:(long long)arg2 reason:(id *)arg3;	// IMP=0x00000001000927d4
- (long long)_resolveChangeTypeWithOriginClient:(id)arg1 forEvent:(long long)arg2;	// IMP=0x000000010009244c
- (void)_onSyncSelf_reevaluateElectedPlayerForEvent:(long long)arg1 withReason:(id)arg2;	// IMP=0x0000000100091f70
- (void)_handleActiveSystemEndpointDidChangeNotification:(id)arg1;	// IMP=0x0000000100091a10
- (void)_handleNowPlayingApplicationDidForegroundNotification:(id)arg1;	// IMP=0x00000001000918b8
- (void)_handleNowPlayingApplicationDidChangeNotification:(id)arg1;	// IMP=0x00000001000917a4
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x000000010009161c
- (void)_handlePlaybackQueueChangedNotification:(id)arg1;	// IMP=0x0000000100091514
- (_Bool)_shouldUseNotification:(id)arg1;	// IMP=0x0000000100091474
@property(retain, nonatomic) NSString *activeSystemEndpointOutputDeviceUID;
- (void)setOriginClient:(id)arg1 withChangeType:(long long)arg2;	// IMP=0x000000010009130c
- (id)initWithOriginClient:(id)arg1;	// IMP=0x0000000100090f00
