...
- (void).cxx_destruct;	// IMP=0x0000000100014418
- (void)dispatchHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000100014370
- (void)dealloc;	// IMP=0x0000000100014320
- (id)init;	// IMP=0x0000000100014260
