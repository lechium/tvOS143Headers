...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b9324
- (void).cxx_destruct;	// IMP=0x00000001000b951c
...
- (unsigned long long)sampleRate;	// IMP=0x00000001000b94bc
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x00000001000b9444
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001000b93a4
