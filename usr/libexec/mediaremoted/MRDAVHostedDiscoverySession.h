...
- (void).cxx_destruct;	// IMP=0x000000010002d628
...
- (void)_invalidate;	// IMP=0x000000010002d514
- (void)getAvailableOutputDevicesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d4a4
- (void)getAvailableEndpointsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d434
- (void)setEndpointFeatures:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002d3d4
- (void)setDiscoveryMode:(unsigned int)arg1 enableThrottling:(_Bool)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010002d308
- (void)getDiscoveryModeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d2f4
- (void)getDevicePresenceDetectedWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d294
- (void)hostedRoutingController:(id)arg1 outputDevicesDidChange:(id)arg2 forFeature:(unsigned int)arg3;	// IMP=0x000000010002cf98
- (void)hostedRoutingController:(id)arg1 endpointsDidChange:(id)arg2;	// IMP=0x000000010002cc9c
@property(readonly, copy) NSString *debugDescription;
- (void)dealloc;	// IMP=0x000000010002c784
- (id)initWithConnection:(id)arg1 hostedRoutingController:(id)arg2;	// IMP=0x000000010002c494
