...
- (void)clearRoutedCommands;	// IMP=0x0000000100013850
- (void)addRoutedCommand:(id)arg1;	// IMP=0x0000000100013660
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x0000000100013454
