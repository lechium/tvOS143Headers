...
- (void).cxx_destruct;	// IMP=0x000000010001d28c
...
- (id)description;	// IMP=0x000000010001d178
- (id)initWithPID:(int)arg1 audioSessionID:(id)arg2 mxSessionIDs:(id)arg3;	// IMP=0x000000010001d0cc
