...
- (void).cxx_destruct;	// IMP=0x0000000100096250
@property(nonatomic) __weak id <MRDPhoneCallObserverDelegate> delegate; // @synthesize delegate=_delegate;
- (void)numberOfActivePhoneCalls:(CDUnknownBlockType)arg1;	// IMP=0x00000001000960c4
- (void)_notifyDelegate:(id)arg1;	// IMP=0x0000000100096034
- (void)callObserver:(id)arg1 callChanged:(id)arg2;	// IMP=0x0000000100095fbc
- (id)init;	// IMP=0x0000000100095f30
