...
- (void).cxx_destruct;	// IMP=0x00000001000345fc
...
- (void)_onQueue_beginTimerWithInterval:(double)arg1;	// IMP=0x0000000100034314
- (void)_onQueue_recalculateStateForReason:(id)arg1;	// IMP=0x0000000100033db0
- (void)_onQueue_restoreState;	// IMP=0x0000000100033a20
- (void)_handlePersonalDeviceChangeNotification:(id)arg1;	// IMP=0x00000001000339b0
- (id)init;	// IMP=0x00000001000337fc
