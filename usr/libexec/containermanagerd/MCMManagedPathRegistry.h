...
- (void).cxx_destruct;	// IMP=0x00000001000639a0
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x0000000100063648
- (void)_addPaths:(id)arg1;	// IMP=0x0000000100063608
- (id)managedPathForURL:(id)arg1;	// IMP=0x0000000100063468
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x0000000100063158
- (id)initWithDaemonUser:(id)arg1;	// IMP=0x0000000100063030
