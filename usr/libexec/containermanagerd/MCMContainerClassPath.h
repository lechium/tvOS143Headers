...
+ (id)_baseURLForUserIdentity:(id)arg1 containerClass:(unsigned long long)arg2;	// IMP=0x000000010003d368
+ (id)_baseURLForUserIdentity:(id)arg1;	// IMP=0x000000010003d304
+ (id)_classComponentForContainerClass:(unsigned long long)arg1;	// IMP=0x000000010003d260
+ (id)_categoryComponentForContainerClass:(unsigned long long)arg1;	// IMP=0x000000010003d200
+ (unsigned short)_modeForContainerClass:(unsigned long long)arg1;	// IMP=0x000000010003d1f8
+ (_Bool)_inLibraryRepairBlock_createURLIfNecessary:(id)arg1 mode:(unsigned short)arg2 owner:(id)arg3 dataProtectionClass:(int)arg4 error:(id *)arg5;	// IMP=0x000000010003ce28
+ (id)posixOwnerForContainerClass:(unsigned long long)arg1 user:(id)arg2;	// IMP=0x000000010003cd20
+ (id)containerPathForUserIdentity:(id)arg1 containerClass:(unsigned long long)arg2;	// IMP=0x000000010003cbac
+ (id)containerPathForContainerIdentity:(id)arg1;	// IMP=0x000000010003cb14
+ (id)containerPathTypeClasses;	// IMP=0x000000010003cad4
- (void).cxx_destruct;	// IMP=0x000000010003c860
...
- (_Bool)_createURLIfNecessary:(id)arg1 mode:(unsigned short)arg2 owner:(id)arg3 dataProtectionClass:(int)arg4 error:(id *)arg5;	// IMP=0x000000010003c6dc
- (_Bool)_obj1:(id)arg1 isEqualToObj2:(id)arg2;	// IMP=0x000000010003c678
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010003c57c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003c504
- (_Bool)isEqualToContainerClassPath:(id)arg1;	// IMP=0x000000010003c440
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithBaseURL:(id)arg1 categoryComponent:(id)arg2 classComponent:(id)arg3 containerClass:(unsigned long long)arg4 POSIXOwner:(id)arg5 POSIXMode:(unsigned short)arg6 userIdentity:(id)arg7;	// IMP=0x000000010003befc
...
- (_Bool)createIfNecessaryWithError:(id *)arg1;	// IMP=0x000000010003b8c4
