...
+ (id)_posixOwnerForContainerSubdirectories:(unsigned long long)arg1 user:(id)arg2;	// IMP=0x00000001000897b0
+ (Class)_containerClassPathClass;	// IMP=0x00000001000897a4
+ (id)containerPathFromURL:(id)arg1 containerClassPath:(id)arg2 relativePath:(id *)arg3;	// IMP=0x0000000100089548
+ (id)containerPathIdentifierForCodeSignIdentifier:(id)arg1 containerClass:(unsigned long long)arg2;	// IMP=0x00000001000893e8
+ (id)containerPathForContainerClassPath:(id)arg1 containerPathIdentifier:(id)arg2;	// IMP=0x00000001000892b0
+ (id)containerPathForUserIdentity:(id)arg1 containerClass:(unsigned long long)arg2 containerPathIdentifier:(id)arg3;	// IMP=0x00000001000891bc
+ (id)containerPathForContainerIdentity:(id)arg1 containerPathIdentifier:(id)arg2;	// IMP=0x00000001000890fc
- (void).cxx_destruct;	// IMP=0x0000000100088e24
...
- (_Bool)_createURLIfNecessary:(id)arg1 mode:(unsigned short)arg2 owner:(id)arg3 dataProtectionClass:(int)arg4 error:(id *)arg5;	// IMP=0x0000000100088c38
- (_Bool)_obj1:(id)arg1 isEqualToObj2:(id)arg2;	// IMP=0x0000000100088bd4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100088b18
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100088aa0
- (_Bool)isEqualToContainerPath:(id)arg1;	// IMP=0x0000000100088a0c
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithContainerClassPath:(id)arg1 containerPathIdentifier:(id)arg2 containerRootComponent:(id)arg3 containerDataComponent:(id)arg4;	// IMP=0x0000000100088660
@property(readonly, nonatomic) NSURL *classURL;
@property(readonly, nonatomic) NSURL *categoryURL;
@property(readonly, nonatomic) NSURL *baseURL;
- (_Bool)createDataURLIfNecessaryWithDataProtectionClass:(int)arg1 error:(id *)arg2;	// IMP=0x00000001000883fc
- (_Bool)createIfNecessaryWithDataProtectionClass:(int)arg1 error:(id *)arg2;	// IMP=0x0000000100088260
