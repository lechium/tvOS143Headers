...
+ (Class)incomingMessageClass;	// IMP=0x0000000100019c14
+ (unsigned long long)command;	// IMP=0x0000000100019c0c
+ (id)commandForStageForDeleteWithContainerIdentities:(id)arg1 useLocking:(_Bool)arg2 onError:(CDUnknownBlockType)arg3;	// IMP=0x0000000100019b90
...
- (_Bool)fromQueue:(id)arg1 executeWithError:(unsigned long long *)arg2;	// IMP=0x0000000100018c70
- (id)initWithContainerIdentities:(id)arg1 useLocking:(_Bool)arg2 onError:(CDUnknownBlockType)arg3;	// IMP=0x0000000100018bb8
