...
+ (id)privilegedClientIdentityWithUserIdentity:(id)arg1 kernel:(_Bool)arg2;	// IMP=0x000000010001fdd8
+ (id)anonymousPrivilegedClientIdentity;	// IMP=0x000000010001fd6c
+ (id)_clientIdentityWithXPCConnection:(id)arg1 personaUniqueString:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x00000001000208e8
+ (id)clientIdentityWithXPCConnection:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x0000000100020828
+ (id)clientIdentityWithClient:(struct container_client *)arg1;	// IMP=0x000000010002072c
- (void).cxx_destruct;	// IMP=0x000000010001f854
...
- (id)shortDescription;	// IMP=0x000000010001f790
- (id)description;	// IMP=0x000000010001f720
- (void)dealloc;	// IMP=0x000000010001f6d8
- (_Bool)boolValueOfEntitlement:(id)arg1;	// IMP=0x000000010001f614
- (id)initWithClient:(struct container_client *)arg1 userIdentity:(id)arg2 entitlements:(id)arg3 sandboxed:(_Bool)arg4 kernel:(_Bool)arg5;	// IMP=0x000000010001f388
- (id)init;	// IMP=0x000000010001f26c
- (id)clientIdentityWithXPCConnection:(id)arg1 xpcMessage:(id)arg2;	// IMP=0x000000010001ff30
