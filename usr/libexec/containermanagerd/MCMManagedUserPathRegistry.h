...
- (void).cxx_destruct;	// IMP=0x0000000100063d4c
...
- (void)_initPathPropertiesWithUserHomeDirectoryURL:(id)arg1 clientUser:(id)arg2;	// IMP=0x0000000100063bd0
- (id)initWithUserIdentity:(id)arg1 daemonUser:(id)arg2;	// IMP=0x0000000100063a48
