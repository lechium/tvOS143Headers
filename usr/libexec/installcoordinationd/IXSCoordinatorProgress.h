...
+ (double)_computeOverallProgressForCurrentProgress:(double)arg1 progressPhase:(unsigned long long)arg2;	// IMP=0x000000010000e034
- (void).cxx_destruct;	// IMP=0x000000010000e36c
...
- (void)_notifyDelegateAndUpdateProgressWithPhaseCompleted:(_Bool)arg1;	// IMP=0x000000010000e074
- (void)finishInstalling;	// IMP=0x000000010000dfb8
- (void)finishLoading;	// IMP=0x000000010000df44
- (id)description;	// IMP=0x000000010000de44
- (id)initForCoordinatorWithBundleID:(id)arg1 totalUnits:(unsigned long long)arg2 delegate:(id)arg3;	// IMP=0x000000010000dd90
