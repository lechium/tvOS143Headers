...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010005d120
- (void).cxx_destruct;	// IMP=0x000000010005ef08
...
- (id)description;	// IMP=0x000000010005ed64
- (void)supersede;	// IMP=0x000000010005ecb8
- (void)decommission;	// IMP=0x000000010005eb6c
...
- (void)_removeSavedState;	// IMP=0x000000010005dcf4
- (void)saveState;	// IMP=0x000000010005d990
- (_Bool)awakeFromSerializationWithLookupBlock:(CDUnknownBlockType)arg1 error:(id *)arg2;	// IMP=0x000000010005d924
- (void)cancelForReason:(id)arg1 client:(unsigned long long)arg2;	// IMP=0x000000010005d4a0
- (void)reset;	// IMP=0x000000010005d244
- (unsigned long long)hash;	// IMP=0x000000010005d1f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005d128
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010005cf48
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010005ccdc
@property(readonly, copy, nonatomic) IXDataPromiseSeed *clientSeed; // @dynamic clientSeed;
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x000000010005cad8
- (void)_internalInitWithUniqueIdentifier:(id)arg1;	// IMP=0x000000010005c97c
- (oneway void)_remote_preflightWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f9a0
- (oneway void)_remote_getErrorInfo:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f858
- (oneway void)_remote_resetWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f590
- (oneway void)_remote_cancelForReason:(id)arg1 client:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010005f434
- (oneway void)_remote_setIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f24c
- (oneway void)_remote_getIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f138
- (oneway void)_remote_setPercentComplete:(double)arg1;	// IMP=0x000000010005f068
- (oneway void)_remote_getPercentComplete:(CDUnknownBlockType)arg1;	// IMP=0x000000010005ef58
