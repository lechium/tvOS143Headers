...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000266e4
@property(readonly, copy, nonatomic) NSDictionary *dictionary;
- (id)initWithSeed:(id)arg1 dictionary:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000266ec
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100026658
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100026624
