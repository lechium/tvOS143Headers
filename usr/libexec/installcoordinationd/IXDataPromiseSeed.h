...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010003156c
- (void).cxx_destruct;	// IMP=0x00000001000316c4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100031574
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100031400
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100031284
