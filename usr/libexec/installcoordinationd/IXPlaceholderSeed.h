...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100029dd0
- (void).cxx_destruct;	// IMP=0x0000000100029f58
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100029dd8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100029c68
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100029afc
