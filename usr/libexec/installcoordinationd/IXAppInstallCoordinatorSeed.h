...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000482f8
- (void).cxx_destruct;	// IMP=0x0000000100048804
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100048680
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000484c0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100048300
