...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100031bf0
- (void).cxx_destruct;	// IMP=0x0000000100031f40
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100031d78
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100031bf8
