...
- (void).cxx_destruct;	// IMP=0x0000000100010e94
...
- (id)requestWithError:(id *)arg1;	// IMP=0x0000000100010b88
- (id)_requestBodyData;	// IMP=0x0000000100010a3c
- (id)_endpointURL;	// IMP=0x000000010001096c
- (id)_requestHeader;	// IMP=0x00000001000107fc
- (id)_contentType;	// IMP=0x00000001000107f0
