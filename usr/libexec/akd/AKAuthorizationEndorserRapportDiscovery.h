...
- (void).cxx_destruct;	// IMP=0x00000001000426b0
...
- (void)_handleFoundDevice:(id)arg1;	// IMP=0x0000000100042504
- (void)authorizationEndorserRapportClientDidFinish:(id)arg1;	// IMP=0x00000001000424f8
- (void)deactivate;	// IMP=0x000000010004245c
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x00000001000423e0
- (id)initWithClient:(id)arg1;	// IMP=0x0000000100042368
