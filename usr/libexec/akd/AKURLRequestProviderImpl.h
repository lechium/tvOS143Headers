...
- (void).cxx_destruct;	// IMP=0x0000000100011d74
...
- (_Bool)signRequest:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100011c94
- (id)serverCompatibleRequestBodyWithPayload:(id)arg1;	// IMP=0x0000000100011bac
@property(readonly, copy, nonatomic) NSDictionary *serverCompatibleRequestBody;
- (_Bool)_validateErrorCode:(id)arg1 withKey:(id)arg2;	// IMP=0x0000000100011a98
- (_Bool)_validateResponseBodyFormat;	// IMP=0x0000000100011a1c
- (_Bool)_validateDataExists:(id)arg1;	// IMP=0x000000010001197c
- (_Bool)validateResponseData:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000115b0
- (unsigned long long)expectedResponseType;	// IMP=0x00000001000115a8
- (id)buildRequest:(id *)arg1;	// IMP=0x0000000100011288
- (void)_setRequestURL;	// IMP=0x00000001000111e8
- (id)initWithContext:(id)arg1 urlBagKey:(id)arg2 shouldCacheResource:(_Bool)arg3;	// IMP=0x0000000100011140
- (id)initWithContext:(id)arg1 urlBagKey:(id)arg2;	// IMP=0x00000001000110e0
- (id)initWithContext:(id)arg1;	// IMP=0x000000010001107c
