...
- (void).cxx_destruct;	// IMP=0x0000000100077cf0
...
- (void)clearContinuationTokenIfSupported;	// IMP=0x00000001000777b4
- (void)authenticationParametersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100076294
@property(readonly, nonatomic, getter=isContextSecretValidForSRP) _Bool contextSecretValidForSRP;
- (id)initWithContext:(id)arg1;	// IMP=0x00000001000761c8
