...
- (void).cxx_destruct;	// IMP=0x00000001000261d4
...
- (id)description;	// IMP=0x00000001000260a4
- (_Bool)isValidMessage;	// IMP=0x000000010002600c
- (id)initWithMessage:(id)arg1;	// IMP=0x00000001000259f4
