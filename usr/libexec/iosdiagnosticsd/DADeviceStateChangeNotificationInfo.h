...
+ (id)infoWithChangedProperties:(unsigned long long)arg1 snapshot:(id)arg2;	// IMP=0x000000010000bd5c
...
- (id)initWithChangedProperties:(unsigned long long)arg1 snapshot:(id)arg2;	// IMP=0x000000010000bdbc
