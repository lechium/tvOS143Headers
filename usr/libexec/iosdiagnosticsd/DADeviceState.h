...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000c704
- (void).cxx_destruct;	// IMP=0x000000010000db90
...
- (void)resetState;	// IMP=0x000000010000da9c
- (void)_sendChangeNotification;	// IMP=0x000000010000d8e0
- (void)_sendChangeNotificationIfNeeded;	// IMP=0x000000010000d8c8
- (id)_stringForPhase:(long long)arg1;	// IMP=0x000000010000d858
- (id)description;	// IMP=0x000000010000d65c
- (void)removeErrorCodes:(id)arg1;	// IMP=0x000000010000d3c4
- (void)removeErrorCode:(long long)arg1;	// IMP=0x000000010000d338
- (void)addErrorCode:(long long)arg1 userInfo:(id)arg2;	// IMP=0x000000010000d21c
- (void)updateWithDeviceState:(id)arg1;	// IMP=0x000000010000cfc8
- (void)transactionWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010000cf48
- (_Bool)object:(id)arg1 isEqualToObject:(id)arg2;	// IMP=0x000000010000ceec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000c70c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000c45c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000bffc
- (id)initWithSerialNumber:(id)arg1 attributes:(id)arg2;	// IMP=0x000000010000bf6c
