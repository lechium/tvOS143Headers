...
- (id)description;	// IMP=0x0000000100023864
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000100023808
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000001000237bc
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000100023694
- (void)_logInvocationForSelector:(id)arg1;	// IMP=0x000000010002367c
- (void)dealloc;	// IMP=0x00000001000235a0
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x000000010002331c
