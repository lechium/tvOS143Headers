...
- (void).cxx_destruct;	// IMP=0x000000010000b0b0
...
- (void)evictRandom;	// IMP=0x000000010000af98
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x000000010000ac8c
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000010000aabc
- (void)flush;	// IMP=0x000000010000a980
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x000000010000a8c0
