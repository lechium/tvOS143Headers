...
- (void).cxx_destruct;	// IMP=0x0000000100055f98
@property(retain, nonatomic) NSObject<OS_os_transaction> *osTransaction; // @synthesize osTransaction=_osTransaction;
- (void)dealloc;	// IMP=0x0000000100055e90
- (void)endTransaction;	// IMP=0x0000000100055d50
- (id)initWithTransactionName:(const char *)arg1;	// IMP=0x0000000100055c54
