...
- (void).cxx_destruct;	// IMP=0x0000000100038ac0
...
- (void)dq_setDownloadState:(long long)arg1 forDownloadIdentifier:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000387b8
- (void)dq_scheduleReconnect;	// IMP=0x00000001000384e4
- (void)dq_notifyServerOfDownloadCancelledWithTaskState:(id)arg1;	// IMP=0x0000000100038178
- (void)dq_processDownloadFailureWithTaskState:(id)arg1 task:(id)arg2 cancelReason:(long long)arg3;	// IMP=0x0000000100037ea8
- (void)dq_processCompletedDownloadWithTaskState:(id)arg1 postProgress:(_Bool)arg2;	// IMP=0x0000000100037dac
- (void)dq_prepareDownloadsForDownloads:(id)arg1 filtersExistingTasks:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000377f0
- (void)dq_logDownloadEvent:(id)arg1 forTaskWithState:(id)arg2;	// IMP=0x00000001000376bc
- (void)doq_performDownloadOperation:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100036bfc
- (void)dq_pumpDownloadsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100035aa4
- (_Bool)dq_setSessionTaskPriorityToHighForDownloadID:(id)arg1;	// IMP=0x0000000100035738
- (void)dq_clearIsLocalServerCacheForDownloadID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010003549c
- (void)dq_saveState:(long long)arg1 forDownloadID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010003521c
- (void)dq_cancelProgressTimer;	// IMP=0x0000000100035168
- (void)dq_commitProgress;	// IMP=0x0000000100033d48
- (void)dq_startProgressTimer;	// IMP=0x0000000100033a98
- (void)_addDownloads:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100033564
- (void)URLSession:(id)arg1 task:(id)arg2 _willSendRequestForEstablishedConnection:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100032fd8
- (void)URLSession:(id)arg1 _willRetryBackgroundDataTask:(id)arg2 withError:(id)arg3;	// IMP=0x0000000100032c48
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100032a04
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100031ef4
- (void)URLSession:(id)arg1 task:(id)arg2 didFinishCollectingMetrics:(id)arg3;	// IMP=0x0000000100031d6c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000316a8
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100031168
- (void)installManager:(id)arg1 didFinishInstallForOperation:(id)arg2;	// IMP=0x0000000100030dac
- (void)installManager:(id)arg1 updatedProgress:(id)arg2 forInstallOperation:(id)arg3;	// IMP=0x0000000100030bd4
- (void)installManager:(id)arg1 didStartInstallWithOperation:(id)arg2 forDownloadID:(id)arg3;	// IMP=0x00000001000307a4
- (void)installManager:(id)arg1 willRestartInstallForDownload:(id)arg2;	// IMP=0x00000001000305d0
- (id)dq_getTaskStateFromDownloadID:(id)arg1;	// IMP=0x00000001000304a0
- (void)stopDownloadsWithIdentifiers:(id)arg1 reason:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010002fb34
- (void)restartDownloadsWithIdentifiers:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002f590
- (void)startupDownloadsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002f140
- (void)prioritizeDownloadWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002ee6c
- (void)reconnectWithURLSessionTasks;	// IMP=0x000000010002ebb0
- (void)pumpDownloadsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002eae8
- (void)dealloc;	// IMP=0x000000010002ea78
- (id)initWithDatabaseManager:(id)arg1 downloadPolicyManager:(id)arg2 transactionCoordinator:(id)arg3 installManager:(id)arg4;	// IMP=0x000000010002e6cc
- (id)newOperationQueue;	// IMP=0x000000010002e674
