...
- (void).cxx_destruct;	// IMP=0x0000000100038d10
...
- (void)run;	// IMP=0x0000000100038c84
- (id)initWithBLDownloadPipeline:(id)arg1 response:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100038bac
