...
+ (id)defaultMonitor;	// IMP=0x0000000100038fe0
- (void).cxx_destruct;	// IMP=0x000000010003a18c
@property(readonly) long long interfaceType; // @synthesize interfaceType=_interfaceType;
- (_Bool)_emulateRoamingNetwork;	// IMP=0x000000010003a16c
- (_Bool)_emulateCellularNetwork;	// IMP=0x000000010003a154
- (void)_updateRoamingStatusForContext:(id)arg1;	// IMP=0x000000010003a0a0
- (void)_setPropertiesUsingPath:(id)arg1;	// IMP=0x0000000100039df8
- (void)_forcePropertyRefresh;	// IMP=0x0000000100039da8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100039ba0
- (void)activeSubscriptionsDidChange;	// IMP=0x000000010003987c
- (void)servingNetworkChanged:(id)arg1;	// IMP=0x0000000100039870
- (void)internetDataStatus:(id)arg1;	// IMP=0x000000010003983c
- (void)currentDataSimChanged:(id)arg1;	// IMP=0x0000000100039838
- (id)copyCellularNetworkIdentityWithError:(id *)arg1;	// IMP=0x000000010003977c
...
- (void)dealloc;	// IMP=0x0000000100039270
- (id)initWithPathEvalulator:(id)arg1;	// IMP=0x0000000100039094
