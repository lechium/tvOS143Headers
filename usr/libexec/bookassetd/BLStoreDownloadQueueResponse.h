...
- (void).cxx_destruct;	// IMP=0x000000010002e4ac
...
- (id)_accountUniqueIdentifierFromValue:(id)arg1;	// IMP=0x000000010002e3e0
- (id)_responseDictionary:(id)arg1 valueForProtocolKey:(id)arg2;	// IMP=0x000000010002e320
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2 responseDictionary:(id)arg3;	// IMP=0x000000010002e1b4
...
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x000000010002deac
@property(readonly) NSOrderedSet *downloads;
- (id)initWithError:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x000000010002dd10
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2 preferredAssetFlavor:(id)arg3;	// IMP=0x000000010002cf20
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x000000010002cec0
- (id)init;	// IMP=0x000000010002ceb4
- (id)_initStoreDownloadQueueResponse;	// IMP=0x000000010002ce4c
