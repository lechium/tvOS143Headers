...
- (void).cxx_destruct;	// IMP=0x000000010003f1a4
...
- (id)sessionTaskWithSession:(id)arg1;	// IMP=0x000000010003ed3c
- (id)sessionConfiguration;	// IMP=0x000000010003eb78
- (id)initWithInstallInfo:(id)arg1;	// IMP=0x000000010003e7c4
- (id)initWithDownload:(id)arg1;	// IMP=0x000000010003e3e0
