...
- (id)_overallProgress;	// IMP=0x000000010000d35c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000ce94
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000cdd4
- (unsigned long long)hash;	// IMP=0x000000010000cdc4
- (void)setTransferProgressWithBytesWritten:(long long)arg1 totalBytesExpected:(long long)arg2;	// IMP=0x000000010000cd9c
- (void)setTransferProgress:(double)arg1;	// IMP=0x000000010000cd30
- (void)setFinishProgress:(double)arg1;	// IMP=0x000000010000ccb8
- (id)initWithPrepareDownloadResponse:(id)arg1;	// IMP=0x000000010000c92c
