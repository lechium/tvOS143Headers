...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x0000000100012c5c
- (void).cxx_destruct;	// IMP=0x0000000100014798
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x00000001000145d4
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x00000001000143f8
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00000001000138bc
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100012a58
- (id)init;	// IMP=0x00000001000129f0
