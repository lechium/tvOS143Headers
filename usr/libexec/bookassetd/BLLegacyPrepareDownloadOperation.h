...
+ (void)enumerateOperationsWithDownloads:(id)arg1 downloadPolicyManager:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010003f82c
- (void).cxx_destruct;	// IMP=0x000000010003fbd4
@property(retain, nonatomic) _BLPrepareDownloadOperation *operation; // @synthesize operation=_operation;
- (void)run;	// IMP=0x000000010003fb70
@property(copy) CDUnknownBlockType outputBlock;
@property(readonly, nonatomic) NSString *downloadIdentifier;
- (id)_initWithDownload:(id)arg1 policy:(id)arg2;	// IMP=0x000000010003f770
