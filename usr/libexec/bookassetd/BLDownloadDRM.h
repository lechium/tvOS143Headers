...
- (void).cxx_destruct;	// IMP=0x000000010001f420
@property(retain, nonatomic) NSArray *sinfs; // @synthesize sinfs=_sinfs;
- (id)_sinfsArrayWithDataKey:(id)arg1;	// IMP=0x000000010001f240
@property(readonly) BLSinfsArray *sinfsArray;
- (id)sinfForIdentifier:(long long)arg1;	// IMP=0x000000010001f0ec
@property(readonly) BLSinfsArray *pinfsArray;
@property(readonly, getter=isDRMFree) _Bool DRMFree;
- (id)firstDataForSinfDataKey:(id)arg1;	// IMP=0x000000010001ef44
- (id)initWithSinfArray:(id)arg1;	// IMP=0x000000010001ed88
