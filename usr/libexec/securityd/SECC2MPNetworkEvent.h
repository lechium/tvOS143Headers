...
- (void).cxx_destruct;	// IMP=0x000000010016a444
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100169a80
- (unsigned long long)hash;	// IMP=0x0000000100169558
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100168dc8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100168704
- (void)copyTo:(id)arg1;	// IMP=0x00000001001680c4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100167b28
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100167b20
- (id)dictionaryRepresentation;	// IMP=0x0000000100166f90
- (id)description;	// IMP=0x0000000100166edc
