...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 error:(id *)arg2;	// IMP=0x000000010018b048
- (void).cxx_destruct;	// IMP=0x000000010018aff4
...
- (void)main;	// IMP=0x000000010018a7d0
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x000000010018a6e8
