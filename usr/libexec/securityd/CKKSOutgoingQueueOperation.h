...
- (void).cxx_destruct;	// IMP=0x0000000100068fd8
...
- (_Bool)_onqueueIsErrorBadEtagOnKeyPointersOnly:(id)arg1;	// IMP=0x0000000100068ba4
- (_Bool)_onqueueIsErrorMissingSyncKey:(id)arg1;	// IMP=0x00000001000688c8
- (void)_onqueueModifyAllRecords:(id)arg1 as:(id)arg2;	// IMP=0x00000001000682c4
- (void)_onqueueModifyRecordAsError:(id)arg1 recordError:(id)arg2;	// IMP=0x0000000100067e14
- (void)groupStart;	// IMP=0x0000000100067b20
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4 ckoperationGroup:(id)arg5;	// IMP=0x0000000100067930
