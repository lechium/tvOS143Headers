...
- (void).cxx_destruct;	// IMP=0x00000001001313c0
...
- (void)groupStart;	// IMP=0x000000010013105c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 peerIDs:(id)arg4;	// IMP=0x0000000100130f1c
