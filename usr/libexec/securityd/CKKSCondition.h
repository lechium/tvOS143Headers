...
- (void).cxx_destruct;	// IMP=0x000000010018021c
...
- (long long)wait:(unsigned long long)arg1;	// IMP=0x0000000100180160
- (void)fulfill;	// IMP=0x00000001001800e0
- (id)initToChain:(id)arg1;	// IMP=0x0000000100180050
- (id)init;	// IMP=0x0000000100180040
