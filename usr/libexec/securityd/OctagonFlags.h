...
- (void).cxx_destruct;	// IMP=0x0000000100095524
...
- (void)_onqueueRemoveFlag:(id)arg1;	// IMP=0x0000000100095300
- (void)setFlag:(id)arg1;	// IMP=0x0000000100095250
- (id)conditionForFlag:(id)arg1;	// IMP=0x00000001000951d0
- (void)_onqueueSetFlag:(id)arg1;	// IMP=0x000000010009513c
- (_Bool)_onqueueContains:(id)arg1;	// IMP=0x000000010009509c
- (id)dumpFlags;	// IMP=0x0000000100095048
- (id)contentsAsString;	// IMP=0x0000000100094f7c
- (id)description;	// IMP=0x0000000100094f08
- (id)initWithQueue:(id)arg1 flags:(id)arg2;	// IMP=0x0000000100094ce8
