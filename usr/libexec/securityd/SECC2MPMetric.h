...
- (void).cxx_destruct;	// IMP=0x000000010008ff58
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010008fc84
- (unsigned long long)hash;	// IMP=0x000000010008fb44
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010008f934
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008f768
- (void)copyTo:(id)arg1;	// IMP=0x000000010008f5f0
- (void)writeTo:(id)arg1;	// IMP=0x000000010008f49c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010008ee70
- (id)dictionaryRepresentation;	// IMP=0x000000010008eb1c
- (id)description;	// IMP=0x000000010008ea68
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x000000010008e83c
- (id)metricTypeAsString:(int)arg1;	// IMP=0x000000010008e7c4
