...
+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010009eb7c
- (void).cxx_destruct;	// IMP=0x000000010009e654
...
- (void)groupStart;	// IMP=0x000000010009dddc
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x000000010009dc50
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x000000010009db58
