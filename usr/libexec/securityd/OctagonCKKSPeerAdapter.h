...
- (void).cxx_destruct;	// IMP=0x00000001000432b0
...
- (id)currentState;	// IMP=0x000000010004322c
- (void)sendTrustedPeerSetChangedUpdate;	// IMP=0x00000001000431a8
- (void)sendSelfPeerChangedUpdate;	// IMP=0x0000000100043124
- (void)registerForPeerChangeUpdates:(id)arg1;	// IMP=0x00000001000430b8
- (id)fetchTrustedPeers:(id *)arg1;	// IMP=0x0000000100042eb4
- (id)fetchSelfPeers:(id *)arg1;	// IMP=0x0000000100042b68
- (id)fetchIdentity:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000429a4
@property(readonly, copy) NSString *description;
- (id)initWithPeerID:(id)arg1 containerName:(id)arg2 contextID:(id)arg3 cuttlefishXPC:(id)arg4;	// IMP=0x00000001000427a8
