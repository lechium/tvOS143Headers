...
+ (id)globalTracker;	// IMP=0x000000010013d028
+ (_Bool)queryAKSLocked;	// IMP=0x000000010013cf24
...
- (void)addLockStateObserver:(id)arg1;	// IMP=0x000000010013ca88
- (_Bool)isLockedError:(id)arg1;	// IMP=0x000000010013c9e8
- (_Bool)checkErrorChainForLockState:(id)arg1;	// IMP=0x000000010013c904
- (_Bool)lockedError:(id)arg1;	// IMP=0x000000010013c820
- (void)recheck;	// IMP=0x000000010013c7a4
- (void)_onqueueRecheck;	// IMP=0x000000010013c4ac
- (void)resetUnlockDependency;	// IMP=0x000000010013c3bc
- (id)description;	// IMP=0x000000010013c2f8
@property(readonly) NSDate *lastUnlockTime;
@property(readonly) _Bool isLocked;
- (void)dealloc;	// IMP=0x000000010013c120
- (id)init;	// IMP=0x000000010013bf2c
