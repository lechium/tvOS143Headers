...
+ (id)fromDatabaseRow:(id)arg1;	// IMP=0x0000000100075830
+ (id)sqlColumns;	// IMP=0x0000000100075824
+ (id)sqlTable;	// IMP=0x0000000100075818
+ (id)tryFromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000756f0
+ (id)fromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000755c8
+ (id)state:(id)arg1;	// IMP=0x0000000100075460
- (void).cxx_destruct;	// IMP=0x00000001000753e4
...
- (id)sqlValues;	// IMP=0x0000000100074df8
- (id)whereClauseToFindSelf;	// IMP=0x0000000100074d4c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000744a8
- (id)initWithCKZone:(id)arg1 zoneCreated:(_Bool)arg2 zoneSubscribed:(_Bool)arg3 changeToken:(id)arg4 moreRecordsInCloudKit:(_Bool)arg5 lastFetch:(id)arg6 lastScan:(id)arg7 lastFixup:(unsigned long long)arg8 encodedRateLimiter:(id)arg9;	// IMP=0x0000000100074304
