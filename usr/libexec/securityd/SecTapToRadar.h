...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x000000010001e04c
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x000000010001df38
+ (void)disableTTRsEntirely;	// IMP=0x000000010001df34
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x000000010001df2c
+ (id)keyname:(id)arg1;	// IMP=0x000000010001deac
- (void).cxx_destruct;	// IMP=0x000000010001dce8
...
- (void)trigger;	// IMP=0x000000010001dbe0
- (void)clearRetryTimestamp;	// IMP=0x000000010001db5c
- (void)updateRetryTimestamp;	// IMP=0x000000010001da7c
- (_Bool)isRateLimited;	// IMP=0x000000010001d954
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x000000010001d7e8
