...
- (void).cxx_destruct;	// IMP=0x000000010006fb5c
...
- (void)proceedWithKeys:(id)arg1 filteredTLKShares:(id)arg2;	// IMP=0x000000010006f784
- (void)noteMetric:(id)arg1 count:(long long)arg2;	// IMP=0x000000010006f5f8
- (void)proceedWithPeerID:(id)arg1 refetchWasNeeded:(_Bool)arg2;	// IMP=0x000000010006f428
- (void)groupStart;	// IMP=0x000000010006eda8
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6 saveVoucher:(_Bool)arg7;	// IMP=0x000000010006ec1c
