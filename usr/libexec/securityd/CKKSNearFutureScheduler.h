...
- (void).cxx_destruct;	// IMP=0x00000001000937b8
...
- (void)cancel;	// IMP=0x0000000100093608
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00000001000930b0
- (void)trigger;	// IMP=0x0000000100092fe4
- (void)_onqueueTimerTick;	// IMP=0x0000000100092cb4
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x0000000100092bd8
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x0000000100092b50
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x000000010009296c
- (id)makeOperationDependency;	// IMP=0x0000000100092890
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x0000000100092800
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x000000010009261c
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x0000000100092574
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00000001000924f4
