...
- (void).cxx_destruct;	// IMP=0x00000001000797f8
...
- (void)groupStart;	// IMP=0x0000000100078b5c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0000000100078a74
