...
- (void).cxx_destruct;	// IMP=0x00000001001dad7c
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x00000001001dac00
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x00000001001daaf4
- (id)setUpConfigForPeer;	// IMP=0x00000001001daa70
