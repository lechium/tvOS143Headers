...
- (void).cxx_destruct;	// IMP=0x00000001000f55dc
...
- (void)proceedWithKeys:(id)arg1 pendingTLKShares:(id)arg2;	// IMP=0x00000001000f5210
- (void)afterSuccessfulAllowList;	// IMP=0x00000001000f501c
- (void)requestSilentEscrowUpdate;	// IMP=0x00000001000f4de0
- (void)afterUpdate;	// IMP=0x00000001000f4c3c
- (void)handlePrepareErrors:(id)arg1 nextExpectedState:(id)arg2;	// IMP=0x00000001000f4ac4
- (void)afterPreflight;	// IMP=0x00000001000f4898
- (void)afterPrepare;	// IMP=0x00000001000f46c4
- (void)groupStart;	// IMP=0x00000001000f34fc
- (id)persistentKeyRef:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x00000001000f3444
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 ckksConflictState:(id)arg3 errorState:(id)arg4 deviceInfo:(id)arg5 policyOverride:(id)arg6;	// IMP=0x00000001000f32d0
