...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010017290c
- (void).cxx_destruct;	// IMP=0x00000001001728d0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100172748
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100172628
- (id)description;	// IMP=0x0000000100172544
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x000000010017246c
