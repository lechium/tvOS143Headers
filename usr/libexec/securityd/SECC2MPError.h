...
- (void).cxx_destruct;	// IMP=0x0000000100125570
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100125424
- (unsigned long long)hash;	// IMP=0x0000000100125380
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100125248
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100125144
- (void)copyTo:(id)arg1;	// IMP=0x000000010012508c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100124fe4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100124fdc
- (id)dictionaryRepresentation;	// IMP=0x0000000100124ea4
- (id)description;	// IMP=0x0000000100124df0
