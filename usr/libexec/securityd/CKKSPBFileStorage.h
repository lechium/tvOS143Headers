...
- (void).cxx_destruct;	// IMP=0x000000010015a64c
...
- (void)setStorage:(id)arg1;	// IMP=0x000000010015a4e8
- (id)storage;	// IMP=0x000000010015a47c
- (id)initWithStoragePath:(id)arg1 storageClass:(Class)arg2;	// IMP=0x000000010015a2e0
