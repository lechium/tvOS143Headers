...
+ (id)urlForSOSAccountSettings;	// IMP=0x0000000100194658
+ (unsigned int)ghostBustGetRampSettings;	// IMP=0x0000000100194650
+ (id)accountFromData:(id)arg1 factory:(struct SOSDataSourceFactory *)arg2 error:(id *)arg3;	// IMP=0x00000001001a272c
+ (id)accountFromDER:(const char **)arg1 end:(const char *)arg2 factory:(struct SOSDataSourceFactory *)arg3 error:(id *)arg4;	// IMP=0x00000001001a19f8
+ (void)performOnQuietAccountQueue:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a5a10
- (void).cxx_destruct;	// IMP=0x0000000100191254
...
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x0000000100190d30
- (id)performRingUpdate;	// IMP=0x0000000100190c48
- (id)performBackup;	// IMP=0x0000000100190b60
- (void)triggerRingUpdate;	// IMP=0x0000000100190a94
- (void)triggerBackupForPeers:(id)arg1;	// IMP=0x000000010019093c
- (void)addRingUpdateFlag;	// IMP=0x00000001001908c0
- (void)addBackupFlag;	// IMP=0x0000000100190844
- (void)setupStateMachine;	// IMP=0x00000001001902f8
- (void)_onQueueRecordRetiredPeersInCircle;	// IMP=0x0000000100190190
- (_Bool)_onQueueEnsureInBackupRings;	// IMP=0x000000010018fd24
- (_Bool)isInCircle:(struct __CFError **)arg1;	// IMP=0x000000010018fcd4
- (int)getCircleStatus:(struct __CFError **)arg1;	// IMP=0x000000010018fc28
- (void)flattenToSaveBlock;	// IMP=0x000000010018fb68
- (void)setWatchdogParmeters:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f9e4
- (void)getWatchdogParameters:(CDUnknownBlockType)arg1;	// IMP=0x000000010018f84c
- (void)rpcTriggerRingUpdate:(CDUnknownBlockType)arg1;	// IMP=0x000000010018f7f4
- (void)rpcTriggerBackup:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f718
- (void)rpcTriggerSync:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f530
- (void)importInitialSyncCredentials:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f464
- (void)initialSyncCredentials:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f020
- (void)joinCircleWithBlob:(id)arg1 version:(int)arg2 complete:(CDUnknownBlockType)arg3;	// IMP=0x000000010018eebc
- (void)circleJoiningBlob:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018ec40
- (void)iCloudIdentityStatus_internal:(CDUnknownBlockType)arg1;	// IMP=0x000000010018ec2c
- (void)iCloudIdentityStatus:(CDUnknownBlockType)arg1;	// IMP=0x000000010018ec18
- (_Bool)ghostBustCheckDate;	// IMP=0x000000010018ec10
- (void)ghostBustInfo:(CDUnknownBlockType)arg1;	// IMP=0x000000010018ebfc
- (void)ghostBustTriggerTimed:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018ebe8
- (void)ghostBustPeriodic:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018ebd4
- (void)ghostBust:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018ebc0
- (void)ghostBustSchedule;	// IMP=0x000000010018ebbc
- (void)ghostBustFollowup;	// IMP=0x000000010018ebb8
- (id)ghostBustGetDate;	// IMP=0x000000010018ebb0
- (void)circleHash:(CDUnknownBlockType)arg1;	// IMP=0x000000010018eab0
- (void)myPeerInfo:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e974
- (void)stashAccountCredential:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018e8a0
- (void)validatedStashedAccountCredential:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e7a8
- (_Bool)syncWaitAndFlush:(struct __CFError **)arg1;	// IMP=0x000000010018e4ec
- (void)assertStashedAccountCredential:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e438
- (void)stashedCredentialPublicKey:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e384
- (void)rateLimitingPerformanceCounters:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e2f8
- (void)kvsPerformanceCounters:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e254
- (void)userPublicKey:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e1a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010018dee8
- (void)startStateMachine;	// IMP=0x000000010018dea8
- (id)initWithGestalt:(struct __CFDictionary *)arg1 factory:(struct SOSDataSourceFactory *)arg2;	// IMP=0x000000010018da80
- (void)ensureOctagonPeerKeys;	// IMP=0x000000010018d9a4
- (_Bool)ensureFactoryCircles;	// IMP=0x000000010018d678
...
- (void)dealloc;	// IMP=0x000000010018d30c
- (id)encodedData:(id *)arg1;	// IMP=0x00000001001a18c0
- (void)performTransaction:(_Bool)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a58d0
- (void)performTransaction:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a58bc
- (void)performTransaction_Locked:(_Bool)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a5828
- (void)performTransaction_Locked:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a5814
