...
- (void).cxx_destruct;	// IMP=0x000000010013eb70
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010013ea08
- (unsigned long long)hash;	// IMP=0x000000010013e944
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013e7e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010013e6bc
- (void)copyTo:(id)arg1;	// IMP=0x000000010013e5e0
- (void)writeTo:(id)arg1;	// IMP=0x000000010013e510
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010013e1c4
- (id)dictionaryRepresentation;	// IMP=0x000000010013e054
- (id)description;	// IMP=0x000000010013dfa0
