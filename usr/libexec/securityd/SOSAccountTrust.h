...
+ (id)trust;	// IMP=0x00000001001c59d4
- (void).cxx_destruct;	// IMP=0x00000001001c5998
...
- (void)dealloc;	// IMP=0x00000001001c575c
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x00000001001c5664
- (id)init;	// IMP=0x00000001001c5568
