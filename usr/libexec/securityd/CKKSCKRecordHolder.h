...
- (void).cxx_destruct;	// IMP=0x000000010009d2a0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010009d1c8
- (_Bool)matchesCKRecord:(id)arg1;	// IMP=0x000000010009d0e4
- (void)setFromCKRecord:(id)arg1;	// IMP=0x000000010009d000
- (id)updateCKRecord:(id)arg1 zoneID:(id)arg2;	// IMP=0x000000010009cf10
- (id)CKRecordName;	// IMP=0x000000010009ce3c
- (id)CKRecordWithZoneID:(id)arg1;	// IMP=0x000000010009ccd8
@property(retain, getter=storedCKRecord, setter=setStoredCKRecord:) CKRecord *storedCKRecord;
- (id)initWithCKRecordType:(id)arg1 encodedCKRecord:(id)arg2 zoneID:(id)arg3;	// IMP=0x000000010009c7cc
- (id)initWithCKRecord:(id)arg1;	// IMP=0x000000010009c700
