...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001b418c
- (void).cxx_destruct;	// IMP=0x00000001001b415c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001b40c8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001b3fe4
