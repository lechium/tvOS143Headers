...
- (void).cxx_destruct;	// IMP=0x00000001000aa664
...
- (void)cancel;	// IMP=0x00000001000aa3b4
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00000001000a9e4c
- (void)performFetch;	// IMP=0x00000001000a9768
- (void)groupStart;	// IMP=0x00000001000a9540
- (void)queryClientsForChangeTokens;	// IMP=0x00000001000a9078
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clients:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00000001000a8cb8
- (id)init;	// IMP=0x00000001000a8ca0
