...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00000001000acc40
- (void).cxx_destruct;	// IMP=0x00000001000acc10
...
- (id)asPathStep;	// IMP=0x00000001000acad8
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00000001000aca34
