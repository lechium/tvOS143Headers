...
+ (id)sqlTable;	// IMP=0x0000000100100b2c
- (void).cxx_destruct;	// IMP=0x0000000100100b18
...
- (id)commitToDatabaseWithError:(id *)arg1;	// IMP=0x0000000100100770
- (_Bool)isReadyToCommit;	// IMP=0x0000000100100574
