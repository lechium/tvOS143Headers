...
- (void).cxx_destruct;	// IMP=0x00000001000e0d0c
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e0bb0
- (id)initRefKeyWrappedKeyWithData:(id)arg1 refKeyBlob:(id)arg2;	// IMP=0x00000001000e0ad8
- (id)initRegularWrappedKeyWithData:(id)arg1;	// IMP=0x00000001000e0a34
