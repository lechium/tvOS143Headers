...
- (void).cxx_destruct;	// IMP=0x00000001000e12cc
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e0f0c
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000e0d18
