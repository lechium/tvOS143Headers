...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x000000010003767c
+ (id)getCircleStatus;	// IMP=0x0000000100037554
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x00000001000374b0
- (void).cxx_destruct;	// IMP=0x00000001000357a8
...
- (void)setHSA2iCloudAccountStatus:(long long)arg1;	// IMP=0x000000010003555c
- (void)triggerOctagonStatusFetch;	// IMP=0x0000000100035380
- (id)checkForAllDeliveries;	// IMP=0x0000000100035260
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x0000000100035220
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x0000000100035210
- (_Bool)notifyCKAccountStatusChangeAndWait:(unsigned long long)arg1;	// IMP=0x00000001000351ac
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x0000000100035068
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0000000100034ecc
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0000000100034bd0
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x0000000100034a44
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x0000000100034838
- (id)notifyCircleChange:(id)arg1;	// IMP=0x0000000100034730
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x0000000100034594
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x000000010003446c
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x0000000100034378
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x00000001000341c4
- (void)dealloc;	// IMP=0x0000000100034148
- (void)performInitialDispatches;	// IMP=0x00000001000340b8
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x0000000100033cdc
