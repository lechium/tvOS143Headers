...
+ (id)itemTypeForVersion:(int)arg1;	// IMP=0x00000001000423ec
+ (id)itemType;	// IMP=0x00000001000423e4
- (void).cxx_destruct;	// IMP=0x000000010004239c
...
- (id)managedItemTypeWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000421a0
@property(readonly, copy) NSArray *syncableKeys;
@property(readonly, copy) NSArray *primaryKeys;
- (id)debugDescription;	// IMP=0x00000001000420dc
- (id)description;	// IMP=0x0000000100042098
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100041fa4
- (id)_initWithName:(id)arg1 version:(int)arg2 primaryKeys:(id)arg3 syncableKeys:(id)arg4;	// IMP=0x0000000100041e80
