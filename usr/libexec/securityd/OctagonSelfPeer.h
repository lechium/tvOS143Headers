...
- (void).cxx_destruct;	// IMP=0x000000010004276c
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x000000010004268c
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x00000001000423f8
