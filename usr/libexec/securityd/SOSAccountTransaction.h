...
- (void).cxx_destruct;	// IMP=0x00000001001a50b0
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x00000001001a4f24
- (void)requestSyncWith:(id)arg1;	// IMP=0x00000001001a4e5c
- (void)finish;	// IMP=0x00000001001a3618
- (void)restart;	// IMP=0x00000001001a35e4
- (void)start;	// IMP=0x00000001001a31bc
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00000001001a3128
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x00000001001a2e58
- (unsigned long long)currentTrustBitmask;	// IMP=0x00000001001a2d50
