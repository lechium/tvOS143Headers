...
- (void).cxx_destruct;	// IMP=0x000000010018cfc4
...
- (void)groupStart;	// IMP=0x000000010018ccf0
- (id)init:(id)arg1 contextID:(id)arg2 reason:(long long)arg3 intendedState:(id)arg4 errorState:(id)arg5 cuttlefishXPCWrapper:(id)arg6;	// IMP=0x000000010018cb94
