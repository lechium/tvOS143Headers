...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001737fc
- (void).cxx_destruct;	// IMP=0x00000001001737cc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001735f4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010017348c
- (id)description;	// IMP=0x0000000100173344
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6;	// IMP=0x0000000100173270
