...
- (void)performWithStatus:(int)arg1;	// IMP=0x0000000100026fc4
- (void)groupStart;	// IMP=0x0000000100026f7c
- (id)initWithDependencies:(id)arg1 intendedViewStatus:(int)arg2 intendedState:(id)arg3 peerMissingState:(id)arg4 errorState:(id)arg5;	// IMP=0x0000000100026e50
