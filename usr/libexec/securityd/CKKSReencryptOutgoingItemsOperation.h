...
- (void).cxx_destruct;	// IMP=0x0000000100164174
...
- (void)main;	// IMP=0x000000010016400c
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intendedState:(id)arg3 errorState:(id)arg4;	// IMP=0x0000000100163e54
- (id)init;	// IMP=0x0000000100163e3c
