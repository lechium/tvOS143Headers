...
- (void).cxx_destruct;	// IMP=0x00000001000af394
...
- (void)resetViews:(id)arg1;	// IMP=0x00000001000aef1c
- (void)proceedWithKeys:(id)arg1 incompleteKeySets:(id)arg2 pendingTLKShares:(id)arg3;	// IMP=0x00000001000aea70
- (void)groupStart;	// IMP=0x00000001000ae7ac
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x00000001000ae6c4
