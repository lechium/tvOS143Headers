...
- (void)afterAuthKitFetch:(id)arg1 accountIsDemo:(_Bool)arg2;	// IMP=0x00000001000764e0
- (void)fetchCurrentDeviceListAfterCuttlefishUpdate:(_Bool)arg1;	// IMP=0x00000001000762c0
- (void)groupStart;	// IMP=0x0000000100075f74
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 listUpdatesState:(id)arg3 errorState:(id)arg4 retryFlag:(id)arg5;	// IMP=0x0000000100075e2c
