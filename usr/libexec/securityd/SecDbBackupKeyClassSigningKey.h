...
- (void).cxx_destruct;	// IMP=0x000000010009aaa0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010009a928
- (unsigned long long)hash;	// IMP=0x000000010009a86c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010009a708
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010009a5dc
- (void)copyTo:(id)arg1;	// IMP=0x000000010009a504
- (void)writeTo:(id)arg1;	// IMP=0x000000010009a440
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010009a17c
- (id)dictionaryRepresentation;	// IMP=0x000000010009a044
- (id)description;	// IMP=0x0000000100099f90
