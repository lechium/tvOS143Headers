...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100173dcc
- (void).cxx_destruct;	// IMP=0x0000000100173d84
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100173c04
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100173a04
- (id)description;	// IMP=0x0000000100173900
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 viewList:(id)arg4;	// IMP=0x0000000100173804
