...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100039984
- (void).cxx_destruct;	// IMP=0x0000000100039948
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000398a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100039640
- (id)initWithCiphertext:(id)arg1 wrappedKeyData:(id)arg2 refKeyBlob:(id)arg3;	// IMP=0x0000000100039550
