...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000b1d5c
- (void).cxx_destruct;	// IMP=0x00000001000b1d2c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000b1c20
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000b1b68
