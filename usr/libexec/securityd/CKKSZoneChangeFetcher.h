...
- (void).cxx_destruct;	// IMP=0x000000010017c4c4
...
- (void)cancel;	// IMP=0x000000010017c340
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x000000010017c334
- (id)createSuccesfulFetchDependency;	// IMP=0x000000010017c2c8
- (void)_onqueueCreateNewFetch;	// IMP=0x000000010017bb44
- (void)maybeCreateNewFetch;	// IMP=0x000000010017bac8
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x000000010017b938
- (id)inflightFetch;	// IMP=0x000000010017b844
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x000000010017b71c
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x000000010017b43c
- (void)notifyZoneChange:(id)arg1;	// IMP=0x000000010017b344
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x000000010017b2dc
- (id)clients;	// IMP=0x000000010017b110
- (void)registerClient:(id)arg1;	// IMP=0x000000010017b034
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x000000010017aba4
