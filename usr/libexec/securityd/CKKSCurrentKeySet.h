...
+ (id)loadForZone:(id)arg1;	// IMP=0x000000010008de0c
- (void).cxx_destruct;	// IMP=0x000000010008dd7c
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x000000010008da20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008d784
- (id)description;	// IMP=0x000000010008d4f8
- (id)initForZoneName:(id)arg1;	// IMP=0x000000010008d480
