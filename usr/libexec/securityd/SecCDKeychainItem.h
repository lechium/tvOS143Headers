...
- (void).cxx_destruct;	// IMP=0x0000000100040550
...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x000000010004000c
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x000000010003f978
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x000000010003f5a0
- (id)primaryKeys;	// IMP=0x000000010003f590
...
- (id)description;	// IMP=0x000000010003f3bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003f2cc
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x000000010003efc4
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x000000010003ee5c
