...
+ (id)lookupTupleWithManagedLookupEntry:(id)arg1;	// IMP=0x000000010003e4d0
+ (id)lookupTupleWithKey:(id)arg1 value:(id)arg2;	// IMP=0x000000010003e45c
- (void).cxx_destruct;	// IMP=0x000000010003e420
...
- (id)description;	// IMP=0x000000010003e2dc
- (unsigned long long)hash;	// IMP=0x000000010003e280
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003e170
- (id)initWithKey:(id)arg1 value:(id)arg2;	// IMP=0x000000010003dfcc
