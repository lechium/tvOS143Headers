...
- (void).cxx_destruct;	// IMP=0x00000001000ee094
...
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00000001000eda58
- (void)setWatcherTimeout:(unsigned long long)arg1;	// IMP=0x00000001000eda4c
- (void)doSimpleStateMachineRPC:(id)arg1 op:(id)arg2 sourceStates:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00000001000ed6d8
- (void)registerMultiStateArrivalWatcher:(id)arg1;	// IMP=0x00000001000ed628
- (void)registerStateTransitionWatcher:(id)arg1;	// IMP=0x00000001000ed578
- (void)handleExternalRequest:(id)arg1;	// IMP=0x00000001000ed4c8
- (void)haltOperation;	// IMP=0x00000001000ed41c
- (void)startOperation;	// IMP=0x00000001000ed3a0
- (_Bool)isPaused;	// IMP=0x00000001000ed2d0
- (void)_onqueueSendAnyPendingFlags;	// IMP=0x00000001000ecb30
- (void)_onqueueRecheckConditions;	// IMP=0x00000001000ec6c8
- (id)possiblePendingFlags;	// IMP=0x00000001000ec674
- (id)dumpPendingFlags;	// IMP=0x00000001000ec558
- (void)disablePendingFlags;	// IMP=0x00000001000ec4dc
- (void)_onqueueHandlePendingFlag:(id)arg1;	// IMP=0x00000001000ec258
- (void)handlePendingFlag:(id)arg1;	// IMP=0x00000001000ec1a8
- (void)_onqueueHandleFlag:(id)arg1;	// IMP=0x00000001000ec104
- (void)handleFlag:(id)arg1;	// IMP=0x00000001000ec054
- (void)_onqueuePokeStateMachine;	// IMP=0x00000001000ec004
- (void)pokeStateMachine;	// IMP=0x00000001000ebf88
- (id)createOperationToFinishAttempt:(id)arg1;	// IMP=0x00000001000ebe10
- (void)_onqueueStartNextStateMachineOperation:(_Bool)arg1;	// IMP=0x00000001000eba34
- (id)_onqueueNextStateMachineTransition;	// IMP=0x00000001000eb62c
- (id)waitForState:(id)arg1 wait:(unsigned long long)arg2;	// IMP=0x00000001000eb574
@property(retain) NSString<OctagonStateString> *currentState;
@property(readonly) id <OctagonFlagContainer> flags;
- (id)description;	// IMP=0x00000001000eb248
- (id)pendingFlagsString;	// IMP=0x00000001000eb1c4
- (id)initWithName:(id)arg1 states:(id)arg2 flags:(id)arg3 initialState:(id)arg4 queue:(id)arg5 stateEngine:(id)arg6 lockStateTracker:(id)arg7;	// IMP=0x00000001000eac80
