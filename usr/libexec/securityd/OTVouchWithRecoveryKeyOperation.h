...
- (void).cxx_destruct;	// IMP=0x00000001000c784c
...
- (void)proceedWithKeys:(id)arg1 tlkShares:(id)arg2 salt:(id)arg3;	// IMP=0x00000001000c74f8
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00000001000c732c
- (void)groupStart;	// IMP=0x00000001000c6dbc
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00000001000c6c90
