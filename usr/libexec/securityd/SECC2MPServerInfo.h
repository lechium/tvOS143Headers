...
- (void).cxx_destruct;	// IMP=0x0000000100184b54
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100184a18
- (unsigned long long)hash;	// IMP=0x000000010018498c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100184860
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100184760
- (void)copyTo:(id)arg1;	// IMP=0x00000001001846b4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100184618
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100184610
- (id)dictionaryRepresentation;	// IMP=0x0000000100184534
- (id)description;	// IMP=0x0000000100184480
