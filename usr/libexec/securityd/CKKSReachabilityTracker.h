...
+ (_Bool)isNetworkFailureError:(id)arg1;	// IMP=0x00000001000e514c
+ (_Bool)isNetworkError:(id)arg1;	// IMP=0x00000001000e5010
- (void).cxx_destruct;	// IMP=0x00000001000e4c88
...
- (_Bool)isNetworkError:(id)arg1;	// IMP=0x00000001000e4bfc
- (void)setNetworkReachability:(_Bool)arg1;	// IMP=0x00000001000e4b70
- (void)_onqueueSetNetworkReachability:(_Bool)arg1;	// IMP=0x00000001000e4aa4
- (void)_onQueueResetReachabilityDependency;	// IMP=0x00000001000e476c
- (void)_onQueueRunReachabilityDependency;	// IMP=0x00000001000e4624
@property(readonly) _Bool currentReachability;
- (id)description;	// IMP=0x00000001000e44ec
- (id)init;	// IMP=0x00000001000e42cc
