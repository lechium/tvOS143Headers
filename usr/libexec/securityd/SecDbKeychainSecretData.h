...
- (void).cxx_destruct;	// IMP=0x00000001000e1830
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e1540
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 backupWrappedKey:(id)arg4 error:(id *)arg5;	// IMP=0x00000001000e12d8
