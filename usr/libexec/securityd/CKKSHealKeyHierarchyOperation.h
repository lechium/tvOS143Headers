...
- (void).cxx_destruct;	// IMP=0x0000000100081bf8
...
- (void)cancel;	// IMP=0x0000000100081aec
- (_Bool)ensureKeyPresent:(id)arg1;	// IMP=0x0000000100081608
- (void)groupStart;	// IMP=0x0000000100081384
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x0000000100081270
- (id)init;	// IMP=0x0000000100081258
