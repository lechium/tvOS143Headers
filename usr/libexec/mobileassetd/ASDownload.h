...
+ (id)downloadWithAsset:(struct __MobileAsset *)arg1 downloadDelegate:(id)arg2 assetRepository:(id)arg3;	// IMP=0x000000010002644c
+ (id)downloadWithAsset:(struct __MobileAsset *)arg1 downloadOptions:(id)arg2 downloadDelegate:(id)arg3 assetRepository:(id)arg4;	// IMP=0x00000001000263fc
+ (id)downloadsDict;	// IMP=0x0000000100026398
+ (id)downloadsDictQueue;	// IMP=0x0000000100026330
+ (void)setContentCacheURLs:(id)arg1;	// IMP=0x0000000100026288
...
- (id)downloadRequestForURL:(id)arg1 useQueuingService:(_Bool)arg2 error:(id *)arg3;	// IMP=0x000000010002b79c
@property(readonly, nonatomic, getter=isStalled) _Bool stalled;
- (void)usePreinstalledAssetArchive:(id)arg1;	// IMP=0x000000010002b61c
- (void)logDownload:(_Bool)arg1;	// IMP=0x000000010002b57c
- (int)verifyArchiveHash;	// IMP=0x000000010002b25c
- (void)notifyResumeClients:(int)arg1;	// IMP=0x000000010002b1d0
- (void)notifyPauseClients:(int)arg1;	// IMP=0x000000010002b0cc
- (void)notifyCancelClients:(int)arg1;	// IMP=0x000000010002b070
- (_Bool)verifyFreeDiskSpace:(long long)arg1 error:(id *)arg2;	// IMP=0x000000010002aef4
- (void)fireErrorWithError:(id)arg1;	// IMP=0x000000010002adac
- (void)fireErrorInDomain:(id)arg1 errorCode:(long long)arg2 userInfo:(id)arg3;	// IMP=0x000000010002ad6c
- (void)fireProgressWithOperation:(id)arg1 progress:(float)arg2 callbackState:(id)arg3;	// IMP=0x000000010002ac60
- (void)resetProgressWithOperation:(id)arg1;	// IMP=0x000000010002ac30
- (void)downloadDidFail:(id)arg1;	// IMP=0x000000010002ab64
- (void)_downloadDidFail:(id)arg1;	// IMP=0x000000010002a7bc
- (void)_retryDownloadWithoutNowServing;	// IMP=0x000000010002a5a0
- (void)_retryDownloadAfterInterval:(id)arg1 withQueueToken:(id)arg2;	// IMP=0x000000010002a368
- (void)downloadDidFinish;	// IMP=0x0000000100029548
- (void)cancel:(CDUnknownBlockType)arg1;	// IMP=0x00000001000294dc
- (void)_cancel:(CDUnknownBlockType)arg1;	// IMP=0x000000010002903c
- (void)cancellationDidFinish:(int)arg1;	// IMP=0x0000000100029020
- (void)resume:(CDUnknownBlockType)arg1;	// IMP=0x0000000100028fb4
- (void)_resume:(CDUnknownBlockType)arg1;	// IMP=0x0000000100028c34
- (void)resumeDidFinish:(int)arg1;	// IMP=0x0000000100028a58
- (void)waitForUnpause;	// IMP=0x0000000100028990
- (void)pause:(CDUnknownBlockType)arg1;	// IMP=0x0000000100028924
- (void)_pause:(CDUnknownBlockType)arg1;	// IMP=0x00000001000285c0
- (void)pauseDidFinish:(int)arg1;	// IMP=0x00000001000283dc
- (int)resumeAfterDownload;	// IMP=0x0000000100028360
- (void)stopObservingDownload;	// IMP=0x0000000100028230
- (void)updateOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100027ecc
- (void)_saveDownloadOptions;	// IMP=0x0000000100027d80
- (void)startBackgroundedDownload:(CDUnknownBlockType)arg1;	// IMP=0x0000000100027b68
- (void)_startDownload:(CDUnknownBlockType)arg1;	// IMP=0x00000001000270f4
- (void)_handleFileURLDownload;	// IMP=0x0000000100026ef4
- (void)startDownload:(CDUnknownBlockType)arg1;	// IMP=0x0000000100026e64
- (int)populateURLs;	// IMP=0x0000000100026d94
- (void)_populatelocalCacheServerURL;	// IMP=0x0000000100026ae0
@property(readonly, nonatomic) NSDictionary *assetAttributes;
- (id)assetType;	// IMP=0x0000000100026aa8
@property(readonly, nonatomic) _Bool useStreamingZip;
- (_Bool)boolDownloadOption:(id)arg1 default:(_Bool)arg2;	// IMP=0x0000000100026978
- (id)downloadOption:(id)arg1;	// IMP=0x0000000100026900
- (void)setDownloadOptionsOnQueue:(id)arg1;	// IMP=0x0000000100026894
- (void)dealloc;	// IMP=0x000000010002672c
- (id)initWithAsset:(struct __MobileAsset *)arg1 downloadDelegate:(id)arg2 assetRepository:(id)arg3;	// IMP=0x000000010002665c
