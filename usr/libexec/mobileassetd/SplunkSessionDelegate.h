...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100020d64
- (void)dealloc;	// IMP=0x0000000100020d30
- (id)initWithDownloadManager:(id)arg1;	// IMP=0x0000000100020ce8
