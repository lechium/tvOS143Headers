...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010001164c
...
- (void)logOptions;	// IMP=0x0000000100011da0
- (id)description;	// IMP=0x0000000100011c64
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100011a1c
- (void)dealloc;	// IMP=0x00000001000119cc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000116b4
