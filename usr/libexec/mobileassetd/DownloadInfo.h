...
- (id)description;	// IMP=0x0000000100015494
- (id)_taskState;	// IMP=0x00000001000153c4
- (void)clearCacheServerUrl;	// IMP=0x000000010001539c
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x0000000100015384
- (double)currentEstimate;	// IMP=0x00000001000151f4
- (void)updateDownloadData:(long long)arg1;	// IMP=0x0000000100015134
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x0000000100014fd0
- (void)dealloc;	// IMP=0x0000000100014f38
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0000000100014d44
- (id)initWithUrl:(id)arg1 options:(id)arg2;	// IMP=0x0000000100014c8c
