...
- (_Bool)verifyResponse:(id)arg1 signature:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000072fc
- (_Bool)verifyCerts:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100006f4c
- (_Bool)determineAlg:(id)arg1;	// IMP=0x0000000100006ecc
- (id)init;	// IMP=0x0000000100006e90
