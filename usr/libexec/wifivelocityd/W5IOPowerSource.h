...
- (int)batteryWarningLevel;	// IMP=0x0000000100019888
- (long long)powerSourceType;	// IMP=0x0000000100019750
- (double)estimatedTimeRemaining;	// IMP=0x000000010001968c
- (double)internalBatteryLevel;	// IMP=0x000000010001952c
- (void)stopEventMonitoring;	// IMP=0x000000010001947c
- (void)startEventMonitoring;	// IMP=0x0000000100018e90
- (void)dealloc;	// IMP=0x0000000100018e34
- (id)init;	// IMP=0x0000000100018bfc
