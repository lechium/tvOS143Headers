...
- (void)resumeMonitoringAfterDelay:(double)arg1;	// IMP=0x0000000100018ac0
- (void)pauseMonitoring;	// IMP=0x0000000100018a18
- (void)stopMonitoring;	// IMP=0x000000010001896c
- (void)startMonitoring;	// IMP=0x00000001000188bc
- (id)__followupTests;	// IMP=0x0000000100018788
- (id)__initialTests;	// IMP=0x000000010001866c
- (void)__runDiagnosticsTests:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000010001834c
- (void)dealloc;	// IMP=0x00000001000181f8
- (id)init;	// IMP=0x00000001000181c0
- (id)initWithStatusManager:(id)arg1 diagnosticsManager:(id)arg2;	// IMP=0x0000000100017b5c
