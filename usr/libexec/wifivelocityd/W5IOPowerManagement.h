...
- (unsigned int)caps;	// IMP=0x0000000100061b60
- (void)stopEventMonitoring;	// IMP=0x0000000100061abc
- (void)startEventMonitoring;	// IMP=0x0000000100061824
- (void)dealloc;	// IMP=0x00000001000617d0
- (id)init;	// IMP=0x0000000100061674
