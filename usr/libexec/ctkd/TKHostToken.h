...
+ (id)keychainItemClasses;	// IMP=0x00000001000030c0
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100002800
- (void).cxx_destruct;	// IMP=0x0000000100003548
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000336c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100003210
- (id)connectionWithError:(id *)arg1;	// IMP=0x0000000100002a30
- (id)description;	// IMP=0x0000000100002930
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2 automatic:(_Bool)arg3;	// IMP=0x0000000100002808
