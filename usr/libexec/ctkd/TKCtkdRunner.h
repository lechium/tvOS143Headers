...
- (void)run;	// IMP=0x00000001000039a8
- (void)ensureSlotWatcherIsRunning;	// IMP=0x0000000100003928
- (id)initWithArgc:(int)arg1 argv:(const char **)arg2;	// IMP=0x00000001000036ec
...
- (void)initializeSandBox;	// IMP=0x00000001000035bc
