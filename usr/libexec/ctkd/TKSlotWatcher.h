...
- (void).cxx_destruct;	// IMP=0x000000010000b4c8
@property(readonly, nonatomic) TKHostTokenRegistry *registry; // @synthesize registry=_registry;
- (void)stop;	// IMP=0x000000010000b2ac
- (void)removeSlotWatch:(id)arg1;	// IMP=0x000000010000b160
- (void)setSlotWithName:(id)arg1 endpoint:(id)arg2 type:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x000000010000afb0
- (void)startWithSlotServer:(id)arg1;	// IMP=0x000000010000acec
@property(readonly) _Bool hasStarted;
- (id)initWithTokenRegistry:(id)arg1;	// IMP=0x000000010000ac28
