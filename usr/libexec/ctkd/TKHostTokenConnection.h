...
- (void).cxx_destruct;	// IMP=0x00000001000027f4
@property(readonly, nonatomic) TKHostToken *token; // @synthesize token=_token;
- (void)dealloc;	// IMP=0x0000000100002644
@property(readonly, nonatomic) NSString *slotName;
@property(readonly, nonatomic) NSXPCListenerEndpoint *endpoint;
- (id)initWithDriver:(id)arg1 slot:(id)arg2 AID:(id)arg3 registry:(id)arg4 error:(id *)arg5;	// IMP=0x000000010000234c
- (id)initWithToken:(id)arg1;	// IMP=0x00000001000022b0
