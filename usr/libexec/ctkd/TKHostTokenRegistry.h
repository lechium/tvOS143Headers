...
+ (id)bundleIdentifierFromAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x0000000100004520
...
- (void)registerClassIDs:(id)arg1;	// IMP=0x0000000100007488
- (id)reloadTokensFromStore;	// IMP=0x0000000100006624
- (void)loadTokensFromStore:(id)arg1;	// IMP=0x0000000100005ef0
- (void)failedToken:(id)arg1;	// IMP=0x0000000100005d20
- (void)disconnectedToken:(id)arg1;	// IMP=0x0000000100005a44
- (void)connectedToken:(id)arg1 notifyAddedToken:(_Bool)arg2;	// IMP=0x00000001000057a0
- (id)createTokenWithTokenID:(id)arg1 persistent:(_Bool)arg2;	// IMP=0x000000010000550c
- (void)notifyTokenReinsertion:(id)arg1;	// IMP=0x0000000100005408
- (void)removeTokenWithTokenID:(id)arg1;	// IMP=0x0000000100005178
- (id)tokenWithTokenID:(id)arg1;	// IMP=0x0000000100005000
- (void)commitTransaction;	// IMP=0x0000000100004bd0
- (void)markModified;	// IMP=0x0000000100004b98
@property(readonly, nonatomic) NSDictionary *tokenExtensions;
- (id)beginTransaction;	// IMP=0x0000000100004a68
@property(readonly, nonatomic) NSArray *tokens;
- (void)dealloc;	// IMP=0x00000001000049ac
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000100004844
- (id)initWithDriverCache:(id)arg1 listener:(id)arg2 keychain:(id)arg3;	// IMP=0x000000010000435c
