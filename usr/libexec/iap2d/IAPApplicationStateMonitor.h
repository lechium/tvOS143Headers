...
- (void).cxx_destruct;	// IMP=0x00000001000339f4
...
- (id)applicationInfoForPIDSync:(int)arg1;	// IMP=0x0000000100033818
- (id)applicationInfoForBundleIDSync:(id)arg1;	// IMP=0x0000000100033808
- (void)layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x0000000100033530
- (void)stopObserving;	// IMP=0x0000000100033420
- (void)startObserving;	// IMP=0x0000000100032f7c
- (void)dealloc;	// IMP=0x0000000100032ef8
- (id)init;	// IMP=0x0000000100032e84
- (void)sharedInit;	// IMP=0x0000000100032dd8
