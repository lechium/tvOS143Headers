...
+ (void)resetSessionIDCounter;	// IMP=0x000000010006b190
...
- (id)description;	// IMP=0x000000010006b2ec
- (int)_createListenSocket;	// IMP=0x000000010006b19c
- (_Bool)closeDataPipes;	// IMP=0x000000010006b148
- (void)_openPipeFromApp;	// IMP=0x000000010006b144
- (_Bool)openPipeFromApp;	// IMP=0x000000010006b110
- (void)_openPipeToApp;	// IMP=0x000000010006b10c
- (_Bool)openPipeToApp;	// IMP=0x000000010006b0d8
- (void)dealloc;	// IMP=0x000000010006b084
- (void)shuttingDownSession;	// IMP=0x000000010006aefc
- (id)initWithClient:(id)arg1 connection:(id)arg2 protocolID:(unsigned char)arg3 sessionID:(unsigned short *)arg4;	// IMP=0x000000010006ab88
- (id)init;	// IMP=0x000000010006ab50
