...
+ (unsigned int)sampleRateMaskFromEnum:(int)arg1;	// IMP=0x000000010002d468
+ (unsigned int)sampleRateValueFromEnum:(int)arg1;	// IMP=0x000000010002d410
+ (int)sampleRateEnumFromValue:(unsigned int)arg1;	// IMP=0x000000010002d2f8
...
- (unsigned char)getMode;	// IMP=0x000000010002d48c
- (void)setMode:(unsigned char)arg1;	// IMP=0x000000010002d47c
- (_Bool)isSampleRateBitSet:(int)arg1;	// IMP=0x000000010002d2e0
- (void)setSampleRateBit:(int)arg1;	// IMP=0x000000010002d2b8
- (void)dealloc;	// IMP=0x000000010002d1e4
- (id)init;	// IMP=0x000000010002d0fc
