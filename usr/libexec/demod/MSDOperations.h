...
- (_Bool)restoreAllAttributesFromManifest;	// IMP=0x000000010002f054
- (_Bool)processAlreadyHaveList:(id)arg1;	// IMP=0x000000010002e6b8
- (_Bool)downloadAndVerifyFile:(id)arg1 to:(id)arg2 withError:(id *)arg3;	// IMP=0x000000010002e1b8
- (_Bool)downloadCreationList:(id)arg1;	// IMP=0x000000010002d77c
- (_Bool)processCreationList:(id)arg1;	// IMP=0x000000010002c1bc
- (_Bool)verify;	// IMP=0x000000010002ba30
- (_Bool)process:(id *)arg1;	// IMP=0x000000010002b5c0
- (id)initWithMasterManifest:(id)arg1 andDeviceManifest:(id)arg2 forSection:(id)arg3;	// IMP=0x000000010002aec8
