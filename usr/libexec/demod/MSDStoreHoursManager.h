...
+ (id)sharedInstance;	// IMP=0x0000000100026860
- (void).cxx_destruct;	// IMP=0x0000000100028650
...
- (void)storeHourSettingsExpirationHandler:(id)arg1;	// IMP=0x00000001000284f4
- (void)setupStoreHourSettingsExpirationTimer:(id)arg1;	// IMP=0x00000001000281a0
- (void)populateStoreHourFromHubSuppliedSettingsForDate:(id)arg1;	// IMP=0x0000000100027dec
- (void)populateStoreHourFromDefaultSettingsForDate:(id)arg1;	// IMP=0x0000000100027a60
- (id)parseRawStoreHours:(id)arg1;	// IMP=0x00000001000274b4
- (void)evaluateStoreStatusAgainstPointInTime:(id)arg1;	// IMP=0x0000000100026f64
- (void)evaluateStoreStatusAgainstCurrentTime;	// IMP=0x0000000100026f10
- (void)updateStoreHours:(id)arg1 lastSettingsUpdatedDate:(id)arg2;	// IMP=0x0000000100026b14
- (id)init;	// IMP=0x00000001000268cc
