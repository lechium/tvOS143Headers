...
- (void).cxx_destruct;	// IMP=0x000000010004b404
...
- (void)coordinator:(id)arg1 canceledWithReason:(id)arg2 client:(unsigned long long)arg3;	// IMP=0x000000010004b264
- (void)coordinatorDidCompleteSuccessfully:(id)arg1;	// IMP=0x000000010004b218
