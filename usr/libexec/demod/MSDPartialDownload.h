...
- (void).cxx_destruct;	// IMP=0x000000010000deb8
...
- (void)pushToTestLog:(id)arg1;	// IMP=0x000000010000dd2c
- (id)description;	// IMP=0x000000010000dc9c
- (void)appendDownloadedFileSize:(long long)arg1;	// IMP=0x000000010000db9c
- (void)processServerRangeResponse:(id)arg1;	// IMP=0x000000010000da6c
- (id)getRangeHeaderForDownload;	// IMP=0x000000010000d884
- (_Bool)isDownloadComplete;	// IMP=0x000000010000d6ec
- (id)init;	// IMP=0x000000010000d6a8
