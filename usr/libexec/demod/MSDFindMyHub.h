...
+ (id)sharedInstance;	// IMP=0x0000000100058d64
- (void).cxx_destruct;	// IMP=0x000000010005a748
...
- (_Bool)compareSavedHubHostsWithNewHosts;	// IMP=0x000000010005a2e4
- (_Bool)compareSavedHubHostNameWithNewHostName;	// IMP=0x000000010005a050
- (_Bool)enrollAndSetup:(id *)arg1;	// IMP=0x0000000100059cb4
- (_Bool)askFindMyHubForHubInfoAndDeviceOptions;	// IMP=0x00000001000591d4
- (unsigned long long)queryFindMyHubAndDetermineLogicSyncResult;	// IMP=0x0000000100058ed4
- (_Bool)discoverAndEnrollWithHub:(id *)arg1;	// IMP=0x0000000100058e14
