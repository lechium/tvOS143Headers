...
+ (id)sharedInstance;	// IMP=0x00000001000375d0
- (void).cxx_destruct;	// IMP=0x000000010003b29c
...
- (void)setAutomatedDeviceGroupStoreID;	// IMP=0x000000010003ae0c
- (void)setMacSpecificSettings;	// IMP=0x000000010003ae08
- (void)setTVSpecificSettings;	// IMP=0x000000010003acd8
- (_Bool)migrateDataWithBlockingUI:(int)arg1;	// IMP=0x000000010003a86c
- (_Bool)PLHasCompletedMomentAnalysis;	// IMP=0x000000010003a7c0
- (_Bool)PLHasCompletedRestorePostProcessing;	// IMP=0x000000010003a714
- (_Bool)removeLowerPriorityAppsTillFreeSpace:(long long)arg1;	// IMP=0x000000010003a224
- (void)loadInstallationOrder:(id)arg1;	// IMP=0x0000000100039e54
- (void)checkWithTimeKeeper:(id)arg1;	// IMP=0x0000000100039c58
- (_Bool)continueToUpdateDemoContentWithServer:(id)arg1;	// IMP=0x0000000100039a28
- (_Bool)updateDemoContentWithServer:(id)arg1;	// IMP=0x0000000100038018
- (_Bool)enrollWithServer:(id)arg1 name:(id)arg2 pairingCredential:(id)arg3 error:(id *)arg4;	// IMP=0x000000010003795c
- (_Bool)enrolledWith:(id)arg1;	// IMP=0x0000000100037850
- (void)getDemoUpdateInProgress:(_Bool *)arg1 operationAllowed:(_Bool *)arg2;	// IMP=0x00000001000377ac
- (id)init;	// IMP=0x000000010003763c
