...
+ (id)sharedInstance;	// IMP=0x000000010006d6d8
- (void).cxx_destruct;	// IMP=0x00000001000704a8
...
- (_Bool)checkFileForEntitlements:(id)arg1 forCorrespondingManifestEntry:(id)arg2;	// IMP=0x000000010006fe80
- (void)registerEntitlementNotificationHandler;	// IMP=0x000000010006fc6c
- (_Bool)runAppLayoutSecurityCheck:(id)arg1;	// IMP=0x000000010006f29c
- (_Bool)runSecurityChecksForSection:(id)arg1 dataType:(id)arg2;	// IMP=0x000000010006e7c4
- (_Bool)runSecurityCheck;	// IMP=0x000000010006dcf8
- (_Bool)secureManifestCheckForSegmentedManifest:(id)arg1;	// IMP=0x000000010006dba0
- (id)init;	// IMP=0x000000010006d744
