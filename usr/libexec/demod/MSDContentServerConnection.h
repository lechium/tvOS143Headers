...
+ (id)contentServerConnection:(id)arg1 port:(id)arg2;	// IMP=0x0000000100052264
- (void).cxx_destruct;	// IMP=0x0000000100055b94
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000001000557d0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000001000553a8
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000550bc
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100054908
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000545a4
- (_Bool)addAuthenticationHeadersToRequest:(id)arg1 withBody:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000542fc
- (void)cancelDownloading;	// IMP=0x0000000100053fa8
- (void)runRunLoopUntilDone;	// IMP=0x0000000100053f6c
- (_Bool)startDownloadingFile;	// IMP=0x000000010005321c
- (void)invalidate;	// IMP=0x00000001000531dc
- (void)enableAuthenticationWithHMACKey:(id)arg1;	// IMP=0x00000001000531d0
- (_Bool)downloadTo:(id)arg1 byPosting:(id)arg2 toPath:(id)arg3 retry:(int)arg4 error:(id *)arg5;	// IMP=0x0000000100052ee0
- (id)postDataForEnrolment:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x0000000100052df0
- (id)postData:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x0000000100052c8c
- (_Bool)downloadFile:(id)arg1 to:(id)arg2 retry:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100052824
- (id)downloadFileToNSData:(id)arg1 retry:(long long)arg2 error:(id *)arg3;	// IMP=0x00000001000526e0
- (void)dealloc;	// IMP=0x00000001000525a0
- (void)setupServer:(id)arg1 port:(id)arg2;	// IMP=0x0000000100052528
- (id)initWithCellularAccess:(_Bool)arg1;	// IMP=0x00000001000522f8
