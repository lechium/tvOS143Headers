...
- (void).cxx_destruct;	// IMP=0x0000000100004d28
...
- (void)schedule;	// IMP=0x0000000100004300
- (void)invalidate;	// IMP=0x0000000100004284
- (void)checkIn;	// IMP=0x0000000100004068
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000100003f98
