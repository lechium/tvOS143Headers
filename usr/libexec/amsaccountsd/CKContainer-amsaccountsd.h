...
- (id)_fetchShareMetadataForURL:(id)arg1 withToken:(id)arg2;	// IMP=0x0000000100031b10
- (id)_acceptShareWithShareMetadata:(id)arg1;	// IMP=0x0000000100031940
- (id)acceptShareURL:(id)arg1 withToken:(id)arg2;	// IMP=0x0000000100031848
