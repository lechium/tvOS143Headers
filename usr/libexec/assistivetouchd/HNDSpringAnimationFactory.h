...
+ (id)factoryWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3;	// IMP=0x000000010006a4b8
...
- (id)_animation;	// IMP=0x000000010006a684
- (id)_springAnimation;	// IMP=0x000000010006a5f4
- (void)_calculateDuration;	// IMP=0x000000010006a598
- (id)_initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3;	// IMP=0x000000010006a500
