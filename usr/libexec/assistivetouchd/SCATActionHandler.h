...
- (void).cxx_destruct;	// IMP=0x0000000100078bc0
...
- (void)_resetWithActionSource:(id)arg1;	// IMP=0x0000000100078ad4
- (void)_handleFireAction;	// IMP=0x00000001000789fc
- (_Bool)isPending;	// IMP=0x00000001000789b0
- (void)cancelPendingAction;	// IMP=0x000000010007885c
- (void)notifyDidReceiveAction:(id)arg1;	// IMP=0x0000000100078504
- (_Bool)_shouldHandleSelectActionImmediately;	// IMP=0x0000000100078468
@property(readonly, nonatomic) _Bool shouldShowMenuOnFirstSelectAction;
- (id)initWithAction:(long long)arg1 timeoutDuration:(double)arg2;	// IMP=0x0000000100078354
