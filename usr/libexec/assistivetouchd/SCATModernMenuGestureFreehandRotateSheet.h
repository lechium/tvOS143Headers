...
- (void).cxx_destruct;	// IMP=0x0000000100031e40
...
- (id)menuItemStruts;	// IMP=0x0000000100031cdc
- (_Bool)shouldUpdateItemsOnOrientationChange;	// IMP=0x0000000100031cd4
- (void)didActivateMultipleMenuItemsElement:(id)arg1;	// IMP=0x0000000100031b58
- (void)multipleMenuItemsElement:(id)arg1 didBecomeHighlighted:(_Bool)arg2;	// IMP=0x0000000100031a34
- (void)menuItemWasActivated:(id)arg1;	// IMP=0x000000010003177c
- (void)menuItem:(id)arg1 didBecomeFocused:(_Bool)arg2;	// IMP=0x00000001000315d4
- (id)elementProvider;	// IMP=0x0000000100031098
- (id)makeMenuItemsIfNeeded;	// IMP=0x00000001000307dc
