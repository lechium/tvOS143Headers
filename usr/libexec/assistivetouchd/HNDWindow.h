...
+ (_Bool)_isSecure;	// IMP=0x0000000100011f80
- (void).cxx_destruct;	// IMP=0x0000000100011fbc
@property(nonatomic) __weak id <HNDWindowDelegateProtocol> hitTestDelegate; // @synthesize hitTestDelegate=_hitTestDelegate;
- (_Bool)_alwaysGetsContexts;	// IMP=0x0000000100011f78
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100011f04
