...
+ (id)pointPickerWithMode:(long long)arg1 menu:(id)arg2;	// IMP=0x00000001000bd6b4
+ (id)mostSuitablePointPickerWithMenu:(id)arg1;	// IMP=0x00000001000bd618
- (void).cxx_destruct;	// IMP=0x00000001000bdcac
...
- (void)didFetchElements:(id)arg1 foundNewElements:(_Bool)arg2 currentFocusContext:(id)arg3 didChangeActiveElementManager:(_Bool)arg4;	// IMP=0x00000001000bdb98
- (void)scannerManager:(id)arg1 didActivateElement:(id)arg2;	// IMP=0x00000001000bdb60
- (void)resetRefinedSelectedPoint;	// IMP=0x00000001000bdb50
- (void)refineSelectedPoint;	// IMP=0x00000001000bdaec
- (id)identifier;	// IMP=0x00000001000bdadc
...
- (_Bool)isRefiningPoint;	// IMP=0x00000001000bd95c
- (void)moveToPoint:(struct CGPoint)arg1;	// IMP=0x00000001000bd950
- (void)_savePoint:(struct CGPoint)arg1 andNotifyDelegate:(_Bool)arg2;	// IMP=0x00000001000bd850
- (id)description;	// IMP=0x00000001000bd6f0
- (id)_initWithMenu:(id)arg1;	// IMP=0x00000001000bd6bc
