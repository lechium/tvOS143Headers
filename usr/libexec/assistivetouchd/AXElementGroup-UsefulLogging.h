...
- (id)elemLog;	// IMP=0x000000010002e774
@property(nonatomic) _Bool scatAssistiveTechFocused;
- (void)prepareElementsForScanning:(id)arg1;	// IMP=0x00000001000a39d4
...
- (void)scatScrollToVisible;	// IMP=0x00000001000a37a0
@property(readonly, nonatomic) _Bool scatIsValid;
@property(readonly, nonatomic) NSString *scatSpeakableDescription;
- (id)scatSpeakableDescription:(_Bool)arg1;	// IMP=0x00000001000a3468
@property(readonly, nonatomic) struct CGRect scatFrame;
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x00000001000a33f4
- (id)scrollableElement;	// IMP=0x00000001000a337c
...
- (id)scatSupportedGestures;	// IMP=0x00000001000a30d0
@property(readonly, nonatomic) struct CGPath *scatPath;
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x00000001000a30c0
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00000001000a30b8
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00000001000a30b0
