...
- (void).cxx_destruct;	// IMP=0x00000001000888f4
...
- (void)_didReceiveActionWithIdentifier:(long long)arg1 start:(_Bool)arg2 ignoreInputHold:(_Bool)arg3;	// IMP=0x0000000100088774
- (void)handleReceivedSwitchEvent:(id)arg1 deviceName:(id)arg2;	// IMP=0x000000010008833c
- (id)_resolveSwitchForSwitchEvent:(id)arg1 deviceName:(id)arg2;	// IMP=0x0000000100087cec
- (void)_getActionIdentifier:(long long *)arg1 longPressActionIdentifier:(long long *)arg2 forSwitchEvent:(id)arg3;	// IMP=0x0000000100087aa8
- (void)updateWithSwitches:(id)arg1 recipe:(id)arg2;	// IMP=0x00000001000877b4
- (void)setDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x000000010008774c
