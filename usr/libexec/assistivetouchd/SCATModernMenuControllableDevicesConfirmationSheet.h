...
- (void).cxx_destruct;	// IMP=0x00000001000566b8
...
- (void)viewControllerViewWillDisappear:(_Bool)arg1;	// IMP=0x00000001000565b8
- (_Bool)shouldKeepScannerAwake;	// IMP=0x00000001000565b0
- (void)menuItemWasActivated:(id)arg1;	// IMP=0x0000000100056480
- (id)makeMenuItemsIfNeeded;	// IMP=0x0000000100056390
- (id)initWithMenu:(id)arg1 interDeviceSearchResult:(id)arg2;	// IMP=0x00000001000562f8
