...
- (void).cxx_destruct;	// IMP=0x0000000100034f18
...
- (void)didExitMenuFromSheet:(id)arg1;	// IMP=0x0000000100034dec
- (void)didConfirmForSheet:(id)arg1;	// IMP=0x0000000100034cf4
- (void)didUpdateSearchResults;	// IMP=0x0000000100034a50
- (_Bool)shouldKeepScannerAwake;	// IMP=0x0000000100034a48
- (void)viewControllerViewWillDisappear:(_Bool)arg1;	// IMP=0x000000010003495c
- (void)viewControllerViewWillAppear:(_Bool)arg1;	// IMP=0x000000010003486c
- (void)menuItemWasActivated:(id)arg1;	// IMP=0x0000000100034658
- (id)makeMenuItemsIfNeeded;	// IMP=0x000000010003440c
- (void)dealloc;	// IMP=0x00000001000343b0
- (id)initWithMenu:(id)arg1 interDeviceCommunicator:(id)arg2;	// IMP=0x0000000100034300
