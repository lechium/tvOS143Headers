...
- (void).cxx_destruct;	// IMP=0x0000000100073c08
...
- (id)focusContextAfterDrillOutOnGroup:(id)arg1;	// IMP=0x0000000100073918
- (id)nextFocusContextAfterActivatingKeyboardElement:(id)arg1;	// IMP=0x000000010007364c
- (id)nextFocusContextAfterDismissingMenuForElement:(id)arg1;	// IMP=0x00000001000732bc
- (void)scannerManager:(id)arg1 didActivateElement:(id)arg2;	// IMP=0x0000000100072f0c
- (id)_replacementForLastFocusedKeyboardItem;	// IMP=0x0000000100072d3c
- (void)_trackLastFocusedKeyboardItem:(id)arg1;	// IMP=0x0000000100072948
- (id)_keyboardElementForIndexPath:(id)arg1;	// IMP=0x00000001000727b4
- (id)_indexPathForKeyboardElement:(id)arg1;	// IMP=0x000000010007268c
- (_Bool)_didFocusLastOnKeyboardElement;	// IMP=0x00000001000725d8
- (_Bool)_isScanningKeyboardContainer:(id)arg1;	// IMP=0x0000000100072544
- (_Bool)_isKeyboardContainerElement:(id)arg1 allowKeyboardContainerItself:(_Bool)arg2;	// IMP=0x000000010007247c
- (id)_firstKeyboardFocusContext;	// IMP=0x00000001000723d8
- (void)didFetchElements:(id)arg1 foundNewElements:(_Bool)arg2 currentFocusContext:(id)arg3 didChangeActiveElementManager:(_Bool)arg4;	// IMP=0x0000000100071cbc
- (void)scannerManager:(id)arg1 nativeFocusElementDidChange:(id)arg2;	// IMP=0x0000000100071c7c
- (_Bool)_deferFocusToNativeFocusElementIfNeeded:(id)arg1;	// IMP=0x0000000100071ab0
- (_Bool)_shouldTrackNativeFocusElement;	// IMP=0x0000000100071a30
- (void)_attemptToRestoreFocusContext:(id)arg1 scannerManager:(id)arg2;	// IMP=0x0000000100070e38
- (unsigned long long)_depthForElement:(id)arg1;	// IMP=0x0000000100070d90
- (void)scannerWillMakeManagerInactive:(id)arg1;	// IMP=0x0000000100070be0
- (void)driver:(id)arg1 willUnfocusFromContext:(id)arg2;	// IMP=0x0000000100070b28
- (void)driver:(id)arg1 didFocusOnContext:(id)arg2 oldContext:(id)arg3;	// IMP=0x0000000100070874
- (void)_updateMenuOpeningElementEnabledWithFocusContext:(id)arg1;	// IMP=0x000000010007058c
- (void)_updateVisualScrollersWithFocusContext:(id)arg1 oldContext:(id)arg2;	// IMP=0x00000001000702f0
- (void)firstResponderDidChange:(id)arg1;	// IMP=0x000000010006fda4
- (void)_trackLastScannedElementCommunityFromFocusContext:(id)arg1;	// IMP=0x000000010006fc74
- (void)screenChangingButtonWasPressed:(id)arg1;	// IMP=0x000000010006faf0
- (void)alertDidAppear:(id)arg1;	// IMP=0x000000010006f958
- (void)screenWillChange:(id)arg1;	// IMP=0x000000010006f94c
- (void)screenDidChange:(id)arg1;	// IMP=0x000000010006f658
- (void)appTransitionDidOccur:(id)arg1;	// IMP=0x000000010006f4c0
- (void)orientationDidChange:(id)arg1;	// IMP=0x000000010006f33c
- (void)_resetFetchFlags;	// IMP=0x000000010006f1a0
- (void)_pauseScanningForLikelyScreenChange;	// IMP=0x000000010006effc
- (void)_pauseScanningTemporarily;	// IMP=0x000000010006ed00
- (void)_startWaitingForFetchAfterTemporaryPause;	// IMP=0x000000010006ece4
- (void)_stopWaitingForFetchAfterTemporaryPause;	// IMP=0x000000010006ecc0
- (void)_giveUpWaitingForFetchAfterPause;	// IMP=0x000000010006e8a4
- (id)numberOfItemsInCurrentScanCycle;	// IMP=0x000000010006e654
- (id)_nativeFocusElementContext;	// IMP=0x000000010006e5a8
- (id)elementBefore:(id)arg1 didWrap:(_Bool *)arg2 options:(int *)arg3;	// IMP=0x000000010006e350
- (id)elementAfter:(id)arg1 didWrap:(_Bool *)arg2 options:(int *)arg3;	// IMP=0x000000010006e0f8
- (id)lastElementWithOptions:(int *)arg1;	// IMP=0x000000010006e06c
- (id)firstElementWithOptions:(int *)arg1;	// IMP=0x000000010006dfe0
- (void)_menuOpeningElementActivated:(id)arg1;	// IMP=0x000000010006dc6c
- (id)identifier;	// IMP=0x000000010006dc5c
...
- (id)init;	// IMP=0x000000010006db48
