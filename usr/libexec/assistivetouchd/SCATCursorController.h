...
- (void).cxx_destruct;	// IMP=0x00000001000bd5c8
...
- (void)hide:(_Bool)arg1 animate:(_Bool)arg2;	// IMP=0x00000001000bd484
- (void)updatePath:(id)arg1 frame:(struct CGRect)arg2 isSimpleRect:(_Bool)arg3 animated:(_Bool)arg4 options:(int)arg5;	// IMP=0x00000001000bd298
- (void)updateLevel:(int)arg1 animated:(_Bool)arg2 options:(int)arg3;	// IMP=0x00000001000bd1b8
- (void)updateTheme:(int)arg1 animated:(_Bool)arg2 options:(int)arg3;	// IMP=0x00000001000bd0d8
- (void)updateTheme:(int)arg1 level:(int)arg2 path:(id)arg3 frame:(struct CGRect)arg4 isSimpleRect:(_Bool)arg5 animated:(_Bool)arg6 options:(int)arg7;	// IMP=0x00000001000bcff4
- (id)description;	// IMP=0x00000001000bcf4c
- (id)init;	// IMP=0x00000001000bcc34
