...
- (id)elemLog;	// IMP=0x000000010002e554
- (void)scatUpdateValue;	// IMP=0x000000010009f9b8
- (void)scatScrollToTop;	// IMP=0x000000010009f9ac
- (void)scatDecreaseAutoscrollSpeed;	// IMP=0x000000010009f9a0
- (void)scatIncreaseAutoscrollSpeed;	// IMP=0x000000010009f994
@property(readonly, nonatomic) _Bool scatIsAutoscrolling;
- (void)scatPauseAutoscrolling;	// IMP=0x000000010009f97c
- (void)scatAutoscrollInDirection:(unsigned long long)arg1;	// IMP=0x000000010009f970
...
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x000000010009f764
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x000000010009f758
...
- (id)scatSupportedGestures;	// IMP=0x000000010009f71c
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x000000010009f614
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x000000010009f608
- (void)scatScrollToVisible;	// IMP=0x000000010009f5fc
...
- (id)scrollableElement;	// IMP=0x000000010009ed48
