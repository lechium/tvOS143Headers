...
- (id)keyboardContainer;	// IMP=0x00000001000a1d88
@property(readonly, nonatomic) struct CGRect frame;
- (_Bool)isGroup;	// IMP=0x00000001000a1d74
- (id)highestAncestorGroup;	// IMP=0x00000001000a1d20
...
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x00000001000a1be4
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00000001000a1bdc
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00000001000a1bd0
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x00000001000a1bc8
- (void)scatScrollToVisible;	// IMP=0x00000001000a1bc4
- (id)scatSupportedGestures;	// IMP=0x00000001000a1bbc
@property(readonly, nonatomic) _Bool scatHidesGroupCursorWhenFocused;
@property(readonly, nonatomic) NSArray *scatCustomActions;
- (id)scrollableElement;	// IMP=0x00000001000a1ba4
