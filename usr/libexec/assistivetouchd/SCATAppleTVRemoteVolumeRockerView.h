...
- (void).cxx_destruct;	// IMP=0x000000010000d1b8
...
- (void)volumeButton:(id)arg1 didChangeFocusState:(long long)arg2;	// IMP=0x000000010000cd50
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000010000ccf4
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000c530
