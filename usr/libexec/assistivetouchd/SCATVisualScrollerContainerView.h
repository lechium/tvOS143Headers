...
- (void).cxx_destruct;	// IMP=0x000000010005ce34
...
- (_Bool)updateFocusState:(long long)arg1;	// IMP=0x000000010005c804
- (id)description;	// IMP=0x000000010005c750
- (void)layoutSubviews;	// IMP=0x000000010005c4f0
- (id)initWithAxis:(long long)arg1;	// IMP=0x000000010005b4f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005b4e0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010005b4d0
