...
+ (struct CGSize)cellSizeForTitle:(id)arg1;	// IMP=0x0000000100094dac
+ (struct CGSize)maxCellSize;	// IMP=0x0000000100094d88
+ (id)measuringCell;	// IMP=0x0000000100094c20
+ (id)titleToSizeCache;	// IMP=0x0000000100094afc
- (void).cxx_destruct;	// IMP=0x0000000100097d7c
...
- (void)resetCell;	// IMP=0x0000000100097b18
- (_Bool)allowsDwellScanningToAbortAfterTimeout;	// IMP=0x0000000100097acc
- (id)accessibilityLabel;	// IMP=0x0000000100097a78
- (id)scatSpeakableDescription;	// IMP=0x0000000100097a24
- (_Bool)scatIndicatesOwnFocus;	// IMP=0x0000000100097a1c
- (_Bool)scatShouldActivateDirectly;	// IMP=0x0000000100097a14
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00000001000979b0
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00000001000979a4
- (void)prepareForReuse;	// IMP=0x0000000100097744
- (void)didUpdateScatMenuItemStyle;	// IMP=0x00000001000975b4
- (void)_setIconDimmed:(_Bool)arg1 asDimAsBorder:(_Bool)arg2 focused:(_Bool)arg3;	// IMP=0x00000001000972d8
- (void)_setBorderDimmed:(_Bool)arg1 focused:(_Bool)arg2 hidden:(_Bool)arg3;	// IMP=0x0000000100096d18
- (_Bool)_useHighVisibilityImage;	// IMP=0x0000000100096d10
...
- (id)description;	// IMP=0x00000001000967a0
- (void)_setupConstraints;	// IMP=0x0000000100095484
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100094f6c
