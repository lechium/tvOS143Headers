...
- (void).cxx_destruct;	// IMP=0x000000010005d83c
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000010005d61c
- (void)_drawLinesInContext:(struct CGContext *)arg1 forRows:(_Bool)arg2;	// IMP=0x000000010005d3e0
- (void)layoutSubviews;	// IMP=0x000000010005d054
- (double)_adjustOriginValue:(double)arg1 forDistance:(double)arg2 maximumEndPosition:(double)arg3;	// IMP=0x000000010005d02c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005cee8
