...
- (void)oldestFilePruned:(id)arg1;	// IMP=0x0000000100014a78
- (void)postURLRequest:(id)arg1 isRealtime:(_Bool)arg2;	// IMP=0x00000001000147bc
- (void)releaseXPCTransaction;	// IMP=0x000000010001477c
- (void)retainXPCTransaction;	// IMP=0x0000000100014744
- (_Bool)taskDispatched;	// IMP=0x00000001000143f8
- (_Bool)performTask:(id)arg1;	// IMP=0x0000000100013668
- (void)dispatchedWorker;	// IMP=0x00000001000134cc
- (void)dispatchedStop;	// IMP=0x00000001000132c8
- (void)dispatchedStart;	// IMP=0x0000000100012f30
- (id)xpcActivityState:(long long)arg1;	// IMP=0x0000000100012ec0
- (int)randomizedDelay;	// IMP=0x0000000100012cd0
- (id)activityDescription;	// IMP=0x0000000100012c74
- (void)processSuspendActivity:(id)arg1;	// IMP=0x0000000100012b88
- (void)processStartActivity:(id)arg1;	// IMP=0x0000000100012a60
- (void)prepareNextActivity:(int)arg1;	// IMP=0x00000001000127cc
- (void)stop;	// IMP=0x0000000100012764
- (void)start;	// IMP=0x00000001000126ac
- (void)dealloc;	// IMP=0x00000001000125d0
- (id)initWithOptions:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000100012460
