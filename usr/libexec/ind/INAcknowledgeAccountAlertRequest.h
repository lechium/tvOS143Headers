...
- (void).cxx_destruct;	// IMP=0x0000000100005b10
...
- (id)urlRequest;	// IMP=0x0000000100005864
- (id)urlString;	// IMP=0x0000000100005808
- (id)initWithAccount:(id)arg1 store:(id)arg2;	// IMP=0x0000000100005754
