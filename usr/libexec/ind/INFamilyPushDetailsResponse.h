...
- (void).cxx_destruct;	// IMP=0x000000010000e1d8
- (_Bool)_booleanValueOfObject:(id)arg1;	// IMP=0x000000010000e154
- (id)description;	// IMP=0x000000010000e0b4
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x000000010000dce4
