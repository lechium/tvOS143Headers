...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001298a0
+ (id)propertiesToFetch;	// IMP=0x0000000100140a48
...
- (id)description;	// IMP=0x0000000100129b90
- (id)serverRepresentation;	// IMP=0x0000000100129b84
- (void)dealloc;	// IMP=0x0000000100129810
- (unsigned long long)hash;	// IMP=0x00000001001297ec
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100129768
- (id)defaultCategory;	// IMP=0x000000010012a1f8
- (unsigned short)numberOfCategories;	// IMP=0x000000010012a1ec
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100140a9c
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100140440
