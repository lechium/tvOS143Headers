...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100131eec
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100131ee4
+ (int)familiarity;	// IMP=0x0000000100142ac4
...
- (int)defaultFamiliarity;	// IMP=0x0000000100132080
- (void)dealloc;	// IMP=0x0000000100131e84
