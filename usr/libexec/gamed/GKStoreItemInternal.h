...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012a2b4
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010012a58c
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x000000010012a52c
- (_Bool)isValid;	// IMP=0x000000010012a508
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012a484
- (unsigned long long)hash;	// IMP=0x000000010012a46c
- (void)dealloc;	// IMP=0x000000010012a204
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100141f68
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100141b88
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100141870
