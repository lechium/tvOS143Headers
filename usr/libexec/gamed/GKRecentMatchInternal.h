...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012b1c0
...
- (unsigned long long)hash;	// IMP=0x000000010012b404
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012b2c4
- (void)dealloc;	// IMP=0x000000010012b150
