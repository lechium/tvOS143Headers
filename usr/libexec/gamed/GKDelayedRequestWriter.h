...
+ (id)writerWithCacheWriter:(id)arg1 cacheReader:(id)arg2 networkWriter:(id)arg3 batchSubmissionInterval:(double)arg4;	// IMP=0x00000001000c2d88
...
- (void)writeResourcesToCacheOnly:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000c4648
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000c3e78
- (void)readAndSubmitDelayedRequestsOfResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000c35b4
- (void)deleteSubmittedRequestsWithIDs:(id)arg1 onConnection:(id)arg2;	// IMP=0x00000001000c3214
- (void)submitDelayedRequestsForPlayer:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000c3164
- (void)batchAndPerformInGroup:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000001000c2fe0
- (void)dealloc;	// IMP=0x00000001000c2f78
- (id)initWithCacheWriter:(id)arg1 cacheReader:(id)arg2 networkWriter:(id)arg3 batchSubmissionInterval:(double)arg4;	// IMP=0x00000001000c2ea4
