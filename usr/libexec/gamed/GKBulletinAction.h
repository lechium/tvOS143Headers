...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100084ac8
...
- (id)description;	// IMP=0x0000000100084d58
@property(readonly) NSDictionary *actionDictionary;
- (void)dealloc;	// IMP=0x0000000100084b3c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100084ad0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100084828
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010008459c
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100084514
- (id)init;	// IMP=0x00000001000844d4
