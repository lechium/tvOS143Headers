...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013d918
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013dbe0
- (unsigned long long)hash;	// IMP=0x000000010013dbc8
- (void)dealloc;	// IMP=0x000000010013d848
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001441c0
