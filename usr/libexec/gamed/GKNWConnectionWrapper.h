...
- (void).cxx_destruct;	// IMP=0x00000001000c8a04
...
- (void)cancelConnection;	// IMP=0x00000001000c8984
- (void)readData;	// IMP=0x00000001000c8980
- (void)_sendData:(id)arg1;	// IMP=0x00000001000c897c
- (_Bool)sendData:(id)arg1;	// IMP=0x00000001000c8910
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000c86e4
- (void)dealloc;	// IMP=0x00000001000c8648
- (id)initWithConnection:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x00000001000c8550
