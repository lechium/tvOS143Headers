...
+ (_Bool)displayNotification;	// IMP=0x00000001000e09bc
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000e09b4
- (void).cxx_destruct;	// IMP=0x00000001000e2fc8
...
- (id)description;	// IMP=0x00000001000e2d54
- (void)assembleBulletin;	// IMP=0x00000001000e2758
- (void)localizeMessage;	// IMP=0x00000001000e2684
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000e2388
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000e2068
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000e1d58
- (void)distributeData;	// IMP=0x00000001000e1d54
- (void)loadDataWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e1840
- (void)determineGameLocationOnDeviceOrInStoreWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e09c4
