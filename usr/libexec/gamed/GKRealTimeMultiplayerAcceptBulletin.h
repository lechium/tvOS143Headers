...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010003fcac
...
- (void)handleAction:(id)arg1;	// IMP=0x0000000100040a08
- (void)assembleBulletin;	// IMP=0x00000001000406d4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100040404
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000400d0
- (id)initWithPushNotification:(id)arg1;	// IMP=0x000000010003fdb8
- (_Bool)isAccept;	// IMP=0x000000010003fdb0
- (id)notificationName;	// IMP=0x000000010003fda0
- (id)debugLine;	// IMP=0x000000010003fd94
- (id)aggregateDictionaryKey;	// IMP=0x000000010003fd84
- (void)dealloc;	// IMP=0x000000010003fcb4
