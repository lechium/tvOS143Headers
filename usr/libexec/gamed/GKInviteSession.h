...
- (_Bool)shouldBeCleared;	// IMP=0x00000001000c57c0
- (void)removeAllResponses;	// IMP=0x00000001000c5664
- (void)addResponse:(id)arg1;	// IMP=0x00000001000c5628
- (void)removeAllInvitees;	// IMP=0x00000001000c53a8
- (id)allInvitees;	// IMP=0x00000001000c538c
- (id)referencesForInvitee:(id)arg1;	// IMP=0x00000001000c5350
- (void)removeInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x00000001000c4bc4
- (void)addInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x00000001000c4a94
- (void)dealloc;	// IMP=0x00000001000c4a1c
- (void)performSync:(CDUnknownBlockType)arg1;	// IMP=0x00000001000c4a10
- (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00000001000c48c4
- (id)initWithSessionToken:(id)arg1;	// IMP=0x00000001000c4884
