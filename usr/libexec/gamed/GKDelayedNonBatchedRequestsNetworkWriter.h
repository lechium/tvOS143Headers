...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100178fa4
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001001790c4
- (void)dealloc;	// IMP=0x0000000100179064
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100178fe4
