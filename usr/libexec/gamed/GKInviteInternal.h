...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013f32c
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x000000010013f17c
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x000000010013f044
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x000000010013eba8
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013f6d4
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013f638
- (unsigned long long)hash;	// IMP=0x000000010013f614
- (void)dealloc;	// IMP=0x000000010013f21c
- (id)init;	// IMP=0x000000010013f1b8
