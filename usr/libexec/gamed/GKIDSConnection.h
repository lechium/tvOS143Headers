...
- (void).cxx_destruct;	// IMP=0x0000000100038fec
...
- (void)cancelBackgroundTimer;	// IMP=0x0000000100038e4c
- (void)clientEnteredForegroundState:(id)arg1;	// IMP=0x0000000100038d8c
- (void)clientEnteredBackgroundState:(id)arg1;	// IMP=0x0000000100038a10
- (void)handleIDSSessionStatusChangeWhileDisconnecting;	// IMP=0x00000001000387ac
- (void)handleIDSSessionStatusChange;	// IMP=0x00000001000385e4
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000100038174
- (void)handleDisconnectForClient:(id)arg1 reason:(long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100037d58
- (void)cancelConnectTimeoutTimer;	// IMP=0x0000000100037d14
- (void)cancelHeartbeatTimer;	// IMP=0x0000000100037cd0
- (void)receivedHeartbeatFromID:(id)arg1;	// IMP=0x0000000100037c54
- (void)sendHeartbeatToConnections;	// IMP=0x0000000100037690
- (_Bool)shouldSaveConnectionStateForLostConnectionWithCKID:(id)arg1;	// IMP=0x00000001000374b0
- (void)startHeartbeatToMonitorConnections;	// IMP=0x0000000100037364
- (void)processInternalMessage:(id)arg1;	// IMP=0x0000000100037044
- (void)connectionWrapper:(id)arg1 didReceiveData:(id)arg2;	// IMP=0x0000000100036e6c
- (void)_sendData:(id)arg1 usingConnections:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100036ba4
- (void)sendData:(id)arg1 reliably:(_Bool)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000001000368f4
- (id)clientPacketWithData:(id)arg1 isReliable:(_Bool)arg2 error:(id *)arg3;	// IMP=0x000000010003677c
- (id)internalPacketWithMessage:(long long)arg1 error:(id *)arg2;	// IMP=0x0000000100036628
- (void)connectionWrapper:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000001000363bc
- (void)setupDatagramForIDSSession:(id)arg1 fromID:(id)arg2;	// IMP=0x0000000100036124
- (void)setupStreamForIDSSession:(id)arg1 fromID:(id)arg2;	// IMP=0x0000000100035e8c
- (void)acceptUnreliableInviteForIDSSession:(id)arg1 fromID:(id)arg2 withData:(id)arg3;	// IMP=0x0000000100035d8c
- (void)sendUnreliableIDSSessionInviteToIdentifier:(id)arg1;	// IMP=0x0000000100035af0
- (void)acceptReliableInviteForIDSSession:(id)arg1 fromID:(id)arg2 context:(id)arg3;	// IMP=0x00000001000359f0
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000100035834
- (_Bool)shouldAllowAddingAnotherConnection;	// IMP=0x00000001000357c0
- (void)invitationAcceptedForIDSSession:(id)arg1 fromID:(id)arg2 withData:(id)arg3;	// IMP=0x000000010003559c
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2 withData:(id)arg3;	// IMP=0x00000001000353b4
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2 withData:(id)arg3;	// IMP=0x00000001000351cc
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2 withData:(id)arg3;	// IMP=0x0000000100034fb0
- (void)connectToPlayersWithIdentifiers:(id)arg1;	// IMP=0x0000000100034710
- (void)connectToGameSessionUsingDelegateQueue:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100033d58
- (_Bool)isBusyChangingConnectionState;	// IMP=0x0000000100033ce8
- (void)updateCloudGameSession:(id)arg1;	// IMP=0x0000000100033cdc
- (void)dealloc;	// IMP=0x00000001000337b4
- (id)initWithClient:(id)arg1 gameSession:(id)arg2 account:(id)arg3;	// IMP=0x00000001000335d0
