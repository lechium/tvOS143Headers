...
+ (id)entityName;	// IMP=0x0000000100057758
- (id)internalRepresentation;	// IMP=0x00000001000573ec
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100056e18
