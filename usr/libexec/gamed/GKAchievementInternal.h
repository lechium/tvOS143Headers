...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100133634
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013342c
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100133adc
...
- (unsigned long long)hash;	// IMP=0x00000001001339cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001338fc
- (id)serverRepresentation;	// IMP=0x000000010013379c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001336d8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010013363c
- (void)dealloc;	// IMP=0x000000010013336c
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x0000000100133be8
