...
+ (Class)entryClass;	// IMP=0x0000000100057770
+ (id)entityName;	// IMP=0x0000000100057764
- (id)internalRepresentation;	// IMP=0x0000000100057934
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005777c
