...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x0000000100092c34
...
- (id)bundleURL;	// IMP=0x0000000100092e2c
...
- (void)dealloc;	// IMP=0x0000000100092d0c
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000100092bf4
- (id)initWithProxy:(id)arg1;	// IMP=0x0000000100092b94
