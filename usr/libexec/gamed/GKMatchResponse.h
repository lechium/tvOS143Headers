...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100091cc4
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x0000000100091f04
- (_Bool)isNetworkError;	// IMP=0x0000000100091ec4
- (_Bool)isTimeout;	// IMP=0x0000000100091e84
- (_Bool)isCancelled;	// IMP=0x0000000100091e44
- (_Bool)isFinished;	// IMP=0x0000000100091e04
- (int)_incrementSequence;	// IMP=0x0000000100091df4
- (void)dealloc;	// IMP=0x0000000100091c14
