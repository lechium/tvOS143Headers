...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100131a10
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100131998
...
- (unsigned long long)hash;	// IMP=0x0000000100131bbc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100131af4
- (void)dealloc;	// IMP=0x00000001001319a0
