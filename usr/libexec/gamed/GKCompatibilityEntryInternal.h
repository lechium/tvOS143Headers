...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013f98c
...
- (unsigned long long)hash;	// IMP=0x000000010013fcc0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013fb54
- (void)dealloc;	// IMP=0x000000010013f90c
