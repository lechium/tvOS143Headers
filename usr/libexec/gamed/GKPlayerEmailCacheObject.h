...
+ (id)entityName;	// IMP=0x000000010004bb10
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004b8e8
- (id)internalRepresentation;	// IMP=0x000000010004b728
