...
+ (id)entityName;	// IMP=0x000000010004dba0
- (_Bool)isValid;	// IMP=0x000000010004dc60
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004dbac
