...
+ (id)entityName;	// IMP=0x0000000100059ae8
- (id)internalRepresentation;	// IMP=0x0000000100059c54
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100059af4
