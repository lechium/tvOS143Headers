...
+ (id)entityName;	// IMP=0x00000001000505c4
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000010005023c
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100050424
