...
+ (id)relationshipKeyPathsForPrefetch;	// IMP=0x0000000100050204
+ (id)fetchSortDescriptors;	// IMP=0x0000000100050120
+ (id)entityName;	// IMP=0x0000000100050114
+ (id)recordForGame:(id)arg1 playerProfile:(id)arg2;	// IMP=0x000000010004ed30
+ (id)recordsForGames:(id)arg1 playerProfile:(id)arg2;	// IMP=0x000000010004ead0
- (id)internalRepresentation;	// IMP=0x000000010004ffec
- (void)updateAchievementsWithServerRepresentation:(id)arg1;	// IMP=0x000000010004fe0c
- (void)updateIDsWithServerRepresentation:(id)arg1;	// IMP=0x000000010004f6b8
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004edc8
