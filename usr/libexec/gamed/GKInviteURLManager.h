...
+ (id)sharedManager;	// IMP=0x0000000100108cac
- (void).cxx_destruct;	// IMP=0x00000001001091c4
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x0000000100108f1c
- (id)init;	// IMP=0x0000000100108e64
