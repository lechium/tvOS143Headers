...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100135380
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100134e5c
...
- (unsigned long long)hash;	// IMP=0x0000000100135834
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013564c
- (id)serverRepresentation;	// IMP=0x0000000100135524
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100135254
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100134e84
- (void)dealloc;	// IMP=0x0000000100134dcc
