...
+ (id)internalRepresentation;	// IMP=0x00000001001376c0
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100137268
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100137b04
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x00000001001377e0
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x00000001001376d4
- (id)serverRepresentation;	// IMP=0x00000001001376c8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013763c
- (unsigned long long)hash;	// IMP=0x0000000100137618
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100137540
- (void)dealloc;	// IMP=0x0000000100137470
