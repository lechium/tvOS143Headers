...
+ (id)bagKey;	// IMP=0x00000001001d9208
- (void).cxx_destruct;	// IMP=0x00000001001da254
...
- (id)taskInfo;	// IMP=0x00000001001d9f5c
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001d9c48
- (id)postBody;	// IMP=0x00000001001d9bb0
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001d99bc
- (id)initWithChallenges:(id)arg1 bundleID:(id)arg2;	// IMP=0x00000001001d9884
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001d9214
