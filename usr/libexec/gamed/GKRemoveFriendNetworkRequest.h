...
+ (id)bagKey;	// IMP=0x00000001001daaf8
- (void).cxx_destruct;	// IMP=0x00000001001dbe98
...
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001dbc58
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001daf50
- (id)taskInfo;	// IMP=0x00000001001dae1c
- (id)initWithFriendPlayerID:(id)arg1;	// IMP=0x00000001001dad18
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001dabb0
- (id)postBody;	// IMP=0x00000001001dab04
