...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000988b8
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000990ec
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100098970
- (id)initWithChallenge:(id)arg1;	// IMP=0x0000000100098918
- (id)challengeInternalObject;	// IMP=0x0000000100098910
- (id)description;	// IMP=0x00000001000988c0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000987cc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100098620
- (void)dealloc;	// IMP=0x0000000100098598
