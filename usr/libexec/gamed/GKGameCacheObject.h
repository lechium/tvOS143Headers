...
+ (id)entityName;	// IMP=0x000000010004db94
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x000000010004c100
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x000000010004bfc0
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x000000010004be80
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x000000010004bcd0
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000010004bc34
+ (id)fetchSortDescriptors;	// IMP=0x000000010004bb88
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010004bb7c
+ (id)uniqueAttributeName;	// IMP=0x000000010004bb70
- (id)gameDescriptor;	// IMP=0x000000010004d8dc
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x000000010004d860
- (id)internalRepresentation;	// IMP=0x000000010004d738
- (_Bool)storePiecesExpired;	// IMP=0x000000010004d708
- (_Bool)storePiecesValid;	// IMP=0x000000010004d6c4
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004d120
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004cab8
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x000000010004c4c0
- (_Bool)isValid;	// IMP=0x000000010004c444
- (void)invalidate;	// IMP=0x000000010004bb1c
