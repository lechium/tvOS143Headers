...
+ (id)entityName;	// IMP=0x000000010005f4f8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005f96c
- (id)internalRepresentation;	// IMP=0x000000010005f678
- (Class)classForInternalRepresentation;	// IMP=0x000000010005f66c
- (_Bool)hasDetails;	// IMP=0x000000010005f504
