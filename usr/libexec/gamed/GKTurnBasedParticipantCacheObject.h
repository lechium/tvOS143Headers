...
+ (id)entityName;	// IMP=0x000000010005b998
- (id)internalRepresentation;	// IMP=0x000000010005bc90
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005b9a4
