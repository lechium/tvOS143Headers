...
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e7e68
+ (_Bool)shouldProcessNotification;	// IMP=0x00000001000e7bc0
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000e77f0
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e6e84
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e6830
+ (id)syncQueue;	// IMP=0x00000001000e67bc
...
- (id)description;	// IMP=0x00000001000e80f8
- (void)handleAction:(id)arg1;	// IMP=0x00000001000e7fc0
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x00000001000e7d14
- (void)dealloc;	// IMP=0x00000001000e7b18
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000e795c
- (id)dataFrom64String:(id)arg1;	// IMP=0x00000001000e77f8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000e73d4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000e6fa8
