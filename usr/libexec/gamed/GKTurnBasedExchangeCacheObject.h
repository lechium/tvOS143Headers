...
+ (id)entityName;	// IMP=0x000000010005bc98
- (id)internalRepresentation;	// IMP=0x000000010005c2f4
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x000000010005bca4
