...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100039104
...
- (id)description;	// IMP=0x000000010003a82c
- (id)customInviteSoundPathForBundleID:(id)arg1;	// IMP=0x000000010003a6bc
- (void)declineInviteWithReason:(int)arg1;	// IMP=0x000000010003a4f4
- (void)updateDeclineInviteTrackingForReason:(long long)arg1;	// IMP=0x000000010003a36c
- (id)clientNotification;	// IMP=0x0000000100039ff0
- (id)clientNotificationWithiCloudID:(id)arg1;	// IMP=0x0000000100039f84
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100039c48
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100039874
- (id)initWithPushNotification:(id)arg1;	// IMP=0x0000000100039514
- (void)parseClientData:(id)arg1;	// IMP=0x0000000100039398
- (long long)inviteVersionFromMessage:(id)arg1;	// IMP=0x0000000100039220
- (void)dealloc;	// IMP=0x0000000100039140
- (id)init;	// IMP=0x000000010003910c
