...
+ (id)entityName;	// IMP=0x0000000100053b9c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100053ba8
- (id)internalRepresentation;	// IMP=0x0000000100053a24
