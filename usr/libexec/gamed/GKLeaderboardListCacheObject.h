...
+ (id)entityName;	// IMP=0x00000001000511c4
- (_Bool)isValid;	// IMP=0x0000000100051284
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00000001000511d0
