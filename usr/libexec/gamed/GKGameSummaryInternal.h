...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100005328
- (void).cxx_destruct;	// IMP=0x00000001000058a8
...
- (id)description;	// IMP=0x0000000100005708
- (id)initWithGameSummary:(id)arg1;	// IMP=0x0000000100005484
