...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013e5a0
...
- (_Bool)hasGuestPlayers;	// IMP=0x000000010013e8c0
- (unsigned long long)hash;	// IMP=0x000000010013e52c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013e10c
- (void)dealloc;	// IMP=0x000000010013e05c
- (id)init;	// IMP=0x000000010013dfdc
