...
+ (id)entityName;	// IMP=0x0000000100055534
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100055540
- (id)internalRepresentation;	// IMP=0x000000010005530c
