...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013c200
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013cf34
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x000000010013c90c
- (long long)previousParticipantIndex;	// IMP=0x000000010013c784
- (long long)localPlayerParticipantIndex;	// IMP=0x000000010013c730
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013c61c
- (unsigned long long)hash;	// IMP=0x000000010013c5f8
- (void)dealloc;	// IMP=0x000000010013c0a0
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010014373c
