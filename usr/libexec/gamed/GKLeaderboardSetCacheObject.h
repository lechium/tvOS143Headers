...
+ (id)entityName;	// IMP=0x0000000100050d54
- (id)internalRepresentation;	// IMP=0x0000000100050b48
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100050704
