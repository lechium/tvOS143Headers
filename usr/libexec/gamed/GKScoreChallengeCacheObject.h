...
+ (id)entityName;	// IMP=0x000000010005edf0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005f19c
- (id)internalRepresentation;	// IMP=0x000000010005ee64
- (Class)classForInternalRepresentation;	// IMP=0x000000010005ee58
- (_Bool)hasDetails;	// IMP=0x000000010005edfc
