...
+ (id)entityName;	// IMP=0x000000010004e218
- (id)internalRepresentation;	// IMP=0x000000010004df98
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004dcc8
