...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00000001001256ec
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001001257fc
- (void)dealloc;	// IMP=0x00000001001257ac
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x000000010012572c
