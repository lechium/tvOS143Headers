...
+ (Class)entryClass;	// IMP=0x000000010005d7e4
+ (id)entityName;	// IMP=0x000000010005d7d8
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005d7f0
