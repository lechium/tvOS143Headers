...
+ (id)entityName;	// IMP=0x000000010004eac4
- (id)internalRepresentation;	// IMP=0x000000010004eabc
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004e8b0
