...
+ (id)sessionsWithSessionIDs:(id)arg1 inContext:(id)arg2;	// IMP=0x000000010005b3ec
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010005b3e0
+ (id)uniqueAttributeName;	// IMP=0x000000010005b3d4
+ (id)sessionWithID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x000000010005b33c
+ (id)relationshipKeyPathsForPrefetch;	// IMP=0x0000000100059d8c
+ (id)entityName;	// IMP=0x0000000100059d80
- (id)internalRepresentation;	// IMP=0x000000010005b870
- (id)participantAtIndex:(long long)arg1;	// IMP=0x000000010005b6f0
- (void)expire;	// IMP=0x000000010005b68c
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005a7b8
- (id)participantWithPlayerID:(id)arg1;	// IMP=0x000000010005a5a8
- (void)saveGameData:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005a374
- (void)expireGameData;	// IMP=0x000000010005a23c
- (void)deleteGameData;	// IMP=0x0000000100059ff4
- (id)gameData;	// IMP=0x0000000100059e94
- (void)prepareForDeletion;	// IMP=0x0000000100059e48
- (_Bool)isActive;	// IMP=0x0000000100059dcc
