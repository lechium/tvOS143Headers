...
+ (long long)coalescingDelay;	// IMP=0x00000001001d7f64
+ (id)bagKey;	// IMP=0x00000001001d7f58
- (void).cxx_destruct;	// IMP=0x00000001001d91a8
...
- (id)taskInfo;	// IMP=0x00000001001d8e90
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001d8b7c
- (id)postBody;	// IMP=0x00000001001d8ae4
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001d8a74
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00000001001d8a00
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00000001001d8634
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00000001001d8380
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithAchievements:(id)arg1 bundleID:(id)arg2;	// IMP=0x00000001001d8028
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001d7f6c
