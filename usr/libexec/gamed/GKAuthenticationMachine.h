...
+ (void)migratePreSundanceAccountInformation;	// IMP=0x000000010008dba4
+ (void)migratePreBlacktailAccountInformation;	// IMP=0x000000010008d7a8
+ (id)authMachineForEnvironment:(long long)arg1;	// IMP=0x000000010008d5ec
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010008d5e4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010008d700
- (void)dealloc;	// IMP=0x000000010008d6b8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010008d5f4
