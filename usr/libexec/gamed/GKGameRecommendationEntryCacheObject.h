...
+ (id)entityName;	// IMP=0x0000000100058fcc
- (id)internalRepresentation;	// IMP=0x00000001000591d8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100058fd8
