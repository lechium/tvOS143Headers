...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x00000001000fca70
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000fc704
- (void).cxx_destruct;	// IMP=0x00000001000fcf6c
