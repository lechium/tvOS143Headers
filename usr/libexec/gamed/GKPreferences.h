...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x000000010007fe48
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x000000010007fe1c
+ (id)shared;	// IMP=0x000000010007ed4c
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x000000010007f20c
- (void)setStringValue:(id)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f1f4
- (id)stringValueForKey:(struct __CFString *)arg1 defaultValue:(id)arg2;	// IMP=0x000000010007f1c4
- (void)setTimeInterval:(double)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f168
- (double)timeIntervalForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x000000010007f124
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f0c8
- (long long)unsignedIntegerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x000000010007f084
- (void)setIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f028
- (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x000000010007efe4
- (void)setBooleanValue:(_Bool)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007ef84
- (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x000000010007ef74
- (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x000000010007ef30
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x000000010007eee0
- (void)_didWriteKey:(struct __CFString *)arg1;	// IMP=0x000000010007eeb8
- (void)synchronize;	// IMP=0x000000010007ee7c
- (void)invalidate;	// IMP=0x000000010007ee6c
- (_Bool)isInternalBuild;	// IMP=0x000000010007edf0
- (void)dealloc;	// IMP=0x000000010007ed04
- (id)init;	// IMP=0x000000010007ecf8
- (id)initWithoutUIKitNotifications;	// IMP=0x000000010007ec78
- (id)initWithUIKitNotifications;	// IMP=0x000000010007ec6c
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000001000e8798
- (id)valueRestrictionForKey:(id)arg1;	// IMP=0x00000001000e875c
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x00000001000e8714
