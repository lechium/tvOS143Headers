...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013d288
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013d6a4
- (id)serverRepresentation;	// IMP=0x000000010013d514
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013d444
- (unsigned long long)hash;	// IMP=0x000000010013d428
- (void)dealloc;	// IMP=0x000000010013d1d8
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100143fc0
