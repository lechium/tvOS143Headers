...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x00000001000fb7dc
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000fb5e0
- (void).cxx_destruct;	// IMP=0x00000001000fbb98
