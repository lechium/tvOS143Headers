...
+ (id)readerWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x000000010013b424
...
- (void)readResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010013b7c0
- (id)poolName;	// IMP=0x000000010013b76c
- (int)familiarityForPlayer:(id)arg1;	// IMP=0x000000010013b5c4
- (void)dealloc;	// IMP=0x000000010013b55c
- (id)initWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x000000010013b48c
