...
+ (id)entityName;	// IMP=0x0000000100057c20
- (id)internalRepresentation;	// IMP=0x0000000100057de8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100057c2c
