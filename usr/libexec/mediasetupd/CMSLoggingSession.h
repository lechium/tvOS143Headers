...
- (void).cxx_destruct;	// IMP=0x0000000100042c70
...
- (void)dealloc;	// IMP=0x0000000100042bc0
- (void)_endSession;	// IMP=0x0000000100042a74
- (id)eventOccurance;	// IMP=0x000000010004286c
- (id)eventDurations;	// IMP=0x0000000100042574
- (void)recordEvent:(id)arg1;	// IMP=0x00000001000424f8
- (void)recordEvent:(id)arg1 occuredAt:(id)arg2;	// IMP=0x00000001000422bc
- (id)initForType:(id)arg1 withMetadata:(id)arg2;	// IMP=0x00000001000421f4
