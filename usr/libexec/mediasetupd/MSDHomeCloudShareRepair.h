...
+ (id)repairTokenForUser:(id)arg1;	// IMP=0x0000000100018948
...
- (void)performRepairRequest:(CDUnknownBlockType)arg1;	// IMP=0x0000000100018ac0
- (id)initWithUser:(id)arg1 repairInfo:(id)arg2 containerID:(id)arg3;	// IMP=0x00000001000189f0
