...
- (void).cxx_destruct;	// IMP=0x0000000100008d94
...
- (void)schedule;	// IMP=0x0000000100008b00
- (void)invalidate;	// IMP=0x0000000100008ab4
- (void)checkIn;	// IMP=0x0000000100008988
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000001000088b4
