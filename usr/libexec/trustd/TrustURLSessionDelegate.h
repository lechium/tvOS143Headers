...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100049954
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100049418
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000001000493a4
- (_Bool)fetchNext:(id)arg1;	// IMP=0x0000000100048fc4
- (id)createNextRequest:(id)arg1;	// IMP=0x0000000100048fb0
- (id)init;	// IMP=0x0000000100048f1c
