...
- (void).cxx_destruct;	// IMP=0x0000000100015acc
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010001561c
- (void)scheduleBackgroundTasks;	// IMP=0x0000000100014c00
- (void)resume;	// IMP=0x0000000100014bf0
- (void)dealloc;	// IMP=0x0000000100014b8c
- (id)init;	// IMP=0x0000000100014aec
