...
- (oneway void)cancel;	// IMP=0x0000000100014a30
- (oneway void)maintainWithAudioType:(long long)arg1 keepAudioSessionActive:(_Bool)arg2;	// IMP=0x0000000100014958
- (_Bool)_shouldChangeAudioSession;	// IMP=0x0000000100014938
- (void)setManager:(id)arg1;	// IMP=0x000000010001492c
- (void)dealloc;	// IMP=0x00000001000148b0
