...
+ (id)updateItemResponseWithDictionary:(id)arg1 installedItem:(id)arg2;	// IMP=0x00000001002a89e0
+ (id)universalItemResponseWithDictionary:(id)arg1;	// IMP=0x00000001002a8988
+ (id)errorItemResponseWithError:(id)arg1 accountID:(id)arg2;	// IMP=0x00000001002a8914
+ (id)defaultItemResponseWithDictionary:(id)arg1;	// IMP=0x00000001002a88bc
+ (id)purchase_itemResponseWithError:(id)arg1 usingPurchaseInfo:(id)arg2;	// IMP=0x000000010018d428
+ (id)purchase_itemResponseFromDictionary:(id)arg1 usingPurchaseInfo:(id)arg2;	// IMP=0x000000010018d26c
- (void).cxx_destruct;	// IMP=0x00000001002a9ba0
...
- (id)_optimalDownloadWindowFromDictionary:(id)arg1;	// IMP=0x00000001002a96d4
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2;	// IMP=0x00000001002a9604
- (id)errorForItemID:(id)arg1;	// IMP=0x00000001002a95f4
- (id)_initWithError:(id)arg1 accountID:(id)arg2;	// IMP=0x00000001002a9550
- (id)_initWithDictionary:(id)arg1 applyingAssetStrategy:(long long)arg2 installedItem:(id)arg3;	// IMP=0x00000001002a8a58
