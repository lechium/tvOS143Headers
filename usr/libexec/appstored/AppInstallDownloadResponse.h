...
+ (id)finishInstallID:(long long)arg1;	// IMP=0x00000001002d8aa0
+ (id)failInstallID:(long long)arg1 withError:(id)arg2;	// IMP=0x00000001002d8a30
+ (id)continueInstallID:(long long)arg1 withDataConsumer:(id)arg2 assetRequest:(id)arg3 event:(id)arg4;	// IMP=0x00000001002d8988
- (void).cxx_destruct;	// IMP=0x00000001002d8c84
...
- (void)setRequestCount:(unsigned long long)arg1 forPackageID:(long long)arg2;	// IMP=0x00000001002d8c20
- (void)setAssetSize:(id)arg1 forPackageID:(long long)arg2;	// IMP=0x00000001002d8bf0
- (id)_initWithInstallID:(long long)arg1 result:(long long)arg2 dataConsumer:(id)arg3 assetRequest:(id)arg4 error:(id)arg5 event:(id)arg6;	// IMP=0x00000001002d8ae4
