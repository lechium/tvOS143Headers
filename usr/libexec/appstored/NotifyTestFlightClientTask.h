...
+ (id)taskForAppInstallPhase:(long long)arg1 bundleID:(id)arg2 error:(id)arg3;	// IMP=0x0000000100100e00
- (void).cxx_destruct;	// IMP=0x0000000100101340
...
- (void)main;	// IMP=0x0000000100100ecc
