...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001e0f48
- (unsigned long long)hash;	// IMP=0x00000001001e0ef4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001e0e20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001e0d90
- (void)copyTo:(id)arg1;	// IMP=0x00000001001e0d1c
- (void)writeTo:(id)arg1;	// IMP=0x00000001001e0ca0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001e0c98
- (id)dictionaryRepresentation;	// IMP=0x00000001001e08ac
- (id)description;	// IMP=0x00000001001e07f8
