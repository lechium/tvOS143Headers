...
- (void).cxx_destruct;	// IMP=0x000000010000d954
...
- (void)notifyRejectedWithError:(id)arg1;	// IMP=0x000000010000d828
- (void)notifyResolvedWithValue:(id)arg1;	// IMP=0x000000010000d720
- (id)initWithValueBlock:(CDUnknownBlockType)arg1 errorBlock:(CDUnknownBlockType)arg2 scheduler:(id)arg3;	// IMP=0x000000010000d634
