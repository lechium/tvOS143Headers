...
- (void).cxx_destruct;	// IMP=0x0000000100135e40
...
- (int)_encryptDatabase:(struct sqlite3 *)arg1;	// IMP=0x0000000100135bb0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100135b04
- (void)setCacheSizeWithNumberOfKilobytes:(long long)arg1;	// IMP=0x0000000100135af4
- (void)setCacheSizeWithNumberOfDatabasePages:(long long)arg1;	// IMP=0x0000000100135ae8
- (int)applyToDatabase:(struct sqlite3 *)arg1;	// IMP=0x00000001001359fc
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x0000000100135968
