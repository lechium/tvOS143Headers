...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x00000001000ad5a4
- (void).cxx_destruct;	// IMP=0x00000001000adc38
...
- (id)description;	// IMP=0x00000001000ad510
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x00000001000ad26c
