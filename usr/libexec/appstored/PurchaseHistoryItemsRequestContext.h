...
+ (id)newContextWithKnownApps:(id)arg1 revision:(id)arg2 forAccountID:(long long)arg3 requestingAccount:(id)arg4 client:(id)arg5 purchaseHistoryContext:(unsigned long long)arg6;	// IMP=0x0000000100292228
- (void).cxx_destruct;	// IMP=0x0000000100292450
...
- (id)_initWithKnownApps:(id)arg1 revision:(id)arg2 forAccountID:(long long)arg3 requestingAccount:(id)arg4 client:(id)arg5 purchaseHistoryContext:(unsigned long long)arg6;	// IMP=0x00000001002922f4
