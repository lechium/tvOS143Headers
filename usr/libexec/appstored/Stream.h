...
- (void).cxx_destruct;	// IMP=0x0000000100006510
- (void)_publishStreamEvent:(unsigned long long)arg1;	// IMP=0x00000001000064ac
- (void)signalEvent:(unsigned long long)arg1;	// IMP=0x00000001000064a0
- (void)open;	// IMP=0x0000000100006464
- (void)close;	// IMP=0x0000000100006454
...
- (id)init;	// IMP=0x0000000100005dac
