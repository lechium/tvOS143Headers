...
- (_Bool)_lib_isValidDSID:(id)arg1;	// IMP=0x00000001002400e8
- (id)lib_storeMetadataError:(id *)arg1;	// IMP=0x0000000100240050
- (id)lib_extensionType:(long long)arg1;	// IMP=0x000000010023febc
