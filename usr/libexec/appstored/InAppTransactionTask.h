...
- (void).cxx_destruct;	// IMP=0x00000001002cacb8
...
- (void)handleEngagementRequest:(id)arg1 purchase:(id)arg2 purchaseQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001002ca700
- (void)handleDialogRequest:(id)arg1 purchase:(id)arg2 purchaseQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001002ca494
- (void)handleAuthenticateRequest:(id)arg1 purchase:(id)arg2 purchaseQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001002ca228
- (id)_processPurchaseResult:(id)arg1;	// IMP=0x00000001002ca158
- (id)_authenticateWithClientInfo:(id)arg1 error:(id *)arg2;	// IMP=0x00000001002c9cb0
- (id)_buyParams;	// IMP=0x00000001002c9284
- (void)main;	// IMP=0x00000001002c869c
- (id)initWithProductIdentifier:(id)arg1 quantity:(unsigned long long)arg2 client:(id)arg3;	// IMP=0x00000001002c8508
- (id)initWithBuyParams:(id)arg1 client:(id)arg2;	// IMP=0x00000001002c8400
