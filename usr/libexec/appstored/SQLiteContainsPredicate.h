...
+ (id)doesNotContainPredicateWithProperty:(id)arg1 values:(id)arg2;	// IMP=0x00000001002b6574
+ (id)containsPredicateWithProperty:(id)arg1 query:(id)arg2 queryProperty:(id)arg3;	// IMP=0x00000001002b6470
+ (id)containsPredicateWithProperty:(id)arg1 values:(id)arg2;	// IMP=0x00000001002b63a8
- (void).cxx_destruct;	// IMP=0x00000001002b6c28
...
- (id)SQLForEntityClass:(Class)arg1;	// IMP=0x00000001002b69e8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001002b67a8
- (void)applyBinding:(id)arg1 atIndex:(inout int *)arg2;	// IMP=0x00000001002b6644
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002b6640
