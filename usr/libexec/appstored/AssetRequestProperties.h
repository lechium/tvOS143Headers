...
- (void).cxx_destruct;	// IMP=0x00000001000bb0bc
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000bacf8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000bacec
- (id)init;	// IMP=0x00000001000bac68
