...
- (void).cxx_destruct;	// IMP=0x000000010026ddc8
...
- (void)updateReportForRequestID:(id)arg1 withSecondsRemaining:(double)arg2 bytesDownloaded:(unsigned long long)arg3;	// IMP=0x000000010026d994
- (id)initWithProgress:(id)arg1;	// IMP=0x000000010026d89c
