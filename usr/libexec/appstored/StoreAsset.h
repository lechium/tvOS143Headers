...
+ (id)selectAssetFromArray:(id)arg1 usingStategy:(long long)arg2 withDeltaForInstalledItem:(id)arg3;	// IMP=0x000000010011df4c
+ (id)selectAssetFromArray:(id)arg1 usingStategy:(long long)arg2;	// IMP=0x000000010011dd84
+ (id)deltaAssetsWithDictionary:(id)arg1;	// IMP=0x000000010011db9c
+ (id)assetWithDictionary:(id)arg1;	// IMP=0x000000010011db48
...
- (_Bool)_parseAssetDictionary:(id)arg1;	// IMP=0x000000010011e8b4
- (id)description;	// IMP=0x000000010011e800
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010011e5e8
- (_Bool)isApplicableUpdateWithInstalledItemContext:(id)arg1;	// IMP=0x000000010011e030
@property(readonly, getter=isDelta) _Bool delta;
- (id)initWithDictionary:(id)arg1 assetType:(long long)arg2;	// IMP=0x000000010011dcdc
