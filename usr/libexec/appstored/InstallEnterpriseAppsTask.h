...
- (void).cxx_destruct;	// IMP=0x0000000100170e84
- (void)main;	// IMP=0x0000000100170624
- (void)_setProcessedExternalIDs:(id)arg1;	// IMP=0x00000001001705a4
@property(readonly) NSArray *processedExternalIDs; // @synthesize processedExternalIDs=_processedExternalIDs;
- (id)initWithEnterpriseApps:(id)arg1 isXDCRequest:(_Bool)arg2 requestToken:(id)arg3;	// IMP=0x0000000100170488
