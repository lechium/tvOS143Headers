...
- (void).cxx_destruct;	// IMP=0x00000001002d9e80
- (id)_request:(id *)arg1;	// IMP=0x00000001002d9ab0
- (void)main;	// IMP=0x00000001002d9618
- (id)initWithAccount:(id)arg1 token:(id)arg2 environment:(id)arg3 logKey:(id)arg4;	// IMP=0x00000001002d94c8
