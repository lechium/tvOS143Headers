...
- (_Bool)resetPurchaseIntentTimestampsForBundleID:(id)arg1;	// IMP=0x00000001000da99c
- (_Bool)clearPurchaseIntentsForBundleID:(id)arg1;	// IMP=0x00000001000da83c
- (_Bool)addPurchaseIntent:(id)arg1;	// IMP=0x00000001000da768
