...
- (void).cxx_destruct;	// IMP=0x0000000100281dac
...
- (void)handleDialogRequest:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100281c90
- (void)handleAuthenticateRequest:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100281c0c
- (void)main;	// IMP=0x0000000100281890
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x0000000100281824
