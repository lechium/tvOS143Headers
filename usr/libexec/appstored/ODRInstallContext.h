...
+ (id)contextWithMetadata:(id)arg1;	// IMP=0x000000010008d8b4
- (void).cxx_destruct;	// IMP=0x000000010008ddb0
...
- (void)_findReason;	// IMP=0x000000010008dc08
- (id)application;	// IMP=0x000000010008dad8
- (id)init;	// IMP=0x000000010008d840
