...
+ (id)defaultMonitor;	// IMP=0x000000010028a5ec
- (void).cxx_destruct;	// IMP=0x000000010028adb8
@property(readonly, getter=isScreenLocked) _Bool screenLocked; // @synthesize screenLocked=_screenLocked;
- (_Bool)_hasItemComplete:(id)arg1;	// IMP=0x000000010028accc
- (void)_addItemComplete:(id)arg1;	// IMP=0x000000010028ac04
- (void)_markHasBooted;	// IMP=0x000000010028ab68
- (_Bool)_checkIfFirstBoot;	// IMP=0x000000010028ab30
- (void)_postStateDidChangeNotification;	// IMP=0x000000010028aa5c
- (void)markFsEntitlementsCompleteForBoot;	// IMP=0x000000010028a908
...
- (id)init;	// IMP=0x000000010028a658
