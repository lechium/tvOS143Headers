...
- (void).cxx_destruct;	// IMP=0x000000010007eefc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010007ec24
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x000000010007ebd4
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000010007eaac
- (void)setValue:(id)arg1 forRequestParameter:(id)arg2;	// IMP=0x000000010007e94c
- (void)setValue:(id)arg1 forRequestHeader:(id)arg2;	// IMP=0x000000010007e7e8
...
- (id)init;	// IMP=0x000000010007d830
