...
- (void)addRefreshed:(id)arg1;	// IMP=0x000000010006db98
- (void)addRevoked:(id)arg1;	// IMP=0x000000010006db20
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010006da14
