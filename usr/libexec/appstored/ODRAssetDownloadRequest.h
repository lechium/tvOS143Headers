...
+ (id)_logPrefixForPriority:(double)arg1;	// IMP=0x00000001001a4a70
+ (id)downloadWithAssetPack:(id)arg1 andManifest:(id)arg2 forApplication:(id)arg3 originatingLogKey:(id)arg4;	// IMP=0x00000001001a2e60
- (void).cxx_destruct;	// IMP=0x00000001001a5220
...
- (void)_validateSourceURL;	// IMP=0x00000001001a4e58
- (void)_unlock;	// IMP=0x00000001001a4e48
- (id)_streamingZipOptions;	// IMP=0x00000001001a4c08
- (id)_simulatedDownloadTimerWithInterval:(double)arg1 dispatchBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a4b40
- (double)_simulatedDownloadTime;	// IMP=0x00000001001a4aa0
- (void)_lock;	// IMP=0x00000001001a4a60
- (unsigned long long)_getFileSizeAtURL:(id)arg1;	// IMP=0x00000001001a4748
- (void)_completeCoordinatorPromise:(id)arg1;	// IMP=0x00000001001a4618
- (void)_cancelSimulatedDownloadTimer;	// IMP=0x00000001001a45dc
- (id)_calculateLocalURLForEmbeddedAssetPackWithKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001a44d0
@property(readonly) unsigned long long totalNewPins;
- (void)simulateDownloadForEmbeddedAssetWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a4008
- (void)setExtractionProgress:(double)arg1;	// IMP=0x00000001001a3fb0
- (id)requestProperties;	// IMP=0x00000001001a3e24
@property(readonly) IXPromisedOutOfBandTransfer *outOfBandTransferPromise;
- (id)extractor;	// IMP=0x00000001001a3d2c
@property(readonly) long long duplicateDownloadCount;
@property(readonly) NSString *downloadPath;
- (void)completeWithSuccess;	// IMP=0x00000001001a3a84
- (void)completeWithError:(id)arg1;	// IMP=0x00000001001a38f0
- (_Bool)allowCellularAccess;	// IMP=0x00000001001a38e8
- (void)addSuccessBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a38d8
- (void)addErrorBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a38c8
- (void)addDuplicateDownload:(id)arg1;	// IMP=0x00000001001a37dc
- (id)init;	// IMP=0x00000001001a34b8
