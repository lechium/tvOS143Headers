...
- (void).cxx_destruct;	// IMP=0x0000000100094f0c
...
- (id)description;	// IMP=0x0000000100094e40
- (void)updateWithIDSDevice:(id)arg1;	// IMP=0x0000000100094d24
- (void)markAsTombstoneDevice;	// IMP=0x0000000100094d14
...
- (id)initWithIDSDevice:(id)arg1;	// IMP=0x0000000100094988
