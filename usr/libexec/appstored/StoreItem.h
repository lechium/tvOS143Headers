...
+ (id)itemWithDictionary:(id)arg1;	// IMP=0x0000000100282318
- (void).cxx_destruct;	// IMP=0x00000001002837e4
...
- (void)_parseMetadataFromDictionary:(id)arg1;	// IMP=0x0000000100282cec
- (void)_parseAssetsFromDictionary:(id)arg1 applyingAssetStrategy:(long long)arg2 withInstalledItem:(id)arg3;	// IMP=0x0000000100282a98
- (id)description;	// IMP=0x00000001002829f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100282540
- (id)copyWritableMetadataForAccount:(id)arg1 includeVariant:(_Bool)arg2;	// IMP=0x0000000100282474
- (id)copyWritableMetadataForAccount:(id)arg1;	// IMP=0x0000000100282464
- (id)initWithDictionary:(id)arg1 applyingAssetStrategy:(long long)arg2 installedItem:(id)arg3;	// IMP=0x0000000100282370
- (id)_newDateFormatter;	// IMP=0x0000000100283a94
