...
+ (id)bulletinWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x000000010022e4a4
+ (id)bulletinFromRequest:(id)arg1;	// IMP=0x000000010022e424
- (void).cxx_destruct;	// IMP=0x000000010022ed30
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010022ebd4
- (unsigned long long)hash;	// IMP=0x000000010022ebc4
- (id)newBulletinRequest;	// IMP=0x000000010022ea60
- (void)handleBulletinActionResponse:(id)arg1;	// IMP=0x000000010022e6bc
- (id)copyBulletinDictionary;	// IMP=0x000000010022e528
- (id)initWithBulletinDictionary:(id)arg1;	// IMP=0x000000010022e094
- (id)init;	// IMP=0x000000010022dfe4
