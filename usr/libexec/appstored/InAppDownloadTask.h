...
- (void).cxx_destruct;	// IMP=0x00000001000a6d6c
...
- (id)_bomInstallPath;	// IMP=0x00000001000a6a70
- (void)_bomInstall;	// IMP=0x00000001000a62b4
- (void)_updateDownloadStatus:(id)arg1;	// IMP=0x00000001000a6230
- (void)_sendDownloadStatus;	// IMP=0x00000001000a6170
- (void)_finalizeTaskWithError:(id)arg1;	// IMP=0x00000001000a5f5c
- (void)_downloadedBytes:(long long)arg1 expectedBytes:(long long)arg2;	// IMP=0x00000001000a5e4c
- (void)pause;	// IMP=0x00000001000a5cf4
- (void)cancel;	// IMP=0x00000001000a5b2c
- (void)main;	// IMP=0x00000001000a4f30
- (id)initWithDownloadID:(id)arg1 info:(id)arg2 client:(id)arg3;	// IMP=0x00000001000a4dac
