...
- (void).cxx_destruct;	// IMP=0x00000001001b5d48
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001b5a40
@property(readonly, nonatomic) RestoreAppInstall *restoreAppInstall;
- (id)initWithApplication:(id)arg1;	// IMP=0x00000001001b5520
