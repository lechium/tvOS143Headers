...
- (void).cxx_destruct;	// IMP=0x00000001002a4120
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000001002a3af4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002a39fc
