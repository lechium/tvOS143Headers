...
- (void).cxx_destruct;	// IMP=0x00000001002950c8
@property(copy, nonatomic) NSArray *bundleIDs; // @synthesize bundleIDs=_bundleIDs;
- (void)main;	// IMP=0x0000000100294dac
- (_Bool)attemptVPPMigrationForApp:(id)arg1;	// IMP=0x0000000100294a44
- (id)init;	// IMP=0x00000001002949a8
