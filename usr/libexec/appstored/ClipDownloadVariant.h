...
+ (id)_variantDescriptorsFromTargetArray:(id)arg1;	// IMP=0x000000010001ad00
+ (id)_variantDeltasFromDeltasInfo:(id)arg1;	// IMP=0x000000010001ab5c
- (void).cxx_destruct;	// IMP=0x000000010001aee8
...
- (id)variantDeltaFromAssetToken:(id)arg1;	// IMP=0x000000010001a8a0
@property(readonly) _Bool deltaUpdate;
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010001a6e8
