...
- (void).cxx_destruct;	// IMP=0x00000001000b6330
...
- (id)description;	// IMP=0x00000001000b628c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b61d8
- (id)initWithBundleID:(id)arg1;	// IMP=0x00000001000b6174
