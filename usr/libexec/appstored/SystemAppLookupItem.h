...
+ (id)_stringFromDigest:(char *)arg1;	// IMP=0x00000001001d234c
+ (id)_hashArrayFromMeasurement:(id)arg1;	// IMP=0x00000001001d2208
- (void).cxx_destruct;	// IMP=0x00000001001d2498
...
- (id)initWithURL:(id)arg1 attributes:(id)arg2;	// IMP=0x00000001001d1e1c
