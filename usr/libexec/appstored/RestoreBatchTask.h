...
+ (_Bool)isErrorBadTokenError:(id)arg1;	// IMP=0x0000000100169e3c
- (void).cxx_destruct;	// IMP=0x000000010016bbf0
...
- (void)_processBatchFailureItems:(id)arg1 error:(id)arg2 context:(id)arg3;	// IMP=0x000000010016b7bc
- (id)_processContentRestoreResponse:(id)arg1 context:(id)arg2;	// IMP=0x000000010016af38
- (void)main;	// IMP=0x000000010016a1c0
- (_Bool)isErrorSoftFail:(id)arg1;	// IMP=0x0000000100169fa8
- (id)initWithRestoreAppInstalls:(id)arg1;	// IMP=0x0000000100169dbc
