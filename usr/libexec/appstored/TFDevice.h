...
- (void).cxx_destruct;	// IMP=0x000000010018ec8c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010018e9c4
- (unsigned long long)hash;	// IMP=0x000000010018e860
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010018e5f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010018e3dc
- (void)copyTo:(id)arg1;	// IMP=0x000000010018e238
- (void)writeTo:(id)arg1;	// IMP=0x000000010018e0c0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010018e0b8
- (id)dictionaryRepresentation;	// IMP=0x000000010018d954
- (id)description;	// IMP=0x000000010018d8a0
...
- (int)StringAsConnection:(id)arg1;	// IMP=0x000000010018d74c
- (id)connectionAsString:(int)arg1;	// IMP=0x000000010018d6bc
