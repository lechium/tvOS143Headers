...
- (void).cxx_destruct;	// IMP=0x0000000100140720
...
- (void)updateGeneratedProperties;	// IMP=0x0000000100140058
...
- (void)setCoordinatorID:(id)arg1;	// IMP=0x000000010013fe0c
- (id)coordinatorID;	// IMP=0x000000010013fdf8
- (void)setWatchType:(long long)arg1;	// IMP=0x000000010013fd9c
- (long long)watchType;	// IMP=0x000000010013fd48
...
- (void)purchase_addVendorIDForApplication:(id)arg1;	// IMP=0x00000001002bd700
- (void)purchase_addThinningHeaders;	// IMP=0x00000001002bd5e0
