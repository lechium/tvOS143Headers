...
- (void).cxx_destruct;	// IMP=0x0000000100135914
...
- (void)_setResponse:(id)arg1;	// IMP=0x0000000100135868
@property(readonly) ASDRequestResponse *response; // @synthesize response=_response;
- (id)initForClient:(id)arg1 withOptions:(id)arg2;	// IMP=0x00000001001356b8
