...
- (void).cxx_destruct;	// IMP=0x000000010028447c
...
- (id)_newCoordinatorWithType:(unsigned long long)arg1 forBundleID:(id)arg2 createIfNotExisting:(_Bool)arg3 wasCreated:(_Bool *)arg4 error:(id *)arg5;	// IMP=0x00000001002841c0
- (_Bool)_cancelOwnedCoordinatorsForBundleID:(id)arg1;	// IMP=0x0000000100283fb8
- (void)main;	// IMP=0x0000000100283be8
- (id)initWithBundleID:(id)arg1 coordinatorType:(unsigned long long)arg2;	// IMP=0x0000000100283b28
