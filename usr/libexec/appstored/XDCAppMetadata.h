...
+ (Class)provisioningProfileType;	// IMP=0x0000000100278fe8
- (void).cxx_destruct;	// IMP=0x000000010027c2a8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010027ba38
- (unsigned long long)hash;	// IMP=0x000000010027b6a4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010027b0b0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010027aaa4
- (void)writeTo:(id)arg1;	// IMP=0x000000010027a5e8
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010027a5e0
- (id)dictionaryRepresentation;	// IMP=0x00000001002792dc
- (id)description;	// IMP=0x0000000100279228
...
- (id)provisioningProfileAtIndex:(unsigned long long)arg1;	// IMP=0x0000000100278fd0
- (unsigned long long)provisioningProfilesCount;	// IMP=0x0000000100278fb8
- (void)addProvisioningProfile:(id)arg1;	// IMP=0x0000000100278f44
- (void)clearProvisioningProfiles;	// IMP=0x0000000100278f2c
