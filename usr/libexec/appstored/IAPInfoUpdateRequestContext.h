...
+ (id)newContextWithRevision:(id)arg1 forAccount:(id)arg2 token:(id)arg3;	// IMP=0x000000010010e06c
...
- (id)_initWithRevision:(id)arg1 forAccount:(id)arg2 client:(id)arg3 logUUID:(id)arg4;	// IMP=0x000000010010e158
