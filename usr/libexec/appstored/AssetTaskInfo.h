...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x000000010028a12c
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x000000010028a0a0
+ (void)removeAllTaskInfo;	// IMP=0x000000010028a064
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x0000000100289f0c
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x0000000100289ebc
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x0000000100289da4
- (void).cxx_destruct;	// IMP=0x000000010028a2c4
...
- (id)initWithTask:(id)arg1;	// IMP=0x0000000100289e1c
