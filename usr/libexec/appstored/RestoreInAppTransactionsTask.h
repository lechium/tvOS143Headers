...
- (void).cxx_destruct;	// IMP=0x000000010015e1a8
...
- (id)_authenticateAccount:(id)arg1 withClientInfo:(id)arg2 error:(id *)arg3;	// IMP=0x000000010015dc6c
- (id)_runRequestWithError:(id *)arg1;	// IMP=0x000000010015d9f0
- (void)main;	// IMP=0x000000010015d23c
- (id)initWithClient:(id)arg1;	// IMP=0x000000010015d110
