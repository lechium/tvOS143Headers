...
- (void).cxx_destruct;	// IMP=0x00000001001326f4
...
- (id)_parseResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100131a7c
- (id)_requestBatches:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100131614
- (id)_queryDictionary;	// IMP=0x0000000100131070
- (void)main;	// IMP=0x0000000100130940
- (id)initWithProductIdentifiers:(id)arg1 client:(id)arg2;	// IMP=0x000000010013088c
