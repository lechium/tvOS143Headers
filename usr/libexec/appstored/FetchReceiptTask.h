...
- (void).cxx_destruct;	// IMP=0x00000001000f3e84
...
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleAuthenticateRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000f3a70
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleDialogRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000f380c
- (_Bool)_useVPPBagURL;	// IMP=0x00000001000f37f0
- (id)_requestBodyForApplication:(id)arg1;	// IMP=0x00000001000f2c9c
- (id)_URLRequestWithBag:(id)arg1 clientInfo:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000f2680
- (id)_requestReceiptDataForApplication:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000f206c
- (void)_finishWithReceiptData:(id)arg1 error:(id)arg2;	// IMP=0x00000001000f1e8c
- (id)_accountWithClientInfo:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000f1704
- (void)main;	// IMP=0x00000001000f11a0
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x00000001000f10d8
