...
- (void).cxx_destruct;	// IMP=0x00000001001e9ae8
...
- (void)main;	// IMP=0x00000001001e95a4
- (id)initWithTransactionIdentifier:(id)arg1 client:(id)arg2;	// IMP=0x00000001001e94f0
