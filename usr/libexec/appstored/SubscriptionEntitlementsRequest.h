...
+ (id)_newResponseWithURLResult:(id)arg1 error:(id *)arg2;	// IMP=0x000000010026ec30
- (void).cxx_destruct;	// IMP=0x000000010026f014
...
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010026e4e0
- (id)initWithRequestToken:(id)arg1;	// IMP=0x000000010026e47c
- (id)init;	// IMP=0x000000010026e3e8
