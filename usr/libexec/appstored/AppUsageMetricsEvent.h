...
- (void).cxx_destruct;	// IMP=0x00000001002551e8
...
- (id)_typeForMetricsType:(unsigned char)arg1;	// IMP=0x0000000100254e5c
- (id)_metricsTypeForInstallationType:(unsigned char)arg1;	// IMP=0x0000000100254e30
- (id)_eventForType:(unsigned char)arg1;	// IMP=0x0000000100254d9c
- (_Bool)requiresDiagnosticSendingPermission;	// IMP=0x0000000100254d94
- (id)metricsDictionary;	// IMP=0x00000001002548c0
...
- (id)externalMapping;	// IMP=0x000000010025357c
