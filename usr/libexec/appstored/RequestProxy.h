...
- (void).cxx_destruct;	// IMP=0x000000010006e170
...
- (id)remoteObjectProxyWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010006e134
- (id)remoteObjectProxy;	// IMP=0x000000010006e120
- (void)startWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010006df60
- (void)cancelWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010006dda0
- (id)initWithBroker:(id)arg1 request:(id)arg2 delegate:(id)arg3;	// IMP=0x000000010006dcdc
- (id)init;	// IMP=0x000000010006dcc4
