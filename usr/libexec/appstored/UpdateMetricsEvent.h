...
+ (id)_defaultProperties;	// IMP=0x0000000100195864
- (void).cxx_destruct;	// IMP=0x0000000100195aa0
...
- (id)description;	// IMP=0x00000001001957a0
- (_Bool)requiresDiagnosticSendingPermission;	// IMP=0x0000000100195798
- (id)initWithTopic:(id)arg1;	// IMP=0x0000000100195400
