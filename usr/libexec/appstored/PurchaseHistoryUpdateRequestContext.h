...
+ (id)newContextWithRevision:(id)arg1 forAccountID:(long long)arg2 requestingAccount:(id)arg3 client:(id)arg4 purchaseHistoryContext:(unsigned long long)arg5;	// IMP=0x00000001002ed69c
- (void).cxx_destruct;	// IMP=0x00000001002ed860
...
- (id)_initWithRevision:(id)arg1 forAccountID:(long long)arg2 requestingAccount:(id)arg3 client:(id)arg4 purchaseHistoryContext:(unsigned long long)arg5;	// IMP=0x00000001002ed744
