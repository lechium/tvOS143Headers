...
- (void).cxx_destruct;	// IMP=0x00000001000bcafc
...
- (id)replyWithProtobuf:(id)arg1 messageType:(long long)arg2;	// IMP=0x00000001000bca08
- (id)copyIDSRepresentation;	// IMP=0x00000001000bc9cc
- (id)initWithProtobuf:(id)arg1 device:(id)arg2 messageID:(id)arg3;	// IMP=0x00000001000bc8d8
- (id)initWithProtobuf:(id)arg1 messageType:(long long)arg2;	// IMP=0x00000001000bc840
