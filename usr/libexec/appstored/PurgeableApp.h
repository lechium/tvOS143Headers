...
- (void).cxx_destruct;	// IMP=0x00000001001e39dc
...
- (id)description;	// IMP=0x00000001001e3910
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001e381c
- (id)asdApp;	// IMP=0x00000001001e3694
- (id)initWithBundleID:(id)arg1;	// IMP=0x00000001001e3630
