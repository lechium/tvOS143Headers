...
+ (id)_titleForProtectionSpace:(id)arg1;	// IMP=0x00000001000dbfe8
+ (id)_messageForProtectionSpace:(id)arg1;	// IMP=0x00000001000dbd2c
- (void).cxx_destruct;	// IMP=0x00000001000dc0d8
...
- (id)initWithAuthenticationChallenge:(id)arg1;	// IMP=0x00000001000dbbec
