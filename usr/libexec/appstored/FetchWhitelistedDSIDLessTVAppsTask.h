...
- (void).cxx_destruct;	// IMP=0x00000001001a7c0c
...
- (void)_lookupWhitelistedProviderAppsWithOutError:(id *)arg1;	// IMP=0x00000001001a787c
- (void)_lookupHeadboardAppsWithOutError:(id *)arg1;	// IMP=0x00000001001a6fa4
- (void)main;	// IMP=0x00000001001a6ef8
