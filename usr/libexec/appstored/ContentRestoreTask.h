...
- (void).cxx_destruct;	// IMP=0x0000000100287a00
...
- (id)_newBodyDictionaryWithAccountID:(id)arg1;	// IMP=0x0000000100287084
- (void)main;	// IMP=0x00000001002867ec
- (id)initWithRestoreAppInstalls:(id)arg1 account:(id)arg2;	// IMP=0x0000000100286738
