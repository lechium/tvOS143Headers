...
+ (id)eTagValueFromContentTasteResponse:(id)arg1;	// IMP=0x00000001000318bc
- (void).cxx_destruct;	// IMP=0x0000000100031a28
...
- (id)initWithContentTasteResponse:(id)arg1;	// IMP=0x0000000100031818
