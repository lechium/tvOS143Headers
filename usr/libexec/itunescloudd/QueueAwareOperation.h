...
- (void).cxx_destruct;	// IMP=0x0000000100049350
...
- (id)initWithArtworkImporter:(id)arg1 operationQueue:(id)arg2 artistPersistentIDsToUpdate:(id)arg3 albumArtistPersistentIDsToUpdate:(id)arg4;	// IMP=0x00000001000490d4
