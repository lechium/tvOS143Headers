...
- (void).cxx_destruct;	// IMP=0x000000010005419c
...
- (id)debugDescription;	// IMP=0x0000000100053fdc
- (_Bool)isValid;	// IMP=0x0000000100053fd4
- (id)initWithSong:(id)arg1;	// IMP=0x0000000100053bec
