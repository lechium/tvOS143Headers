...
+ (id)daemonDefaults;	// IMP=0x000000010001df74
- (void).cxx_destruct;	// IMP=0x000000010001e858
...
- (void)_setOrRemoveObject:(id)arg1 forKey:(id)arg2;	// IMP=0x000000010001e788
- (id)_init;	// IMP=0x000000010001e698
