...
- (void).cxx_destruct;	// IMP=0x00000001000572c0
...
- (id)debugDescription;	// IMP=0x0000000100057074
- (float)legacyScore;	// IMP=0x0000000100056f88
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x0000000100056c7c
