...
- (void).cxx_destruct;	// IMP=0x0000000100078ef0
...
- (void)_initializeMappings;	// IMP=0x0000000100077e74
- (id)geniusValueForML3ContainerProperty:(id)arg1 value:(id)arg2;	// IMP=0x0000000100077dd0
- (id)geniusPlaylistPropertyForML3ContainerProperty:(id)arg1;	// IMP=0x0000000100077dc0
- (id)geniusValueForML3TrackProperty:(id)arg1 value:(id)arg2;	// IMP=0x0000000100077d1c
- (id)geniusTrackPropertyForML3TrackProperty:(id)arg1;	// IMP=0x0000000100077d0c
- (id)init;	// IMP=0x0000000100077cb4
