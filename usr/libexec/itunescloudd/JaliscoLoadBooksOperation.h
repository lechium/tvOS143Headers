...
- (void).cxx_destruct;	// IMP=0x000000010009d268
...
- (id)metadataFilter;	// IMP=0x000000010009d1e4
- (id)queryFilter;	// IMP=0x000000010009d168
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x000000010009d148
- (void)main;	// IMP=0x000000010009c8a4
