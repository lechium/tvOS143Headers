...
- (void).cxx_destruct;	// IMP=0x000000010001df0c
- (void)cancel;	// IMP=0x000000010001deb4
- (void)main;	// IMP=0x000000010001d6fc
- (id)initWithConfiguration:(id)arg1 dictionary:(id)arg2;	// IMP=0x000000010001d524
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010001d4b0
