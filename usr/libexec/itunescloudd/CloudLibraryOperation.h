...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100064904
- (void).cxx_destruct;	// IMP=0x0000000100064cec
...
- (id)description;	// IMP=0x0000000100064bcc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100064b54
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100064a9c
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000010006495c
- (id)init;	// IMP=0x000000010006490c
