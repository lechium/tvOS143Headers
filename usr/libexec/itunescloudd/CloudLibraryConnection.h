...
- (void).cxx_destruct;	// IMP=0x00000001000b4700
...
- (void)disconnect;	// IMP=0x00000001000b4640
- (void)connectWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000b3c64
- (void)_onQueue_sendRequest:(id)arg1 withInternalResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b145c
- (void)sendRequest:(id)arg1 withResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b11f4
@property(readonly, nonatomic) ICUserIdentityStore *userIdentityStore;
@property(readonly, nonatomic) ICUserIdentity *userIdentity;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00000001000b10b4
