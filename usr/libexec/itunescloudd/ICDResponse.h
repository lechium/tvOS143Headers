...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x0000000100082c70
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x0000000100082bb0
...
- (id)description;	// IMP=0x0000000100082d98
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x0000000100082a80
