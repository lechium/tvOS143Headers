...
- (void).cxx_destruct;	// IMP=0x00000001000defb4
...
- (void)_clearAllCloudIDs;	// IMP=0x00000001000debb0
- (id)_determineResultsURLWhenReadyWithUpdateID:(id)arg1 retryTimeout:(double)arg2 responseStatusCode:(out long long *)arg3;	// IMP=0x00000001000de500
- (_Bool)_updateLibrary;	// IMP=0x00000001000dd04c
- (void)_prepareLibraryForInitialUpdate;	// IMP=0x00000001000dcae8
- (_Bool)_uploadLibrary;	// IMP=0x00000001000d9294
- (_Bool)_ensureDeviceIsRegistered;	// IMP=0x00000001000d916c
- (void)main;	// IMP=0x00000001000d7b34
- (void)cancel;	// IMP=0x00000001000d79d8
@property(readonly, nonatomic) float progress;
@property(readonly, nonatomic, getter=isInitialUpdate) _Bool initialUpdate;
- (void)dealloc;	// IMP=0x00000001000d795c
- (id)initWithConfiguration:(id)arg1 reason:(long long)arg2 updateTaskHelper:(id)arg3;	// IMP=0x00000001000d78bc
