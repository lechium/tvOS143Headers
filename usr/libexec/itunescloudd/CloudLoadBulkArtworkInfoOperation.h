...
- (void).cxx_destruct;	// IMP=0x0000000100039590
...
- (void)main;	// IMP=0x0000000100038fb0
- (id)initWithConfiguration:(id)arg1 cloudIDs:(id)arg2;	// IMP=0x0000000100038e88
- (id)initWithCloudIDs:(id)arg1;	// IMP=0x0000000100038e14
