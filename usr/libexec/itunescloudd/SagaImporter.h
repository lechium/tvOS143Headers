...
- (void).cxx_destruct;	// IMP=0x00000001000876c4
...
- (_Bool)_updateGlobalPlaylistsFromContainersPayloadAtPath:(id)arg1 downloadPathForSubscribedContainersPayload:(id)arg2;	// IMP=0x00000001000874a8
- (void)_importLyricsWithLyricsTokenMap:(id)arg1;	// IMP=0x0000000100087380
- (void)_removeUnavailableSubscriptionAssetsInLibrary:(id)arg1;	// IMP=0x0000000100086df4
- (void)importTracksFromRevision:(unsigned int)arg1 toRevision:(unsigned int)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100085568
- (void)cancel;	// IMP=0x0000000100085488
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000100085350
