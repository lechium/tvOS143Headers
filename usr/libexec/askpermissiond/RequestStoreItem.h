...
- (void).cxx_destruct;	// IMP=0x0000000100010a1c
...
- (id)compile;	// IMP=0x0000000100010854
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010001066c
- (id)initWithItemIdentifier:(id)arg1 requestIdentifier:(id)arg2 date:(id)arg3;	// IMP=0x000000010001059c
