...
- (id)description;	// IMP=0x0000000100015188
- (id)compile;	// IMP=0x0000000100014e88
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100014998
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 mocked:(_Bool)arg5 offerName:(id)arg6 previewURL:(id)arg7 productURL:(id)arg8 status:(long long)arg9;	// IMP=0x0000000100014818
