...
- (_Bool)attemptRecoveryUsingHandle:(struct sqlite3 *)arg1 withError:(id *)arg2;	// IMP=0x0000000100016ac8
- (id)description;	// IMP=0x0000000100016a3c
- (id)initWithFaultString:(id)arg1;	// IMP=0x00000001000169b4
