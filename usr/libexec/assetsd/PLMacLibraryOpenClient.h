...
- (void).cxx_destruct;	// IMP=0x0000000100010d90
@property(readonly) id <PLUnlocker> bundleUnlocker; // @synthesize bundleUnlocker=_bundleUnlocker;
- (long long)performMigrationWithError:(id *)arg1;	// IMP=0x0000000100010d7c
- (id)initWithLibraryServiceManager:(id)arg1 clientIdentifier:(id)arg2;	// IMP=0x0000000100010bf0
