...
+ (id)purgeOpAtUrgency:(int)arg1 info:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010003f8ac
- (void).cxx_destruct;	// IMP=0x000000010003f95c
...
- (id)initWithUrgency:(int)arg1 info:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010003f7f4
