...
- (void).cxx_destruct;	// IMP=0x000000010003f74c
...
- (void)_startOperation:(CDUnknownBlockType)arg1;	// IMP=0x000000010003c788
- (id)copyInFlights;	// IMP=0x000000010003c61c
- (void)removeInFlight:(id)arg1;	// IMP=0x000000010003c520
- (void)addInFlight:(id)arg1;	// IMP=0x000000010003c424
- (void)cancelOperation;	// IMP=0x000000010003c414
- (id)initWithInfo:(id)arg1 services:(id)arg2 volumes:(id)arg3;	// IMP=0x000000010003c14c
