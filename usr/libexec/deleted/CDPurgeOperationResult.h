...
- (void).cxx_destruct;	// IMP=0x00000001000266b0
...
- (void)addResult:(id)arg1;	// IMP=0x0000000100026524
...
- (id)initWithVolumes:(id)arg1 requestedBytes:(unsigned long long)arg2 beginFreeSpace:(unsigned long long)arg3;	// IMP=0x00000001000262c4
