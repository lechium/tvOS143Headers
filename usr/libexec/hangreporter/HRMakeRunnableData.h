...
- (void).cxx_destruct;	// IMP=0x0000000100012568
...
- (long long)findBlockingThreadForTailspin:(id)arg1 sampleStore:(id)arg2 mainThread:(id)arg3 hangStartTime:(unsigned long long)arg4 hangEndTime:(unsigned long long)arg5 hangDuration:(int)arg6;	// IMP=0x0000000100010e54
- (id)init;	// IMP=0x0000000100010d74
