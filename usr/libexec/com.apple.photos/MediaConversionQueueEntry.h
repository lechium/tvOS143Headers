...
- (void).cxx_destruct;	// IMP=0x000000010000b138
...
- (void)videoConversionTask:(id)arg1 didUpdateFractionCompleted:(double)arg2;	// IMP=0x000000010000aed8
- (void)addClientRequest:(id)arg1;	// IMP=0x000000010000adf8
- (id)description;	// IMP=0x000000010000ad20
- (void)dealloc;	// IMP=0x000000010000abe8
- (id)initWithIdentifier:(id)arg1 initialConversionOptions:(id)arg2;	// IMP=0x000000010000aabc
