...
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100011f9c
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100011dbc
- (id)init;	// IMP=0x0000000100011cec
- (void)_loadEnterpriseData;	// IMP=0x00000001000123c8
