...
- (void).cxx_destruct;	// IMP=0x000000010000566c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000054f0
- (unsigned long long)hash;	// IMP=0x00000001000054a4
@property(readonly) NSString *model;
@property(readonly) _Bool isReachable;
- (_Bool)_onQueue_isReachable;	// IMP=0x0000000100005290
@property(readonly) _Bool supportsNewProtocol;
@property(readonly) _Bool supportsPCSKeySync;
@property(readonly) NSUUID *pairingID;
- (void)removeObserver:(id)arg1;	// IMP=0x000000010000517c
- (void)addObserver:(id)arg1;	// IMP=0x0000000100005080
