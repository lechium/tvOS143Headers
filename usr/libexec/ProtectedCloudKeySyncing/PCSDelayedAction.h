...
- (void).cxx_destruct;	// IMP=0x000000010000d7fc
...
- (void)trigger;	// IMP=0x000000010000d664
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x000000010000d5cc
- (void)run;	// IMP=0x000000010000d5bc
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x000000010000d578
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x000000010000d1ac
