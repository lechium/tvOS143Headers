...
+ (id)transportWithIDSServiceName:(id)arg1;	// IMP=0x00000001000035ec
- (void).cxx_destruct;	// IMP=0x0000000100004f9c
...
- (id)copyLocalPairedDevices;	// IMP=0x0000000100004f30
- (void)service:(id)arg1 account:(id)arg2 identifier:(id)arg3 didSendWithSuccess:(_Bool)arg4 error:(id)arg5;	// IMP=0x0000000100004de0
- (void)service:(id)arg1 account:(id)arg2 incomingMessage:(id)arg3 fromID:(id)arg4 context:(id)arg5;	// IMP=0x00000001000049f8
- (void)sendResponse:(id)arg1 toMessage:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 logDescription:(id)arg5;	// IMP=0x000000010000436c
- (void)sendMessage:(id)arg1 toDevice:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 logDescription:(id)arg5 handleReply:(CDUnknownBlockType)arg6;	// IMP=0x0000000100003c2c
- (id)initWithServiceName:(id)arg1;	// IMP=0x0000000100003894
