...
- (void).cxx_destruct;	// IMP=0x00000001000bf290
...
- (void)_handlePingPongMessage:(id)arg1 client:(id)arg2;	// IMP=0x00000001000bf09c
- (void)_notifyXPCDisconnectionToProxy:(id)arg1;	// IMP=0x00000001000bf034
- (void)_notifyXPCDisconnectionToProxies;	// IMP=0x00000001000bef70
- (void)_handleClientError:(id)arg1 client:(id)arg2;	// IMP=0x00000001000bed8c
- (void)_handleSetXPCClientTypeMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00000001000bec64
- (void)_handleAudioProvidingRequestTypeSwitchMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00000001000beafc
- (void)_handleAudioProvidingMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00000001000be958
- (void)_handleClientMessage:(id)arg1 client:(id)arg2;	// IMP=0x00000001000be788
- (void)_handleClientEvent:(id)arg1;	// IMP=0x00000001000be69c
- (void)sendMessageToClient:(id)arg1;	// IMP=0x00000001000be510
- (void)activateConnection;	// IMP=0x00000001000be400
- (_Bool)_getAudioProvideWithContext:(id)arg1 streamClientType:(unsigned long long)arg2;	// IMP=0x00000001000be194
- (id)initWithConnection:(id)arg1;	// IMP=0x00000001000bdf54
