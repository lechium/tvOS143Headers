...
- (void).cxx_destruct;	// IMP=0x00000001000ace54
- (void)stopReportZeroStatistics;	// IMP=0x00000001000acda4
- (void)getZeroStatisticsFromBuffer:(id)arg1 entireSamples:(unsigned int)arg2;	// IMP=0x00000001000acbdc
- (void)resetWithSampleRate:(float)arg1;	// IMP=0x00000001000acb5c
- (id)initWithToken:(id)arg1 sampleRate:(float)arg2 numChannels:(unsigned int)arg3;	// IMP=0x00000001000aca44
