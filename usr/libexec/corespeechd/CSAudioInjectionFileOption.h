...
- (void).cxx_destruct;	// IMP=0x00000001000196cc
...
- (id)description;	// IMP=0x0000000100019634
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x0000000100019598
