...
- (void)performTransitionForEvent:(long long)arg1;	// IMP=0x00000001000162b0
- (void)addTransitionFrom:(long long)arg1 to:(long long)arg2 for:(long long)arg3;	// IMP=0x0000000100016100
- (void)reset;	// IMP=0x00000001000160f4
- (id)initWithInitialState:(long long)arg1;	// IMP=0x0000000100016078
