...
- (void).cxx_destruct;	// IMP=0x00000001000a5e40
...
- (void)_handleNewRemoteConnection:(id)arg1;	// IMP=0x00000001000a5c98
- (void)_handleListenerError:(id)arg1;	// IMP=0x00000001000a5c40
- (void)_handleListenerEvent:(id)arg1;	// IMP=0x00000001000a5b18
- (void)listen;	// IMP=0x00000001000a5984
- (id)init;	// IMP=0x00000001000a5894
