...
+ (id)requestForSpeexRecordSettingsWithContext:(id)arg1;	// IMP=0x00000001000d88e0
+ (id)requestForOpusRecordSettingsWithContext:(id)arg1;	// IMP=0x00000001000d8744
+ (id)requestForLpcmRecordSettingsWithContext:(id)arg1;	// IMP=0x00000001000d8588
+ (id)defaultRequestWithContext:(id)arg1;	// IMP=0x00000001000d829c
- (void).cxx_destruct;	// IMP=0x00000001000d8e0c
...
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00000001000d8a68
