...
- (void).cxx_destruct;	// IMP=0x00000001000dbd58
...
- (struct AudioStreamBasicDescription)_defaultOutASBD;	// IMP=0x00000001000dbbac
- (id)_compensateChannelDataIfNeeded:(id)arg1 receivedNumChannels:(unsigned int)arg2;	// IMP=0x00000001000db9ac
- (id)_deinterleaveBufferIfNeeded:(struct AudioBufferList *)arg1;	// IMP=0x00000001000db85c
- (void)stopAudioStream;	// IMP=0x00000001000db6d8
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00000001000db5cc
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3 playbackStarted:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000001000db084
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000dafbc
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00000001000dafa0
- (void)_readAudioBufferAndFeed;	// IMP=0x00000001000da660
- (void)_startAudioFeedingTimer;	// IMP=0x00000001000da53c
- (void)stop;	// IMP=0x00000001000da390
- (void)_createDeInterleaverIfNeeded;	// IMP=0x00000001000da210
- (void)start;	// IMP=0x00000001000da180
- (void)attachDevice:(id)arg1;	// IMP=0x00000001000da17c
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00000001000da174
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00000001000da170
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00000001000da168
- (void)dealloc;	// IMP=0x00000001000da110
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00000001000d9fcc
