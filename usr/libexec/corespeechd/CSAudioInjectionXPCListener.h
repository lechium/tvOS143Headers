...
- (void).cxx_destruct;	// IMP=0x0000000100039918
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000397dc
- (void)listen;	// IMP=0x000000010003969c
