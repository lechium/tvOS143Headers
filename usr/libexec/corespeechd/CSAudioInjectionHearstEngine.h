...
- (void).cxx_destruct;	// IMP=0x000000010009f5f0
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x000000010009f488
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x000000010009ef58
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x000000010009ef54
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x000000010009ef50
- (void)stopAudioStream;	// IMP=0x000000010009ee18
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x000000010009ec74
- (_Bool)isRecording;	// IMP=0x000000010009ebc0
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010009eb24
- (_Bool)injectAudio:(id)arg1;	// IMP=0x000000010009eaf0
- (void)stop;	// IMP=0x000000010009ea14
- (void)start;	// IMP=0x000000010009e810
- (void)dealloc;	// IMP=0x000000010009e734
- (void)attachDevice:(id)arg1;	// IMP=0x000000010009e628
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x000000010009e574
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x000000010009e4f8
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x000000010009e4f0
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x000000010009e3cc
