...
- (void).cxx_destruct;	// IMP=0x0000000100082418
...
- (void)beepCancellerDidCancelSamples:(id)arg1 buffer:(id)arg2 timestamp:(unsigned long long)arg3;	// IMP=0x000000010008231c
- (void)zeroFilter:(id)arg1 zeroFilteredBufferAvailable:(id)arg2 atHostTime:(unsigned long long)arg3;	// IMP=0x0000000100082248
- (_Bool)_isNarrowBand:(float)arg1;	// IMP=0x0000000100082210
- (void)_reportMetrics;	// IMP=0x0000000100081ff0
- (_Bool)_isHeadphoneDeviceWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;	// IMP=0x0000000100081ca4
- (void)willBeepWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;	// IMP=0x0000000100081c0c
- (void)flush;	// IMP=0x0000000100081aec
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x0000000100081928
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00000001000816c4
- (id)initWithSampleRate:(float)arg1;	// IMP=0x00000001000815c4
