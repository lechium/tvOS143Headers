...
+ (id)stringForSecondPassResult:(unsigned long long)arg1;	// IMP=0x00000001000bca74
+ (id)timeStampString;	// IMP=0x00000001000bc994
+ (id)secondPassAudioLogDirectory;	// IMP=0x00000001000bc860
+ (id)secondPassAudioLoggingFilePath;	// IMP=0x00000001000bc788
- (void).cxx_destruct;	// IMP=0x00000001000bdc78
...
- (void)_clearSecondPassCompletionWatchDog;	// IMP=0x00000001000bd6a0
- (void)_scheduleDidStartSecondPassCompletionWatchDogWithToken:(id)arg1;	// IMP=0x00000001000bd4dc
- (void)_scheduleSecondPassCompletionWatchDog;	// IMP=0x00000001000bd2e8
- (void)_handleResultCompletion:(unsigned long long)arg1 voiceTriggerInfo:(id)arg2 error:(id)arg3;	// IMP=0x00000001000bd224
- (void)_setStartAnalyzeTime:(unsigned long long)arg1;	// IMP=0x00000001000bd108
- (void)_resetStartAnalyzeTime;	// IMP=0x00000001000bd0fc
- (_Bool)_shouldLogMediaplayState:(unsigned long long)arg1;	// IMP=0x00000001000bd08c
- (_Bool)_shouldRequestSingleChannelFromAudioProvider;	// IMP=0x00000001000bd088
- (void)_logSecondPassResult:(unsigned long long)arg1 withVTEI:(id)arg2;	// IMP=0x00000001000bcb20
- (void)CSVolumeMonitor:(id)arg1 didReceiveMusicVolumeChanged:(float)arg2;	// IMP=0x00000001000bc71c
- (void)CSMediaPlayingMonitor:(id)arg1 didReceiveMediaPlayingChanged:(long long)arg2;	// IMP=0x00000001000bc6b8
- (void)selfTriggerDetector:(id)arg1 didDetectSelfTrigger:(id)arg2;	// IMP=0x00000001000bc650
- (void)CSAudioServerCrashMonitorDidReceiveServerRestart:(id)arg1;	// IMP=0x00000001000bc4fc
- (void)_handlePHSResults:(id)arg1 voiceTriggerEventInfo:(id)arg2;	// IMP=0x00000001000bbb1c
- (void)_addPHSInfoToVTEI:(id)arg1 fromSpeakerInfo:(id)arg2;	// IMP=0x00000001000bb160
- (void)_getDidWakeAP:(id)arg1;	// IMP=0x00000001000bb0b0
- (void)_addDeviceStatusInfoToDict:(id)arg1;	// IMP=0x00000001000baec0
- (void)_addRejectStatsToDict:(id)arg1;	// IMP=0x00000001000bad4c
- (void)_handleVoiceTriggerFirstPassFromAOP:(id)arg1 audioProviderUUID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000ba5ec
- (void)CSVoiceTriggerEnabledMonitor:(id)arg1 didReceiveEnabled:(_Bool)arg2;	// IMP=0x00000001000ba534
- (void)_resetUpTime;	// IMP=0x00000001000ba438
- (void)_logUptimeWithVTSwitchChanged:(_Bool)arg1 VTEnabled:(_Bool)arg2;	// IMP=0x00000001000ba228
- (_Bool)_supportTwoShotFeedbackDelay;	// IMP=0x00000001000ba130
- (void)_handleSecondPassSuccess:(id)arg1;	// IMP=0x00000001000b9c34
- (void)_markSecondPassTriggerMachAbsoluteTime:(unsigned long long)arg1;	// IMP=0x00000001000b9ac8
- (void)keywordAnalyzerNDEAPI:(id)arg1 hasResultAvailable:(id)arg2 forChannel:(unsigned long long)arg3;	// IMP=0x00000001000b96f0
- (void)_analyzeForKeywordDetection:(id)arg1 forChannel:(unsigned long long)arg2 forceMaximized:(_Bool)arg3;	// IMP=0x00000001000b8e60
- (void)_mpAnalyzeForTriggerDetection:(id)arg1 forceMaximized:(_Bool)arg2;	// IMP=0x00000001000b8738
- (id)_getVoiceTriggerInfoWithLastResult:(id)arg1 withNumAnalyzedSamples:(unsigned long long)arg2 withKeywordScore:(float)arg3;	// IMP=0x00000001000b7524
- (id)_mpvtGetVoiceTriggerInfoWithLastResult:(id)arg1;	// IMP=0x00000001000b7210
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x00000001000b720c
- (void)_runRecognizersWithChunk:(id)arg1;	// IMP=0x00000001000b6eec
- (void)_handleAudioChunk:(id)arg1;	// IMP=0x00000001000b69dc
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x00000001000b6760
- (void)_computeEffectiveThreshold;	// IMP=0x00000001000b65b4
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x00000001000b6470
- (void)_didStopAudioStream;	// IMP=0x00000001000b62d0
- (void)_didStartAudioStream:(_Bool)arg1;	// IMP=0x00000001000b6128
- (void)_prepareStartAudioStream;	// IMP=0x00000001000b5f60
- (void)_notifySecondPassReject:(id)arg1 result:(unsigned long long)arg2;	// IMP=0x00000001000b5bd8
- (void)_voiceTriggerFirstPassDidDetectKeywordFrom:(unsigned long long)arg1 deviceId:(id)arg2 audioProviderUUID:(id)arg3 firstPassInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000001000b5088
- (void)cancelCurrentRequest;	// IMP=0x00000001000b4dfc
- (void)handleVoiceTriggerSecondPassFrom:(unsigned long long)arg1 deviceId:(id)arg2 audioProviderUUID:(id)arg3 firstPassInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000001000b4d64
- (void)_handleVoiceTriggerFirstPassFromJarvis:(unsigned long long)arg1 deviceId:(id)arg2 audioProviderUUID:(id)arg3 firstPassInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000001000b46fc
- (void)_handleVoiceTriggerFirstPassFromHearstAP:(unsigned long long)arg1 deviceId:(id)arg2 audioProviderUUID:(id)arg3 firstPassInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000001000b4158
- (void)_handleVoiceTriggerFirstPassFromRemora:(unsigned long long)arg1 deviceId:(id)arg2 audioProviderUUID:(id)arg3 firstPassInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000001000b3dac
- (void)_handleVoiceTriggerFirstPassFromHearst:(unsigned long long)arg1 deviceId:(id)arg2 audioProviderUUID:(id)arg3 firstPassInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000001000b3894
- (void)_handleVoiceTriggerFirstPassFromAP:(id)arg1 audioProviderUUID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000b31cc
- (void)_requestStartAudioStreamWitContext:(id)arg1 audioProviderUUID:(id)arg2 startStreamOption:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000b2a0c
- (void)_clearTriggerCandidate;	// IMP=0x00000001000b2910
- (void)_initializeMediaPlayingState;	// IMP=0x00000001000b270c
- (void)_setAsset:(id)arg1;	// IMP=0x00000001000b1938
- (void)setAsset:(id)arg1;	// IMP=0x00000001000b18a0
- (void)_reset;	// IMP=0x00000001000b172c
- (void)reset;	// IMP=0x00000001000b16c4
- (void)start;	// IMP=0x00000001000b1610
- (void)dealloc;	// IMP=0x00000001000b1470
- (id)initWithPHSEnabled:(_Bool)arg1;	// IMP=0x00000001000b1460
- (id)initWithPHSEnabled:(_Bool)arg1 speechManager:(id)arg2;	// IMP=0x00000001000b1158
