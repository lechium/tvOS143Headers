...
- (void).cxx_destruct;	// IMP=0x0000000100072efc
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x0000000100072cc0
- (void)_calculateSpeechVoicingLevel;	// IMP=0x0000000100072af0
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x0000000100072ab0
- (void)calculateShadowMicScore;	// IMP=0x00000001000727c8
- (void)addDataToBuffer:(id)arg1;	// IMP=0x00000001000727b8
- (id)init;	// IMP=0x000000010007272c
