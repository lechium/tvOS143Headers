...
- (void).cxx_destruct;	// IMP=0x0000000100092e10
...
- (void)cancelAudioStreamHold;	// IMP=0x0000000100092d4c
- (void)holdAudioStreamWithTimeout:(double)arg1;	// IMP=0x0000000100092ce4
- (void)setAsset:(id)arg1;	// IMP=0x0000000100092cd4
- (void)reset;	// IMP=0x0000000100092cb8
- (void)start;	// IMP=0x0000000100092ca8
- (void)dealloc;	// IMP=0x0000000100092be4
- (id)initWithDeviceID:(id)arg1;	// IMP=0x0000000100092b20
