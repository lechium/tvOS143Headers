...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010008748c
- (void).cxx_destruct;	// IMP=0x0000000100087644
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100087588
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100087494
- (id)initWithVolumeEstimate:(float)arg1 debugLogFile:(id)arg2;	// IMP=0x0000000100087404
