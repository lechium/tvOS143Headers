...
+ (id)noAlertOption;	// IMP=0x0000000100023a68
...
- (id)initWithXPCObject:(id)arg1;	// IMP=0x0000000100023aa4
- (long long)_alertBehaviorTypeFromAVVCOberrideType:(long long)arg1;	// IMP=0x00000001000064b4
- (long long)_avvcAlertOverrideType:(long long)arg1;	// IMP=0x00000001000064a0
- (id)avvcAlertBehavior;	// IMP=0x00000001000062c4
- (void)setAVVCAlertBehavior:(id)arg1;	// IMP=0x0000000100006084
- (id)avvcSettings;	// IMP=0x0000000100005f5c
- (id)avvcStartRecordSettingsWithAudioStreamHandleId:(unsigned long long)arg1;	// IMP=0x0000000100005c94
