...
- (void).cxx_destruct;	// IMP=0x0000000100099ec8
...
- (id)metrics;	// IMP=0x0000000100099e50
- (void)flush;	// IMP=0x0000000100099dc4
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x0000000100099b2c
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00000001000998d0
- (id)init;	// IMP=0x000000010009989c
