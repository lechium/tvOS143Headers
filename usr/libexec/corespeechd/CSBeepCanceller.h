...
- (id).cxx_construct;	// IMP=0x0000000100075ad0
...
- (void)flush;	// IMP=0x000000010007561c
- (void)reset;	// IMP=0x00000001000754e4
- (void)willBeep;	// IMP=0x00000001000753c8
- (void)cancelBeepFromSamples:(id)arg1 timestamp:(unsigned long long)arg2;	// IMP=0x0000000100075104
- (id)init;	// IMP=0x0000000100074b04
