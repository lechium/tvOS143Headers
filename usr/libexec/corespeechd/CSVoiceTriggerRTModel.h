...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100039948
- (void).cxx_destruct;	// IMP=0x000000010003a1e4
...
- (id)description;	// IMP=0x000000010003a030
- (id)builtInRTModelDictionary;	// IMP=0x0000000100039ef4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100039e14
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100039c08
- (id)initWithData:(id)arg1 hash:(id)arg2 locale:(id)arg3;	// IMP=0x0000000100039b38
- (id)initWithHash:(id)arg1 locale:(id)arg2;	// IMP=0x0000000100039a94
- (id)initWithData:(id)arg1 hash:(id)arg2 locale:(id)arg3 digest:(id)arg4 signature:(id)arg5 certificate:(id)arg6;	// IMP=0x0000000100039950
