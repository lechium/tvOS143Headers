...
- (void).cxx_destruct;	// IMP=0x00000001002b104c
- (id)generate;	// IMP=0x00000001002b0f98
- (void)setGenerationsByDataType:(id)arg1;	// IMP=0x00000001002b0f64
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001002b0eec
- (id)init;	// IMP=0x00000001002b0edc
