...
- (void).cxx_destruct;	// IMP=0x00000001001a7c84
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00000001001a8118
- (id)metricValue;	// IMP=0x00000001001a7cfc
