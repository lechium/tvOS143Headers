...
- (void).cxx_destruct;	// IMP=0x000000010010cd64
...
- (void)reset;	// IMP=0x000000010010cd04
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000010010cc40
