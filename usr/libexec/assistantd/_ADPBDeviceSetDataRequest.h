...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x00000001000dda68
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x000000010008ddf8
- (void).cxx_destruct;	// IMP=0x00000001000e0a54
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000e022c
- (unsigned long long)hash;	// IMP=0x00000001000dff18
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000df9ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000df42c
- (void)copyTo:(id)arg1;	// IMP=0x00000001000deff4
- (void)writeTo:(id)arg1;	// IMP=0x00000001000debc4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000debbc
- (id)dictionaryRepresentation;	// IMP=0x00000001000ddc78
- (id)description;	// IMP=0x00000001000ddbc4
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00000001000dda50
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00000001000dda38
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x00000001000dd9c4
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x00000001000dd9ac
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000aa758
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100120060
