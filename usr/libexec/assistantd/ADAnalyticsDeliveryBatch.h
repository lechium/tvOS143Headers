...
- (void).cxx_destruct;	// IMP=0x00000001001e17f8
...
- (id)analyticsDictionary;	// IMP=0x00000001001e1500
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x00000001001e14f4
- (void)markSucceeded;	// IMP=0x00000001001e14e8
- (void)markEndTime;	// IMP=0x00000001001e14a4
- (void)markStartTime;	// IMP=0x00000001001e1460
- (_Bool)hasFailureType;	// IMP=0x00000001001e1450
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x00000001001e13c4
