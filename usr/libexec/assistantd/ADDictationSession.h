...
- (void).cxx_destruct;	// IMP=0x00000001000c02b0
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00000001000bff50
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00000001000bfc30
- (void)dealloc;	// IMP=0x00000001000bf944
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00000001000bf818
- (id)init;	// IMP=0x00000001000bf800
