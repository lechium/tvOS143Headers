...
- (void).cxx_destruct;	// IMP=0x00000001000dccdc
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dcc5c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dcc58
- (void)setDuration:(double)arg1;	// IMP=0x00000001000dcbd4
- (void)setState:(unsigned long long)arg1;	// IMP=0x00000001000dcbb0
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) long long type;
- (id)initWithTimerID:(id)arg1 state:(unsigned long long)arg2 duration:(double)arg3 remainingTime:(double)arg4 lastModifiedDate:(id)arg5 title:(id)arg6 siriContext:(id)arg7;	// IMP=0x00000001000dc94c
