...
- (void).cxx_destruct;	// IMP=0x00000001001e10f0
- (id)generate;	// IMP=0x00000001001e0f80
- (void)setDeletedItemUUIDs:(id)arg1;	// IMP=0x00000001001e0f4c
- (void)setInsertedOrUpdatedItems:(id)arg1;	// IMP=0x00000001001e0f14
- (void)setDate:(id)arg1;	// IMP=0x00000001001e0edc
- (void)setGeneration:(unsigned long long)arg1;	// IMP=0x00000001001e0ec8
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001001e0e50
- (id)init;	// IMP=0x00000001001e0e40
