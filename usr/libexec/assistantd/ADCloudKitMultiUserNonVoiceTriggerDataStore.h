...
- (void).cxx_destruct;	// IMP=0x000000010022411c
...
- (void)synchronizeUsingActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001002240ac
- (void)fetchDeviceTypesForAllLanguages:(CDUnknownBlockType)arg1;	// IMP=0x0000000100224090
- (void)fetchDeviceTypesForLanguage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100224078
- (void)deleteUserData:(id)arg1;	// IMP=0x0000000100223fd4
- (void)mergeDataWithModifiedRecords:(id)arg1 deletedRecordIDs:(id)arg2 containsAllChanges:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100223f08
- (void)synchronizeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100223e3c
@property(retain, nonatomic) CKServerChangeToken *serverChangeToken;
@property(nonatomic) _Bool hasSetUpRecordZoneSubscription;
- (id)init;	// IMP=0x0000000100223a8c
