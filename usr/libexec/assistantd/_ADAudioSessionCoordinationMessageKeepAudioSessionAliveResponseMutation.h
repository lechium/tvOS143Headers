...
- (void).cxx_destruct;	// IMP=0x00000001000eba44
- (id)generate;	// IMP=0x00000001000eba10
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001000eb998
- (id)init;	// IMP=0x00000001000eb988
