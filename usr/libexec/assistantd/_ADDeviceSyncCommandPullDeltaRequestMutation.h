...
- (void).cxx_destruct;	// IMP=0x00000001002ad2cc
- (id)generate;	// IMP=0x00000001002ad1b8
- (void)setLimit:(unsigned long long)arg1;	// IMP=0x00000001002ad1a0
- (void)setGeneration:(unsigned long long)arg1;	// IMP=0x00000001002ad188
- (void)setDataType:(id)arg1;	// IMP=0x00000001002ad154
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001002ad0dc
- (id)init;	// IMP=0x00000001002ad0cc
