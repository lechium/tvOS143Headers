...
- (void).cxx_destruct;	// IMP=0x00000001000fc5a0
- (id)build;	// IMP=0x00000001000fc380
- (void)setStorageValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000001000fc23c
- (void)reset;	// IMP=0x00000001000fc1d0
