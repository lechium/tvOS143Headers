...
- (void).cxx_destruct;	// IMP=0x00000001000dd670
...
- (void)synchronizeUsingActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000dd5f0
- (void)fetchDeviceTypesForAllLanguages:(CDUnknownBlockType)arg1;	// IMP=0x00000001000dd5d4
- (void)fetchDeviceTypesForLanguage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000dd5bc
- (void)deleteUserData:(id)arg1;	// IMP=0x00000001000dd518
- (void)mergeDataWithModifiedRecords:(id)arg1 deletedRecordIDs:(id)arg2 containsAllChanges:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000dd44c
- (void)synchronizeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000dd264
@property(retain, nonatomic) CKServerChangeToken *serverChangeToken;
@property(nonatomic) _Bool hasSetUpRecordZoneSubscription;
- (id)init;	// IMP=0x00000001000dd15c
