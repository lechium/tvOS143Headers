...
- (void).cxx_destruct;	// IMP=0x0000000100100a9c
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000100100a5c
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000001001009fc
@property double endWaitTime;
@property double interspeechWaitTime;
@property double startWaitTime;
@property int endpointMode;
- (void)reset;	// IMP=0x000000010010096c
- (int)getStatus:(struct AudioQueueBuffer *)arg1;	// IMP=0x00000001001008dc
- (_Bool)configureWithASBD:(struct AudioStreamBasicDescription *)arg1 andFrameRate:(unsigned int)arg2;	// IMP=0x0000000100100838
