...
+ (id)sharedDiagnostics;	// IMP=0x00000001001a5fbc
- (void).cxx_destruct;	// IMP=0x00000001001a7b38
...
- (unsigned long long)_AWDTimestampTruncatedToHourPrecision;	// IMP=0x00000001001a7a60
- (double)_currentTime;	// IMP=0x00000001001a7a04
- (void)_submitMetricWithIdentifier:(unsigned int)arg1 hotShipIdentifier:(unsigned int)arg2 hotShipTimestamp:(unsigned long long)arg3 generation:(CDUnknownBlockType)arg4;	// IMP=0x00000001001a7894
- (void)_submitMetricWithIdentifier:(unsigned int)arg1 generation:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a7790
...
- (unsigned long long)_durationInMillisecondsFromTime:(double)arg1 toTime:(double)arg2;	// IMP=0x00000001001a7768
- (void)logSpeechRecognized;	// IMP=0x00000001001a7460
- (void)logNetworkAnalyzeRunWithResults:(id)arg1;	// IMP=0x00000001001a7270
- (void)logVoiceSendEnd;	// IMP=0x00000001001a6f98
- (void)logVoiceSendStart;	// IMP=0x00000001001a6da0
- (void)logVoiceRecordingEnd;	// IMP=0x00000001001a6ac8
- (void)logVoiceRecordingStart;	// IMP=0x00000001001a68d0
- (void)logConnectionFailedWithError:(id)arg1 connectionType:(long long)arg2;	// IMP=0x00000001001a662c
- (void)logConnectionOpenWithConnectionType:(long long)arg1;	// IMP=0x00000001001a6390
- (void)logConnectionStart;	// IMP=0x00000001001a619c
- (void)flush;	// IMP=0x00000001001a6158
- (id)init;	// IMP=0x00000001001a6028
