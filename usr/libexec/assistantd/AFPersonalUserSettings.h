...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010013c68c
- (void).cxx_destruct;	// IMP=0x000000010013c91c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010013c74c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010013c694
