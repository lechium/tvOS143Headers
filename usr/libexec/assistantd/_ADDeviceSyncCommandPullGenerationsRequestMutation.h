...
- (void).cxx_destruct;	// IMP=0x000000010009033c
- (id)generate;	// IMP=0x0000000100090288
- (void)setDataTypes:(id)arg1;	// IMP=0x0000000100090254
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001000901dc
- (id)init;	// IMP=0x00000001000901cc
