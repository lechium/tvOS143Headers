...
- (void).cxx_destruct;	// IMP=0x000000010020a70c
...
- (id)dictionaryRepresentation;	// IMP=0x000000010020a64c
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 RSSI:(id)arg3 state:(id)arg4;	// IMP=0x000000010020a550
