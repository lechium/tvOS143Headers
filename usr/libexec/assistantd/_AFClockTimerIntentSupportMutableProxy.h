...
- (void).cxx_destruct;	// IMP=0x00000001000dd124
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dcfd8
@property(readonly, nonatomic) NSArray *trackedChanges;
- (void)setDuration:(double)arg1;	// IMP=0x00000001000dce50
- (void)setState:(unsigned long long)arg1;	// IMP=0x00000001000dcd24
