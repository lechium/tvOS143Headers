...
- (void).cxx_destruct;	// IMP=0x000000010001ef54
...
- (_Bool)isAlive;	// IMP=0x000000010001ef1c
- (void)registerClientsForMonitoring;	// IMP=0x000000010001ef0c
- (id)init;	// IMP=0x000000010001ee6c
