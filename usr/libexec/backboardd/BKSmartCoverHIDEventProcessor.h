...
+ (_Bool)isSmartCoverSupported;	// IMP=0x000000010004c784
- (void).cxx_destruct;	// IMP=0x000000010004c5f8
...
- (id)addSmartCoverObserver:(id)arg1;	// IMP=0x000000010004c4b8
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x000000010004be2c
@property(readonly, nonatomic, getter=isSmartCoverClosed) _Bool smartCoverClosed;
- (int)_smartCoverSensorsDidDisengage:(unsigned long long)arg1;	// IMP=0x000000010004bd94
- (int)_smartCoverSensorsDidEngage:(unsigned long long)arg1;	// IMP=0x000000010004bd58
- (id)initWithContext:(id)arg1;	// IMP=0x000000010004bb0c
- (unsigned long long)_currentMaskForUsage:(unsigned int)arg1 HIDSystem:(id)arg2 mask:(unsigned long long *)arg3 maskIfEngaged:(unsigned long long *)arg4;	// IMP=0x000000010004b9b8
- (id)initWithSupportedHES:(unsigned long long)arg1 disengagedHES:(unsigned long long)arg2 attached:(_Bool)arg3 unknownState:(_Bool)arg4;	// IMP=0x000000010004b78c
