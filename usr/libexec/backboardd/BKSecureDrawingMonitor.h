...
+ (id)sharedInstance;	// IMP=0x000000010003fd7c
- (void).cxx_destruct;	// IMP=0x000000010003f81c
@property(getter=isSecureModeEnabled) _Bool secureModeEnabled; // @synthesize secureModeEnabled=_secureModeEnabled;
- (void)reportAndKillInsecureProcesses;	// IMP=0x000000010003f4f4
- (void)startMonitoringSecureDrawing;	// IMP=0x000000010003f494
- (id)init;	// IMP=0x000000010003f3d8
