...
- (void).cxx_destruct;	// IMP=0x000000010004b338
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x000000010004b0c4
- (void)activate;	// IMP=0x000000010004b0b4
- (id)initWithObservationManager:(id)arg1;	// IMP=0x000000010004afc4
