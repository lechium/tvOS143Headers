...
- (void).cxx_destruct;	// IMP=0x00000001000208a8
...
- (void)_loadAllImages;	// IMP=0x00000001000207ec
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x00000001000205f0
- (id)_idiomSuffix;	// IMP=0x0000000100020544
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x0000000100020248
- (id)allImages;	// IMP=0x0000000100020214
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x0000000100020208
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x00000001000200d0
