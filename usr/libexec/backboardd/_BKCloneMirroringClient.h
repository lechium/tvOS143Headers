...
+ (id)defaultClient;	// IMP=0x000000010004d9d0
- (void).cxx_destruct;	// IMP=0x000000010004d958
...
- (id)initWithMode:(unsigned long long)arg1 port:(id)arg2 auditToken:(id)arg3;	// IMP=0x000000010004d7d4
