...
- (void).cxx_destruct;	// IMP=0x000000010005f8a4
...
- (id)touchStreamClientForReference:(unsigned int)arg1;	// IMP=0x000000010005f83c
- (unsigned int)addTouchStreamClient:(id)arg1 toDisplayUUID:(id)arg2;	// IMP=0x000000010005f65c
- (void)enumerateTouchStreamsForAllDisplaysUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f5e8
- (void)enumerateDigitizersForAllDisplaysUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f574
- (void)enumerateDigitizersForDisplay:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010005f3b8
- (id)touchStreamInfoForDisplayUUID:(id)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x000000010005f2dc
- (struct OpaqueBKDigitizerInfo *)infoForDigitizerService:(id)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x000000010005edb8
- (id)_displayInfoForDisplay:(id)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x000000010005ed14
