...
- (void).cxx_destruct;	// IMP=0x000000010002fe08
...
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x000000010002fb58
- (void)getStatus:(unsigned long long *)arg1 presence:(_Bool *)arg2 proximityInCentimeters:(double *)arg3 forDisplayUUID:(id)arg4;	// IMP=0x000000010002fab4
- (void)_setPresence:(_Bool)arg1 forDisplayUUID:(id)arg2;	// IMP=0x000000010002fa20
- (void)_setProximityInCentimeters:(double)arg1 forDisplayUUID:(id)arg2;	// IMP=0x000000010002f98c
- (void)serviceDidDisappear:(id)arg1;	// IMP=0x000000010002f7d4
- (void)matcher:(id)arg1 servicesDidMatch:(id)arg2;	// IMP=0x000000010002f574
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000010002f48c
- (id)init;	// IMP=0x000000010002f33c
