...
- (void)applyEventPhase:(unsigned short)arg1 down:(_Bool)arg2;	// IMP=0x0000000100016418
- (id)conciseDescription;	// IMP=0x00000001000162e4
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000001000161b0
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x000000010001615c
- (id)succinctDescriptionBuilder;	// IMP=0x0000000100016144
- (id)succinctDescription;	// IMP=0x00000001000160f0
