...
+ (id)workQueue;	// IMP=0x0000000100045efc
- (void).cxx_destruct;	// IMP=0x000000010004596c
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x00000001000458d4
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x00000001000458c4
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x0000000100045734
