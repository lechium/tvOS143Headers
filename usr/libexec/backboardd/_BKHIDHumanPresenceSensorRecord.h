...
- (void).cxx_destruct;	// IMP=0x000000010004de60
...
- (void)removeService:(id)arg1;	// IMP=0x000000010004ddf4
- (void)addService:(id)arg1;	// IMP=0x000000010004dd80
- (void)_resetServiceStatus;	// IMP=0x000000010004dbc8
- (id)description;	// IMP=0x000000010004dad0
