...
- (void).cxx_destruct;	// IMP=0x0000000100017d68
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x0000000100017b80
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x0000000100017abc
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x0000000100017a30
