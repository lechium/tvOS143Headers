...
+ (id)keyboardInfoWithIOHIDService:(id)arg1;	// IMP=0x000000010004a1b8
- (void).cxx_destruct;	// IMP=0x0000000100049fec
...
- (void)loadModifierKeyRemapping;	// IMP=0x0000000100049a28
- (void)setCapsLockDelayOverride:(double)arg1;	// IMP=0x00000001000498e8
- (void)setCapsLockLEDOn:(_Bool)arg1;	// IMP=0x0000000100049810
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0000000100049308
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000001000492a4
- (id)initWithService:(id)arg1;	// IMP=0x00000001000490cc
