...
+ (id)relativeToBottomMiddleOfSuper:(struct CGPoint)arg1;	// IMP=0x00000001000565e8
+ (id)relativeToBottomLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x0000000100056564
+ (id)relativeToTopLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x00000001000564e0
+ (id)centerAtPoint:(struct CGPoint)arg1;	// IMP=0x0000000100056470
+ (id)controlledBySupernode;	// IMP=0x0000000100056430
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100056308
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000562c0
