...
- (void).cxx_destruct;	// IMP=0x000000010004437c
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000001000441b8
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000100044164
- (id)succinctDescriptionBuilder;	// IMP=0x00000001000440bc
- (id)succinctDescription;	// IMP=0x0000000100044068
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000010004400c
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000100043f70
