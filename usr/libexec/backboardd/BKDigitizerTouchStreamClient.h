...
- (void)watchForPortDeathOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000001000556a4
- (id)description;	// IMP=0x00000001000554c0
- (void)invalidate;	// IMP=0x000000010005544c
- (void)dealloc;	// IMP=0x00000001000553b0
- (id)init;	// IMP=0x000000010005536c
