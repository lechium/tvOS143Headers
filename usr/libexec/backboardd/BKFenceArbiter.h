...
+ (id)sharedInstance;	// IMP=0x0000000100007148
- (void).cxx_destruct;	// IMP=0x0000000100005c00
- (id)_newAssertionForTriggerPort:(unsigned int)arg1;	// IMP=0x0000000100005618
- (id)_newFenceHandle;	// IMP=0x0000000100004b48
