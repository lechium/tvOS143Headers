...
- (void)dealloc;	// IMP=0x0000000100010594
- (void)_endSession;	// IMP=0x0000000100010448
- (id)eventOccurance;	// IMP=0x0000000100010240
- (id)eventDurations;	// IMP=0x000000010000ff48
- (void)recordEvent:(id)arg1;	// IMP=0x000000010000fecc
- (void)recordEvent:(id)arg1 occuredAt:(id)arg2;	// IMP=0x000000010000fc30
- (id)initForType:(id)arg1 withMetadata:(id)arg2;	// IMP=0x000000010000fb68
