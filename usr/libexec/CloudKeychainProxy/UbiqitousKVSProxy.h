...
+ (id)withAccount:(id)arg1 store:(id)arg2 lockMonitor:(id)arg3 persistence:(id)arg4;	// IMP=0x0000000100008840
- (void).cxx_destruct;	// IMP=0x00000001000062fc
...
- (void)processPendingKeysForCurrentLockState;	// IMP=0x00000001000060b8
- (void)processKeyChangedEvent:(id)arg1;	// IMP=0x0000000100005d74
- (id)copyValues:(id)arg1;	// IMP=0x0000000100005c5c
- (id)pendKeysAndGetPendingForCurrentLockState:(id)arg1;	// IMP=0x0000000100005c20
- (id)pendingKeysForCurrentLockState;	// IMP=0x0000000100005bd8
- (void)intersectWithCurrentLockState:(id)arg1;	// IMP=0x0000000100005b68
- (id)pendKeysAndGetNewlyPended:(id)arg1;	// IMP=0x0000000100005aa4
- (id)keysForCurrentLockState;	// IMP=0x00000001000059bc
- (void)unlocked;	// IMP=0x0000000100005964
- (void)locked;	// IMP=0x000000010000590c
- (void)storeAccountChanged;	// IMP=0x00000001000058b4
- (void)storeKeysChanged:(id)arg1 initial:(_Bool)arg2;	// IMP=0x0000000100005824
- (void)handleNotification:(const char *)arg1;	// IMP=0x00000001000057cc
- (void)_queue_kvsStoreChange;	// IMP=0x0000000100005754
- (void)_queue_unlocked;	// IMP=0x0000000100005654
- (void)_queue_locked;	// IMP=0x000000010000559c
- (void)requestEnsurePeerRegistration;	// IMP=0x000000010000553c
- (_Bool)hasPendingKey:(id)arg1;	// IMP=0x0000000100005470
- (_Bool)hasSyncPendingFor:(id)arg1;	// IMP=0x00000001000053f0
- (void)requestSyncWithPeerIDs:(id)arg1 backupPeerIDs:(id)arg2;	// IMP=0x0000000100005240
- (_Bool)hasPendingSyncIDs;	// IMP=0x00000001000051f4
- (_Bool)hasPendingShadowSyncIDs;	// IMP=0x00000001000051a4
- (_Bool)hasPendingNonShadowSyncIDs;	// IMP=0x0000000100005158
- (void)doSyncWithAllPeers;	// IMP=0x00000001000050b8
- (void)doSyncWithPendingPeers;	// IMP=0x0000000100005018
- (void)doEnsurePeerRegistration;	// IMP=0x0000000100004f5c
- (void)handlePendingEnsurePeerRegistrationRequests:(_Bool)arg1;	// IMP=0x0000000100004f00
- (void)sendKeysCallout:(CDUnknownBlockType)arg1;	// IMP=0x0000000100004e6c
- (void)calloutWith:(CDUnknownBlockType)arg1;	// IMP=0x0000000100004dd4
- (void)doAfterFlush:(CDUnknownBlockType)arg1;	// IMP=0x0000000100004d88
- (void)_queue_storeAccountChanged;	// IMP=0x0000000100004c30
- (void)_queue_storeKeysChanged:(id)arg1 initial:(_Bool)arg2;	// IMP=0x00000001000049c0
- (void)_queue_handleNotification:(const char *)arg1;	// IMP=0x0000000100004948
- (void)registerKeys:(id)arg1 forAccount:(id)arg2;	// IMP=0x0000000100004574
- (void)removeKeys:(id)arg1 forAccount:(id)arg2;	// IMP=0x000000010000440c
- (void)registerAtTimeKeys:(id)arg1;	// IMP=0x000000010000427c
- (id)copyAllKeyInterests;	// IMP=0x000000010000420c
- (void)waitForSyncDone:(_Bool)arg1 error:(id)arg2;	// IMP=0x00000001000040a4
- (void)waitForSynchronization:(CDUnknownBlockType)arg1;	// IMP=0x0000000100003ec0
- (void)setObjectsFromDictionary:(id)arg1;	// IMP=0x0000000100003eb4
- (void)setStoreObjectsFromDictionary:(id)arg1;	// IMP=0x0000000100003a74
- (void)perfCounters:(CDUnknownBlockType)arg1;	// IMP=0x0000000100003a08
- (void)persistState;	// IMP=0x00000001000038c8
@property(retain, nonatomic) NSDictionary *persistentData;
- (void)dealloc;	// IMP=0x00000001000032d4
- (void)_queue_processAllItems;	// IMP=0x0000000100003160
- (id)copyAsDictionary;	// IMP=0x0000000100003114
- (id)objectForKey:(id)arg1;	// IMP=0x0000000100003094
- (void)synchronizeStore;	// IMP=0x0000000100003020
- (void)clearStore;	// IMP=0x0000000100002fe0
@property(readonly, copy) NSString *description;
- (id)initWithAccount:(id)arg1 store:(id)arg2 lockMonitor:(id)arg3 persistence:(id)arg4;	// IMP=0x0000000100002a58
