...
+ (id)monitor;	// IMP=0x0000000100002388
- (void).cxx_destruct;	// IMP=0x00000001000022cc
...
- (void)_onqueueRecheck;	// IMP=0x000000010000209c
- (void)recheck;	// IMP=0x0000000100002044
- (void)connectTo:(id)arg1;	// IMP=0x0000000100002010
- (void)notifyListener;	// IMP=0x0000000100001fa0
- (void)handleNotification:(const char *)arg1;	// IMP=0x0000000100001f58
- (id)init;	// IMP=0x0000000100001df0
