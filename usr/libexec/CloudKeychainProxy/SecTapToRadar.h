...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x0000000100011908
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x00000001000117f4
+ (void)disableTTRsEntirely;	// IMP=0x00000001000117f0
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x00000001000117e8
+ (id)keyname:(id)arg1;	// IMP=0x0000000100011768
...
- (void)trigger;	// IMP=0x000000010001149c
- (void)clearRetryTimestamp;	// IMP=0x0000000100011418
- (void)updateRetryTimestamp;	// IMP=0x0000000100011338
- (_Bool)isRateLimited;	// IMP=0x0000000100011210
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x00000001000110a4
