...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100160dd8
- (unsigned long long)hash;	// IMP=0x0000000100160ce4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100160b30
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001609d0
- (void)copyTo:(id)arg1;	// IMP=0x000000010016088c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100160754
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010016074c
- (id)dictionaryRepresentation;	// IMP=0x000000010015fe4c
- (id)description;	// IMP=0x000000010015fd98
