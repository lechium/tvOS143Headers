...
+ (id)sharedManager;	// IMP=0x00000001000ddff4
- (void).cxx_destruct;	// IMP=0x00000001000df1a8
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00000001000df04c
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00000001000df03c
- (void)appleAccountSignedOut;	// IMP=0x00000001000defbc
- (void)appleAccountSignedIn;	// IMP=0x00000001000def3c
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000001000deeb4
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001000debec
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001000de874
- (void)cleanUpConnections;	// IMP=0x00000001000de5d4
- (void)start;	// IMP=0x00000001000de1b8
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00000001000de060
