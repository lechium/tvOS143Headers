...
- (void).cxx_destruct;	// IMP=0x0000000100087790
...
- (void)service:(id)arg1 nearbyDevicesChanged:(id)arg2;	// IMP=0x0000000100087680
- (void)service:(id)arg1 devicesChanged:(id)arg2;	// IMP=0x0000000100087500
- (void)nearbyServiceDevicesChanged:(id)arg1;	// IMP=0x0000000100087044
- (void)activityServiceDevicesChanged:(id)arg1;	// IMP=0x0000000100087040
- (id)idsDeviceFromBTIdentifier:(id)arg1;	// IMP=0x0000000100086d00
- (void)stop;	// IMP=0x0000000100086cfc
- (_Bool)restart;	// IMP=0x0000000100086cf4
- (void)start;	// IMP=0x0000000100086cf0
- (id)init;	// IMP=0x0000000100086c54
