...
- (void).cxx_destruct;	// IMP=0x00000001001d1f50
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x00000001001d1040
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x00000001001d0d40
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x00000001001d05a8
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x00000001001d0188
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001cfe80
- (void)consumeAuthTokenIfReady;	// IMP=0x00000001001cf904
- (void)startAWDL;	// IMP=0x00000001001ced70
- (void)handleConfirmationACK;	// IMP=0x00000001001ceb10
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00000001001ce6dc
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00000001001cded8
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x00000001001cdb6c
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x00000001001cd4e4
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00000001001cd040
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001001ccdf0
- (void)handleWiFiRequestInvalidated;	// IMP=0x00000001001ccd84
- (void)handleRangingStarted;	// IMP=0x00000001001ccce4
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x00000001001ccc1c
- (void)handleAWDLUp;	// IMP=0x00000001001cca48
- (void)handlePeerOutOfRange;	// IMP=0x00000001001cc770
- (void)handlePeerInRange;	// IMP=0x00000001001cc618
- (_Bool)peerInRange:(id)arg1;	// IMP=0x00000001001cc364
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x00000001001cbf04
- (void)invalidateConfirmationTimer;	// IMP=0x00000001001cbe2c
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000001001cbba8
- (void)handleTimerFired;	// IMP=0x00000001001cb640
- (void)invalidateTimerIfReady;	// IMP=0x00000001001cb5e8
- (id)aksPeerAvailable;	// IMP=0x00000001001cb3e0
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001001caff8
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x00000001001cad00
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001001cac94
- (void)connectionActivated;	// IMP=0x00000001001ca978
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x00000001001ca35c
- (id)getAppName;	// IMP=0x00000001001ca354
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x00000001001ca220
- (_Bool)isAcceptor;	// IMP=0x00000001001ca218
- (id)attemptResults;	// IMP=0x00000001001c9650
- (void)logResults;	// IMP=0x00000001001c8838
- (void)displayConfigChanged:(id)arg1;	// IMP=0x00000001001c8794
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x00000001001c86f0
- (void)removeObservers;	// IMP=0x00000001001c86a0
- (void)addObservers;	// IMP=0x00000001001c8598
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x00000001001c8430
- (void)_handleCanceledAfterSuccess;	// IMP=0x00000001001c8328
- (void)handleCanceledAfterSuccess;	// IMP=0x00000001001c829c
- (void)lockKeyBagIfNeeded;	// IMP=0x00000001001c81b8
- (void)_cancel;	// IMP=0x00000001001c7e44
- (void)cancel;	// IMP=0x00000001001c7db8
- (void)invalidateNoDisconnect;	// IMP=0x00000001001c7d84
- (void)invalidate;	// IMP=0x00000001001c7b80
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001001c778c
