...
- (void).cxx_destruct;	// IMP=0x00000001000ca018
...
- (void)stop;	// IMP=0x00000001000c9f74
- (int)start;	// IMP=0x00000001000c9c8c
- (void)mount;	// IMP=0x00000001000c9c88
- (void)bonjourResolverDidChange:(id)arg1;	// IMP=0x00000001000c99d0
- (void)mountDiskImageAsync;	// IMP=0x00000001000c99cc
- (void)notifyClientAboutResolve:(int)arg1;	// IMP=0x00000001000c9898
- (void)dealloc;	// IMP=0x00000001000c9850
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x00000001000c97d0
