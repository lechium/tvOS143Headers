...
- (void).cxx_destruct;	// IMP=0x0000000100108430
...
- (void)stop;	// IMP=0x000000010010839c
- (int)start;	// IMP=0x00000001001082ec
- (void)eject;	// IMP=0x00000001001080b8
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x00000001001080b4
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x0000000100107f34
- (void)dealloc;	// IMP=0x0000000100107eec
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x0000000100107e78
