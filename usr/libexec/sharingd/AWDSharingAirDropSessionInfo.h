...
- (void).cxx_destruct;	// IMP=0x00000001000895f0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000892f4
- (unsigned long long)hash;	// IMP=0x0000000100089144
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100088ebc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100088c78
- (void)copyTo:(id)arg1;	// IMP=0x0000000100088a78
- (void)writeTo:(id)arg1;	// IMP=0x00000001000888a8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000888a0
- (id)dictionaryRepresentation;	// IMP=0x0000000100087d04
- (id)description;	// IMP=0x0000000100087c50
