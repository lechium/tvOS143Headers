...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010017618c
- (unsigned long long)hash;	// IMP=0x00000001001760d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100175f8c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100175e7c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100175d88
- (void)writeTo:(id)arg1;	// IMP=0x0000000100175c98
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100175c90
- (id)dictionaryRepresentation;	// IMP=0x00000001001755ac
- (id)description;	// IMP=0x00000001001754f8
