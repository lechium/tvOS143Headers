...
- (void).cxx_destruct;	// IMP=0x000000010004e618
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010004d700
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010004d6a4
- (id)description;	// IMP=0x000000010004d5b4
- (id)initWithDevice:(id)arg1;	// IMP=0x000000010004d518
