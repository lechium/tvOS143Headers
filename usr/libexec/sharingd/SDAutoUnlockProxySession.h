...
- (void)sendProxyTrigger;	// IMP=0x00000001000c5f64
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001000c5e90
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001000c5c20
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001000c5aa8
- (id)results;	// IMP=0x00000001000c5928
- (void)removeObservers;	// IMP=0x00000001000c58d8
- (void)addObservers;	// IMP=0x00000001000c5870
- (void)invalidate;	// IMP=0x00000001000c5788
- (void)_start;	// IMP=0x00000001000c56d0
- (void)start;	// IMP=0x00000001000c5644
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001000c5578
