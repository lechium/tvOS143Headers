...
+ (id)sharedBrowser;	// IMP=0x00000001000cd470
- (void).cxx_destruct;	// IMP=0x00000001000cd8a8
- (void)stop;	// IMP=0x00000001000cd844
- (void)start;	// IMP=0x00000001000cd734
- (void)bonjourNodesDidChange:(id)arg1;	// IMP=0x00000001000cd6dc
@property(readonly, copy) NSSet *workgroups;
@property(readonly, copy) NSArray *nodes;
- (id)init;	// IMP=0x00000001000cd4dc
