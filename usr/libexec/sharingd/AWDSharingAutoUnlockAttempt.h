...
- (void).cxx_destruct;	// IMP=0x00000001000f8048
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000f774c
- (unsigned long long)hash;	// IMP=0x00000001000f7248
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000f6b50
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000f64c4
- (void)copyTo:(id)arg1;	// IMP=0x00000001000f5e9c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000f590c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000f5904
- (id)dictionaryRepresentation;	// IMP=0x00000001000f325c
- (id)description;	// IMP=0x00000001000f31a8
