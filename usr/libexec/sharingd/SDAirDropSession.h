...
- (void).cxx_destruct;	// IMP=0x000000010003b394
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003afa0
- (void)handleConversionProgress:(id)arg1;	// IMP=0x000000010003aeb0
- (void)startProgress;	// IMP=0x000000010003ac04
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x000000010003ac00
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x000000010003a490
- (void)removeClientAlerts;	// IMP=0x000000010003a368
- (void)dealloc;	// IMP=0x000000010003a2dc
- (void)stop;	// IMP=0x000000010003a148
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x0000000100039e3c
- (void)serversChanged:(id)arg1;	// IMP=0x0000000100039b64
- (_Bool)send;	// IMP=0x0000000100039a38
- (void)start;	// IMP=0x0000000100039848
- (void)releaseSandboxExtensions;	// IMP=0x0000000100039734
- (void)consumeSandboxExtensions;	// IMP=0x00000001000394c8
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000100039460
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x000000010003926c
