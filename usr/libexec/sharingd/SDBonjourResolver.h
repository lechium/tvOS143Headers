...
- (void).cxx_destruct;	// IMP=0x00000001001c7574
...
- (void)cancel;	// IMP=0x00000001001c7478
- (void)resolve;	// IMP=0x00000001001c7008
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x00000001001c6c50
- (void)notifyClient:(int)arg1;	// IMP=0x00000001001c6c00
- (void)dealloc;	// IMP=0x00000001001c6bb4
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x00000001001c6a74
