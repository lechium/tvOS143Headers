...
+ (id)sharedSession;	// IMP=0x00000001000d04a4
- (void).cxx_destruct;	// IMP=0x00000001000d0770
...
- (void)connectionManagerDidInvalidate:(id)arg1;	// IMP=0x00000001000d0738
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000d0698
- (void)stop;	// IMP=0x00000001000d0640
- (void)start;	// IMP=0x00000001000d0580
- (id)init;	// IMP=0x00000001000d0510
