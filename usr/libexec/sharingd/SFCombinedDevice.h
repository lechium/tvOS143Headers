...
- (void).cxx_destruct;	// IMP=0x00000001000a0838
...
- (_Bool)stateIsNearby;	// IMP=0x00000001000a04bc
- (_Bool)stateIsMedium;	// IMP=0x00000001000a0478
- (_Bool)stateIsClose;	// IMP=0x00000001000a0464
- (void)resetTicks;	// IMP=0x00000001000a02b8
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x000000010009ff74
- (_Bool)canTransition:(int)arg1;	// IMP=0x000000010009fe78
- (id)description;	// IMP=0x000000010009fadc
