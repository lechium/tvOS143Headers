...
- (void).cxx_destruct;	// IMP=0x000000010015e99c
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x000000010015e91c
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010015e6fc
- (void)disableService:(id)arg1;	// IMP=0x000000010015e674
- (void)enableService:(id)arg1;	// IMP=0x000000010015e5f0
- (id)streamHandlerForService:(id)arg1;	// IMP=0x000000010015e58c
- (void)stop;	// IMP=0x000000010015e3a0
- (void)start;	// IMP=0x000000010015e350
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010015e248
