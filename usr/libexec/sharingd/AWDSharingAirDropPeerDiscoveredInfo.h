...
- (void).cxx_destruct;	// IMP=0x00000001001734f4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100173058
- (unsigned long long)hash;	// IMP=0x0000000100172dd4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100172a24
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001726c8
- (void)copyTo:(id)arg1;	// IMP=0x00000001001723c0
- (void)writeTo:(id)arg1;	// IMP=0x0000000100172104
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001720fc
- (id)dictionaryRepresentation;	// IMP=0x0000000100171000
- (id)description;	// IMP=0x0000000100170f4c
