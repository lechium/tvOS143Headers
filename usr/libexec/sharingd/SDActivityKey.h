...
- (void).cxx_destruct;	// IMP=0x0000000100124bac
...
- (unsigned long long)hash;	// IMP=0x00000001001249b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001248d8
- (id)description;	// IMP=0x00000001001247d4
- (void)dealloc;	// IMP=0x000000010012471c
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x0000000100124528
