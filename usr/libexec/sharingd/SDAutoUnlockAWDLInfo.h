...
- (void).cxx_destruct;	// IMP=0x00000001000c78d0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000c76b8
- (unsigned long long)hash;	// IMP=0x00000001000c7584
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000c7384
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000c71e4
- (void)copyTo:(id)arg1;	// IMP=0x00000001000c7088
- (void)writeTo:(id)arg1;	// IMP=0x00000001000c6f4c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000c6f44
- (id)dictionaryRepresentation;	// IMP=0x00000001000c6774
- (id)description;	// IMP=0x00000001000c66c0
