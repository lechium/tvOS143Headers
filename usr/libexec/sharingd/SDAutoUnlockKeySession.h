...
- (void).cxx_destruct;	// IMP=0x00000001000480cc
...
- (void)logAutoUnlockEnd;	// IMP=0x0000000100047c2c
- (void)logAutoUnlockStart;	// IMP=0x0000000100047adc
- (void)invalidateAssertionTimer;	// IMP=0x0000000100047a04
- (void)restartAssertionTimer;	// IMP=0x00000001000477ec
- (void)releaseIdleSleepAssertion;	// IMP=0x0000000100047744
- (void)declareSystemActivityAssertion;	// IMP=0x00000001000474e0
- (void)sendConfirmationACK;	// IMP=0x00000001000472a8
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x0000000100046e08
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x0000000100046abc
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x0000000100046798
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x000000010004614c
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x0000000100045d28
- (void)createAuthTokenIfReady;	// IMP=0x00000001000455e0
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x0000000100045380
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x00000001000450bc
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x0000000100044c38
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x0000000100044874
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00000001000441e4
- (void)handleWiFiRequestInvalidated;	// IMP=0x000000010004419c
- (void)handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100044168
- (void)awdlNetworkStarted;	// IMP=0x0000000100043f9c
- (void)createWiFiRequest;	// IMP=0x0000000100043990
- (void)alertOfUnlock;	// IMP=0x000000010004387c
- (void)promptForApproval;	// IMP=0x0000000100043878
- (void)deviceDisconnected:(id)arg1;	// IMP=0x0000000100043600
- (void)removeObservers;	// IMP=0x00000001000435b0
- (void)addObservers;	// IMP=0x0000000100043548
- (void)beginAKSSession;	// IMP=0x0000000100043544
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0000000100043370
- (_Bool)keyCanUnlock;	// IMP=0x0000000100043368
- (void)_invalidate;	// IMP=0x0000000100043134
- (void)invalidate;	// IMP=0x00000001000430b0
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x0000000100042de8
