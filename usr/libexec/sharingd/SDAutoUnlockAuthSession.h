...
- (void).cxx_destruct;	// IMP=0x0000000100162a54
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x00000001001620e8
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100161bf8
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100161b88
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x0000000100161458
- (void)sendAWDLInfo;	// IMP=0x0000000100161448
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100161380
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100161264
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010016120c
- (void)_start;	// IMP=0x0000000100161200
- (void)start;	// IMP=0x0000000100161174
- (id)getAppName;	// IMP=0x000000010016116c
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0000000100161168
- (void)connectionActivated;	// IMP=0x0000000100161164
- (void)invalidate;	// IMP=0x0000000100161054
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0000000100160f8c
