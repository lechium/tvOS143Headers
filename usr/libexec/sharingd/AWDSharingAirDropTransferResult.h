...
- (void).cxx_destruct;	// IMP=0x00000001001d56f0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001d54a0
- (unsigned long long)hash;	// IMP=0x00000001001d534c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001d5128
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001d4f60
- (void)copyTo:(id)arg1;	// IMP=0x00000001001d4ddc
- (void)writeTo:(id)arg1;	// IMP=0x00000001001d4c7c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001d4c74
- (id)dictionaryRepresentation;	// IMP=0x00000001001d43a8
- (id)description;	// IMP=0x00000001001d42f4
