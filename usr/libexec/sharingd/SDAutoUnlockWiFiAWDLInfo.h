...
- (void).cxx_destruct;	// IMP=0x0000000100059620
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100059484
- (unsigned long long)hash;	// IMP=0x0000000100059398
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100059218
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000590c0
- (void)copyTo:(id)arg1;	// IMP=0x0000000100058fac
- (void)writeTo:(id)arg1;	// IMP=0x0000000100058ea8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100058ea0
- (id)dictionaryRepresentation;	// IMP=0x000000010005882c
- (id)description;	// IMP=0x0000000100058778
