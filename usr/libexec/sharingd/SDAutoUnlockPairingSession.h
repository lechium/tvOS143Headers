...
- (void)handleTimerFired;	// IMP=0x000000010003d18c
- (void)invalidateResponseTimer;	// IMP=0x000000010003d0b4
- (void)restartResponseTimer:(unsigned long long)arg1;	// IMP=0x000000010003ceb8
- (id)dataFromUUID:(id)arg1;	// IMP=0x000000010003ce38
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2 useProxy:(_Bool)arg3 senderID:(id)arg4;	// IMP=0x000000010003cc68
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2;	// IMP=0x000000010003cc54
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x000000010003cc50
- (void)start;	// IMP=0x000000010003cc4c
- (void)invalidate;	// IMP=0x000000010003cac8
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x000000010003c9cc
- (id)init;	// IMP=0x000000010003c964
