...
- (void).cxx_destruct;	// IMP=0x00000001000e2b0c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000e2828
- (unsigned long long)hash;	// IMP=0x00000001000e26ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000e2438
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000e2220
- (void)copyTo:(id)arg1;	// IMP=0x00000001000e2064
- (void)writeTo:(id)arg1;	// IMP=0x00000001000e1ed4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000e1ecc
- (id)dictionaryRepresentation;	// IMP=0x00000001000e1654
- (id)description;	// IMP=0x00000001000e15a0
