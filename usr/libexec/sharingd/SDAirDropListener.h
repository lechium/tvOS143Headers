...
- (void).cxx_destruct;	// IMP=0x00000001000b6d08
...
- (void)dealloc;	// IMP=0x00000001000b6c0c
- (void)stop;	// IMP=0x00000001000b6bb4
- (void)start;	// IMP=0x00000001000b6b30
- (void)networkOperation:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000b6838
- (id)init;	// IMP=0x00000001000b67e4
