...
+ (id)shared;	// IMP=0x00000001001dee20
- (void).cxx_destruct;	// IMP=0x00000001001e72dc
- (id)init;	// IMP=0x00000001001e0828
- (_Bool)acquireTokenForIdentifier:(unsigned long long)arg1;	// IMP=0x00000001001dee60
