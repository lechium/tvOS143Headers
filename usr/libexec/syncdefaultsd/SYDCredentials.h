...
- (void).cxx_destruct;	// IMP=0x000000010000780c
...
- (_Bool)renewCredentials;	// IMP=0x00000001000071b8
- (id)publicURLForConfigurationWithService:(id)arg1;	// IMP=0x00000001000070c8
@property(readonly, nonatomic) NSString *apsEnvironment;
- (id)initWithAccount:(id)arg1 sydAccount:(id)arg2;	// IMP=0x0000000100006d80
