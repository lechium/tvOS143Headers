...
+ (id)descriptionForReason:(int)arg1;	// IMP=0x0000000100049988
- (void).cxx_destruct;	// IMP=0x000000010004b5ec
...
- (id)schedulingDescription;	// IMP=0x000000010004b08c
- (void)resetUpdateRequests;	// IMP=0x000000010004b00c
- (void)disableUntilNextLaunch;	// IMP=0x000000010004aff8
- (void)disableSyncUntil:(double)arg1;	// IMP=0x000000010004aff0
- (void)didFinishSyncWithIdentifier:(unsigned long long)arg1 success:(_Bool)arg2 now:(double)arg3;	// IMP=0x000000010004ad54
- (void)willStartSyncWithIdentifier:(unsigned long long)arg1;	// IMP=0x000000010004ac38
- (_Bool)requestSyncSoonForReason:(int)arg1 now:(double)arg2;	// IMP=0x000000010004a888
- (double)nextRefreshDateUsingNow:(double)arg1;	// IMP=0x000000010004a848
- (double)_nextRefreshDateForReason:(int)arg1 usingNow:(double)arg2;	// IMP=0x000000010004a50c
- (id)persistentState;	// IMP=0x000000010004a1f8
- (void)_markEntriesAsIncorrect;	// IMP=0x000000010004a0c4
- (void)_resizeEntriesWithUpdatedParametersIfNecessary;	// IMP=0x000000010004a010
- (void)dealloc;	// IMP=0x0000000100049fc8
- (id)initWithApplication:(id)arg1 persistentState:(id)arg2;	// IMP=0x0000000100049a80
