...
- (void).cxx_destruct;	// IMP=0x0000000100051534
...
- (void)sendReply:(id)arg1;	// IMP=0x0000000100051258
...
- (void)_translateMessageIfNecessary;	// IMP=0x0000000100050f50
- (id)description;	// IMP=0x0000000100050edc
- (id)initWithPeer:(id)arg1 andMessage:(id)arg2 activity:(id)arg3;	// IMP=0x0000000100050e0c
