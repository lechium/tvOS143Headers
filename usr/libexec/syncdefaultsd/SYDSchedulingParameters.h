...
- (void).cxx_destruct;	// IMP=0x0000000100055784
@property(retain, nonatomic) NSDictionary *persistentState; // @synthesize persistentState=_persistentState;
- (id)limitsDescription;	// IMP=0x00000001000551a0
- (_Bool)updateWithNewPersistentState:(id)arg1;	// IMP=0x000000010005512c
...
- (id)initWithPersistentState:(id)arg1;	// IMP=0x0000000100054508
