...
+ (id)_unrecoverableErrors;	// IMP=0x0000000100157560
- (void).cxx_destruct;	// IMP=0x0000000100157680
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x00000001001574d8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015741c
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x0000000100156ff8
