...
- (void).cxx_destruct;	// IMP=0x00000001001e6d70
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00000001001e6c20
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00000001001e6c10
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00000001001e6a64
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00000001001e69e0
