...
- (_Bool)_parsePropertyList:(id)arg1 error:(id *)arg2;	// IMP=0x000000010008bbc8
- (_Bool)_loadResponseReturningError:(id *)arg1;	// IMP=0x000000010008b8d4
- (_Bool)_appendRangeRequestsToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x000000010008b698
- (void)run;	// IMP=0x000000010008b634
- (void)dealloc;	// IMP=0x000000010008b5c4
