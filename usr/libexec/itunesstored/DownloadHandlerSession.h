...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001948fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100194888
- (unsigned long long)hash;	// IMP=0x0000000100194880
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x000000010019485c
@property(copy, nonatomic) NSString *statusDescription;
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x00000001001947f4
@property(nonatomic) long long sessionState;
- (void)setSessionPropertyValues:(id)arg1;	// IMP=0x0000000100194718
...
- (void)dealloc;	// IMP=0x00000001001944a8
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x0000000100194460
- (id)init;	// IMP=0x00000001001943b8
