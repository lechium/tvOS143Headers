...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000a1530
- (void)run;	// IMP=0x00000001000a1014
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x00000001000a0ea4
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x00000001000a0e14
- (id)init;	// IMP=0x00000001000a0e00
