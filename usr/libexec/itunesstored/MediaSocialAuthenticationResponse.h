...
- (void).cxx_destruct;	// IMP=0x00000001000df2c8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000df1e4
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00000001000df18c
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00000001000df134
- (id)init;	// IMP=0x00000001000df0b8
