...
- (void).cxx_destruct;	// IMP=0x000000010006ac30
- (void)_runForIdentity:(id)arg1;	// IMP=0x000000010006a2c4
- (id)_newFetchOperationForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3;	// IMP=0x0000000100069d10
- (id)_copyResponseForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3 returningError:(id *)arg4;	// IMP=0x0000000100069a7c
- (void)run;	// IMP=0x00000001000696c8
