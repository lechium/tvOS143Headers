...
- (void).cxx_destruct;	// IMP=0x000000010008b55c
...
- (id)_URLBagContext;	// IMP=0x000000010008b49c
- (_Bool)_shouldCheckAutoRenewQueue;	// IMP=0x000000010008b3a8
- (_Bool)_appendToResponse:(id)arg1 usingOperation:(id)arg2 error:(id *)arg3;	// IMP=0x000000010008af58
- (_Bool)_appendNormalQueueToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x000000010008add4
- (_Bool)_appendAutoRenewQueueToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x000000010008ac50
- (void)run;	// IMP=0x000000010008a4dc
