...
- (_Bool)_loadPaymentsWithExpectedCount:(long long)arg1 error:(id *)arg2;	// IMP=0x000000010008c564
- (_Bool)_getQueueCount:(long long *)arg1 error:(id *)arg2;	// IMP=0x000000010008c450
- (void)run;	// IMP=0x000000010008c35c
- (void)dealloc;	// IMP=0x000000010008c2cc
