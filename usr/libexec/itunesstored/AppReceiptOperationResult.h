...
- (void)addRefreshed:(id)arg1;	// IMP=0x000000010011cf58
- (void)addRevoked:(id)arg1;	// IMP=0x000000010011cefc
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010011ce10
- (void)dealloc;	// IMP=0x000000010011cda0
