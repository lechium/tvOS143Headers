...
- (void).cxx_destruct;	// IMP=0x0000000100034260
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000340dc
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000100033b20
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000100033958
