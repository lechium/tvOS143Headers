...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001b96b0
- (void)_presentDialog:(id)arg1;	// IMP=0x00000001001b9618
- (void)dealloc;	// IMP=0x00000001001b95c8
