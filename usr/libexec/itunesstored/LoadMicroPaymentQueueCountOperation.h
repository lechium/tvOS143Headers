...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100089380
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x000000010008908c
- (void)run;	// IMP=0x0000000100088dbc
- (void)dealloc;	// IMP=0x0000000100088d4c
