...
- (void).cxx_destruct;	// IMP=0x00000001001d93a0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001d9264
- (unsigned long long)hash;	// IMP=0x00000001001d919c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001d9050
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001d8f48
- (void)writeTo:(id)arg1;	// IMP=0x00000001001d8e7c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001d8e74
- (id)dictionaryRepresentation;	// IMP=0x00000001001d8854
- (id)description;	// IMP=0x00000001001d87a0
