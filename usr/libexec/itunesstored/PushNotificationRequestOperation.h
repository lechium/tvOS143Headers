...
- (_Bool)_loadResponseWithAccountIdentifier:(id)arg1 URL:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000872a8
- (void)run;	// IMP=0x0000000100086acc
@property(copy) NSString *userAgent;
@property(readonly) SSURLConnectionResponse *URLResponse;
- (void)dealloc;	// IMP=0x0000000100086950
- (id)initWithPushNotificationParameters:(id)arg1;	// IMP=0x00000001000868e8
