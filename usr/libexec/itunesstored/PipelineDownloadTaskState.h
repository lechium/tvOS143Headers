...
- (void).cxx_destruct;	// IMP=0x000000010003525c
...
- (id)_overallProgress;	// IMP=0x0000000100035134
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100035024
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100034f98
- (unsigned long long)hash;	// IMP=0x0000000100034f90
- (void)setTransferProgressWithBytesWritten:(long long)arg1 totalBytesExpected:(long long)arg2;	// IMP=0x0000000100034f68
- (void)setTransferProgress:(double)arg1;	// IMP=0x0000000100034efc
- (void)setFinishProgress:(double)arg1;	// IMP=0x0000000100034e84
@property(readonly, nonatomic) SSOperationProgress *overallProgress;
- (id)initWithPrepareDownloadResponse:(id)arg1;	// IMP=0x0000000100034c94
