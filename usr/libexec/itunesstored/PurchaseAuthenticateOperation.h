...
- (id)_userAgentForPurchases:(id)arg1;	// IMP=0x00000001001cb370
- (id)_clientIdentifierForPurchases:(id)arg1;	// IMP=0x00000001001cb218
- (void)run;	// IMP=0x00000001001cb04c
@property(copy) NSString *clientIdentifierHeader;
@property(copy) CDUnknownBlockType authenticationBlock;
- (void)dealloc;	// IMP=0x00000001001cae80
- (id)initWithPurchases:(id)arg1;	// IMP=0x00000001001caca0
