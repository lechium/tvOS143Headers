...
- (void).cxx_destruct;	// IMP=0x0000000100104930
...
- (void)run;	// IMP=0x000000010010454c
- (id)initWithAccountIdentifier:(id)arg1 rentalKeyIdentifier:(id)arg2;	// IMP=0x000000010010447c
