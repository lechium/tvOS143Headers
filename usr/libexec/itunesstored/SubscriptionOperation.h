...
- (void).cxx_destruct;	// IMP=0x00000001000bf980
- (id)_requestPropertiesWithAccount:(id)arg1 syncState:(id)arg2 fairPlaySubscriptionController:(id)arg3;	// IMP=0x00000001000bf1dc
- (id)_newMachineDataOperationWithAccount:(id)arg1 response:(id)arg2;	// IMP=0x00000001000bf0a4
- (void)run;	// IMP=0x00000001000be3dc
