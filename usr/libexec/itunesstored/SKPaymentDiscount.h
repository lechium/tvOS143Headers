...
- (void).cxx_destruct;	// IMP=0x00000001000823f4
...
- (id)initWithIdentifier:(id)arg1 keyIdentifier:(id)arg2 nonce:(id)arg3 signature:(id)arg4 timestamp:(id)arg5;	// IMP=0x0000000100082130
