...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001b855c
- (unsigned long long)hash;	// IMP=0x00000001001b8554
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x00000001001b8530
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x00000001001b84bc
- (void)dealloc;	// IMP=0x00000001001b8474
- (id)init;	// IMP=0x00000001001b83e0
