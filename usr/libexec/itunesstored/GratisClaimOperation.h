...
- (id)_newRetryRequestPropertiesWithURL:(id)arg1;	// IMP=0x0000000100152e00
- (id)_newDefaultRequestProperties;	// IMP=0x0000000100152cac
- (id)_bodyData;	// IMP=0x0000000100152bd4
- (id)_authenticationContext;	// IMP=0x0000000100152ad0
- (id)_accountID;	// IMP=0x0000000100152a24
- (void)operation:(id)arg1 didAuthenticateWithDSID:(id)arg2;	// IMP=0x000000010015293c
- (void)run;	// IMP=0x000000010015244c
...
- (void)dealloc;	// IMP=0x0000000100152100
- (id)initWithRequestBody:(id)arg1;	// IMP=0x0000000100152058
- (id)initWithPurchase:(id)arg1;	// IMP=0x0000000100151edc
