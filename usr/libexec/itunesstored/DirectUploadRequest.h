...
- (void).cxx_destruct;	// IMP=0x00000001001a6888
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001a6734
- (id)initWithEntity:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x00000001001a6450
