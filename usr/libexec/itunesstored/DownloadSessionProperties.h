...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000276c8
- (unsigned long long)hash;	// IMP=0x00000001000276c0
- (id)description;	// IMP=0x0000000100027648
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100027580
- (void)dealloc;	// IMP=0x0000000100027520
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x00000001000274b0
