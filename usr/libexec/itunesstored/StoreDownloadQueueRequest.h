...
+ (void)initialize;	// IMP=0x00000001000bbe68
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000bbdc4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000bbc7c
- (unsigned long long)hash;	// IMP=0x00000001000bbc6c
- (id)description;	// IMP=0x00000001000bbbfc
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00000001000bbb44
