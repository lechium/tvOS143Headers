...
- (void).cxx_destruct;	// IMP=0x000000010018a2d4
...
- (void)_sendActivationWithError:(id)arg1;	// IMP=0x000000010018a0fc
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x0000000100189f1c
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0000000100189d64
- (void)remoteAlertHandleDidActivate:(id)arg1;	// IMP=0x0000000100189bbc
- (void)run;	// IMP=0x00000001001894dc
- (id)initWithWebViewRequest:(id)arg1;	// IMP=0x0000000100189434
