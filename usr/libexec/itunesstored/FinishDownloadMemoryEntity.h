...
+ (id)defaultProperties;	// IMP=0x0000000100081dd8
+ (Class)databaseEntityClass;	// IMP=0x0000000100081dcc
- (void).cxx_destruct;	// IMP=0x00000001000820dc
...
- (id)secondaryAssetForType:(id)arg1;	// IMP=0x0000000100081af8
@property(readonly, nonatomic) long long restoreState;
- (id)newITunesMetadataDictionary;	// IMP=0x000000010008134c
- (void)loadAssetsUsingSession:(id)arg1;	// IMP=0x0000000100080e08
...
- (id)destinationDirectoryPathForAsset:(id)arg1;	// IMP=0x0000000100080828
