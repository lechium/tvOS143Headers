...
- (void).cxx_destruct;	// IMP=0x00000001001e55f8
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00000001001e54f4
- (id)description;	// IMP=0x00000001001e53d4
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00000001001e52ac
