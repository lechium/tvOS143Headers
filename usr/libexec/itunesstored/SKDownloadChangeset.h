...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0000000100015dd8
- (void).cxx_destruct;	// IMP=0x0000000100016354
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100016190
- (id)copyXPCEncoding;	// IMP=0x00000001000160bc
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000100015e78
