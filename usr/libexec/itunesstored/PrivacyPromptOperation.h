...
- (void).cxx_destruct;	// IMP=0x0000000100151540
...
- (id)_privacyAcknowledgementURLString;	// IMP=0x000000010015125c
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x0000000100151090
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0000000100150eec
- (void)run;	// IMP=0x0000000100150078
- (id)initWithPrivacyIdentifier:(id)arg1;	// IMP=0x000000010014fff8
