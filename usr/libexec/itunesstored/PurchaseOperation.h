...
+ (double)_randomDouble;	// IMP=0x00000001000256f8
+ (void)reportAnonymousPings:(id)arg1;	// IMP=0x000000010001add8
- (void).cxx_destruct;	// IMP=0x0000000100026214
...
- (id)_URLBagContext;	// IMP=0x0000000100025f2c
- (_Bool)_shouldUseClientAuthentication;	// IMP=0x0000000100025b14
- (_Bool)_shouldSendSBSyncData;	// IMP=0x0000000100025a54
- (_Bool)_shouldSendKeyBagSyncData;	// IMP=0x0000000100025854
- (void)_setMoveToiOS;	// IMP=0x0000000100025748
- (_Bool)_shouldDisableReversePush;	// IMP=0x0000000100025368
- (void)_setChangedBuyParameters:(id)arg1 fromDataProvider:(id)arg2;	// IMP=0x00000001000251f8
- (void)_scoreDevice;	// IMP=0x0000000100024d78
- (void)_runPurchaseRequest;	// IMP=0x0000000100023f80
- (void)_runDialogOperationForDialog:(id)arg1;	// IMP=0x000000010002218c
- (id)_priceFromBuyParams;	// IMP=0x0000000100022084
- (void)_performAutoEnrollmentCheck;	// IMP=0x0000000100021ef0
- (void)_performApplePayClassicCheck;	// IMP=0x0000000100021d5c
- (void)_performMachineDataActionForURLResponse:(id)arg1;	// IMP=0x00000001000218c8
- (void)_performDelayedGotoForOperation:(id)arg1;	// IMP=0x000000010002171c
- (id)_newRequestParameters;	// IMP=0x00000001000211a4
- (id)_newPurchaseRequestOperation;	// IMP=0x000000010001f970
- (void)_handleFailureForOperation:(id)arg1;	// IMP=0x000000010001e958
- (id)_fairPlaySubscriptionController;	// IMP=0x000000010001e8f0
- (id)_deviceScoreMetricsParam;	// IMP=0x000000010001e85c
- (id)_countryCode;	// IMP=0x000000010001e494
- (void)_continueTouchIDSessionWithDialog:(id)arg1;	// IMP=0x000000010001e2ac
- (_Bool)_clientIsViewService;	// IMP=0x000000010001e14c
- (id)_buyParamProductType;	// IMP=0x000000010001def4
- (void)_addFairPlayToRequestProperties:(id)arg1 withAccountIdentifier:(unsigned long long)arg2;	// IMP=0x000000010001da9c
- (id)_accountWithUniqueIdentifier:(id)arg1;	// IMP=0x000000010001d97c
- (id)_account;	// IMP=0x000000010001d830
- (void)sender:(id)arg1 willSendChallenge:(id)arg2 andSignature:(id)arg3 andPaymentTokenData:(id)arg4 andFpanID:(id)arg5 isExtendedAction:(_Bool)arg6 isPayment:(_Bool)arg7 additionalHeaders:(id)arg8;	// IMP=0x000000010001d64c
- (void)sender:(id)arg1 shouldContinueTouchIDSession:(_Bool)arg2;	// IMP=0x000000010001d630
- (void)sender:(id)arg1 didFallbackToPassword:(_Bool)arg2;	// IMP=0x000000010001d614
- (void)operation:(id)arg1 willSendRequest:(id)arg2;	// IMP=0x000000010001d39c
- (void)operation:(id)arg1 shouldAuthenticateWithContext:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010001d274
- (void)operation:(id)arg1 didAuthenticateWithDSID:(id)arg2;	// IMP=0x000000010001cec0
- (id)uniqueKey;	// IMP=0x000000010001ceb4
- (void)run;	// IMP=0x000000010001bb78
- (id)authenticatedAccountDSID;	// IMP=0x000000010001baec
...
- (id)initWithPurchase:(id)arg1;	// IMP=0x000000010001a8dc
- (id)init;	// IMP=0x000000010001a8cc
