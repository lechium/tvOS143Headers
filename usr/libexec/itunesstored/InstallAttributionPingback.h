...
- (void).cxx_destruct;	// IMP=0x00000001001a73f8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001a6ff4
- (id)description;	// IMP=0x00000001001a6f9c
- (id)initWithAppAdamId:(id)arg1 transactionId:(id)arg2 campaignId:(id)arg3 adNetworkId:(id)arg4 attributionSignature:(id)arg5 pingbackUrl:(id)arg6 retryCount:(long long)arg7 localTimestamp:(id)arg8;	// IMP=0x00000001001a6b7c
