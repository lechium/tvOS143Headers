...
- (void).cxx_destruct;	// IMP=0x0000000100180638
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x000000010017fbf0
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x000000010017f5fc
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1;	// IMP=0x000000010017f238
- (id)sessionConfiguration;	// IMP=0x000000010017f058
