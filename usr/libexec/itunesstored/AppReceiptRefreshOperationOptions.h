...
- (void).cxx_destruct;	// IMP=0x00000001001b1d94
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001b1c78
@property(readonly, nonatomic) NSString *URLBagKey;
- (id)initWithReceiptFlags:(unsigned long long)arg1;	// IMP=0x00000001001b1bf8
