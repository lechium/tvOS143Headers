...
- (void)runWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010005070c
@property(readonly, nonatomic) _Bool blocksAppInstallation;
- (_Bool)applicationIsInstalled:(id)arg1;	// IMP=0x000000010005067c
- (void)dealloc;	// IMP=0x0000000100050634
- (id)initWithApplicationHandle:(id)arg1;	// IMP=0x00000001000505d4
