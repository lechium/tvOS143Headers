...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010018ddac
- (void)dealloc;	// IMP=0x000000010018dd5c
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x000000010018dcfc
