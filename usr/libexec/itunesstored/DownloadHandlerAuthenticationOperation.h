...
- (void)_setURLCredential:(id)arg1;	// IMP=0x0000000100195e20
- (void)_setState:(long long)arg1;	// IMP=0x0000000100195dc0
- (id)_openSession;	// IMP=0x0000000100195b64
- (void)downloadHandlerManager:(id)arg1 sessionsDidChange:(id)arg2;	// IMP=0x0000000100195994
- (void)run;	// IMP=0x0000000100195500
- (void)cancel;	// IMP=0x0000000100195470
...
- (void)dealloc;	// IMP=0x0000000100195274
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x00000001001951f8
