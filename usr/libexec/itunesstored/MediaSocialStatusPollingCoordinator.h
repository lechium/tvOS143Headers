...
- (void).cxx_destruct;	// IMP=0x00000001001e1e84
@property(nonatomic) __weak id <MediaSocialStatusPollingDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_finishRequests:(id)arg1 withResponses:(id)arg2;	// IMP=0x00000001001e18d0
- (void)_addBackgroundTaskJob;	// IMP=0x00000001001e15f8
- (void)_handleBackgroundTaskEvent:(id)arg1;	// IMP=0x00000001001e0ff8
@property(readonly, nonatomic) long long numberOfPollRequests;
- (void)addPollRequest:(id)arg1;	// IMP=0x00000001001e0ef4
- (void)dealloc;	// IMP=0x00000001001e0e74
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x00000001001e0c6c
