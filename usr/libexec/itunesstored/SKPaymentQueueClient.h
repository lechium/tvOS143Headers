...
- (void).cxx_destruct;	// IMP=0x00000001000a579c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000a55b4
- (id)copyXPCEncoding;	// IMP=0x00000001000a54a8
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000001000a52a0
