...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x000000010006660c
...
- (id)copyProduct;	// IMP=0x0000000100066228
- (void)dealloc;	// IMP=0x0000000100066198
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100065b34
