...
- (void).cxx_destruct;	// IMP=0x00000001001a3ebc
@property(nonatomic) long long postID; // @synthesize postID=_postID;
- (id)_targetDictionaryWithContentItem:(id)arg1;	// IMP=0x00000001001a3db8
- (id)_requestBodyDictionary;	// IMP=0x00000001001a3770
- (id)_externalServiceDictionaryWithDestination:(id)arg1;	// IMP=0x00000001001a35a8
- (id)_attachmentDictionaryWithAttachment:(id)arg1;	// IMP=0x00000001001a2fa0
- (void)run;	// IMP=0x00000001001a2260
@property(copy) NSString *userAgent;
@property(copy) CDUnknownBlockType resultBlock;
- (id)initWithPostEntity:(id)arg1;	// IMP=0x00000001001a1c70
- (id)initWithPostDescription:(id)arg1;	// IMP=0x00000001001a1a94
