...
+ (id)identifierForInvalidCode;	// IMP=0x00000001000319ac
- (void).cxx_destruct;	// IMP=0x0000000100032a38
...
- (_Bool)hasEntitlement:(id)arg1 containsServiceAllOrService:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x00000001000328d0
- (_Bool)hasEntitlement:(id)arg1 containsService:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000100032628
- (id)description;	// IMP=0x0000000100032504
- (id)arrayValueForEntitlement:(id)arg1;	// IMP=0x00000001000323d0
- (_Bool)boolValueForEntitlement:(id)arg1;	// IMP=0x00000001000322a0
@property(readonly) NSString *responsiblePath; // @synthesize responsiblePath=_responsiblePath;
- (void)dealloc;	// IMP=0x0000000100032234
- (id)initWithPID:(int)arg1 responsiblePath:(id)arg2;	// IMP=0x0000000100031f24
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1 responsiblePath:(id)arg2;	// IMP=0x0000000100031a3c
- (id)logHandle;	// IMP=0x00000001000319b8
