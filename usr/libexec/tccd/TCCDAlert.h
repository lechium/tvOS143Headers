...
- (void).cxx_destruct;	// IMP=0x0000000100035db8
...
- (void)display;	// IMP=0x0000000100035a04
- (_Bool)isDisplayableForCondition:(long long)arg1;	// IMP=0x00000001000358f8
- (id)initWithCondition:(long long)arg1 platformName:(id)arg2 service:(id)arg3 displayPolicy:(long long)arg4 persistentStateType:(unsigned long long)arg5 displayCountlimit:(int)arg6 configuration:(id)arg7;	// IMP=0x00000001000357d8
