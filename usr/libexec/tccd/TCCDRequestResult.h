...
+ (void)populateReplyMessageToDeny:(id)arg1 withError:(id)arg2;	// IMP=0x000000010002f14c
...
- (void)populateReplyMessage:(id)arg1;	// IMP=0x000000010002f6b4
- (id)description;	// IMP=0x000000010002f6a4
- (id)descriptionWithRespectToService:(id)arg1;	// IMP=0x000000010002f3f0
- (void)denyAuthorizationWithErrorCode:(long long)arg1 format:(id)arg2;	// IMP=0x000000010002f29c
- (id)init;	// IMP=0x000000010002f240
