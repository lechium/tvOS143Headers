...
+ (id)publisher;	// IMP=0x000000010003004c
...
- (void)publish:(id)arg1;	// IMP=0x0000000100031258
- (void)sendEvent:(id)arg1;	// IMP=0x0000000100030ea4
- (void)addPendingEvent:(id)arg1;	// IMP=0x0000000100030d74
- (void)removeSubscriber:(unsigned long long)arg1;	// IMP=0x0000000100030c00
- (void)addSubscriber:(unsigned long long)arg1;	// IMP=0x00000001000306f4
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x0000000100030490
- (void)handleError:(int)arg1;	// IMP=0x0000000100030428
- (id)init;	// IMP=0x00000001000300b8
