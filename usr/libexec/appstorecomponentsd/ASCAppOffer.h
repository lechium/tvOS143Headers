...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000e924
- (void).cxx_destruct;	// IMP=0x0000000100010238
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000f6d4
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000010000f188
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000f184
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000ee48
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000e92c
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13;	// IMP=0x000000010000e648
