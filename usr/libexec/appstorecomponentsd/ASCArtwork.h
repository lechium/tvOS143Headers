...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100016a20
- (void).cxx_destruct;	// IMP=0x000000010001771c
...
- (id)makeURLWithSubstitutions:(id)arg1;	// IMP=0x000000010001754c
- (id)description;	// IMP=0x0000000100017398
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100017090
- (unsigned long long)hash;	// IMP=0x0000000100016f24
@property(readonly, copy, nonatomic) NSString *URLTemplate;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100016e74
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100016cf4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100016a28
- (id)initWithURLTemplate:(id)arg1 width:(double)arg2 height:(double)arg3 decoration:(id)arg4 preferredCrop:(id)arg5 preferredFormat:(id)arg6;	// IMP=0x00000001000168dc
