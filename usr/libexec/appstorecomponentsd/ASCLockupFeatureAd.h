...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100008e80
- (void).cxx_destruct;	// IMP=0x000000010000986c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000936c
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000091f4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100009070
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100008e88
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6;	// IMP=0x0000000100008d30
