...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100007390
- (void).cxx_destruct;	// IMP=0x0000000100008b70
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x0000000100008910
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x0000000100008604
- (id)featureWithClass:(Class)arg1;	// IMP=0x00000001000084cc
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100007ba0
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100007938
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000076a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100007398
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x0000000100007250
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x0000000100006fd4
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x00000001000053f4
@property(readonly, copy, nonatomic) NSSet *signpostTags;
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x0000000100008c00
