...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100017968
- (void).cxx_destruct;	// IMP=0x00000001000188fc
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000181cc
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000100017e58
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100017e54
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100017c44
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100017970
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x0000000100017788
