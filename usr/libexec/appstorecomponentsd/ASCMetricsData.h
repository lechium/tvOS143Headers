...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000158e0
...
- (id)metricsDataByMergingFields:(id)arg1 uniquingFieldsWithBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100016218
- (id)description;	// IMP=0x0000000100016084
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100015dc0
- (unsigned long long)hash;	// IMP=0x0000000100015c70
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100015c6c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100015b10
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000158e8
- (id)initWithTopic:(id)arg1 shouldFlush:(_Bool)arg2 fields:(id)arg3 includingFields:(id)arg4 excludingFields:(id)arg5;	// IMP=0x00000001000157a0
