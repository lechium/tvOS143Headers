...
+ (id)entryWithID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 andTask:(id)arg4;	// IMP=0x0000000100005d1c
- (void).cxx_destruct;	// IMP=0x0000000100005dd8
...
- (id)initWithID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 andTask:(id)arg4;	// IMP=0x0000000100005c58
