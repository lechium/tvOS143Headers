...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x000000010001dcd4
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x000000010001dcc0
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x000000010001dcb4
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x000000010001dca0
- (unsigned long long)unanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x000000010001dc94
- (void)addUnanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x000000010001dc80
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x000000010001dc74
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x000000010001dc60
- (id)init;	// IMP=0x000000010001dbb4
