...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x0000000100031f24
- (void).cxx_destruct;	// IMP=0x0000000100032c48
...
- (int)mainInternal;	// IMP=0x00000001000325e4
- (_Bool)containsAsset:(id)arg1;	// IMP=0x00000001000323c8
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x0000000100032328
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x0000000100031f90
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0000000100031e44
