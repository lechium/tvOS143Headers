...
+ (id)assetWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x0000000100010c84
...
- (_Bool)isDegraded;	// IMP=0x0000000100010dd4
- (_Bool)isDeletePending;	// IMP=0x0000000100010dc8
- (void)updateLocalIdentifier:(id)arg1;	// IMP=0x0000000100010dbc
- (id)initWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x0000000100010ac4
