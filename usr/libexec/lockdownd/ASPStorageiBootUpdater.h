...
- (void)dealloc;	// IMP=0x000000010002c9fc
- (_Bool)updateBootFirmwareWithCallback:(struct ramrod_update_callbacks *)arg1 context:(struct firmware_update_context *)arg2 error:(id *)arg3;	// IMP=0x000000010002c9ec
- (_Bool)updateBootFirmwareWithError:(id *)arg1;	// IMP=0x000000010002c270
- (id)initWithApNonce:(id)arg1;	// IMP=0x000000010002c1cc
