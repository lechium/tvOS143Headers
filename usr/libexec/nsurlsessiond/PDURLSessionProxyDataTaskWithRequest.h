...
- (void).cxx_destruct;	// IMP=0x000000010000b568
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010000b3ec
- (unsigned long long)hash;	// IMP=0x000000010000b344
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000b210
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000b10c
- (void)copyTo:(id)arg1;	// IMP=0x000000010000b054
- (void)writeTo:(id)arg1;	// IMP=0x000000010000afac
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010000ac98
- (id)dictionaryRepresentation;	// IMP=0x000000010000ab18
- (id)description;	// IMP=0x000000010000aa64
