...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100051104
- (void).cxx_destruct;	// IMP=0x00000001000510f8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100050f9c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100050ea8
- (id)initWithCallbackType:(int)arg1 taskIdentifier:(unsigned long long)arg2 args:(id)arg3;	// IMP=0x0000000100050dc4
