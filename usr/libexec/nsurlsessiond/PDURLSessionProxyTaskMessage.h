...
- (void).cxx_destruct;	// IMP=0x00000001000421a4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000420e0
- (unsigned long long)hash;	// IMP=0x0000000100042078
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100041f9c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100041ef4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100041e7c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100041e0c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100041e04
- (id)dictionaryRepresentation;	// IMP=0x0000000100041d14
- (id)description;	// IMP=0x0000000100041c60
