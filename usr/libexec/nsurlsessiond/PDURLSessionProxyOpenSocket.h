...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000058f0
- (unsigned long long)hash;	// IMP=0x0000000100005848
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100005714
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100005610
- (void)copyTo:(id)arg1;	// IMP=0x0000000100005558
- (void)writeTo:(id)arg1;	// IMP=0x00000001000054b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000051b8
- (id)dictionaryRepresentation;	// IMP=0x0000000100005080
- (id)description;	// IMP=0x0000000100004fcc
