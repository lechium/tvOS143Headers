...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010005f47c
- (unsigned long long)hash;	// IMP=0x000000010005f408
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005f308
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005f230
- (void)copyTo:(id)arg1;	// IMP=0x000000010005f1a4
- (void)writeTo:(id)arg1;	// IMP=0x000000010005f124
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010005ee9c
- (id)dictionaryRepresentation;	// IMP=0x000000010005ed78
- (id)description;	// IMP=0x000000010005ecc4
