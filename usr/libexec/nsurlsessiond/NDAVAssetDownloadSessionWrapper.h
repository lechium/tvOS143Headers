...
- (void).cxx_destruct;	// IMP=0x000000010000db54
...
- (void)assetDownloadSession:(id)arg1 didResolveMediaSelection:(id)arg2;	// IMP=0x000000010000da28
- (void)assetDownloadSession:(id)arg1 didFinishDownloadForMediaSelection:(id)arg2;	// IMP=0x000000010000d954
- (void)assetDownloadSession:(id)arg1 didLoadTimeRange:(CDStruct_3c1748cc)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(CDStruct_3c1748cc)arg4 forMediaSelection:(id)arg5;	// IMP=0x000000010000d860
- (void)assetDownloadSession:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x000000010000d78c
- (void)assetDownloadSessionDidFinishDownload:(id)arg1;	// IMP=0x000000010000d6ec
- (void)startLoadingMetadata;	// IMP=0x000000010000d694
- (void)cancelAndDeliverError:(id)arg1;	// IMP=0x000000010000d600
- (void)cancel;	// IMP=0x000000010000d594
- (void)suspend;	// IMP=0x000000010000d4e4
- (void)resume;	// IMP=0x000000010000d36c
- (void)releasePowerAssertion;	// IMP=0x000000010000d264
- (void)takePowerAssertion;	// IMP=0x000000010000d00c
- (void)sendProgressUpdate;	// IMP=0x000000010000cedc
- (void)didReceiveMediaSelectionResolutionNotification:(id)arg1;	// IMP=0x000000010000ce84
- (void)didReceiveTimeRangesChangedNotification:(id)arg1;	// IMP=0x000000010000ce00
- (void)didReceiveFileSizeAvailableNotification:(id)arg1;	// IMP=0x000000010000cdfc
- (void)didReceiveFailedNotification:(id)arg1;	// IMP=0x000000010000cda4
- (void)didReceiveSucceededNotification:(id)arg1;	// IMP=0x000000010000cd4c
- (void)disavowSession;	// IMP=0x000000010000cc48
- (void)removeSessionObservers;	// IMP=0x000000010000cb10
- (void)addSessionObservers;	// IMP=0x000000010000c9b0
- (id)initWithURLAsset:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x000000010000bfdc
- (id)initWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x000000010000bdb4
- (_Bool)doesAVAssetDownloadSessionSupportMultipleDownloads;	// IMP=0x000000010000bd8c
