...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100036104
- (unsigned long long)hash;	// IMP=0x00000001000360b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100035fdc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100035f4c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100035ed8
- (void)writeTo:(id)arg1;	// IMP=0x0000000100035e5c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100035b74
- (id)dictionaryRepresentation;	// IMP=0x0000000100035a70
- (id)description;	// IMP=0x00000001000359bc
