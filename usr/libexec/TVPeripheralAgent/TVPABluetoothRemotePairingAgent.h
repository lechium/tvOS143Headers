...
- (void).cxx_destruct;	// IMP=0x00000001000044f8
...
- (void)_peripheralStateDidChangeNotification:(id)arg1;	// IMP=0x00000001000041bc
- (void)_handleRemoteDidPair;	// IMP=0x0000000100003ee8
- (void)_handlePairingTimeout;	// IMP=0x0000000100003dfc
- (void)unpairAllRemotes;	// IMP=0x0000000100003af0
- (void)stopProximityPairing;	// IMP=0x00000001000039f8
- (void)startProximityPairing;	// IMP=0x0000000100003670
- (void)dealloc;	// IMP=0x0000000100003568
