...
- (void).cxx_destruct;	// IMP=0x0000000100163d78
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x00000001001612c0
- (id)data;	// IMP=0x000000010016070c
- (id)init;	// IMP=0x0000000100160684
- (_Bool)_isTinkerFlagSet;	// IMP=0x0000000100160604
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x0000000100160584
- (id)description;	// IMP=0x000000010016037c
