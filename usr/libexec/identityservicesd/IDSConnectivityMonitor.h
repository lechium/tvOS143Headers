...
- (void).cxx_destruct;	// IMP=0x00000001001b0f08
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x00000001001b0ad8
- (void)sendMonitorMessage;	// IMP=0x00000001001b00b0
- (void)checkConnectivityState:(id)arg1;	// IMP=0x00000001001afc74
- (id)init;	// IMP=0x00000001001afad4
