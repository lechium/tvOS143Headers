...
- (void).cxx_destruct;	// IMP=0x00000001004cadd4
...
- (void)purgeData;	// IMP=0x00000001004cab74
- (void)saveData:(id)arg1;	// IMP=0x00000001004ca7fc
- (id)data;	// IMP=0x00000001004ca4ac
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 keychainWrapper:(id)arg2 systemMonitor:(id)arg3;	// IMP=0x00000001004ca2e4
