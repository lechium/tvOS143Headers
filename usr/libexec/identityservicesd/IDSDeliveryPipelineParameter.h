...
- (void).cxx_destruct;	// IMP=0x00000001004d013c
...
- (id)description;	// IMP=0x00000001004cf8d4
- (_Bool)overrideSendOnePerTokenForService:(id)arg1;	// IMP=0x00000001004cf834
- (id)initWithInfo:(id)arg1 uris:(id)arg2 service:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00000001004cf184
