...
- (void).cxx_destruct;	// IMP=0x000000010048f648
...
- (id)initWithMessage:(id)arg1 fromID:(id)arg2 topic:(id)arg3 guid:(id)arg4 isLocal:(_Bool)arg5;	// IMP=0x000000010048f2b4
