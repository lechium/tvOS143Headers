...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010007a558
- (void).cxx_destruct;	// IMP=0x000000010007a968
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010007a634
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010007a578
