...
+ (id)sharedInstance;	// IMP=0x00000001001a0da8
- (void).cxx_destruct;	// IMP=0x00000001001a23a0
@property __weak id <IDSDaemonMIGInterfaceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)denyIncomingGrantRequests;	// IMP=0x00000001001a22b4
- (void)acceptIncomingGrantRequests;	// IMP=0x00000001001a21a0
- (void)__setupServer;	// IMP=0x00000001001a0f54
