...
- (void).cxx_destruct;	// IMP=0x000000010048ba94
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010048b7c0
- (id)bagKey;	// IMP=0x000000010048b7a4
- (id)messageBody;	// IMP=0x000000010048b5e0
- (id)additionalMessageHeaders;	// IMP=0x000000010048b3e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010048b174
