...
- (void).cxx_destruct;	// IMP=0x00000001003ab814
...
- (void)setNegotiationTimer;	// IMP=0x00000001003ab348
- (void)_handleNegotiationTimeout;	// IMP=0x00000001003aa9c8
- (void)removeNegotiationTimer;	// IMP=0x00000001003aa78c
- (void)dealloc;	// IMP=0x00000001003aa704
- (id)initWithToken:(id)arg1;	// IMP=0x00000001003aa61c
