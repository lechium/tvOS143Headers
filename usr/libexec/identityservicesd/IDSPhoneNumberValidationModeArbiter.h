...
- (void).cxx_destruct;	// IMP=0x000000010040aae0
...
- (_Bool)isPrefightEnabledByServerBag;	// IMP=0x000000010040a240
...
- (id)initWithServerBag:(id)arg1;	// IMP=0x0000000100409d40
- (id)init;	// IMP=0x0000000100409c88
