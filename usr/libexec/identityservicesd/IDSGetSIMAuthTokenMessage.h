...
- (void).cxx_destruct;	// IMP=0x0000000100611c40
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00000001006116f8
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x00000001006116d8
- (id)bagKey;	// IMP=0x00000001006116bc
- (id)requiredKeys;	// IMP=0x0000000100611650
- (id)messageBody;	// IMP=0x00000001006112e4
- (id)additionalMessageHeaders;	// IMP=0x0000000100611144
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100610de4
