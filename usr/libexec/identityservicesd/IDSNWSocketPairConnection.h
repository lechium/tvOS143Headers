...
- (void).cxx_destruct;	// IMP=0x00000001006067d0
...
- (void)_sendDataViaNWConnection:(id)arg1 isLargeTransfer:(_Bool)arg2;	// IMP=0x0000000100605c84
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x0000000100605510
- (double)lastSocketActivityTime;	// IMP=0x00000001006054f4
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x0000000100604d9c
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x0000000100604d0c
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x0000000100603b28
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0000000100603ac0
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x0000000100602ccc
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100602bfc
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x0000000100602b58
- (void)endSession;	// IMP=0x0000000100602864
- (void)dealloc;	// IMP=0x000000010060276c
- (void)start;	// IMP=0x0000000100601838
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x0000000100601544
