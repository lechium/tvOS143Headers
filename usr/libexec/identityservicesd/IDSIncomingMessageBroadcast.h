...
- (void).cxx_destruct;	// IMP=0x000000010010787c
...
- (id)initWithBroadcastBlock:(CDUnknownBlockType)arg1 needsClientAck:(_Bool)arg2 messageUUID:(id)arg3 priority:(long long)arg4 senderID:(id)arg5 sequenceNumber:(unsigned int)arg6;	// IMP=0x000000010010735c
- (id)init;	// IMP=0x000000010010722c
