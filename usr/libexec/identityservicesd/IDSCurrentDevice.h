...
+ (id)sharedInstance;	// IMP=0x000000010046ed74
- (void).cxx_destruct;	// IMP=0x000000010046f818
- (void)regenerateDeviceIdentifier;	// IMP=0x000000010046f64c
@property(readonly, retain, nonatomic) NSString *deviceIdentifier;
- (id)_deviceIdentifierKeychainID;	// IMP=0x000000010046f34c
...
- (id)init;	// IMP=0x000000010046ef20
