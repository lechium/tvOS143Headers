...
- (void).cxx_destruct;	// IMP=0x00000001004ee5b4
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x00000001004ecc2c
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001004ec55c
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x00000001004ec304
- (void)invalidate;	// IMP=0x00000001004eb99c
- (void)dealloc;	// IMP=0x00000001004eb8a4
- (void)_closeSockets;	// IMP=0x00000001004eb230
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00000001004eadd0
- (id)flagsString;	// IMP=0x00000001004eacd8
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00000001004eacbc
- (id)description;	// IMP=0x00000001004ea754
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x00000001004ea344
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x00000001004e9f30
