...
+ (id)sharedInstance;	// IMP=0x000000010015d1e4
- (void).cxx_destruct;	// IMP=0x000000010015ed4c
...
- (void)rapportClient:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x000000010015e9d8
- (unsigned int)_nextMessageID;	// IMP=0x000000010015e998
- (void)sendMessage:(id)arg1 messageID:(id)arg2 topic:(id)arg3 command:(id)arg4 destinationIDs:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x000000010015d5b8
- (void)dealloc;	// IMP=0x000000010015d54c
- (id)init;	// IMP=0x000000010015d49c
- (id)initWithRapportClient:(id)arg1;	// IMP=0x000000010015d390
