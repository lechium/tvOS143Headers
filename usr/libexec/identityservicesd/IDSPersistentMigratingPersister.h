...
- (void).cxx_destruct;	// IMP=0x00000001004cdb24
...
- (void)purgeData;	// IMP=0x00000001004cd7a4
- (void)saveData:(id)arg1;	// IMP=0x00000001004cd69c
- (id)data;	// IMP=0x00000001004cd5f8
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x00000001004cd238
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x00000001004cd120
