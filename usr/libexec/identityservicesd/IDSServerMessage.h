...
- (void).cxx_destruct;	// IMP=0x00000001003bb414
...
- (_Bool)wantsBinaryPush;	// IMP=0x00000001003bb330
- (id)messageBody;	// IMP=0x00000001003bb0fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001003bb018
- (id)initWithPayload:(id)arg1 command:(id)arg2;	// IMP=0x00000001003baebc
