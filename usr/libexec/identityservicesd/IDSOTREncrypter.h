...
- (void).cxx_destruct;	// IMP=0x000000010041f1dc
...
- (id)decryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x000000010041e620
- (id)encryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x000000010041da14
- (id)initWithOTRController:(id)arg1 OTRToken:(id)arg2;	// IMP=0x000000010041d8f8
