...
+ (long long)phaseForExpirationDate:(id)arg1;	// IMP=0x000000010013943c
- (void).cxx_destruct;	// IMP=0x0000000100139518
...
- (id)initWithUser:(id)arg1 expirationPhase:(long long)arg2;	// IMP=0x00000001001391b0
- (id)initWithUser:(id)arg1;	// IMP=0x00000001001390a0
