...
- (void).cxx_destruct;	// IMP=0x0000000100160238
...
- (id)messageBody;	// IMP=0x000000010015f468
- (id)requiredKeys;	// IMP=0x000000010015f33c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015ef40
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x000000010015ee60
- (id)init;	// IMP=0x000000010015ed94
