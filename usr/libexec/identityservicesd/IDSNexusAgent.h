...
+ (id)agentFromData:(id)arg1;	// IMP=0x000000010005b020
+ (id)agentType;	// IMP=0x000000010005b000
+ (id)agentDomain;	// IMP=0x000000010005af80
- (void).cxx_destruct;	// IMP=0x000000010005c0d0
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x000000010005be0c
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x000000010005bbf0
- (_Bool)startAgentWithOptions:(id)arg1;	// IMP=0x000000010005b9d4
- (void)closeNexusWithOptions:(id)arg1;	// IMP=0x000000010005b778
- (_Bool)requestNexusWithOptions:(id)arg1;	// IMP=0x000000010005b3b4
...
- (id)copyAgentData;	// IMP=0x000000010005b08c
