...
+ (id)sharedInstance;	// IMP=0x00000001005f86e8
- (void).cxx_destruct;	// IMP=0x00000001005f8f4c
...
- (void)_timerFired;	// IMP=0x00000001005f8c14
- (void)removeTarget:(id)arg1;	// IMP=0x00000001005f8b58
- (void)addTarget:(id)arg1 actionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001005f8a14
- (_Bool)hasActionForTarget:(id)arg1;	// IMP=0x00000001005f8988
- (id)initWithTimerBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001005f8878
