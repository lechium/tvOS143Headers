...
- (void).cxx_destruct;	// IMP=0x00000001000aba78
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000ab834
- (unsigned long long)hash;	// IMP=0x00000001000ab67c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000ab2e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000ab10c
- (void)copyTo:(id)arg1;	// IMP=0x00000001000aaf84
- (void)writeTo:(id)arg1;	// IMP=0x00000001000aae48
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000aadd8
- (id)dictionaryRepresentation;	// IMP=0x00000001000aa33c
- (id)description;	// IMP=0x00000001000aa254
