...
- (void).cxx_destruct;	// IMP=0x0000000100427660
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010042725c
- (id)bagKey;	// IMP=0x0000000100427240
- (id)messageBody;	// IMP=0x00000001004270d0
- (id)additionalMessageHeaders;	// IMP=0x0000000100426ed4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100426c14
