...
- (void).cxx_destruct;	// IMP=0x00000001003d9d08
...
- (id)initWithPublicLegacyIdentityData:(id)arg1 publicNGMIdentityData:(id)arg2 publicNGMPrekeyData:(id)arg3 NGMVersion:(id)arg4;	// IMP=0x00000001003d9b14
