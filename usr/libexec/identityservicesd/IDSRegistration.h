...
- (id)debugDescription;	// IMP=0x00000001005cd5a8
- (id)description;	// IMP=0x00000001005cd0f0
- (id)_userStore;	// IMP=0x00000001005cd058
- (id)_user;	// IMP=0x00000001005ccfe4
- (void)voidPassword;	// IMP=0x00000001005ccc7c
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x00000001005cca28
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001005ca698
...
- (id)_userID;	// IMP=0x00000001005c8f48
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x00000001005c8de4
- (void)addCandidateEmail:(id)arg1;	// IMP=0x00000001005c8cd4
@property(readonly, nonatomic) NSArray *candidateEmails;
- (_Bool)saveToKeychain;	// IMP=0x00000001005c8c40
- (_Bool)removeFromKeychain;	// IMP=0x00000001005c8bc8
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001005c36ec
- (id)init;	// IMP=0x00000001005c363c
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x00000001005c351c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001005c3500
- (id)_keychain_comparisonValue;	// IMP=0x000000010030d160
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x000000010030cea8
