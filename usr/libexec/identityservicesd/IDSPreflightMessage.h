...
- (void).cxx_destruct;	// IMP=0x000000010001ade8
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010001a4dc
- (_Bool)requiresPushTokenKeys;	// IMP=0x000000010001a4bc
- (id)bagKey;	// IMP=0x000000010001a4a0
- (id)requiredKeys;	// IMP=0x000000010001a434
- (id)messageBody;	// IMP=0x0000000100019f30
- (id)additionalMessageHeaders;	// IMP=0x0000000100019d90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100019988
