...
- (void).cxx_destruct;	// IMP=0x00000001004cd0b0
...
- (void)purgeData;	// IMP=0x00000001004ccb04
- (void)saveData:(id)arg1;	// IMP=0x00000001004cbb08
- (id)data;	// IMP=0x00000001004cb1f4
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4 fileDirectory:(id)arg5;	// IMP=0x00000001004caf48
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4;	// IMP=0x00000001004cae34
