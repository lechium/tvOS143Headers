...
- (void).cxx_destruct;	// IMP=0x0000000100018098
...
- (void)_signalDidUpdateEndpoints;	// IMP=0x0000000100017e7c
- (void)_noteSourceDidDiscoverEndpointMap:(id)arg1 forLocalURI:(id)arg2;	// IMP=0x00000001000179a0
- (void)_registerEndpointQueryCompletionBlock;	// IMP=0x0000000100017668
- (id)resolvedEndpoints;	// IMP=0x0000000100017418
- (void)initializeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100016d64
- (id)peerIDManager;	// IMP=0x0000000100016d28
- (id)description;	// IMP=0x0000000100016bfc
- (void)dealloc;	// IMP=0x0000000100016b64
- (id)initWithServiceIdentifier:(id)arg1 localURI:(id)arg2 subscribedURIs:(id)arg3 queue:(id)arg4;	// IMP=0x0000000100016984
