...
- (void).cxx_destruct;	// IMP=0x00000001005e2418
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00000001005e1ed0
- (id)bagKey;	// IMP=0x00000001005e1eb4
- (id)requiredKeys;	// IMP=0x00000001005e1e48
- (id)messageBody;	// IMP=0x00000001005e1a88
- (id)additionalMessageHeaders;	// IMP=0x00000001005e1790
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001005e1430
