...
- (void).cxx_destruct;	// IMP=0x00000001004bf194
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x00000001004bdccc
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x00000001004bdbd4
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x00000001004bdb54
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x00000001004bd728
- (_Bool)supportsReinitiate;	// IMP=0x00000001004bd644
- (void)_endSessionTimedOut;	// IMP=0x00000001004bd4c8
- (void)setEndSessionTimeoutTimer;	// IMP=0x00000001004bd20c
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x00000001004bcff4
- (void)_clearPacketLossTimer;	// IMP=0x00000001004bce60
- (void)_connectionTimedOut;	// IMP=0x00000001004bcd08
- (void)setConnectionTimer;	// IMP=0x00000001004bc8b8
- (void)_clearConnectionTimer;	// IMP=0x00000001004bc6a0
- (void)_clearInvitationTimer;	// IMP=0x00000001004bc488
- (void)_inviteTimedOut;	// IMP=0x00000001004bc2b8
- (void)setInvitationTimer;	// IMP=0x00000001004bbfe0
- (void)clearAllTimers;	// IMP=0x00000001004bbf70
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x00000001004b9d08
