...
- (void).cxx_destruct;	// IMP=0x000000010006b328
...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010006aea8
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x000000010006ae54
- (void)_endSession;	// IMP=0x000000010006aabc
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x000000010006a5b4
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x000000010006a524
- (void)_sendToConnectedSocket;	// IMP=0x00000001000697b8
- (_Bool)_queueNextOutgoingData;	// IMP=0x00000001000687d0
- (void)_processBytesAvailable;	// IMP=0x000000010006760c
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x0000000100066748
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0000000100066320
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x0000000100065a88
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x000000010006561c
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001000654a0
...
- (void)endSession;	// IMP=0x00000001000649f8
- (void)dealloc;	// IMP=0x0000000100064900
- (void)start;	// IMP=0x0000000100064674
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x00000001000640d8
