...
- (void).cxx_destruct;	// IMP=0x0000000100280ff4
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0000000100280ac4
- (_Bool)wantsHTTPGet;	// IMP=0x0000000100280aa4
- (id)additionalQueryStringParameters;	// IMP=0x0000000100280888
- (id)additionalMessageHeaders;	// IMP=0x0000000100280618
- (id)bagKey;	// IMP=0x00000001002805fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002802d4
