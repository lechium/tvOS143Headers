...
- (void).cxx_destruct;	// IMP=0x000000010015d0f4
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010015cc34
- (id)bagKey;	// IMP=0x000000010015cc18
- (id)requiredKeys;	// IMP=0x000000010015cbac
- (id)messageBody;	// IMP=0x000000010015c9b8
- (id)additionalMessageHeaders;	// IMP=0x000000010015c818
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015c558
