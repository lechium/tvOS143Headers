...
- (void).cxx_destruct;	// IMP=0x00000001000940f4
...
- (void)copyOpportunisticCacheWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100093c44
- (id)initWithQueue:(id)arg1 connection:(id)arg2 opportunisticCache:(id)arg3;	// IMP=0x0000000100093b04
