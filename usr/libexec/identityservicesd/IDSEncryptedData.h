...
- (void).cxx_destruct;	// IMP=0x0000000100139050
...
- (id)description;	// IMP=0x0000000100138f18
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x0000000100138de4
