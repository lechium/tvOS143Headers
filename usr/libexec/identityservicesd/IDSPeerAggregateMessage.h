...
- (void).cxx_destruct;	// IMP=0x00000001000a9e7c
...
- (id)messageBody;	// IMP=0x00000001000a8be4
- (id)requiredKeys;	// IMP=0x00000001000a8af0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000a84e0
- (void)logFailureInfo;	// IMP=0x00000001000a7dac
- (_Bool)expectingMoreResponses;	// IMP=0x00000001000a7d54
- (id)_processMessageResponseForMessage:(id)arg1 withError:(id)arg2 resultCode:(long long)arg3 toURI:(id)arg4 fromURI:(id)arg5 service:(id)arg6 fromIdentity:(id)arg7;	// IMP=0x00000001000a6b38
- (void)noteResponseForToken:(id)arg1;	// IMP=0x00000001000a60f8
- (void)callAllAckBlocks;	// IMP=0x00000001000a5f08
- (void)clearAllPendingResponseTokens;	// IMP=0x00000001000a5e64
- (void)callAllIndividualCompletionBlocksWithDeliveryContext:(id)arg1;	// IMP=0x00000001000a5c6c
- (_Bool)removeAllAggregatableMessages;	// IMP=0x00000001000a5ad8
- (_Bool)addAggregatableMessage:(id)arg1;	// IMP=0x00000001000a58e8
- (_Bool)hasSpaceForAggregatableMessage:(id)arg1;	// IMP=0x00000001000a580c
- (id)initWithPeerMessage:(id)arg1 service:(id)arg2 fromIdentity:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00000001000a50c8
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x00000001000a4fcc
- (id)init;	// IMP=0x00000001000a4f00
