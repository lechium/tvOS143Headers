...
- (void).cxx_destruct;	// IMP=0x00000001001b1cbc
...
- (_Bool)_isEntitledForPreferInfraWiFiForServices:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001b1900
- (void)_defaultPeerSetPreferInfraWiFi:(_Bool)arg1 services:(id)arg2;	// IMP=0x00000001001b1850
- (void)reunionSyncCompletedForServices:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001b14cc
- (void)reunionSyncStartedForServices:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001b1148
- (id)initWithConnection:(id)arg1 clientProcessName:(id)arg2 UTunDeliveryController:(id)arg3 duetInterface:(id)arg4;	// IMP=0x00000001001b0fc4
