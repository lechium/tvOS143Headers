...
- (void).cxx_destruct;	// IMP=0x000000010024f170
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x000000010024ee60
- (void)addSession:(id)arg1;	// IMP=0x000000010024ede0
- (void)addServiceType:(id)arg1;	// IMP=0x000000010024ed74
- (void)addAlias:(id)arg1;	// IMP=0x000000010024ed0c
- (id)init;	// IMP=0x000000010024ebcc
