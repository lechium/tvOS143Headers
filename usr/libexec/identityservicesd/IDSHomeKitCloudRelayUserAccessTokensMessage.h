...
- (void).cxx_destruct;	// IMP=0x00000001000744a0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00000001000741cc
- (id)bagKey;	// IMP=0x00000001000741b0
- (id)messageBody;	// IMP=0x0000000100073fec
- (id)additionalMessageHeaders;	// IMP=0x0000000100073df0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100073b80
