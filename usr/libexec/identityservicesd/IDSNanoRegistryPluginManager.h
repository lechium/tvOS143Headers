...
+ (id)sharedInstance;	// IMP=0x0000000100074558
- (void).cxx_destruct;	// IMP=0x00000001000761f0
...
- (void)_initializePluginWithClass:(Class)arg1;	// IMP=0x00000001000756fc
- (void)_initializePlugin;	// IMP=0x00000001000753c8
- (void)executeSynchronouslyOnCallbackQueue:(CDUnknownBlockType)arg1;	// IMP=0x00000001000752d0
- (void)initializePluginWithClass:(Class)arg1;	// IMP=0x00000001000751ec
- (void)notifyWatchToStopAdvertising;	// IMP=0x0000000100074eec
- (void)notifyWatchDidStopAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0000000100074cd4
- (void)notifyWatchToStartAdvertising;	// IMP=0x00000001000749d8
- (void)notifyWatchDidStartAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0000000100074808
- (id)init;	// IMP=0x0000000100074624
