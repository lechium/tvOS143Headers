...
+ (id)sharedInstance;	// IMP=0x00000001002f6f0c
- (void).cxx_destruct;	// IMP=0x00000001002f7fb4
...
- (void)logState;	// IMP=0x00000001002f7e08
- (id)publicDeviceIdentityContainerForDeviceID:(id)arg1;	// IMP=0x00000001002f78ac
- (void)clearCache;	// IMP=0x00000001002f77b0
- (void)dealloc;	// IMP=0x00000001002f7740
- (void)_removeOldPersistence;	// IMP=0x00000001002f7614
- (id)initWithPeerIDManager:(id)arg1 accountController:(id)arg2;	// IMP=0x00000001002f70f0
- (id)init;	// IMP=0x00000001002f7008
