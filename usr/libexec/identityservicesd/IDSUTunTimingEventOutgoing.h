...
- (void)appendToString:(id)arg1;	// IMP=0x00000001004eec48
- (id)initWithTimestamp:(double)arg1 duration:(double)arg2 processTime:(double)arg3 compressionTime:(double)arg4 sendTime:(double)arg5 bytes:(long long)arg6;	// IMP=0x00000001004eeb38
