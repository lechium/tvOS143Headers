...
- (id)initWithMPIdentityIdentifier:(id)arg1;	// IMP=0x00000001001ce848
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x00000001001ce788
- (id)init;	// IMP=0x00000001001ce718
