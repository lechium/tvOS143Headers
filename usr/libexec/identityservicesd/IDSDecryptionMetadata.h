...
- (id)initWithUsedLastResortCache:(_Bool)arg1 usedCachedData:(_Bool)arg2;	// IMP=0x00000001001ce620
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x00000001001ce5a0
- (id)init;	// IMP=0x00000001001ce524
- (id)initWithEncryptionType:(long long)arg1 usedLastResortCache:(_Bool)arg2 usedCachedData:(_Bool)arg3;	// IMP=0x00000001001ce42c
