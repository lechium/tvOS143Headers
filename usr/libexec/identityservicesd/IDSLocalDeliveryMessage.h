...
- (id)socketPairMessage;	// IMP=0x00000001002828a8
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x0000000100282840
- (void)kickProgressBlock;	// IMP=0x0000000100282620
- (id)init;	// IMP=0x0000000100282368
