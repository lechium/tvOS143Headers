...
- (void).cxx_destruct;	// IMP=0x000000010007a4d8
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010007a108
- (double)anisetteHeadersTimeout;	// IMP=0x000000010007a0f0
- (id)messageBody;	// IMP=0x000000010007a084
- (id)requiredKeys;	// IMP=0x000000010007a018
- (id)bagKey;	// IMP=0x0000000100079ffc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100079e38
- (id)init;	// IMP=0x0000000100079d6c
