...
- (void).cxx_destruct;	// IMP=0x00000001001bbc8c
...
- (id)description;	// IMP=0x00000001001bbb48
- (id)initWithLocalFullIdentity:(id)arg1 remotePublicIdentity:(id)arg2;	// IMP=0x00000001001bba2c
