...
+ (id)builderWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 avoidMainQueue:(_Bool)arg7 forceLegacy:(_Bool)arg8;	// IMP=0x00000001001222a4
- (void).cxx_destruct;	// IMP=0x000000010012308c
...
- (id)encrypterWithOTRToken:(id)arg1;	// IMP=0x0000000100122d4c
- (id)encrypterWithEndpoint:(id)arg1;	// IMP=0x0000000100122bd0
- (id)encrypterWithDeviceID:(id)arg1;	// IMP=0x0000000100122aa0
- (id)encrypterWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5;	// IMP=0x00000001001227c0
- (id)_createHashingDeviceIdentityEncrypter;	// IMP=0x000000010012269c
- (id)initWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 avoidMainQueue:(_Bool)arg7 forceLegacy:(_Bool)arg8;	// IMP=0x0000000100122460
