...
- (void).cxx_destruct;	// IMP=0x00000001003c1184
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x00000001003c07cc
- (void)_addRemotePacketOutage;	// IMP=0x00000001003c0718
- (id)description;	// IMP=0x00000001003c05ac
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x00000001003c04a8
