...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x000000010002ffa0
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x000000010002fedc
- (int)numberOfFields;	// IMP=0x000000010002fed4
- (_Bool)isFrontCameraPowered;	// IMP=0x000000010002fecc
- (_Bool)isRearCameraPowered;	// IMP=0x000000010002fec4
- (void)handleOdeonStateNotification:(unsigned long long)arg1;	// IMP=0x000000010002fde0
- (void)handleFrontCameraPowerStateNotification:(unsigned long long)arg1;	// IMP=0x000000010002fcfc
- (void)handleRearCameraPowerStateNotification:(unsigned long long)arg1;	// IMP=0x000000010002fc18
- (void)updatePackageFloorsAndCeilings:(_Bool)arg1;	// IMP=0x000000010002fb08
- (void)updateMaxLIFloorsAndCeilings;	// IMP=0x000000010002f630
- (void)updateInternal;	// IMP=0x000000010002e8e8
- (void)update;	// IMP=0x000000010002e878
- (id)initWithParams:(id)arg1 backlightController:(id)arg2 product:(id)arg3;	// IMP=0x000000010002d3a0
- (id)init;	// IMP=0x000000010002d388
