...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x00000001000296c0
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x00000001000296ac
- (int)numberOfFields;	// IMP=0x00000001000296a4
- (void)overrideParam:(id)arg1 value:(int)arg2;	// IMP=0x0000000100029558
- (void)updateInternal;	// IMP=0x00000001000293dc
- (void)update;	// IMP=0x0000000100029370
- (id)initWithParams:(id)arg1 product:(id)arg2;	// IMP=0x00000001000290c8
- (id)init;	// IMP=0x00000001000290b4
