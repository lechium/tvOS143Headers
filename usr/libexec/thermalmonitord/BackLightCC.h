...
- (_Bool)findBacklightServices;	// IMP=0x0000000100031db0
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x0000000100031c78
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x0000000100031bb8
- (int)numberOfFields;	// IMP=0x0000000100031b80
- (void)setCPMSMitigationState:(_Bool)arg1;	// IMP=0x0000000100031ad8
- (void)initPowerTable:(struct __CFArray *)arg1;	// IMP=0x0000000100031858
- (void)initBrightnessTable:(struct __CFArray *)arg1;	// IMP=0x0000000100031614
- (void)setMaxLICeilingSoft:(int)arg1;	// IMP=0x0000000100031604
- (void)setMaxLICeiling:(int)arg1;	// IMP=0x00000001000315f4
- (_Bool)shouldSuppressMitigations;	// IMP=0x00000001000315bc
- (void)refreshFunctionalTelemetry;	// IMP=0x0000000100031560
- (void)defaultCPMSAction;	// IMP=0x000000010003131c
- (void)defaultAction;	// IMP=0x00000001000310f4
- (void)setBrightnessKey:(id)arg1 value:(int)arg2;	// IMP=0x0000000100030fac
- (id)initWithParams:(struct __CFDictionary *)arg1;	// IMP=0x0000000100030c64
