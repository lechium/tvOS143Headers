...
+ (id)sharedInstance;	// IMP=0x0000000100016ae4
- (void).cxx_destruct;	// IMP=0x00000001000176a4
...
- (_Bool)runningInRAMDisk;	// IMP=0x0000000100017570
- (id)copyDeviceTreeInt:(id)arg1 key:(id)arg2 defaultValue:(int)arg3;	// IMP=0x0000000100017420
- (id)copyBootArgs;	// IMP=0x000000010001737c
- (id)copyBootSessionUUID;	// IMP=0x00000001000172cc
- (id)copyDeviceTreeProperty:(id)arg1 key:(id)arg2;	// IMP=0x0000000100017218
- (id)init;	// IMP=0x0000000100016b50
