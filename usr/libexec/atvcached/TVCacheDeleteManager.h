...
- (void).cxx_destruct;	// IMP=0x00000001000026bc
...
- (id)_purgeTasksForUrgency:(long long)arg1;	// IMP=0x00000001000025b8
- (void)cancelPurge;	// IMP=0x000000010000254c
- (long long)purgeAmount:(long long)arg1 withUrgency:(long long)arg2 isPeriodic:(_Bool)arg3;	// IMP=0x000000010000207c
- (long long)purgeAmount:(long long)arg1 withUrgency:(long long)arg2;	// IMP=0x000000010000206c
- (long long)purgeableAmountWithUrgency:(long long)arg1;	// IMP=0x0000000100001c84
- (void)registerForCallbacks;	// IMP=0x0000000100001960
- (id)initWithCacheDeleteID:(id)arg1;	// IMP=0x00000001000018ac
