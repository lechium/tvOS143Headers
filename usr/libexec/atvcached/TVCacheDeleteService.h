...
+ (id)sharedInstance;	// IMP=0x0000000100003fc8
- (void).cxx_destruct;	// IMP=0x0000000100004bc0
...
- (id)manager:(id)arg1 purgeTasksForUrgency:(long long)arg2;	// IMP=0x0000000100004ad4
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000100004484
- (void)start;	// IMP=0x00000001000043b0
- (void)dealloc;	// IMP=0x000000010000434c
- (id)_init;	// IMP=0x0000000100004040
