...
+ (unsigned long long)_priorityForState:(unsigned long long)arg1;	// IMP=0x0000000100004600
- (void).cxx_destruct;	// IMP=0x00000001000054fc
...
- (void)_schedule;	// IMP=0x00000001000049d8
- (void)finish;	// IMP=0x00000001000048a4
- (void)cancel;	// IMP=0x0000000100004770
- (void)setState:(unsigned long long)arg1;	// IMP=0x000000010000463c
- (id)_activityName;	// IMP=0x00000001000045ac
- (id)initWithOperationID:(id)arg1 group:(id)arg2 bundleID:(id)arg3 requiresPastBuddy:(_Bool)arg4 options:(id)arg5 state:(unsigned long long)arg6 queue:(id)arg7 startHandler:(CDUnknownBlockType)arg8 suspendHandler:(CDUnknownBlockType)arg9;	// IMP=0x00000001000042ec
