...
- (void)cleanup;	// IMP=0x0000000100006d28
- (void)finishOperationID:(id)arg1;	// IMP=0x0000000100006994
- (void)queueOperationID:(id)arg1 options:(id)arg2 clientOperationCallbackProxy:(id)arg3 withBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000100005d50
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x00000001000058ec
- (id)initWithDaemon:(id)arg1 group:(id)arg2 bundleID:(id)arg3 isSpringBoardApp:(_Bool)arg4 requiresPastBuddy:(_Bool)arg5 scheduleSendBarrierBlock:(CDUnknownBlockType)arg6;	// IMP=0x0000000100005740
