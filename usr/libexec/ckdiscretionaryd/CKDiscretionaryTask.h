...
- (void).cxx_destruct;	// IMP=0x0000000100003d3c
...
- (void)complete;	// IMP=0x0000000100003a2c
- (void)applicationNoLongerInForeground:(id)arg1;	// IMP=0x00000001000037b8
- (void)applicationEnteredForeground:(id)arg1;	// IMP=0x0000000100003544
- (id)_schedulerTaskIdentifier;	// IMP=0x0000000100003454
- (void)dealloc;	// IMP=0x0000000100003224
- (id)initWithConnection:(id)arg1 operationID:(id)arg2 group:(id)arg3 bundleID:(id)arg4 isSpringBoardApp:(_Bool)arg5 requiresPastBuddy:(_Bool)arg6 options:(id)arg7 schedulerClass:(Class)arg8 startHandler:(CDUnknownBlockType)arg9 suspendHandler:(CDUnknownBlockType)arg10;	// IMP=0x0000000100002478
