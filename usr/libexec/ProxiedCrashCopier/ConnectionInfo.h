...
- (void).cxx_destruct;	// IMP=0x0000000100004ab8
@property(readonly) NSString *connectionType; // @synthesize connectionType=_connectionType;
- (void)reachabilityCallback:(id)arg1;	// IMP=0x0000000100004aa0
@property(readonly) _Bool onCellular;
- (void)dealloc;	// IMP=0x0000000100004a54
- (id)init;	// IMP=0x0000000100004774
