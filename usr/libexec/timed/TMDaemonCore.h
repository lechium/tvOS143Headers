...
- (void)addTimeProvider:(id)arg1 forKey:(id)arg2;	// IMP=0x00000001000101d8
@property(readonly, nonatomic) id <TMTimeProvider> timeProvider;
@property(readonly) TMTimeZone *computedTimeZone;
- (void)timeZoneManager:(id)arg1 shouldFetch:(id)arg2;	// IMP=0x0000000100010064
- (void)timeZoneManager:(id)arg1 didComputeResult:(id)arg2;	// IMP=0x000000010000ffb0
- (void)timeZoneManager:(id)arg1 didReset:(id)arg2;	// IMP=0x000000010000ff58
- (void)resetTimeZone:(id)arg1;	// IMP=0x000000010000fcac
- (void)setSourceTimeZone:(id)arg1;	// IMP=0x000000010000f3ec
- (void)setSourceUnavailable:(id)arg1;	// IMP=0x000000010000f140
- (void)setSourceAvailable:(id)arg1;	// IMP=0x000000010000ee94
- (void)setSourceTime:(id)arg1;	// IMP=0x000000010000e870
- (void)checkActiveTimeSourceRequired;	// IMP=0x000000010000e2f0
...
- (void)executeCommand:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000ad78
@property(nonatomic, getter=isSystemTimeZoneSet) _Bool systemTimeZoneSet;
- (void)testAndApplySystemTime;	// IMP=0x000000010000931c
- (void)addPlugin:(id)arg1;	// IMP=0x0000000100008ca4
- (void)dealloc;	// IMP=0x0000000100008a78
- (id)initWithTimeZoneRules:(id)arg1 monotonicClock:(id)arg2 preferences:(id)arg3;	// IMP=0x0000000100007c50
- (void)handleShutdown;	// IMP=0x00000001000077bc
- (void)setAccurateThresholds:(_Bool)arg1;	// IMP=0x00000001000077ac
