...
- (id)description;	// IMP=0x0000000100016a28
- (void)setAccurateThresholds:(_Bool)arg1;	// IMP=0x00000001000167a8
...
- (id)init;	// IMP=0x000000010001669c
- (id)initWithDefaults:(id)arg1;	// IMP=0x00000001000160ac
- (void)dealloc;	// IMP=0x0000000100016064
