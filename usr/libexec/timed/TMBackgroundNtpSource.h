...
- (void)setWantedTime:(double)arg1;	// IMP=0x0000000100014ae8
- (void)dealloc;	// IMP=0x0000000100014a58
- (id)init;	// IMP=0x00000001000149fc
- (void)fetchTime;	// IMP=0x0000000100014998
