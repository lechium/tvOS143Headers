...
- (id)description;	// IMP=0x000000010001137c
- (_Bool)isSourceAvailable:(id)arg1;	// IMP=0x0000000100011254
- (void)setSourceUnavailable:(id)arg1;	// IMP=0x000000010001109c
- (void)setSourceAvailable:(id)arg1;	// IMP=0x0000000100010ee0
- (id)initWithRules:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000100010d50
- (id)initWithRules:(id)arg1;	// IMP=0x0000000100010d40
- (void)dealloc;	// IMP=0x0000000100010cd4
- (void)reset:(id)arg1;	// IMP=0x0000000100010b10
- (void)setSourceTimeZone:(id)arg1;	// IMP=0x0000000100010914
