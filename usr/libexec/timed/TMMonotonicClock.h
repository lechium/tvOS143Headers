...
- (_Bool)isMachTimeValid:(unsigned long long)arg1;	// IMP=0x000000010001280c
...
- (void)montonicTimeForMachTime:(unsigned long long)arg1 toQueue:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100012088
- (void)dealloc;	// IMP=0x0000000100012040
- (id)initWithSyncInterval:(double)arg1;	// IMP=0x0000000100011f8c
- (id)init;	// IMP=0x0000000100011f2c
