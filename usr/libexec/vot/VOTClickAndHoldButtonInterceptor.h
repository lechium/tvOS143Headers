...
- (void).cxx_destruct;	// IMP=0x00000001001089d4
...
- (void)_drainQueueAndSendEventsToSystem:(_Bool)arg1;	// IMP=0x00000001001087b4
- (void)_releaseTimerFired;	// IMP=0x000000010010873c
- (void)_holdTimerFired;	// IMP=0x00000001001086c4
- (void)_resetStateAndSendPendingEventsToSystem:(_Bool)arg1;	// IMP=0x0000000100108650
- (void)_processStateChangeWithEvent:(long long)arg1 axEvent:(id)arg2;	// IMP=0x0000000100108280
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x00000001001081ac
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x00000001001080d8
- (void)dealloc;	// IMP=0x0000000100108044
- (id)initWithThreadKey:(id)arg1;	// IMP=0x0000000100107eb4
