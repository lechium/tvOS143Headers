...
- (void).cxx_destruct;	// IMP=0x0000000100107458
...
- (void)_timerFired;	// IMP=0x0000000100107354
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x00000001001071dc
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x0000000100107100
- (void)dealloc;	// IMP=0x0000000100107094
- (id)initWithThreadKey:(id)arg1 longPressDelay:(double)arg2 longPressHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100106fa8
