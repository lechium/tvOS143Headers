...
+ (id)fetchFoundData:(id)arg1 forceUpdate:(_Bool)arg2 direction:(long long)arg3 generation:(unsigned long long)arg4 range:(struct _NSRange)arg5 searchType:(long long)arg6;	// IMP=0x00000001000eddb4
- (void).cxx_destruct;	// IMP=0x00000001000edffc
...
- (id)description;	// IMP=0x00000001000edea0
