...
- (void).cxx_destruct;	// IMP=0x000000010005c1d8
...
- (id)description;	// IMP=0x000000010005bf08
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x000000010005beec
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x000000010005be0c
- (id)initWithAttributes:(id)arg1;	// IMP=0x000000010005bad0
