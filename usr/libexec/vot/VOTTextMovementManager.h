...
- (void).cxx_destruct;	// IMP=0x00000001000c4a04
...
- (id)_localizedStringForKey:(id)arg1;	// IMP=0x00000001000c4948
- (void)previousSegment;	// IMP=0x00000001000c48c0
- (void)nextSegment;	// IMP=0x00000001000c4848
...
- (id)initWithSegments:(id)arg1;	// IMP=0x00000001000c44f4
