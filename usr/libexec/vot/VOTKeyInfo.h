...
- (void).cxx_destruct;	// IMP=0x00000001000eb204
...
- (id)description;	// IMP=0x00000001000eaf90
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000ea924
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x00000001000ea7b8
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x00000001000eb240
