...
- (void).cxx_destruct;	// IMP=0x000000010005ca00
...
- (long long)_repeatStateForEvent:(id)arg1;	// IMP=0x000000010005c904
- (long long)_currentGestureRepeaterEvent;	// IMP=0x000000010005c8dc
- (double)_delayForCurrentRepeatCount;	// IMP=0x000000010005c8d0
- (void)_handleRepeaterTimerDidFire:(id)arg1;	// IMP=0x000000010005c7d0
- (void)updateWithEvent:(id)arg1;	// IMP=0x000000010005c594
- (void)dealloc;	// IMP=0x000000010005c470
- (id)initWithThread:(id)arg1;	// IMP=0x000000010005c210
