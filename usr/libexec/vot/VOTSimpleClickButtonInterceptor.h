...
- (void).cxx_destruct;	// IMP=0x0000000100107e4c
...
- (void)_drainQueue:(_Bool)arg1;	// IMP=0x0000000100107bcc
- (_Bool)touchEventOccurred:(id)arg1 inTVDirectTouch:(_Bool)arg2;	// IMP=0x0000000100107990
- (void)_timerFired;	// IMP=0x0000000100107964
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x000000010010779c
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x000000010010764c
- (void)dealloc;	// IMP=0x00000001001075cc
- (id)initWithThreadKey:(id)arg1 simpleClickHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001001074ac
