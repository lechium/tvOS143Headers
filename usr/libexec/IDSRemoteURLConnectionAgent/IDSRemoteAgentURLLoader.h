...
+ (_Bool)shouldAssertWiFi;	// IMP=0x00000001000055b4
...
- (void)cancel;	// IMP=0x0000000100005c0c
- (void)load;	// IMP=0x0000000100005920
- (void)dealloc;	// IMP=0x00000001000058ec
- (id)initWithURLRequest:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000056cc
