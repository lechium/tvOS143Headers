...
- (void).cxx_destruct;	// IMP=0x0000000100021b54
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100021714
- (unsigned long long)hash;	// IMP=0x0000000100021694
- (id)copy;	// IMP=0x0000000100021630
- (id)initWithType:(int)arg1 usageString:(id)arg2 usageBool:(id)arg3 appId:(id)arg4 createTime:(id)arg5;	// IMP=0x000000010002150c
