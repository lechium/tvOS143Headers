...
- (void).cxx_destruct;	// IMP=0x0000000100021148
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100020fac
- (unsigned long long)hash;	// IMP=0x0000000100020f30
- (id)copy;	// IMP=0x0000000100020e84
- (id)initWithType:(int)arg1 handlingPolicyId:(int)arg2 logMsg:(id)arg3 expireTime:(id)arg4 createTime:(id)arg5;	// IMP=0x0000000100020d7c
