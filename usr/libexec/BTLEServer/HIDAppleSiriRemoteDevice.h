...
+ (id)hwRevisionFromRevisionString:(id)arg1 fwVersions:(id)arg2;	// IMP=0x000000010001fd8c
+ (id)properties:(id)arg1 locationIdOffset:(unsigned int)arg2 hidDescriptor:(id)arg3 extendedData:(id)arg4;	// IMP=0x000000010001fca4
+ (id)dataFromRevisionString:(id)arg1;	// IMP=0x000000010001fac8
+ (id)fwVersionsFromRevisionData:(id)arg1;	// IMP=0x000000010001f948
+ (unsigned short)hwVersionFromRevisionData:(id)arg1;	// IMP=0x000000010001f8e0
+ (id)getProximityHIDReportDescriptor;	// IMP=0x000000010001f868
+ (id)getDeviceManagementHIDReportDescriptor;	// IMP=0x000000010001f7ec
+ (id)getRadioHIDReportDescriptor;	// IMP=0x000000010001f774
+ (id)getAudioHIDReportDescriptor;	// IMP=0x000000010001f6fc
+ (id)getInfraredHIDReportDescriptor;	// IMP=0x000000010001f684
+ (id)getInertialHIDReportDescriptor;	// IMP=0x000000010001f60c
+ (id)getButtonsHIDReportDescriptor;	// IMP=0x000000010001f58c
+ (id)getTouchHIDReportDescriptor;	// IMP=0x000000010001f514
+ (void)preallocateButtonDriver;	// IMP=0x000000010001f34c
+ (void)initialize;	// IMP=0x000000010001f2f0
...
- (void)siriAudioDidStop:(CDUnknownBlockType)arg1;	// IMP=0x0000000100025fec
- (void)waitForSiriAudioToStop:(CDUnknownBlockType)arg1;	// IMP=0x0000000100025ac8
- (void)siriAudioWillStart:(CDUnknownBlockType)arg1;	// IMP=0x0000000100025490
- (void)logHwFwVersions;	// IMP=0x00000001000251ec
- (void)parseMultiSubsystemV3Report:(char *)arg1 reportLength:(long long)arg2 reportID:(unsigned char)arg3;	// IMP=0x0000000100024db8
- (void)extractButtonDataFromReport:(char *)arg1 buttonIndex:(unsigned char)arg2;	// IMP=0x0000000100024d7c
- (void)clearMultiSubsystemReport;	// IMP=0x0000000100024d14
- (int)getReport:(char *)arg1 reportLength:(long long *)arg2 reportID:(unsigned int)arg3 reportType:(int)arg4 keyholeID:(unsigned char)arg5;	// IMP=0x000000010002492c
- (void)cacheData:(id)arg1 ForReportID:(unsigned int)arg2;	// IMP=0x00000001000247c0
- (void)getCachedReport:(char *)arg1 reportLength:(long long *)arg2 reportID:(unsigned int)arg3 reportType:(int)arg4 keyholeID:(unsigned char)arg5;	// IMP=0x0000000100024498
- (_Bool)isCachedReportID:(unsigned int)arg1 reportType:(int)arg2 keyholeID:(unsigned char)arg3;	// IMP=0x0000000100024258
- (_Bool)canCacheReportID:(unsigned int)arg1 reportType:(int)arg2 keyholeID:(unsigned char)arg3;	// IMP=0x0000000100024188
- (int)setReport:(char *)arg1 reportLength:(long long)arg2 reportID:(unsigned int)arg3 reportType:(int)arg4 keyholeID:(unsigned char)arg5 error:(id *)arg6;	// IMP=0x0000000100023e90
- (int)setReport:(char *)arg1 reportLength:(long long)arg2 reportID:(unsigned int)arg3 reportType:(int)arg4 keyholeID:(unsigned char)arg5;	// IMP=0x0000000100023e80
- (void)handleInputReportData:(id)arg1 reportID:(unsigned char)arg2;	// IMP=0x0000000100023ce0
- (void)handleInputReportData:(id)arg1 reportID:(unsigned char)arg2 timestamp:(unsigned long long)arg3;	// IMP=0x0000000100023c90
- (void)generateMTStatusReport;	// IMP=0x0000000100023ba8
- (void)handleDeviceManagementData:(char *)arg1 dataLength:(long long)arg2;	// IMP=0x0000000100023b24
- (void)handleAudioData:(char *)arg1 dataLength:(long long)arg2;	// IMP=0x0000000100023884
- (void)handleInertialData;	// IMP=0x00000001000236c4
- (void)logTouchData;	// IMP=0x0000000100022df4
- (void)handleTouchData;	// IMP=0x0000000100022c74
- (void)handleProximityData;	// IMP=0x0000000100022ae4
- (void)handleButtonData;	// IMP=0x00000001000227a4
- (void)setZeroSlaveLatency;	// IMP=0x000000010002276c
- (void)setNormalSlaveLatency;	// IMP=0x00000001000226c4
- (id)desiredConnectionParameters;	// IMP=0x0000000100022520
- (void)touchDriverArrived:(unsigned int)arg1;	// IMP=0x0000000100022284
- (void)deviceMgtDriverArrived:(unsigned int)arg1;	// IMP=0x0000000100021fa0
- (void)clearDeviceManagementNotification;	// IMP=0x0000000100021f6c
- (void)clearTouchNotification;	// IMP=0x0000000100021f38
- (void)start;	// IMP=0x0000000100020a04
- (void)stop;	// IMP=0x0000000100020650
- (void)dealloc;	// IMP=0x00000001000203e0
- (id)initWithProperties:(id)arg1 reports:(id)arg2;	// IMP=0x000000010001fddc
