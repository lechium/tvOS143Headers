...
+ (id)updateWithValue:(id)arg1 characteristic:(id)arg2 centrals:(id)arg3;	// IMP=0x000000010002c6e8
- (void).cxx_destruct;	// IMP=0x000000010002c794
...
- (id)initWithValue:(id)arg1 characteristic:(id)arg2 centrals:(id)arg3;	// IMP=0x000000010002c618
