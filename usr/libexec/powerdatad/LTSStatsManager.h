...
+ (id)sharedLTSStatsManager;	// IMP=0x00000001000048c4
...
- (id)getLifetimeStats;	// IMP=0x0000000100005488
- (void)updateLifetimeStats;	// IMP=0x0000000100005420
- (void)updateLifetimeStatsGated;	// IMP=0x000000010000522c
- (int)updateLifetimeStatsForChannel:(struct __CFDictionary *)arg1;	// IMP=0x0000000100004e10
- (id)getStatsSinceBoot;	// IMP=0x0000000100004d60
- (void)dealloc;	// IMP=0x0000000100004cc8
- (id)init;	// IMP=0x0000000100004968
