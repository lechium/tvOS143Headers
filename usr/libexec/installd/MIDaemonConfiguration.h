...
+ (id)sharedInstance;	// IMP=0x0000000100023c94
...
- (id)diskImageMountPoints;	// IMP=0x0000000100024184
- (id)diskImageAppBundleIDToInfoMap;	// IMP=0x0000000100024004
...
- (id)init;	// IMP=0x0000000100023818
