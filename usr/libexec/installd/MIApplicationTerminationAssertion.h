...
- (void).cxx_destruct;	// IMP=0x000000010005c2e4
@property(retain, nonatomic) FBSApplicationTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x000000010005c270
- (void)invalidate;	// IMP=0x000000010005c218
- (id)initWithBundleIdentifier:(id)arg1 reason:(unsigned char)arg2;	// IMP=0x000000010005be54
