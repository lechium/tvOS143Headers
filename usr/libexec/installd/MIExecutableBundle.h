...
+ (id)bundlesInParentBundle:(id)arg1 subDirectory:(id)arg2 matchingPredicate:(CDUnknownBlockType)arg3 error:(id *)arg4;	// IMP=0x000000010002d5d4
- (void).cxx_destruct;	// IMP=0x0000000100034e6c
...
- (_Bool)hasOnlyAllowedWatchKitAppInfoPlistKeysForWatchKitVersion:(unsigned char)arg1 error:(id *)arg2;	// IMP=0x0000000100034904
- (id)watchKitV2AppBundleWithError:(id *)arg1;	// IMP=0x000000010003420c
- (id)_discoverWatchAppBundleAsPlaceholder:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0000000100033b2c
- (id)watchKitV1AppBundleWithError:(id *)arg1;	// IMP=0x00000001000337dc
- (id)watchKitAppBundleForWKVersionOrEarlier:(unsigned char)arg1 error:(id *)arg2;	// IMP=0x000000010003360c
- (unsigned char)watchKitVersionWithError:(id *)arg1;	// IMP=0x0000000100033468
- (id)watchKitPluginWithError:(id *)arg1;	// IMP=0x0000000100033250
...
- (_Bool)_hasResource:(id)arg1 withExtension:(id)arg2;	// IMP=0x0000000100032874
- (_Bool)validateSinfWithError:(id *)arg1;	// IMP=0x000000010003266c
- (id)fairPlaySinfInfoWithError:(id *)arg1;	// IMP=0x000000010003202c
@property(readonly, nonatomic) _Bool hasSinf;
@property(readonly, nonatomic) _Bool needsSinf;
- (void)removeSinf;	// IMP=0x0000000100031e3c
- (_Bool)replicateRootSinfWithError:(id *)arg1;	// IMP=0x0000000100031d38
- (id)updateAndValidateSinf:(id)arg1 withRollback:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0000000100031a54
- (id)updateAndValidateSinf:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100031a40
- (void)bestEffortRollbackSinfData:(id)arg1;	// IMP=0x00000001000318ec
- (_Bool)updateSinfWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100031790
...
- (_Bool)validatePluginMetadataWithError:(id *)arg1;	// IMP=0x000000010003121c
- (_Bool)makeExecutableWithError:(id *)arg1;	// IMP=0x0000000100031060
@property(readonly, copy, nonatomic) NSArray *vpnPluginIdentifiers;
- (id)_dataContainerCreatingIfNeeded:(_Bool)arg1 makeLive:(_Bool)arg2 checkIfNeeded:(_Bool)arg3 created:(_Bool *)arg4 error:(id *)arg5;	// IMP=0x0000000100030b2c
- (id)dataContainerCreatingIfNeeded:(_Bool)arg1 makeLive:(_Bool)arg2 created:(_Bool *)arg3 error:(id *)arg4;	// IMP=0x0000000100030b14
- (id)dataContainerWithError:(id *)arg1;	// IMP=0x0000000100030af4
@property(readonly, nonatomic) Class dataContainerClass;
@property(readonly, nonatomic) long long dataContainerContentClass;
- (_Bool)hasNoConflictsWithOtherInstalledEntitiesForSigningInfo:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000301d0
- (_Bool)_hasNoConflictWithSystemAppsForSigningInfo:(id)arg1 error:(id *)arg2;	// IMP=0x000000010002fbb0
- (int)installEmbeddedProvisioningProfileWithProgress:(CDUnknownBlockType)arg1;	// IMP=0x000000010002fa54
- (id)codeSigningInfoByValidatingResources:(_Bool)arg1 performingOnlineAuthorization:(_Bool)arg2 ignoringCachedSigningInfo:(_Bool)arg3 checkingTrustCacheIfApplicable:(_Bool)arg4 skippingProfileIDValidation:(_Bool)arg5 error:(id *)arg6;	// IMP=0x000000010002ed58
- (id)_codeSigningInfoFromMCM;	// IMP=0x000000010002eb68
- (_Bool)updateMCMWithCodeSigningInfoAsAdvanceCopy:(_Bool)arg1 withError:(id *)arg2;	// IMP=0x000000010002e75c
- (_Bool)needsDataContainer;	// IMP=0x000000010002e470
- (_Bool)_hasNonContainerizingEntitlement:(id)arg1 checkSeatbeltProfiles:(_Bool)arg2;	// IMP=0x000000010002e240
- (_Bool)_isGrandfatheredNonContainerized:(id)arg1;	// IMP=0x000000010002e158
@property(readonly, nonatomic) unsigned int maxLinkedSDKVersion;
- (_Bool)makeAndSetNewInstallationIdentityWithError:(id *)arg1;	// IMP=0x000000010002e084
- (_Bool)transferInstallationIdentityFromBundle:(id)arg1 error:(id *)arg2;	// IMP=0x000000010002df80
- (id)installationIdentitySettingIfNotSet:(_Bool)arg1 withError:(id *)arg2;	// IMP=0x000000010002dec8
- (id)watchKitAppExecutableHashWithError:(id *)arg1;	// IMP=0x000000010002dbc4
- (void)setBundleParentDirectoryURL:(id)arg1;	// IMP=0x000000010002dac8
- (id)lsInstallTypeWithError:(id *)arg1;	// IMP=0x000000010002d844
...
- (id)initWithBundleInContainer:(id)arg1 withExtension:(id)arg2 error:(id *)arg3;	// IMP=0x000000010002d500
- (_Bool)_validateWithError:(id *)arg1;	// IMP=0x000000010002d214
- (void)dealloc;	// IMP=0x000000010002d1bc
