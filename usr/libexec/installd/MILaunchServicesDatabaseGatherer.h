...
+ (id)fetchInfoForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100004c08
+ (id)entryForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100004954
+ (_Bool)enumeratePluginKitPluginsInBundle:(id)arg1 updatingPluginParentID:(_Bool)arg2 ensurePluginsAreExecutable:(_Bool)arg3 installProfiles:(_Bool)arg4 error:(id *)arg5 enumerator:(CDUnknownBlockType)arg6;	// IMP=0x0000000100004290
...
- (_Bool)performGatherWithError:(id *)arg1;	// IMP=0x00000001000058b8
- (void)errorOccurred:(id)arg1;	// IMP=0x000000010000582c
- (_Bool)scanExecutableBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x00000001000054d0
- (id)_setForEntry:(id)arg1;	// IMP=0x00000001000052a8
- (_Bool)_scanBundle:(id)arg1 inBundleContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005014
- (id)initWithEnumerator:(CDUnknownBlockType)arg1;	// IMP=0x00000001000040d4
