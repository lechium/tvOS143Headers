...
+ (void)unpackPackedCpuTypeAndSubType:(id)arg1 cputype:(int *)arg2 subtype:(int *)arg3;	// IMP=0x000000010005de54
+ (id)packedNumberForCPUType:(int)arg1 subtype:(int)arg2;	// IMP=0x000000010005de34
- (void).cxx_destruct;	// IMP=0x000000010005ded0
...
- (_Bool)performHashWithError:(id *)arg1;	// IMP=0x000000010005d5ac
- (id)_hashSliceAtOffset:(long long)arg1 withSize:(long long)arg2 machHeaderAndCommands:(const struct mach_header *)arg3 dictionaryKey:(id *)arg4 error:(id *)arg5;	// IMP=0x000000010005c400
- (void)dealloc;	// IMP=0x000000010005c39c
- (id)initWithExecutable:(id)arg1 searchForSectionNamed:(id)arg2;	// IMP=0x000000010005c2f0
