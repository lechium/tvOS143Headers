...
+ (_Bool)_validateStubSignature:(id)arg1 withSigningID:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100057f64
+ (_Bool)_validateBundleExecutable:(id)arg1 againstStubAt:(id)arg2 trustedHashes:(id)arg3 sectionName:(id)arg4 signingIdentifier:(id)arg5 error:(id *)arg6;	// IMP=0x0000000100057638
+ (_Bool)validateWatchKitV2StubExecutableBundle:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000573cc
+ (_Bool)validateWatchKitV1StubExecutableBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100057160
+ (id)_validateSignatureAndCopyInfoForURL:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100055be4
+ (id)codeSigningVerifierForBundle:(id)arg1;	// IMP=0x0000000100055b90
- (void).cxx_destruct;	// IMP=0x0000000100058310
...
- (_Bool)performValidationWithError:(id *)arg1;	// IMP=0x000000010005608c
- (id)_loadSystemDetachedSignatureForBundleID:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100055ef4
- (id)initWithBundle:(id)arg1;	// IMP=0x0000000100055b10
