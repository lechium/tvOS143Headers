...
+ (id)installerForURL:(id)arg1 withOptions:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000f008
- (void).cxx_destruct;	// IMP=0x0000000100014854
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x0000000100012bb4
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x0000000100012760
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x00000001000123ec
- (_Bool)_discoverInstallablesWithError:(id *)arg1;	// IMP=0x00000001000113d0
- (void)_writeLockBundles:(id)arg1;	// IMP=0x00000001000111b0
- (void)_acquireTerminationAssertionsForBundles:(id)arg1;	// IMP=0x0000000100010fac
- (id)_bundlesAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100010bf8
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x000000010001077c
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x000000010000ffbc
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x000000010000f3e4
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x000000010000f17c
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x000000010000f110
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x000000010000f09c
- (void)dealloc;	// IMP=0x000000010000ee2c
- (id)initWithURL:(id)arg1 options:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000ed5c
