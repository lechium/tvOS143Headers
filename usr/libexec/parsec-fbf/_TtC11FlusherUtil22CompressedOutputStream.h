...
- (void).cxx_destruct;	// IMP=0x000000010002cda0
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x000000010002cf5c
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x000000010002ceb0
- (id)initToMemory;	// IMP=0x000000010002ce40
- (void)close;	// IMP=0x000000010002cd48
- (void)open;	// IMP=0x000000010002ca4c
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x000000010002c7d0
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x000000010002c2e0
- (id)init;	// IMP=0x000000010002c00c
