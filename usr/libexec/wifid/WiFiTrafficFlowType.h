...
- (_Bool)canTrigger11axPerfStudy;	// IMP=0x000000010012462c
- (id)copyStringRepresentationWithFlowClassification:(unsigned int)arg1;	// IMP=0x00000001001240dc
- (id)copyStringRepresentationWithFlowProperty:(unsigned int)arg1 flowPropertyString:(id)arg2;	// IMP=0x0000000100123f64
- (void)processFlowClassifications:(unsigned int)arg1;	// IMP=0x0000000100123c9c
- (void)processCombinedFlowProperties:(unsigned long long)arg1;	// IMP=0x0000000100123a90
- (void)dealloc;	// IMP=0x0000000100123a40
- (id)initWithType:(_Bool)arg1;	// IMP=0x00000001001239c8
