...
+ (id)getAllGeoTagsFromMOC:(id)arg1;	// IMP=0x00000001001221bc
+ (id)copyFetchRequest;	// IMP=0x0000000100121ec0
+ (id)fetchRequest;	// IMP=0x00000001001293f0
- (void)updateWithLocation:(id)arg1 bssid:(id)arg2;	// IMP=0x0000000100122024
- (double)getDistanceFromLocation:(id)arg1;	// IMP=0x0000000100121eec
