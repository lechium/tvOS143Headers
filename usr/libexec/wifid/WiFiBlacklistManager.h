...
- (void)blacklistDidUpdate;	// IMP=0x0000000100129388
- (_Bool)isUserModeInteractive;	// IMP=0x0000000100129368
- (_Bool)retrieveBatteryInfo:(_Bool *)arg1 batteryLevel:(unsigned int *)arg2;	// IMP=0x0000000100129230
- (void)dealloc;	// IMP=0x00000001001291e8
- (id)initWithArgs:(struct __WiFiDeviceManager *)arg1;	// IMP=0x000000010012909c
