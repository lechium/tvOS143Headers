...
+ (id)generateNewScoreObjectFromMOC:(id)arg1;	// IMP=0x0000000100121980
+ (id)copyFetchRequest;	// IMP=0x0000000100121954
+ (id)fetchRequest;	// IMP=0x0000000100129444
- (void)updateScoreForSwitch:(_Bool)arg1;	// IMP=0x0000000100121dfc
- (_Bool)checkIncrementForOverflowWithMuliplier:(long long)arg1 multiplier:(long long)arg2;	// IMP=0x0000000100121df4
- (id)copyScoreLog;	// IMP=0x0000000100121cbc
- (long long)getTotalScore;	// IMP=0x0000000100121af4
