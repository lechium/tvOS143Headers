...
- (void)printDeferredNetworks;	// IMP=0x000000010011f198
- (_Bool)isTimeDeferredNetworksPresent;	// IMP=0x000000010011f170
- (void)setLinkDown;	// IMP=0x000000010011effc
- (void)setLinkUpForNetwork:(struct __WiFiNetwork *)arg1;	// IMP=0x000000010011ee70
- (void)setScanResultsWithAutoJoinSessionCompletion:(id)arg1 complete:(_Bool)arg2;	// IMP=0x000000010011e968
- (void)clearScanResultsForAutoJoinSessionReset;	// IMP=0x000000010011e958
- (_Bool)deferNetwork:(struct __WiFiNetwork *)arg1;	// IMP=0x000000010011e798
- (_Bool)canDeferNetwork:(struct __WiFiNetwork *)arg1 withUsageRank:(unsigned long long)arg2 andMotionState:(int)arg3;	// IMP=0x000000010011e030
- (void)dealloc;	// IMP=0x000000010011dfa8
- (id)initWithArgs:(struct __WiFiDeviceManager *)arg1;	// IMP=0x000000010011de34
