...
- (void).cxx_destruct;	// IMP=0x000000010001b1bc
...
- (id)_dataWithBTAddress:(unsigned long long)arg1;	// IMP=0x000000010001b0ec
- (void)forceNonConnectableAddressReadAndUpdate;	// IMP=0x000000010001aee4
- (void)addressChanged:(_Bool)arg1;	// IMP=0x000000010001abc4
- (void)invalidate;	// IMP=0x000000010001aa68
- (void)activate;	// IMP=0x000000010001a8f0
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000010001a7e8
- (id)description;	// IMP=0x000000010001a7d8
