...
+ (id)alertOptionsWithConnectionAlerts:(_Bool)arg1 disconnectionAlerts:(_Bool)arg2 notificationAlerts:(_Bool)arg3 delay:(long long)arg4 bridgeTransport:(_Bool)arg5;	// IMP=0x0000000100257a44
- (void).cxx_destruct;	// IMP=0x00000001002583b0
...
- (id)description;	// IMP=0x0000000100258140
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010025801c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100257f50
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100257b80
