...
- (void).cxx_destruct;	// IMP=0x000000010001eb60
...
- (void)localDeviceEvent:(int)arg1;	// IMP=0x000000010001e804
- (void)invalidate;	// IMP=0x000000010001e5ec
- (void)activate;	// IMP=0x000000010001e3f8
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000010001e324
- (id)description;	// IMP=0x000000010001e314
- (_Bool)powerOff:(id *)arg1;	// IMP=0x000000010001e278
- (_Bool)powerOn:(id *)arg1;	// IMP=0x000000010001e1dc
...
- (_Bool)modifyDevice:(id)arg1 error:(id *)arg2;	// IMP=0x000000010001d9b4
