...
- (void).cxx_destruct;	// IMP=0x000000010001ca38
...
- (id)_identifier;	// IMP=0x000000010001c940
- (_Bool)_getAppRunningState;	// IMP=0x000000010001c8b8
- (void)_stopObserving;	// IMP=0x000000010001c750
- (void)_startObserving;	// IMP=0x000000010001c4bc
- (void)dealloc;	// IMP=0x000000010001c470
- (id)initWithBundleID:(id)arg1;	// IMP=0x000000010001c3d8
