...
- (void).cxx_destruct;	// IMP=0x000000010001bdf4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010001bc48
- (unsigned long long)hash;	// IMP=0x000000010001bb68
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010001b9d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010001b884
- (void)copyTo:(id)arg1;	// IMP=0x000000010001b788
- (void)writeTo:(id)arg1;	// IMP=0x000000010001b69c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010001b694
- (id)dictionaryRepresentation;	// IMP=0x000000010001b188
- (id)description;	// IMP=0x000000010001b0d4
