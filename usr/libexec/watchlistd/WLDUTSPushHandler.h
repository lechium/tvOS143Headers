...
- (void)_reportMetrics:(id)arg1;	// IMP=0x000000010000cd88
- (void)handleNotification:(id)arg1;	// IMP=0x000000010000c854
- (_Bool)shouldHandleNotification:(id)arg1;	// IMP=0x000000010000c76c
