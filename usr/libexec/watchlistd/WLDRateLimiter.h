...
- (_Bool)_claimToken;	// IMP=0x000000010001c2f0
- (void)_addToken;	// IMP=0x000000010001c27c
@property unsigned long long burst;
@property unsigned long long rate;
- (_Bool)doOperation;	// IMP=0x000000010001c020
- (id)initWithRate:(unsigned long long)arg1 burst:(unsigned long long)arg2;	// IMP=0x000000010001bea8
