...
- (void).cxx_destruct;	// IMP=0x00000001000160ec
...
- (void)statusBarCoordinator:(id)arg1 invalidatedRegistrationWithError:(id)arg2;	// IMP=0x0000000100015f74
- (void)updateStatusStringWithTimer:(id)arg1;	// IMP=0x0000000100015f70
- (void)updateDoubleHeightStatusBarWithDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100015f6c
- (id)rpLocalizedRecordingDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100015e68
- (id)stringWithTimeInterval:(double)arg1;	// IMP=0x0000000100015d7c
- (void)invalidateDoubleHeightStatusBar;	// IMP=0x0000000100015d78
- (void)startRepeatingTimer;	// IMP=0x0000000100015c7c
- (void)showDoubleHeightStatusBarWithPid:(int)arg1;	// IMP=0x0000000100015c78
- (void)acquireAssertionWithPid:(int)arg1;	// IMP=0x0000000100015c1c
- (void)acquireAssertionWithPidWaitForCompletion:(int)arg1;	// IMP=0x0000000100015c18
