...
- (void)notifyRecordingResumed;	// IMP=0x000000010000b548
- (void)notifyRecordingMayBeStopped;	// IMP=0x000000010000b4f0
- (void)saveVideoToCameraRoll:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000b238
- (void)dispatchedAppendAudio2SampleBuffer:(struct opaqueCMSampleBuffer *)arg1;	// IMP=0x000000010000ad18
- (void)dispatchedAppendAudio1SampleBuffer:(struct opaqueCMSampleBuffer *)arg1;	// IMP=0x000000010000a7f8
- (_Bool)appendInitialSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 withTransform:(struct CGAffineTransform)arg2;	// IMP=0x000000010000a294
- (_Bool)dispatchedAppendVideoSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 withWindowTransform:(struct CGAffineTransform)arg2;	// IMP=0x00000001000099f0
- (void)setUpAssetWriterWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100008e84
- (id)averageVideoBitrate;	// IMP=0x0000000100008d94
- (void)updateOutputPath;	// IMP=0x0000000100008b2c
@property(readonly, nonatomic) NSURL *outputURL;
- (void)dealloc;	// IMP=0x00000001000089b4
- (void)trimMovieWithURL:(id)arg1 startClipDuration:(double)arg2 endClipDuration:(double)arg3 outputFileURL:(id)arg4 handler:(CDUnknownBlockType)arg5;	// IMP=0x00000001000082e4
- (void)finishWritingAndSaveToCameraRoll:(CDUnknownBlockType)arg1;	// IMP=0x0000000100007e94
- (void)finishWritingWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010000763c
- (void)appendAudio2SampleBuffer:(struct opaqueCMSampleBuffer *)arg1;	// IMP=0x00000001000075a0
- (void)appendAudio1SampleBuffer:(struct opaqueCMSampleBuffer *)arg1;	// IMP=0x00000001000074fc
- (_Bool)appendVideoSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 withWindowTransform:(struct CGAffineTransform)arg2;	// IMP=0x0000000100007348
- (void)startWritingHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100007064
- (id)initWithWindowSize:(struct CGSize)arg1 outputPath:(id)arg2;	// IMP=0x0000000100006de8
