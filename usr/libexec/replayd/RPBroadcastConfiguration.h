...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010002a4bc
- (void).cxx_destruct;	// IMP=0x000000010002a4e8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010002a3e4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010002a2f0
