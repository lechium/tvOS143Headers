...
+ (void)reportSessionEnded:(unsigned short)arg1 endReason:(id)arg2 withServiceName:(id)arg3 clientBundleId:(id)arg4;	// IMP=0x0000000100019614
...
- (void)reportEventWithType:(unsigned short)arg1 dictionary:(id)arg2 clientBundleId:(id)arg3;	// IMP=0x0000000100019310
- (id)collectSummaryEventMetrics;	// IMP=0x0000000100018ef8
- (id)initWithServiceName:(id)arg1;	// IMP=0x0000000100018dd4
