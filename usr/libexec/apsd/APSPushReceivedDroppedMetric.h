...
- (void).cxx_destruct;	// IMP=0x000000010006a0b8
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 dualChannelState:(unsigned int)arg4 receiveOffset:(id)arg5 payloadSize:(id)arg6 isFromStorage:(id)arg7 topic:(id)arg8;	// IMP=0x00000001000696a8
