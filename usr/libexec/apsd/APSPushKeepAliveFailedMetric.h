...
- (void).cxx_destruct;	// IMP=0x000000010003f71c
...
- (id)initWithGuid:(id)arg1 version:(unsigned int)arg2 connectionType:(unsigned int)arg3 linkQuality:(id)arg4 dualChannelState:(unsigned int)arg5 timeSinceLastSuccessfulKeepAlive:(id)arg6 timeSinceConnected:(id)arg7 lastKeepAliveInterval:(id)arg8 currentGrowthStage:(id)arg9;	// IMP=0x000000010003ebe4
