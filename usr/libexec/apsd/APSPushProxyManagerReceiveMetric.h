...
- (void).cxx_destruct;	// IMP=0x000000010003d4e8
...
- (id)initWithGuid:(id)arg1 messageCommand:(long long)arg2 topic:(id)arg3 isNearby:(_Bool)arg4;	// IMP=0x000000010003cf8c
