...
- (void).cxx_destruct;	// IMP=0x00000001000784c0
...
- (id)initWithSendBlock:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2 timeout:(double)arg3;	// IMP=0x0000000100078384
