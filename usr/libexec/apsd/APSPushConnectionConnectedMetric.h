...
- (void).cxx_destruct;	// IMP=0x000000010007ef60
...
- (id)initWithGuid:(id)arg1 connectDuration:(id)arg2 connectionType:(unsigned int)arg3 linkQuality:(id)arg4 dualChannelState:(unsigned int)arg5 dnsTimeMilliSeconds:(id)arg6 tlsTimeMilliSeconds:(id)arg7;	// IMP=0x000000010007e66c
