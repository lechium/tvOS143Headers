...
+ (id)sharedInstance;	// IMP=0x0000000100082b28
- (void).cxx_destruct;	// IMP=0x0000000100083610
...
- (void)removeListener:(id)arg1;	// IMP=0x0000000100083548
- (void)addListener:(id)arg1;	// IMP=0x00000001000834b8
- (void)_setSystemLockState:(_Bool)arg1;	// IMP=0x0000000100083334
- (void)_setSystemScreenState:(_Bool)arg1;	// IMP=0x00000001000831b0
- (void)_systemWillSleep;	// IMP=0x0000000100082f4c
- (void)_systemDidWake;	// IMP=0x0000000100082f34
- (void)_deliverNotificationSelector:(SEL)arg1;	// IMP=0x0000000100082e74
- (void)dealloc;	// IMP=0x0000000100082c08
- (id)init;	// IMP=0x0000000100082b94
