...
- (void).cxx_destruct;	// IMP=0x00000001000676fc
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000671f8
- (void)_cleanupConnection:(id)arg1;	// IMP=0x0000000100067084
- (void)dealloc;	// IMP=0x0000000100066ff4
- (id)initWithQueue:(id)arg1 apsDaemon:(id)arg2;	// IMP=0x0000000100066e38
