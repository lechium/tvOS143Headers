...
- (void).cxx_destruct;	// IMP=0x0000000100060d6c
...
- (void)updateExpirationTime:(double)arg1;	// IMP=0x0000000100060cfc
- (id)initWithIPAddress:(id)arg1 addressFamily:(unsigned long long)arg2 timeToLive:(double)arg3;	// IMP=0x0000000100060c5c
