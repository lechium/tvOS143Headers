...
- (void).cxx_destruct;	// IMP=0x0000000100004160
...
- (id)initWithDNSTask:(id)arg1 messageId:(unsigned long long)arg2 taskId:(unsigned long long)arg3 taskStatus:(unsigned long long)arg4;	// IMP=0x0000000100004050
- (id)initWithDNSTask:(id)arg1;	// IMP=0x0000000100003fd0
