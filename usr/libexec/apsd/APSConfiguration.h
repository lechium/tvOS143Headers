...
+ (void)invalidateConfigurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100065108
+ (void)loadConfigurationForEnvironment:(id)arg1 interface:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000100064d90
+ (id)configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100064b4c
+ (id)_onQueue_configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100064904
+ (void)initialize;	// IMP=0x00000001000648a8
- (void).cxx_destruct;	// IMP=0x0000000100066c40
...
- (void)setExpiryInterval:(double)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100066a2c
- (_Bool)_isExpired;	// IMP=0x00000001000669c8
- (_Bool)_isLoaded;	// IMP=0x00000001000669c0
...
- (id)bagExpiryInterval;	// IMP=0x0000000100066960
...
- (id)ExpensiveConditionsBackOffInterval;	// IMP=0x0000000100066840
...
- (void)_finishLoadWithResponse:(id)arg1 urlHost:(id)arg2 data:(id)arg3;	// IMP=0x00000001000660b0
- (void)_failWithError:(id)arg1;	// IMP=0x0000000100065fa0
- (void)_callCompletionBlocksWithError:(id)arg1;	// IMP=0x0000000100065d2c
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100065b8c
- (id)pendingCompletionBocks;	// IMP=0x0000000100065b84
- (void)dealloc;	// IMP=0x0000000100065b38
- (id)initWithEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x00000001000653e0
