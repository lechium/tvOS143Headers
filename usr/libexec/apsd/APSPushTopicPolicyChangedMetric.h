...
- (void).cxx_destruct;	// IMP=0x0000000100011a24
...
- (id)initWithGuid:(id)arg1 topic:(id)arg2 changedReason:(long long)arg3 didCauseFilterChange:(_Bool)arg4;	// IMP=0x00000001000114cc
