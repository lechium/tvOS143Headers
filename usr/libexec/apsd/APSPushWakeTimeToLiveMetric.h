...
- (void).cxx_destruct;	// IMP=0x0000000100006600
...
- (id)initWithGuid:(id)arg1 connectedOnWake:(_Bool)arg2 everConnected:(_Bool)arg3 timeToFullyConnect:(id)arg4 timeToLastFromStorage:(id)arg5;	// IMP=0x00000001000062f0
