...
- (void).cxx_destruct;	// IMP=0x000000010005ea88
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010005e960
- (unsigned long long)hash;	// IMP=0x000000010005e8bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005e798
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005e6bc
- (void)copyTo:(id)arg1;	// IMP=0x000000010005e618
- (void)writeTo:(id)arg1;	// IMP=0x000000010005e570
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010005e568
- (id)dictionaryRepresentation;	// IMP=0x000000010005dfd0
- (id)description;	// IMP=0x000000010005df1c
