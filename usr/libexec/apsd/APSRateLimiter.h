...
- (id)description;	// IMP=0x000000010003fe84
- (_Bool)isUnset;	// IMP=0x000000010003fe68
- (void)clear;	// IMP=0x000000010003fe58
- (_Bool)isUnderLimit;	// IMP=0x000000010003fe20
- (void)note;	// IMP=0x000000010003fdc0
- (_Bool)_checkIsExpired;	// IMP=0x000000010003fd54
- (id)initWithLimit:(long long)arg1 timeLimit:(double)arg2;	// IMP=0x000000010003fcfc
