...
- (void).cxx_destruct;	// IMP=0x00000001000191e4
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 reason:(unsigned int)arg4;	// IMP=0x0000000100018c78
