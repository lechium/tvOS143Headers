...
- (void).cxx_destruct;	// IMP=0x0000000100087954
...
- (id)initWithGuid:(id)arg1 messageCommand:(long long)arg2 topic:(id)arg3 isNearby:(_Bool)arg4;	// IMP=0x00000001000873f8
