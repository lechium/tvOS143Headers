...
+ (void)_saveCachedProperties;	// IMP=0x000000010006427c
+ (void)_loadCachedProperties;	// IMP=0x0000000100063e2c
+ (id)environmentForName:(id)arg1;	// IMP=0x0000000100063e18
+ (void)initialize;	// IMP=0x00000001000637f4
- (void).cxx_destruct;	// IMP=0x00000001000646c0
...
- (id)description;	// IMP=0x00000001000645bc
@property(readonly, nonatomic) unsigned long long priority;
- (unsigned long long)hash;	// IMP=0x0000000100064554
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100064550
