...
- (void).cxx_destruct;	// IMP=0x000000010003eb04
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 dualChannelState:(unsigned int)arg4 flushes:(id)arg5 sendDuration:(id)arg6 payloadSize:(id)arg7 error:(unsigned int)arg8 topic:(id)arg9;	// IMP=0x000000010003e03c
