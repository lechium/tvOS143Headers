...
- (void).cxx_destruct;	// IMP=0x000000010000b48c
...
- (void)load;	// IMP=0x000000010000b470
- (id)initWithCommand:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010000b2bc
