...
+ (id)sharedDaemon;	// IMP=0x000000010002be78
...
- (void)_xpcPublisherStateChangedForToken:(unsigned long long)arg1 state:(_Bool)arg2;	// IMP=0x000000010002ec60
- (void)_xpcPublisherTriggeredReply:(id)arg1 token:(unsigned long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002e904
- (void)_xpcPublisherTriggeredToken:(unsigned long long)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002e624
- (void)_xpcPublisherRemoveToken:(unsigned long long)arg1;	// IMP=0x000000010002e4a4
- (void)_xpcPublisherAddToken:(unsigned long long)arg1 event:(id)arg2;	// IMP=0x000000010002e000
- (void)_xpcPublisherAction:(unsigned int)arg1 token:(unsigned long long)arg2 event:(id)arg3;	// IMP=0x000000010002df18
- (void)_updateErrorFlags;	// IMP=0x000000010002ddb8
- (void)_prefsChanged;	// IMP=0x000000010002dc9c
- (void)postDaemonInfoChanges:(unsigned long long)arg1;	// IMP=0x000000010002dac0
- (id)keychainStateString;	// IMP=0x000000010002d86c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010002d5f8
- (_Bool)diagnosticCommand:(id)arg1 params:(id)arg2;	// IMP=0x000000010002d4c0
- (void)invalidate;	// IMP=0x000000010002d168
- (void)activate;	// IMP=0x000000010002c73c
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000010002c0ac
- (id)init;	// IMP=0x000000010002bee4
