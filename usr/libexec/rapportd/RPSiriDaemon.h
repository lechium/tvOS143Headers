...
- (void).cxx_destruct;	// IMP=0x000000010004f95c
@property(retain, nonatomic) id <RPMessageable> messenger; // @synthesize messenger=_messenger;
- (void)_handleSiriStop:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010004f6ec
- (void)_handleSiriStart:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010004f108
- (void)_handleSiriAudio:(id)arg1;	// IMP=0x000000010004f070
- (void)invalidate;	// IMP=0x000000010004ef80
- (_Bool)activateAndReturnError:(id *)arg1;	// IMP=0x000000010004ebdc
- (id)init;	// IMP=0x000000010004eb74
