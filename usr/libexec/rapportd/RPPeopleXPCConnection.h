...
- (void).cxx_destruct;	// IMP=0x000000010004c724
...
- (void)xpcPeopleDiscoveryUpdate:(id)arg1;	// IMP=0x000000010004c4e0
- (void)xpcPeopleDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004c17c
- (void)xpcPeopleRemoveAppleID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004bd5c
- (void)xpcPeopleAddAppleID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004bc7c
- (void)clientPeopleStatusChanged:(unsigned int)arg1;	// IMP=0x000000010004bc30
- (void)clientDeviceChanged:(id)arg1 changes:(unsigned int)arg2;	// IMP=0x000000010004b94c
- (void)clientDeviceLost:(id)arg1;	// IMP=0x000000010004b584
- (void)clientDeviceFound:(id)arg1 report:(_Bool)arg2;	// IMP=0x000000010004b170
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x000000010004b030
- (void)connectionInvalidated;	// IMP=0x000000010004af4c
- (id)initWithDaemon:(id)arg1 xpcCnx:(id)arg2;	// IMP=0x000000010004ae98
