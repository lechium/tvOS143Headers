...
- (void).cxx_destruct;	// IMP=0x0000000100091aa8
...
- (void)runOperations;	// IMP=0x000000010009027c
- (void)sendProgressBatch:(id)arg1 updatedCursor:(id)arg2;	// IMP=0x00000001000901f8
- (void)runWithinSyncSession:(id)arg1;	// IMP=0x0000000100090168
- (id)initWithController:(id)arg1 cursor:(id)arg2 class:(Class)arg3 cloudKitScope:(id)arg4 scope:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x000000010008fe30
