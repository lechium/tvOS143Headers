...
- (void).cxx_destruct;	// IMP=0x00000001000d60d4
...
- (void)runOperations;	// IMP=0x00000001000d5574
- (void)_checkRecordsExistenceWithOperationType:(long long)arg1 recordIDsToCPLRecord:(id)arg2 recordsToCheckOnly:(id)arg3 recordsToFetch:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000001000d4344
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 additionalTransportScopes:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000001000d41f8
