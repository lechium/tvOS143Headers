...
- (void).cxx_destruct;	// IMP=0x0000000100048834
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x0000000100048690
- (id)initWithResource:(id)arg1;	// IMP=0x000000010004842c
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100048280
