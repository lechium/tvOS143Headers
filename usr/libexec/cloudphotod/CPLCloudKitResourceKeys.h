...
+ (unsigned long long)resourceTypeForFieldName:(id)arg1;	// IMP=0x00000001000c1928
+ (id)resourceKeysForResourceType:(unsigned long long)arg1;	// IMP=0x00000001000c18c0
- (void).cxx_destruct;	// IMP=0x00000001000c1c74
...
- (id)initWithPrefix:(id)arg1 resourceType:(unsigned long long)arg2;	// IMP=0x00000001000c19d4
