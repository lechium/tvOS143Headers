...
- (void).cxx_destruct;	// IMP=0x0000000100044e1c
...
- (id)bindValuesToKeepAlive;	// IMP=0x0000000100044dfc
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0000000100044bb0
- (id)initWithVariables:(id)arg1 object:(id)arg2 sql:(id)arg3;	// IMP=0x0000000100044ae0
