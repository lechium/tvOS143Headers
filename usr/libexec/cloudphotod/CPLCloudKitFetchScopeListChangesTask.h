...
+ (id)descriptionForScopeListSyncAnchor:(id)arg1;	// IMP=0x00000001000e40d0
- (void).cxx_destruct;	// IMP=0x00000001000e4b94
- (void)_launchOperationForSharedDatabase:(_Bool)arg1;	// IMP=0x00000001000e4278
- (void)runOperations;	// IMP=0x00000001000e4268
- (id)initWithController:(id)arg1 scopeListSyncAnchor:(id)arg2 progressHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000e412c
