...
+ (id)platformImplementationProtocol;	// IMP=0x0000000100058e94
- (void).cxx_destruct;	// IMP=0x0000000100058fac
@property(readonly, nonatomic) __weak CPLPrequeliteStore *store; // @synthesize store=_store;
@property(readonly, nonatomic) CPLPlatformObject *platformObject; // @synthesize platformObject=_platformObject;
- (id)redactedDescription;	// IMP=0x0000000100058f80
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) CPLEngineStore *engineStore;
- (id)initWithStore:(id)arg1;	// IMP=0x0000000100058d20
