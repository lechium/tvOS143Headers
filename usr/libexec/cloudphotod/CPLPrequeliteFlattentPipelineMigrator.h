...
- (void).cxx_destruct;	// IMP=0x00000001000560ec
@property(readonly, nonatomic) CPLPrequeliteStore *store; // @synthesize store=_store;
- (_Bool)migrate;	// IMP=0x0000000100055e6c
- (_Bool)_migratePushQueue:(id)arg1;	// IMP=0x00000001000557c4
- (_Bool)_discardResourceForUpload:(id)arg1;	// IMP=0x0000000100055654
- (_Bool)_enqueueResourcesForChange:(id)arg1 inOutgoingResourcesWithUploadIdentifier:(id)arg2;	// IMP=0x00000001000551d0
- (unsigned long long)_availabilityOfResource:(id)arg1;	// IMP=0x0000000100054fa4
@property(readonly, nonatomic) NSError *lastError; // @synthesize lastError=_lastError;
- (void)_setLastError:(id)arg1;	// IMP=0x0000000100054eec
- (id)initWithStore:(id)arg1;	// IMP=0x0000000100054d3c
