...
+ (void)initialize;	// IMP=0x00000001000c6c30
- (void).cxx_destruct;	// IMP=0x00000001000c9f80
...
- (void)runOperations;	// IMP=0x00000001000c72c8
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 additionalTransportScopes:(id)arg4 progressHandler:(CDUnknownBlockType)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000001000c6c88
