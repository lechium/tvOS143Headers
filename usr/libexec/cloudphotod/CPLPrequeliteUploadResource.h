...
- (void).cxx_destruct;	// IMP=0x0000000100051850
...
- (id)resource;	// IMP=0x0000000100051690
- (id)initWithResource:(id)arg1;	// IMP=0x00000001000514a0
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000512fc
