...
- (void).cxx_destruct;	// IMP=0x000000010009a460
- (void)_fetchMetadataForShareURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000995a8
- (void)_acceptShareWithURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100098ec0
- (void)_udpateScopeAndFlagsWithCKRecord:(id)arg1;	// IMP=0x0000000100098d28
- (void)runOperations;	// IMP=0x0000000100098798
- (id)initWithController:(id)arg1 scope:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001000986b0
