...
- (void).cxx_destruct;	// IMP=0x000000010008bb38
...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x000000010008b784
- (id)operationDescription;	// IMP=0x000000010008b77c
- (id)extendedStatusDescriptionStrings;	// IMP=0x000000010008b774
