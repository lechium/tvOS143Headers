...
- (void).cxx_destruct;	// IMP=0x000000010008fc98
...
- (void)runOperations;	// IMP=0x000000010008fb38
- (void)fetchUserRecord;	// IMP=0x000000010008f578
- (void)fetchDerivativesFilter;	// IMP=0x000000010008f2d4
- (void)fetchDisabledFeatures;	// IMP=0x000000010008ee48
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010008ed8c
