...
- (void).cxx_destruct;	// IMP=0x00000001000d3df0
...
- (void)runOperations;	// IMP=0x00000001000d32b0
- (id)_streamOperationForKey:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000d2c94
- (id)initWithController:(id)arg1 resource:(id)arg2 hints:(id)arg3 transportScope:(id)arg4 cache:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000001000d2ae0
