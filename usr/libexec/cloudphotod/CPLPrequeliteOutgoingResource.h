...
- (void).cxx_destruct;	// IMP=0x00000001000398d4
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x000000010003974c
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x0000000100039634
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x000000010003934c
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000391d8
