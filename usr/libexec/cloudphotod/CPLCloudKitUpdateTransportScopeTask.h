...
- (void).cxx_destruct;	// IMP=0x00000001000aefdc
...
- (void)runOperations;	// IMP=0x00000001000aebb4
- (id)_errorForUpdateError:(id)arg1;	// IMP=0x00000001000aea54
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 scopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000001000ae904
