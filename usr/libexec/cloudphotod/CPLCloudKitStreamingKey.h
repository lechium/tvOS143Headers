...
- (void).cxx_destruct;	// IMP=0x00000001000d4134
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000d3fec
- (unsigned long long)hash;	// IMP=0x00000001000d3fdc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000d3fd8
- (id)initWithRecordID:(id)arg1 resourceKey:(id)arg2 fingerPrint:(id)arg3 filename:(id)arg4 groupName:(id)arg5;	// IMP=0x00000001000d3e6c
