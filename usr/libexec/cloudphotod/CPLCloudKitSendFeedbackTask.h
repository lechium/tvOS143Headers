...
- (void)runOperations;	// IMP=0x000000010008a790
- (id)initWithController:(id)arg1 messages:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010008a688
