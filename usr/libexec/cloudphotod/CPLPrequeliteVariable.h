...
+ (id)variableWithName:(id)arg1 forTable:(id)arg2 type:(id)arg3;	// IMP=0x0000000100043a04
+ (id)variableWithName:(id)arg1 type:(id)arg2;	// IMP=0x000000010004399c
+ (id)indexVariableForVariableWithName:(id)arg1 forTable:(id)arg2;	// IMP=0x00000001000433dc
+ (id)variableWithName:(id)arg1 defaultValue:(id)arg2 forTable:(id)arg3 type:(id)arg4;	// IMP=0x0000000100043328
+ (id)variableWithName:(id)arg1 defaultValue:(id)arg2 type:(id)arg3;	// IMP=0x0000000100043294
- (void).cxx_destruct;	// IMP=0x0000000100043d80
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100043c88
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100043c74
- (id)columnDefinitionWithDefaultValue:(id)arg1;	// IMP=0x0000000100043a98
@property(readonly, nonatomic) id <PQLInjecting> columnDefinition;
- (id)valueFromSet:(id)arg1 atIndex:(int)arg2;	// IMP=0x00000001000438fc
- (id)bindableValueForValue:(id)arg1;	// IMP=0x0000000100043864
- (void)discardCachedValue;	// IMP=0x0000000100043834
- (void)setCachedValue:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x00000001000437bc
- (id)cachedValueForIdentifier:(id)arg1;	// IMP=0x0000000100043750
- (_Bool)hasCachedValueForIdentifier:(id)arg1;	// IMP=0x00000001000436f0
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0000000100043674
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1 defaultValue:(id)arg2 table:(id)arg3 type:(id)arg4;	// IMP=0x00000001000434b8
