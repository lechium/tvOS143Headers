...
+ (id)selfCrashResetReason;	// IMP=0x00000001000845e8
- (void).cxx_destruct;	// IMP=0x00000001000846d4
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100083964
- (void)acknowledgeChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100082868
- (void)getChangeBatchWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100081af4
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001000812b4
- (id)clientWorkDescription;	// IMP=0x00000001000812a8
