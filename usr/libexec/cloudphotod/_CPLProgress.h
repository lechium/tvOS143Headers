...
- (void).cxx_destruct;	// IMP=0x000000010002d7ec
...
- (void)unpublish;	// IMP=0x000000010002d774
- (void)publish;	// IMP=0x000000010002d73c
- (void)_publishRealProgressIfNecessary;	// IMP=0x000000010002d540
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x000000010002d4a8
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x000000010002d2e4
