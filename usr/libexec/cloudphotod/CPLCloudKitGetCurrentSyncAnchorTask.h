...
- (void).cxx_destruct;	// IMP=0x00000001000e400c
...
- (void)runOperations;	// IMP=0x00000001000e3990
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1;	// IMP=0x00000001000e3724
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000e3608
