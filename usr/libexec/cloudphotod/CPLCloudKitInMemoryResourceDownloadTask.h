...
- (void).cxx_destruct;	// IMP=0x00000001000d9c70
@property(readonly, copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(readonly, nonatomic) CPLResource *resource; // @synthesize resource=_resource;
- (void)runOperations;	// IMP=0x00000001000d9384
- (id)_inMemoryDownloadOperationForRecordID:(id)arg1 resource:(id)arg2 keys:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000001000d8aec
- (id)initWithController:(id)arg1 resource:(id)arg2 transportScope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000d898c
