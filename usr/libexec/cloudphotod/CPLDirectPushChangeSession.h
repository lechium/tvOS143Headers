...
+ (id)selfCrashResetReason;	// IMP=0x0000000100087e8c
- (void).cxx_destruct;	// IMP=0x0000000100087f78
- (void)commitChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000869b4
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010008612c
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001000859d8
- (id)clientWorkDescription;	// IMP=0x00000001000859cc
