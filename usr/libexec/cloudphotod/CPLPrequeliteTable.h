...
+ (id)tableWithName:(id)arg1;	// IMP=0x0000000100043064
- (void).cxx_destruct;	// IMP=0x0000000100043258
@property(readonly, nonatomic) NSString *tableName; // @synthesize tableName=_tableName;
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0000000100043200
@property(readonly, nonatomic) NSString *injectedTableName;
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1;	// IMP=0x00000001000430b4
