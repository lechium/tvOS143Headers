...
- (void).cxx_destruct;	// IMP=0x000000010009c460
...
- (void)runOperations;	// IMP=0x000000010009aa3c
- (void)sendProgressBatch:(id)arg1 updatedScopeChange:(id)arg2 updatedFlags:(id)arg3 updatedSyncAnchor:(id)arg4;	// IMP=0x000000010009a928
- (void)runWithinSyncSession:(id)arg1;	// IMP=0x000000010009a898
- (id)initWithController:(id)arg1 syncAnchor:(id)arg2 cloudKitScope:(id)arg3 scope:(id)arg4 currentScopeChange:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x000000010009a560
