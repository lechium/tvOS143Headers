...
- (void).cxx_destruct;	// IMP=0x0000000100095754
...
- (void)runOperations;	// IMP=0x0000000100094c9c
- (id)_errorForDeleteError:(id)arg1;	// IMP=0x0000000100094b3c
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100094a20
