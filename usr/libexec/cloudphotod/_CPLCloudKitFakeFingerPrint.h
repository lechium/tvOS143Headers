...
- (void).cxx_destruct;	// IMP=0x0000000100093f84
...
- (id)initWithRealResourceType:(unsigned long long)arg1 realFingerPrint:(id)arg2 outputType:(id)arg3 dimensions:(struct CGSize)arg4;	// IMP=0x0000000100093c70
- (id)initWithFakeFingerPrint:(id)arg1;	// IMP=0x0000000100093920
- (id)initWithFakeIdentity:(id)arg1;	// IMP=0x00000001000938c4
