...
- (void)_determineScopeTypeAndFetchLibraryInfo;	// IMP=0x00000001000e2fcc
- (void)runOperations;	// IMP=0x00000001000e26e8
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000e25b8
