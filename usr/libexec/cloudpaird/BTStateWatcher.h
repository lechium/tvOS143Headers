...
+ (id)monitorFirstUnlockWithAction:(CDUnknownBlockType)arg1;	// IMP=0x0000000100022fd8
+ (id)monitorBuddyStateWithAction:(CDUnknownBlockType)arg1;	// IMP=0x0000000100022e0c
+ (id)monitorURL:(id)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x0000000100022cf4
...
- (void)cancel;	// IMP=0x00000001000235f8
- (void)fileDiscovered;	// IMP=0x00000001000234f8
- (void)directoryChanged;	// IMP=0x0000000100023190
- (_Bool)start;	// IMP=0x0000000100022638
- (void)dealloc;	// IMP=0x00000001000225ec
- (id)initWithURL:(id)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x0000000100022438
