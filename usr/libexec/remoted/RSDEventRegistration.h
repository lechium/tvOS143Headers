...
- (void).cxx_destruct;	// IMP=0x0000000100017900
...
- (void)dealloc;	// IMP=0x0000000100017874
- (void)fire:(id)arg1;	// IMP=0x00000001000176ec
- (void)cancelBrowsing;	// IMP=0x00000001000175c4
- (void)startBrowsing:(id)arg1;	// IMP=0x00000001000173bc
- (id)initWithToken:(unsigned long long)arg1 name:(char *)arg2;	// IMP=0x000000010001733c
