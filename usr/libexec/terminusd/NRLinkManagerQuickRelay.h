...
- (void).cxx_destruct;	// IMP=0x0000000100091d44
...
- (void)connection:(id)arg1 didChangeConnectedStatus:(_Bool)arg2;	// IMP=0x0000000100091b48
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x0000000100091a9c
- (void)checkEnabledDevices;	// IMP=0x0000000100091888
- (void)linkDidReceiveData:(id)arg1 data:(id)arg2;	// IMP=0x0000000100091720
- (void)linkIsUnavailable:(id)arg1;	// IMP=0x00000001000915d0
- (void)linkIsReady:(id)arg1;	// IMP=0x00000001000914c8
- (void)linkIsSuspended:(id)arg1;	// IMP=0x00000001000913c0
- (void)linkIsAvailable:(id)arg1;	// IMP=0x0000000100091284
- (void)createLinkForNRUUID:(id)arg1;	// IMP=0x00000001000911b4
- (void)createLinkIfApplicable;	// IMP=0x0000000100090d7c
- (void)setup;	// IMP=0x0000000100090914
- (id)copyStatusString;	// IMP=0x0000000100090804
- (id)copyName;	// IMP=0x00000001000907f8
- (void)dealloc;	// IMP=0x0000000100090778
- (void)invalidateManager;	// IMP=0x0000000100090664
- (void)cancel;	// IMP=0x000000010009062c
- (id)initManagerWithQueue:(id)arg1 managerDelegate:(id)arg2 quickRelayManagerDelegate:(id)arg3;	// IMP=0x0000000100090428
