...
- (void).cxx_destruct;	// IMP=0x0000000100004fc0
...
- (void)dealloc;	// IMP=0x0000000100004e98
- (void)stop;	// IMP=0x0000000100004e14
- (_Bool)start;	// IMP=0x0000000100004bc0
- (id)initWithSrcIfIndex:(unsigned int)arg1 dstIfIndex:(unsigned int)arg2 name:(id)arg3 type:(id)arg4 domain:(id)arg5 hostTarget:(id)arg6 port:(unsigned short)arg7 txtRecord:(id)arg8;	// IMP=0x0000000100004a18
