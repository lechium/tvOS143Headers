...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100035734
+ (id)agentDomain;	// IMP=0x0000000100035704
+ (id)agentType;	// IMP=0x00000001000356c0
- (void).cxx_destruct;	// IMP=0x000000010003545c
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x00000001000352c4
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100035244
- (_Bool)registerAgent;	// IMP=0x0000000100034e24
- (_Bool)unregisterAgent;	// IMP=0x0000000100034c8c
@property(nonatomic) _Bool requiresAssert;
- (id)copyAgentData;	// IMP=0x0000000100034c7c
- (void)dealloc;	// IMP=0x0000000100034c30
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000100034940
