...
- (void).cxx_destruct;	// IMP=0x0000000100095e9c
...
- (void)removePolicies;	// IMP=0x0000000100095a3c
- (void)refreshCompanionProxyAgent;	// IMP=0x0000000100095a38
- (void)checkPeerAvailabilityWithForceAggressive:(_Bool)arg1;	// IMP=0x00000001000959bc
- (_Bool)setNoACKPrioritization;	// IMP=0x0000000100095918
- (_Bool)setInterfaceSubfamily;	// IMP=0x0000000100095840
- (void)setInterfaceAvailabilityForcedWithInterfaceName:(id)arg1;	// IMP=0x0000000100095664
- (void)setInterfaceAvailabilityIfApplicable;	// IMP=0x0000000100095554
- (void)dealloc;	// IMP=0x0000000100095500
- (_Bool)changeStateTo:(unsigned char)arg1;	// IMP=0x00000001000953c8
- (_Bool)changeStateTo:(unsigned char)arg1 detailsFormat:(id)arg2;	// IMP=0x000000010009532c
- (_Bool)changeStateTo:(unsigned char)arg1 details:(id)arg2;	// IMP=0x0000000100095114
- (void)reportEvent:(int)arg1;	// IMP=0x0000000100095104
- (void)reportEvent:(int)arg1 detailsFormat:(id)arg2;	// IMP=0x0000000100095070
- (void)reportEvent:(int)arg1 details:(id)arg2;	// IMP=0x0000000100095008
- (_Bool)sendControlData:(id)arg1;	// IMP=0x0000000100095000
- (_Bool)cancelWithReason:(id)arg1;	// IMP=0x0000000100094ff8
- (id)copyStatusString;	// IMP=0x0000000100094fd8
- (_Bool)resume;	// IMP=0x0000000100094fc0
- (_Bool)suspend;	// IMP=0x0000000100094fb8
- (_Bool)start;	// IMP=0x0000000100094fb0
- (id)copyShortDescription;	// IMP=0x0000000100094f3c
- (id)copyShortDescriptionInner;	// IMP=0x0000000100094e68
- (id)description;	// IMP=0x0000000100094e4c
- (id)copyDescription;	// IMP=0x0000000100094dd8
- (id)copyDescriptionInner;	// IMP=0x0000000100094c78
- (id)initLinkWithQueue:(id)arg1 linkDelegate:(id)arg2 nrUUID:(id)arg3;	// IMP=0x00000001000949c8
- (void)checkProxyAgentWithForceUpdate:(_Bool)arg1;	// IMP=0x0000000100096370
- (void)unregisterProxyAgent;	// IMP=0x00000001000962dc
- (void)invalidateIKESessionForClass:(unsigned char)arg1;	// IMP=0x00000001000962b8
- (void)invalidateIKESession:(id *)arg1;	// IMP=0x0000000100096160
- (void)invalidateLink;	// IMP=0x0000000100096128
- (void)setState:(unsigned char)arg1;	// IMP=0x00000001000960e8
