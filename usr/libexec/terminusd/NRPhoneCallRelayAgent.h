...
+ (id)agentFromData:(id)arg1;	// IMP=0x00000001000be778
+ (id)agentDomain;	// IMP=0x00000001000be734
+ (id)agentType;	// IMP=0x00000001000be6f0
- (void).cxx_destruct;	// IMP=0x00000001000be3e0
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x00000001000be25c
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x00000001000be1dc
- (_Bool)registerAgent;	// IMP=0x00000001000bde00
- (_Bool)unregisterAgent;	// IMP=0x00000001000bdc68
@property(nonatomic) _Bool requiresAssert;
- (id)copyAgentData;	// IMP=0x00000001000bdc58
- (void)dealloc;	// IMP=0x00000001000bdc0c
- (id)initWithQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001000bd93c
