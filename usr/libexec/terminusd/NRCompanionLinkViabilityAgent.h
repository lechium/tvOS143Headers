...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100036d68
+ (id)agentDomain;	// IMP=0x0000000100036d24
+ (id)agentType;	// IMP=0x0000000100036ce0
- (void).cxx_destruct;	// IMP=0x0000000100036c14
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x0000000100036ad8
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100036a90
- (_Bool)registerAgentWithActivate:(_Bool)arg1;	// IMP=0x00000001000364ec
- (void)activateAgent;	// IMP=0x00000001000363c4
- (void)suspendAgent;	// IMP=0x000000010003629c
- (_Bool)unregisterAgent;	// IMP=0x00000001000360a8
- (id)copyAgentData;	// IMP=0x00000001000360a0
- (id)description;	// IMP=0x0000000100035f28
- (void)dealloc;	// IMP=0x0000000100035e84
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2;	// IMP=0x00000001000359a8
