...
+ (id)copySharedServer;	// IMP=0x000000010002dc38
- (void).cxx_destruct;	// IMP=0x0000000100027be4
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x000000010002787c
- (void)startXPCListener;	// IMP=0x0000000100027544
- (void)registerHandlerFunctions;	// IMP=0x0000000100026068
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(unsigned long long)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000100025c30
- (id)initInternal;	// IMP=0x0000000100025868
