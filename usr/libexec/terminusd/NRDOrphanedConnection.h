...
- (void).cxx_destruct;	// IMP=0x0000000100066ba8
@property(retain, nonatomic) NSObject<OS_xpc_object> *connection; // @synthesize connection=_connection;
@property(retain, nonatomic) NSUUID *nrUUID; // @synthesize nrUUID=_nrUUID;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100066a50
- (unsigned long long)hash;	// IMP=0x00000001000669d8
- (id)description;	// IMP=0x0000000100066930
