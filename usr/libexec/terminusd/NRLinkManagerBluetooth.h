...
- (void)checkEnabledDevices;	// IMP=0x000000010000e82c
- (void)scalablePipeManager:(id)arg1 pipeDidDisconnect:(id)arg2 error:(id)arg3;	// IMP=0x000000010000e130
- (void)scalablePipeManager:(id)arg1 pipeDidConnect:(id)arg2;	// IMP=0x000000010000dee8
- (void)scalablePipeManager:(id)arg1 didUnregisterEndpoint:(id)arg2;	// IMP=0x000000010000dcc4
- (void)scalablePipeManager:(id)arg1 didRegisterEndpoint:(id)arg2 error:(id)arg3;	// IMP=0x000000010000d97c
- (void)scalablePipeManagerDidUpdateState:(id)arg1;	// IMP=0x000000010000d880
- (void)cyclePipeRegistration;	// IMP=0x000000010000d814
- (void)handleSPMStateChange:(long long)arg1;	// IMP=0x000000010000d440
- (void)unregisterUrgentPipe;	// IMP=0x000000010000d2e8
- (void)registerUrgentPipeIfNeeded;	// IMP=0x000000010000d090
- (void)unregisterPipe;	// IMP=0x000000010000cf28
- (void)registerPipe;	// IMP=0x000000010000ccd0
- (void)linkPeerIsAsleep:(id)arg1 isAsleep:(_Bool)arg2;	// IMP=0x000000010000cc14
- (void)linkDidReceiveData:(id)arg1 data:(id)arg2;	// IMP=0x000000010000c9d8
- (void)linkIsUnavailable:(id)arg1;	// IMP=0x000000010000c730
- (void)linkIsSuspended:(id)arg1;	// IMP=0x000000010000c554
- (void)linkIsReady:(id)arg1;	// IMP=0x000000010000c100
- (void)linkIsAvailable:(id)arg1;	// IMP=0x000000010000bcc0
- (_Bool)setMPKLLoggingWithEnabled:(_Bool)arg1;	// IMP=0x000000010000bb5c
- (void)pipeisAvailable:(id)arg1;	// IMP=0x000000010000b48c
- (void)setLinkRequirementsForNRUUID:(id)arg1 inputBPS:(unsigned int)arg2 outputBPS:(unsigned int)arg3 packetsPS:(unsigned int)arg4;	// IMP=0x000000010000b2c0
- (void)disconnectFromPeripherals;	// IMP=0x000000010000b288
- (void)registerDatagramPipeIfApplicable;	// IMP=0x000000010000b244
- (void)unregisterDatagramPipe;	// IMP=0x000000010000b0e8
- (void)registerDatagramPipe;	// IMP=0x000000010000ae08
- (long long)getCBScalablePipeEndpointType;	// IMP=0x000000010000adb4
- (void)connectToPeripherals;	// IMP=0x000000010000ad7c
- (void)setup;	// IMP=0x000000010000acf0
- (void)resetConnectedPipes;	// IMP=0x000000010000acb0
- (id)copyStatusString;	// IMP=0x000000010000aad0
- (id)copyName;	// IMP=0x000000010000aac4
- (void)dealloc;	// IMP=0x000000010000aa28
- (void)invalidateManager;	// IMP=0x000000010000a978
- (void)cancel;	// IMP=0x000000010000a7a4
- (id)initManagerWithQueue:(id)arg1 managerDelegate:(id)arg2 bluetoothManagerDelegate:(id)arg3;	// IMP=0x000000010000a55c
