...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100030fd8
+ (id)agentType;	// IMP=0x0000000100030f94
+ (id)agentDomain;	// IMP=0x0000000100030f50
- (void).cxx_destruct;	// IMP=0x0000000100030888
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x00000001000306f8
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100030654
- (_Bool)startAgentWithOptions:(id)arg1;	// IMP=0x00000001000305b4
- (_Bool)unregisterAgent;	// IMP=0x00000001000303f8
- (void)activateAgent;	// IMP=0x0000000100030328
- (_Bool)registerAgentOnQueue:(id)arg1;	// IMP=0x0000000100030204
- (id)copyAgentData;	// IMP=0x00000001000301fc
- (id)description;	// IMP=0x0000000100030114
- (void)dealloc;	// IMP=0x0000000100030060
- (id)init;	// IMP=0x000000010002fdb8
