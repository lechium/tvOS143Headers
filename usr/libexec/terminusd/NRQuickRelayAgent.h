...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100010a18
+ (id)agentDomain;	// IMP=0x00000001000109d4
+ (id)agentType;	// IMP=0x0000000100010990
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x0000000100010464
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x00000001000103e4
- (_Bool)registerAgent;	// IMP=0x000000010000ff6c
- (void)activateAgent;	// IMP=0x000000010000fdd0
- (void)suspendAgent;	// IMP=0x000000010000fc48
- (_Bool)unregisterAgent;	// IMP=0x000000010000fa54
- (void)updateQRConnectedState:(_Bool)arg1;	// IMP=0x000000010000f9e4
- (id)copyAgentData;	// IMP=0x000000010000f970
- (id)description;	// IMP=0x000000010000f7d0
- (void)dealloc;	// IMP=0x000000010000f72c
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000010000f1f8
