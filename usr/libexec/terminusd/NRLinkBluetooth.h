...
- (void).cxx_destruct;	// IMP=0x000000010004cd58
...
- (void)attemptPairingUsingOutOfBandKey:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010004b060
- (void)setPacketReceiver:(id)arg1;	// IMP=0x000000010004adf8
- (_Bool)sendPacketData:(id)arg1;	// IMP=0x000000010004acb0
- (void)requestConfigurationForListener:(id)arg1 session:(id)arg2 sessionConfig:(id)arg3 childConfig:(id)arg4 validateAuthBlock:(CDUnknownBlockType)arg5 responseBlock:(CDUnknownBlockType)arg6;	// IMP=0x0000000100049db4
- (id)respondToIKESession:(id)arg1 dataProtectionClass:(unsigned char)arg2 validateAuthBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010004998c
- (void)listener:(id)arg1 receivedNewSession:(id)arg2;	// IMP=0x0000000100049890
- (_Bool)setupIPsec;	// IMP=0x0000000100049664
- (void)restartIKESessionForDataProtectionClass:(unsigned char)arg1;	// IMP=0x000000010004949c
- (void)scheduleIKESessionClassADueToConnectFailure;	// IMP=0x0000000100049278
- (void)restartIKESessionClassA;	// IMP=0x0000000100049268
- (void)restartIKESessionClassC;	// IMP=0x0000000100049258
- (void)restartIKESessionClassD;	// IMP=0x0000000100049248
- (void)setupIPsecInitiatorIfNecessary:(unsigned char)arg1;	// IMP=0x0000000100048b9c
- (void)setupIPsecForPairingInitiatorIfNecessary;	// IMP=0x00000001000488d4
- (void)setupIKECallbacksPairing;	// IMP=0x0000000100048470
- (void)sendlocalPublicClassAKeysEncryptedWithIDS;	// IMP=0x0000000100048224
- (void)sendlocalPublicClassCKeysEncryptedWithIDS;	// IMP=0x0000000100047fd8
- (void)setupIKECallbacksClassA;	// IMP=0x0000000100047fc8
- (void)setupIKECallbacksClassC;	// IMP=0x0000000100047fb8
- (void)setupIKECallbacksClassD;	// IMP=0x0000000100047fa8
- (void)setupIKECallbacks:(unsigned char)arg1;	// IMP=0x00000001000479f4
- (void)reportRegistrationFailureIfNeededWithFailureCode:(long long)arg1 errorDescription:(id)arg2;	// IMP=0x00000001000479d8
- (void)handleNotifyCode:(unsigned short)arg1 payload:(id)arg2;	// IMP=0x0000000100045ff0
- (void)sendNotifyPayload;	// IMP=0x0000000100045fec
- (_Bool)sendAlwaysOnWiFiUpdate;	// IMP=0x0000000100045ddc
- (id)copyNotifyPayloadsToSendWithProxy:(_Bool)arg1;	// IMP=0x000000010004564c
- (_Bool)sendControlData:(id)arg1;	// IMP=0x00000001000453fc
- (_Bool)handleIncomingIKEData:(id)arg1;	// IMP=0x00000001000451ac
- (_Bool)sendIKEData:(id)arg1;	// IMP=0x0000000100044ea0
- (void)handleRequestToActivateNexus:(id)arg1 fromFlow:(id)arg2;	// IMP=0x0000000100044e9c
- (void)acceptNewFlow:(id)arg1 fromNexus:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100044e0c
- (_Bool)appendEncapsulatedData:(id)arg1 type:(unsigned char)arg2;	// IMP=0x0000000100044a98
- (void)appendlinkOutgoingData:(id)arg1;	// IMP=0x0000000100044a28
- (_Bool)sendData;	// IMP=0x0000000100044a18
- (_Bool)sendDataWithCount:(unsigned int)arg1;	// IMP=0x00000001000447d0
- (void)stopReadingPackets;	// IMP=0x00000001000447c0
- (void)stopReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x0000000100044634
- (void)resumeReadingPackets;	// IMP=0x0000000100044624
- (void)resumeReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x000000010004448c
- (unsigned long long)writeBytesToChannel:(const char *)arg1 length:(unsigned long long)arg2;	// IMP=0x0000000100044244
- (void)readDataFromChannelWithIsUrgent:(_Bool)arg1;	// IMP=0x0000000100043fd8
- (void)readIncomingData:(char *)arg1 length:(unsigned long long)arg2 isUrgentLink:(_Bool)arg3;	// IMP=0x0000000100043d3c
- (void)handleIncoming6LoWPANData:(const char *)arg1 tlvBufferLength:(unsigned short)arg2 length:(unsigned short)arg3 tlvType:(unsigned char)arg4;	// IMP=0x00000001000439f0
- (void)handPacketToNexus:(id)arg1;	// IMP=0x00000001000439e4
- (void)writePacketToNexusChannel:(id)arg1;	// IMP=0x00000001000438e8
- (void)handleReadData:(_Bool)arg1;	// IMP=0x00000001000414ac
- (void)flushPipeWithReason:(id)arg1;	// IMP=0x0000000100041418
- (void)cleanupLinkReadBufferWithExtra:(unsigned int)arg1;	// IMP=0x0000000100041294
- (void)armLinkStatsTimer;	// IMP=0x0000000100041174
- (_Bool)setupNexus;	// IMP=0x0000000100040bc0
- (void)checkProxyAgentWithForceUpdate:(_Bool)arg1;	// IMP=0x0000000100040af4
- (void)addVirtualInterfaceRoutes;	// IMP=0x0000000100040940
- (void)handlePongSequenceNumber:(unsigned long long)arg1 receiveTime:(unsigned long long)arg2;	// IMP=0x00000001000405a8
- (void)measureLatencyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100040180
- (void)updateDatagramPipe:(id)arg1;	// IMP=0x000000010003f708
- (void)updateUrgentPipe:(id)arg1;	// IMP=0x000000010003ed38
- (void)cleanupUrgentPipeState;	// IMP=0x000000010003ea14
- (_Bool)setQosMarkingEnabled;	// IMP=0x000000010003e744
- (_Bool)setMPKLLoggingWithEnabled:(_Bool)arg1;	// IMP=0x000000010003e4fc
- (_Bool)setupNexusChannelVoice:(id)arg1;	// IMP=0x000000010003deac
- (_Bool)setupNexusChannelBestEffort:(id)arg1;	// IMP=0x000000010003d85c
- (_Bool)setupNexusChannelBackground:(id)arg1;	// IMP=0x000000010003d20c
- (_Bool)setupNexusChannelVideo:(id)arg1;	// IMP=0x000000010003cbbc
- (_Bool)validateChannelAttributes:(struct channel_attr *)arg1;	// IMP=0x000000010003bfe0
- (_Bool)setupNexusChannel;	// IMP=0x000000010003bd68
- (void)pipeDidDisconnect;	// IMP=0x000000010003bd54
- (_Bool)resume;	// IMP=0x000000010003bc58
- (_Bool)suspend;	// IMP=0x000000010003baec
- (_Bool)cancelBecausePipeDisconnected;	// IMP=0x000000010003b97c
- (_Bool)cancelWithReason:(id)arg1;	// IMP=0x000000010003b42c
- (unsigned short)metric;	// IMP=0x000000010003b424
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003b24c
- (void)refreshCompanionProxyAgent;	// IMP=0x000000010003b1c4
- (void)dealloc;	// IMP=0x000000010003b128
- (void)invalidateLink;	// IMP=0x000000010003ad14
- (void)invalidateNexusChannels;	// IMP=0x000000010003a6d0
- (void)invalidateIKESessionClassA;	// IMP=0x000000010003a6c0
- (void)invalidateIKESessionClassC;	// IMP=0x000000010003a6b0
- (void)invalidateIKESessionClassD;	// IMP=0x000000010003a6a0
- (id *)ikeSessionPointerForDataProtectionClass:(unsigned char)arg1;	// IMP=0x000000010003a54c
- (void)invalidateIKESessionForClass:(unsigned char)arg1;	// IMP=0x000000010003a4e0
- (_Bool)start;	// IMP=0x0000000100038980
- (id)copyShortDescriptionInner;	// IMP=0x0000000100038890
- (id)copyDescriptionInner;	// IMP=0x000000010003870c
- (id)initLinkWithQueue:(id)arg1 linkDelegate:(id)arg2 nrUUID:(id)arg3 pipe:(id)arg4 remoteDeviceName:(id)arg5;	// IMP=0x0000000100038198
@property(readonly, nonatomic) _Bool hasValidPipe;
- (id)copyStatusString;	// IMP=0x0000000100036db0
