...
- (void).cxx_destruct;	// IMP=0x0000000100075dd0
...
- (_Bool)cancelIfMatchesPrefix:(id)arg1 routerID:(unsigned long long)arg2 seqno:(unsigned short)arg3;	// IMP=0x0000000100075c40
- (_Bool)cancelIfRouteUnselected;	// IMP=0x0000000100075b64
- (void)dealloc;	// IMP=0x0000000100075ae4
- (void)cancelWithDelay:(_Bool)arg1;	// IMP=0x00000001000759b0
- (void)cancelTimer;	// IMP=0x0000000100075974
- (void)start;	// IMP=0x00000001000758e8
- (id)description;	// IMP=0x00000001000757e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100075710
- (_Bool)matchesPrefix:(id)arg1 routerID:(unsigned long long)arg2;	// IMP=0x00000001000756ec
- (id)initWithInstance:(id)arg1 prefix:(id)arg2 routerID:(unsigned long long)arg3;	// IMP=0x00000001000754a0
- (void)sendSeqnoReq;	// IMP=0x00000001000753a8
- (id)createTLV;	// IMP=0x00000001000752f8
