...
- (void).cxx_destruct;	// IMP=0x0000000100020b60
...
- (id)description;	// IMP=0x0000000100020974
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0000000100020910
- (id)entitlementValueForKey:(id)arg1;	// IMP=0x000000010002085c
@property(readonly) int pid;
- (void)dead;	// IMP=0x000000010002077c
- (void)dying;	// IMP=0x0000000100020728
- (void)dealloc;	// IMP=0x00000001000206dc
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x000000010001febc
