...
+ (id)server;	// IMP=0x0000000100004068
...
- (void)stop;	// IMP=0x000000010000528c
- (void)unholdClient:(id)arg1;	// IMP=0x0000000100004f24
- (void)unholdToken:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0000000100004c1c
- (void)addHold:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0000000100004b0c
- (id)holdOnPlugIn:(id)arg1;	// IMP=0x00000001000047dc
- (void)terminatePlugIns:(id)arg1 synchronously:(_Bool)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001000041b4
- (void)removedPlugIns:(id)arg1;	// IMP=0x00000001000040c4
- (void)run;	// IMP=0x0000000100004074
- (id)initForService:(const char *)arg1 database:(const char *)arg2;	// IMP=0x0000000100003ba4
