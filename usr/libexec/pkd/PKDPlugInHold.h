...
- (id)description;	// IMP=0x0000000100019930
- (unsigned long long)hash;	// IMP=0x00000001000198e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100019824
- (id)initWithPlugIns:(id)arg1 forClient:(id)arg2;	// IMP=0x00000001000196ac
