...
- (void)pluginsWillUninstall:(id)arg1;	// IMP=0x0000000100015968
- (void)pluginsDidInstall:(id)arg1;	// IMP=0x0000000100015674
- (void)autoElect:(id)arg1;	// IMP=0x00000001000154fc
- (void)notifyAnnotationChange;	// IMP=0x0000000100015480
- (id)setAnnotation:(id)arg1 forPlugIn:(id)arg2;	// IMP=0x000000010001534c
- (id)annotationForPlugIn:(id)arg1;	// IMP=0x00000001000151b8
- (id)removePlugIn:(id)arg1;	// IMP=0x0000000100015030
- (id)addPlugIn:(id)arg1;	// IMP=0x0000000100014ea8
- (id)plugInsWithinApplication:(id)arg1;	// IMP=0x0000000100014c0c
- (id)findPlugInAtPath:(id)arg1;	// IMP=0x0000000100014b1c
- (id)findPlugIn:(id)arg1;	// IMP=0x000000010001476c
- (id)findPlugIns:(id)arg1 discoveryInstanceUUID:(id)arg2;	// IMP=0x00000001000137d0
- (void)purgeCachesToLimit:(long long)arg1;	// IMP=0x0000000100013644
- (id)createPlugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x00000001000133fc
- (id)plugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x0000000100012fac
- (id)initWithDatabase:(const char *)arg1;	// IMP=0x0000000100012c3c
