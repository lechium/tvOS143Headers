...
- (void).cxx_destruct;	// IMP=0x000000010010b458
...
- (id)description;	// IMP=0x000000010010b29c
- (_Bool)hasContainerDatabase;	// IMP=0x000000010010b28c
- (_Bool)hasCloudStoreZones;	// IMP=0x000000010010b130
