...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001552e8
- (void).cxx_destruct;	// IMP=0x00000001001555dc
...
- (void)generateNewDeviceIdentifier;	// IMP=0x0000000100155534
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100155480
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001552f0
- (id)description;	// IMP=0x00000001001551f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100154f94
