...
+ (id)createAutomaticGroupForPass:(id)arg1 withGroupingProfile:(id)arg2;	// IMP=0x000000010022d644
- (void).cxx_destruct;	// IMP=0x000000010022e298
...
- (_Bool)updateOrderWithCatalogGroup:(id)arg1;	// IMP=0x000000010022decc
- (_Bool)removePass:(id)arg1;	// IMP=0x000000010022dd94
- (_Bool)addPass:(id)arg1 withGroupingProfile:(id)arg2;	// IMP=0x000000010022d950
