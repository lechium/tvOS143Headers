...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100155630
- (void).cxx_destruct;	// IMP=0x0000000100155b50
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100155820
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100155638
