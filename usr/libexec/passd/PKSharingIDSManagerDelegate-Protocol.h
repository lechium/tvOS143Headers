...
@class NSString, PKAppleCashSharingRecipientCapabilities, PKCloudStoreZoneInvitation, PKRemoteRegistrationRequest, PKSharingDestination;
...
- (void)didReceiveCloudStoreZoneInvitation:(PKCloudStoreZoneInvitation *)arg1 fromDestination:(PKSharingDestination *)arg2;
@end
