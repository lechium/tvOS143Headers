...
- (void).cxx_destruct;	// IMP=0x000000010019d5f0
...
- (id)description;	// IMP=0x000000010019d13c
- (void)callCompletionsWithResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000010019cfd0
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010019cf88
- (id)initWithRequestType:(unsigned long long)arg1 storeChanges:(_Bool)arg2 returnRecords:(_Bool)arg3 qualityOfService:(long long)arg4 groupName:(id)arg5 groupNameSuffix:(id)arg6;	// IMP=0x000000010019ce9c
