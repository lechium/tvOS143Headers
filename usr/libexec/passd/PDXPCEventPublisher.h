...
- (void).cxx_destruct;	// IMP=0x00000001001602e4
...
- (void)sendEvent:(id)arg1;	// IMP=0x000000010015ff0c
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x000000010015fb7c
- (id)initWithStreamName:(id)arg1;	// IMP=0x000000010015f854
