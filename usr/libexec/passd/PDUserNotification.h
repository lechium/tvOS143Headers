...
+ (_Bool)supportsCoalescing;	// IMP=0x0000000100142d60
+ (_Bool)allowReinsertionAfterDismissal;	// IMP=0x0000000100142d58
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010014277c
- (void).cxx_destruct;	// IMP=0x0000000100143870
...
- (id)notificationContentWithDataSource:(id)arg1;	// IMP=0x0000000100142d80
- (unsigned long long)coalesceWithExistingUserNotification:(id)arg1;	// IMP=0x0000000100142d78
@property(readonly, nonatomic) unsigned long long notificationType;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isCashFamilyNotification;	// IMP=0x0000000100142d50
- (id)description;	// IMP=0x0000000100142c08
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100142a6c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100142784
- (id)initWithNotificationIdentifier:(id)arg1 forPassUniqueIdentifier:(id)arg2;	// IMP=0x0000000100142698
