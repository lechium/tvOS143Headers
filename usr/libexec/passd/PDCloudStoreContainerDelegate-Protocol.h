...
- (void)cloudStoreContainer:(PDCloudStoreContainer *)arg1 sendZoneShareInvitationForHandle:(NSString *)arg2 zoneName:(NSString *)arg3 qualitOfService:(long long)arg4 completion:(void (^)(_Bool, NSError *))arg5;
