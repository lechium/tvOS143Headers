...
- (void).cxx_destruct;	// IMP=0x00000001001f1178
...
- (void)receivedXPCEvent:(id)arg1 forEventStream:(id)arg2;	// IMP=0x00000001001f0ef0
- (void)_requestEnableExpressMode:(_Bool)arg1;	// IMP=0x00000001001f0d70
- (void)_logControllerState;	// IMP=0x00000001001f0c34
- (void)_unregisterForExpressAvailabilityChanges;	// IMP=0x00000001001f0ba4
- (void)_registerForExpressAvailabilityChanges;	// IMP=0x00000001001f0ae4
- (id)initWithExpressPassInformation:(id)arg1 inLostMode:(_Bool)arg2;	// IMP=0x00000001001f0700
