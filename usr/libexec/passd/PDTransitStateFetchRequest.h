...
- (void).cxx_destruct;	// IMP=0x000000010007852c
...
- (unsigned long long)hash;	// IMP=0x000000010007844c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000783a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000782b8
