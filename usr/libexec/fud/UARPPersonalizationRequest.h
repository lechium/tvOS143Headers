...
- (id)description;	// IMP=0x0000000100029720
- (_Bool)executeWithResponse:(CDUnknownBlockType)arg1;	// IMP=0x0000000100029514
- (void)convertManifestEntries:(id)arg1 productionMode:(_Bool)arg2 securityMode:(_Bool)arg3;	// IMP=0x0000000100029330
- (id)responseTicketName;	// IMP=0x00000001000292c8
- (id)requestTicketName;	// IMP=0x0000000100029260
- (_Bool)supportsImg4;	// IMP=0x0000000100029248
- (id)personalizationRequestDict;	// IMP=0x0000000100028fc4
- (id)personalizationParameterDict;	// IMP=0x0000000100028d10
@property(readonly) NSNumber *ecid;
@property(readonly) _Bool securityMode;
- (void)setSecurityMode:(_Bool)arg1;	// IMP=0x0000000100028c40
@property(readonly) _Bool productionMode;
- (void)setProductionMode:(_Bool)arg1;	// IMP=0x0000000100028bc0
- (void)setNonce:(id)arg1;	// IMP=0x0000000100028b50
- (void)setECID:(unsigned long long)arg1;	// IMP=0x0000000100028ae0
- (id)keyForFieldName:(id)arg1 default:(struct __CFString *)arg2;	// IMP=0x0000000100028a64
...
- (void)dealloc;	// IMP=0x0000000100028990
- (id)initWithChipName:(id)arg1 boardID:(id)arg2 chipID:(id)arg3 securityDomain:(id)arg4 productionMode:(_Bool)arg5 securityMode:(_Bool)arg6 nonce:(id)arg7 manifestEntries:(id)arg8;	// IMP=0x0000000100028844
