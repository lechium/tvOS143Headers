...
- (void)personalizeWithServer:(id)arg1;	// IMP=0x000000010000a208
- (struct __CFDictionary *)createPersonalizationManifestCFDict:(id)arg1;	// IMP=0x00000001000099f8
- (struct __CFDictionary *)createPersonalizationObjectCFDict:(id)arg1;	// IMP=0x00000001000097c8
- (void)doPersonalization:(id)arg1;	// IMP=0x000000010000960c
- (void)overrideSecurityDomain:(_Bool)arg1;	// IMP=0x0000000100009604
- (void)overrideServerURL:(id)arg1;	// IMP=0x00000001000095bc
- (void)dealloc;	// IMP=0x0000000100009550
- (void)freePersonalizationData;	// IMP=0x00000001000094c4
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000001000093dc
