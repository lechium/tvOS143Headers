...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000173e8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010001761c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100017454
- (void)dealloc;	// IMP=0x00000001000173f0
- (_Bool)doesPolicyContainGroup:(id)arg1;	// IMP=0x00000001000172a8
- (id)getMatchingFilterWithName:(id)arg1;	// IMP=0x0000000100017168
- (void)parsePolicyDict:(id)arg1;	// IMP=0x0000000100016698
- (id)initWithPolicyDictionary:(id)arg1 pluginName:(id)arg2;	// IMP=0x00000001000165dc
