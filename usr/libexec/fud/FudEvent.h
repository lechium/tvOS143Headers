...
- (id)description;	// IMP=0x0000000100012344
- (_Bool)isInternalEvent;	// IMP=0x000000010001232c
- (id)initWithEventType:(int)arg1 filter:(id)arg2 client:(id)arg3 data:(id)arg4;	// IMP=0x00000001000120a0
