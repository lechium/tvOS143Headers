...
- (void).cxx_destruct;	// IMP=0x0000000100011b98
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100011a18
- (unsigned long long)hash;	// IMP=0x0000000100011974
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010001181c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000116f4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100011628
- (void)writeTo:(id)arg1;	// IMP=0x0000000100011570
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100011568
- (id)dictionaryRepresentation;	// IMP=0x00000001000112b8
- (id)description;	// IMP=0x0000000100011204
