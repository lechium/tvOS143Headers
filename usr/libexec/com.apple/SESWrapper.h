...
- (void).cxx_destruct;	// IMP=0x000000010005ba08
...
- (id)recoveryResponseForBlob:(id)arg1;	// IMP=0x000000010005b024
- (id)srpResponseForEscrowBlob:(id)arg1 withKey:(struct __SecKey *)arg2 withFullCCKey:(struct ccrsa_full_ctx *)arg3;	// IMP=0x000000010005a54c
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(_Bool)arg2 enroll:(_Bool)arg3 env:(id)arg4 duplicate:(_Bool)arg5;	// IMP=0x0000000100059838
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x0000000100057c1c
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100056ec0
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;	// IMP=0x0000000100056e44
- (unsigned long long)srpPublicKeySize;	// IMP=0x0000000100056de0
- (unsigned long long)srpKeySize;	// IMP=0x0000000100056d50
- (id)srpInitBlob;	// IMP=0x0000000100056bcc
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 ckvrFlag:(_Bool)arg6 reqVersion:(int)arg7;	// IMP=0x0000000100056934
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5;	// IMP=0x0000000100056844
- (id)initWithRequest:(id)arg1 ckvrFlag:(_Bool)arg2 reqVersion:(int)arg3;	// IMP=0x000000010005668c
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;	// IMP=0x0000000100056618
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000100056608
