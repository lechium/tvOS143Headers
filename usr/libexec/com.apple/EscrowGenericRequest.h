...
- (void).cxx_destruct;	// IMP=0x0000000100018fd8
...
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x0000000100018cbc
- (id)urlString;	// IMP=0x0000000100018c00
- (id)urlRequest;	// IMP=0x0000000100018ac8
- (id)authorizationHeader;	// IMP=0x00000001000189a0
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x000000010001876c
- (id)bodyDictionary;	// IMP=0x0000000100018468
- (id)validateInput;	// IMP=0x0000000100018118
...
- (id)initWithRequest:(id)arg1;	// IMP=0x000000010001789c
