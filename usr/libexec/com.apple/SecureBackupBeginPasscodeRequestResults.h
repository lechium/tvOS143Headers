...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000f8e8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000fa20
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000f8f0
- (id)description;	// IMP=0x000000010000f79c
- (id)initWithStoredCertificate:(id)arg1 uuid:(id)arg2;	// IMP=0x000000010000f670
