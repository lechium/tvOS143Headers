...
- (void).cxx_destruct;	// IMP=0x00000001000177a0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100017620
- (unsigned long long)hash;	// IMP=0x000000010001757c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100017424
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000172fc
- (void)copyTo:(id)arg1;	// IMP=0x0000000100017230
- (void)writeTo:(id)arg1;	// IMP=0x0000000100017178
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100017170
- (id)dictionaryRepresentation;	// IMP=0x0000000100016e2c
- (id)description;	// IMP=0x0000000100016d78
