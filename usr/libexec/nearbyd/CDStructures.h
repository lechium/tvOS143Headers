...
struct Session {
    ...
    struct RoseServiceRequest _field4;
    struct function<void (rose::ServiceRequestStatusUpdate)> _field5;
    struct function<void (const rose::RoseSolution &)> _field6;
    struct function<void (const rose::RemoteSessionData &)> _field7;
    struct function<void (rose::objects::Session *, rose::objects::InvalidationReason)> _field8;
    struct function<void (rose::objects::ReturnCode, float, float, int)> _field9;
    shared_ptr_7f363ebc _field10;
    id _field11;
    struct optional<unsigned short> _field12;
    struct optional<rose::RoseStartRangingOptions> _field13;
    struct optional<rose::ServiceRequestStatusUpdate> _field14;
    struct optional<rose::RoseServiceStateUpdate> _field15;
    struct atomic<bool> _field16;
    struct atomic<unsigned char> _field17;
};
