...
- (void).cxx_destruct;	// IMP=0x0000000100088650
...
- (void)setPowerState:(long long)arg1;	// IMP=0x00000001000882dc
- (void)stop;	// IMP=0x0000000100088254
- (_Bool)start;	// IMP=0x0000000100087ff4
- (void)setReadyToSleep;	// IMP=0x0000000100087e00
- (_Bool)sleepPending;	// IMP=0x0000000100087dc4
- (id)initWithDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100087d1c
