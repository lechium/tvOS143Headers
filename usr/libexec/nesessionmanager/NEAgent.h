...
- (void).cxx_destruct;	// IMP=0x000000010007da6c
...
- (_Bool)validateAfterStartWithAuditTokens:(id)arg1;	// IMP=0x000000010007d924
@property(readonly) _Bool isPerUser;
- (void)addUUIDs:(id)arg1;	// IMP=0x000000010007d690
- (void)setPluginPID:(int)arg1 uuids:(id)arg2;	// IMP=0x000000010007d608
- (_Bool)supportsMultipleInstancesOfExtension;	// IMP=0x000000010007d598
- (void)terminate;	// IMP=0x000000010007d504
- (void)disposeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007cf24
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007c9b0
- (void)sendSetupCommandWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007c300
- (id)description;	// IMP=0x000000010007c2f8
- (_Bool)matchesAuditToken:(id)arg1 expectedCDHashes:(id)arg2 requiredEntitlement:(id)arg3;	// IMP=0x000000010007c2f0
- (id)initWithPluginType:(id)arg1 pluginVersion:(long long)arg2 pluginClass:(long long)arg3 pluginInfo:(id)arg4 userID:(id)arg5;	// IMP=0x000000010007c190
