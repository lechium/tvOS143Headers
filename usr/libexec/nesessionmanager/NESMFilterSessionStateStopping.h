...
- (void)handleTimeout;	// IMP=0x000000010005c9e8
- (void)handlePluginDisposeComplete:(id)arg1;	// IMP=0x000000010005c8d0
- (void)enterWithSession:(id)arg1;	// IMP=0x000000010005c5f0
- (id)init;	// IMP=0x000000010005c5a4
